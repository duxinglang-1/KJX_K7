...
fssim_tls_struct _fssim_tls[FSSIM_MAX_THREAD];
...
{    /* SAMPLE Line
	  * { DriveLetter, , , DEVICE, SectorSize(512), SectorsPerCluster(4), TotalClusters = Disk Size, , }
	  */
     {FSSIM_SYSTEM_DRIVE, 0, 1, FSSIM_DEV_NOR, FSSIM_BYTES_PER_SECTOR, FSSIM_SECTORS_PER_CLUSER, 67890, 0, 0, 0 }
    ,{FSSIM_SYSTEM_DRIVE + 1, 0, 0, FSSIM_DEV_NAND, FSSIM_BYTES_PER_SECTOR, FSSIM_SECTORS_PER_CLUSER, 67890, 0, 0, 0 }
    ,{FSSIM_SYSTEM_DRIVE + 2, 0, 0, FSSIM_DEV_CARD1, FSSIM_BYTES_PER_SECTOR, FSSIM_SECTORS_PER_CLUSER, 1048576, 0, 0, 0 }
    #ifdef __FS_CARD2_SUPPORT__  // dual t-card support
    ,{FSSIM_SYSTEM_DRIVE + 3, 0, 0, FSSIM_DEV_CARD2, FSSIM_BYTES_PER_SECTOR, FSSIM_SECTORS_PER_CLUSER, 1048576, 0, 0, 0 }
 ...
 * Array of drives' information.
 */
FSSIM_HW_DEVICE_STRUCT_T fssim_device[FSSIM_MAX_DRIVE + 1] =
{    {0,0,0, 0}
    ,{1,0,0, FS_DEVICE_TYPE_NOR} /* FSSIM_DEV_NOR */
    ,{1,0,0, FS_DEVICE_TYPE_NAND} /* FSSIM_DEV_NAND*/
    ,{1,0,0, FS_DEVICE_TYPE_CARD}  /* FSSIM_DEV_CARD1*/
    #ifdef __FS_CARD2_SUPPORT__  // dual t-card support
    ,{1,0,0, FS_DEVICE_TYPE_CARD}  /* FSSIM_DEV_CARD2*/
    #endif  // __FS_CARD2_SUPPORT__
};

int fssim_public_drive_existence = 1;
 ...
 * Dir Cache Array
 */
FSSIM_DIRASSOCIATEDCACHE_T fssim_DirCacheArray[FSSIM_DIRCACHE_NUM] = { 0 };
...
{
   {"Z:\\@DRM\\",  FS_QP_HIG_ENUM, 400*1024, FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},

   {"Z:\\@Java\\", FS_QP_HIG_ENUM, 200*1024, FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},

   {"Z:\\@USER\\", FS_QP_HIG_ENUM,  20*1024,  30 * 1024      , FS_COUNT_IN_BYTE},

   {"Z:\\@imps\\", FS_QP_HIG_ENUM, 80*1024, FS_QMAX_NO_LIMIT, FS_COUNT_IN_BYTE},
...
#define FSSIM_DATA_MAX_QSET (3+1)
