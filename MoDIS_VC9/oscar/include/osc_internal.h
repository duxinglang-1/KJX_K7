...
//osc_enhmutex.c ------------------------------------------------------------------
extern osc_struct_dd_hdr     g_osc_enhmutex_list;
...
extern osc_enum_bool       g_osc_bProcessingTimerHISR;
...
extern void                osc_platform_critical_section_initialize ( void *pcs );

extern void                osc_platform_critical_section_delete ( void *pcs );

extern void                osc_platform_critical_section_enter ( void *pcs );

extern osc_enum_bool       osc_platform_critical_section_try_enter ( void *pcs);

extern void                osc_platform_critical_section_leave ( void *pcs );

extern void                osc_platform_tls_set_value ( void *lpTlsValue );

extern void*               osc_platform_tls_get_value ( void );
...
extern void                osc_system_resource_penalty_suspend (
                              osc_struct_thread *thread,
...
extern osc_enum_bool       osc_system_resource_penalty_resume ( 
                              osc_struct_thread *thread,
                              osc_enum_state    new_state );

extern void                osc_system_fatal_error ( void );

extern osc_type_s32 osc_internal_timer_create(
         osc_type_u8          *name,
         ...
         osc_type_void_ptr    *information );


extern osc_type_s32 osc_internal_timer_config (
...
extern void  osc_thread_timeout(osc_struct_thread *thread);
