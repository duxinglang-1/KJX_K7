...
KJX_GPS_SUPPORT = TRUE #TRUETRUE

KJX_OBD_SUPPORT = FALSE #TRUE   FALSE

NPR_TTS_SUPPORT = TRUE #TRUE 
...
MOTION_SENSOR_SUPPORT = MOTION_SENSOR_SUPPORT
  # Description:
...
MAIN_LCD_SIZE = 240X320	#128X128	#240X320
  # Description:
...
TOUCH_PANEL_SUPPORT = NONE  #TP_INTERNAL
  # Description:
...
INPUT_METHOD = NONE   #MMI_GUOBI_V5_2_SLIM
  # Description:
...
GOOGLE_SEARCH_SUPPORT = FALSE  #TRUE
  # Description:
...
# ------------------------------ Connectivity
BLUETOOTH_SUPPORT = NONE  #BTMTK_MT6260
  # Description:
...
CMMB_CAS_2GPP_VER = NONE
  ...
  # Option Values:
  #   NONE: Disable this feature
  #   V10: Support 2G CMMB Post paid version 1.0 (Support å¼€æˆ?æŽˆæƒ,need 2G CMMB Chip Support,Such as IF206)
  # Switch-ability:
  #   Non-switchable
...
TIME_LAPSE_VIDEO_RECORDER = DISABLE  #ENABLE
  # Description:
...
CAMCORDER_SUPPORT = NONE # STANDARD
  # Description:
...
# ------------------------------ VoIP
# ------------------------------ Wifi
CUSTOM_WIFI_FEATURES_SWITCH = FALSE  #TRUE
  # Description:
...
FONT_ENGINE = NONE #FONT_ENGINE_ETRUMP
  # Description:
...
BROWSER_SUPPORT = NONE  #OBIGO_Q03C
  # Description:
...
YAHOO_CONTENT_SUPPORT = FALSE  #TRUE
  # Description:
...
BLUETOOTH_VERSION = NONE   #BT_VER_30
  # Description:
...
BT_FM_RADIO_VIA_SCO =FALSE   #  TRUE
  # Description:
...
MEDIA_PLAYER_VER = SEPARATED # INTEGRATED
  # Description:
...
PGDL_SUPPORT_YOUTUBE = FALSE  #TRUE
  # Description:
...
WIFI_BT_SINGLE_ANTENNA_SUPPORT = FALSE   #TRUE
  # Description:
...
# baiwenlin 20130831  
# COM_DEFS+= __OLED_BW_DIVER__		#OLEDÇý¶¯
#COM_DEFS+= __OLED_BW_MMI__		#ºÚ°×ÆÁMMI´¦Àí
#COM_DEFS+= __OLED_SH1106__
# *************************************************************************
