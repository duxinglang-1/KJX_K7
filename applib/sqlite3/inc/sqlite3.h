...
void *sqlite3_malloc_cache(int);
void *sqlite3_realloc(void*, int);
void sqlite3_free(void*);
void sqlite3_free_cache(void*);

/*
** This API will dump memory info with API name
*/
#ifdef __TST_MODULE__
void sqlite3_log_meminfo(unsigned int msg_index, const char* arg_type);
#else
#define sqlite3_log_meminfo(msg_index);
#endif  /* __TST_MODULE__ */

/*
** Speed up memory allocate speed in multi-instance environment
*/
void *sqlite3_malloc_ex(sqlite3_instance*, int);
void *sqlite3_malloc_cache_ex(sqlite3_instance*, int);
void *sqlite3_realloc_ex(sqlite3_instance*, void*, int);
void sqlite3_free_ex(sqlite3_instance*, void*);
void sqlite3_free_cache_ex(sqlite3_instance*, void*);
