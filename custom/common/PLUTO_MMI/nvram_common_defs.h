...
#ifdef __IV_TTS__
#define NVRAM_IVTTS_SETTING_TOTAL 1
#define NVRAM_IVTTS_SETTING_SIZE  sizeof(nvram_iv_tts_setting)
#define NVRAM_IVTTS_SETTING_LID_VERNO "000"
#endif
     
#ifdef __KJX_FUN__
#ifdef __KJX_NEW_NVRAM__
#define NVRAM_EF_KJX_APPICON_TOTAL	1
#define NVRAM_EF_KJX_APPICON_SIZE       sizeof(nvram_ef_kjx_nvram_struct)
#endif

#define NVRAM_EF_KJX_WORK_TIME_TOTAL	1
#define NVRAM_EF_KJX_WORK_TIME_SIZE       sizeof(nvram_ef_kjx_work_time_fun)

#if defined(__KJX_LOG_OUTPUT__)
#define NVRAM_EF_KJX_LOG_PARAM_TOTAL	1
#define NVRAM_EF_KJX_LOG_PARAM_SIZE       sizeof(nvram_ef_kjx_log_param_struct)
#endif/*__KJX_LOG_OUTPUT__*/

#if defined(__KJX_SOC_APP__)
#define NVRAM_EF_TRACKER_APN_TOTAL    	1
#define NVRAM_EF_TRACKER_APN_SIZE     sizeof(nvram_ef_tracker_apn_param_struct) 

#define NVRAM_EF_TRACKER_SERVER_TOTAL	1
#define NVRAM_EF_TRACKER_SERVER_SIZE     sizeof(nvram_ef_tracker_server_param_struct) 
#endif/*__KJX_SOC_APP__*/
