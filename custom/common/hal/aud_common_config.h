...
#elif defined(MT6235) || defined(MT6235B) || defined(MT6253) || defined(MT6268) || defined(MT6236) || defined(MT6236B) || defined(MT6256_S00) || defined(MT6251) || defined(MT6253E) || defined(MT6253L)|| defined(MT6252) || defined(MT6252H)
#define DEFAULT_SPEECH_COMMON_PARA \
{ \
     0, 55997, 31000, 10752, 32769,     0,     0,     0,     0,     0, \
     0,     0 \
}
#elif defined(MT6276) || defined(MT6573) || defined(MT6575)
#define DEFAULT_SPEECH_COMMON_PARA \
{ \
     0, 55997, 31000, 10752,     32769,     0,     0,     0,     0,     0, \
     0,     0 \
