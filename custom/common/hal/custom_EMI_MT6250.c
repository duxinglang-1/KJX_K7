 ...
 *============================================================================
 ****************************************************************************/
#if defined(MT6250) && defined(__MTK_TARGET__)
...
#define EMI_ARB_C_VAL                           0x00005045   // MM 
...
#if defined(__EMI_CLK_130MHZ__) //Tk-pSRAM mode
...
#endif //#if defined(__EMI_CLK_130MHZ__) //Tk-pSRAM mode
...
#endif //#if defined(MT6250) && defined(__MTK_TARGET__)
