    ...
    {    
     ...
     /*--------------------------------------------------------------------------
        ...
        {   
            ...
            SFI_WriteReg32(RW_SFI_MISC_CTL2, sfi->HWConf_78M[SFC_MISC_CTL2]);
            SFI_WriteReg32(RW_SFI_DLY_CTL2, sfi->HWConf_78M[SFC_DLY_CTL2]);
			/*Sample clock delay of dual SF must right shift 2 setps in comparison to Single SF*/
			if(CS_COUNT_SFI==2)
                SFI_WriteReg32(RW_SFI_DLY_CTL3, (sfi->HWConf_78M[SFC_DLY_CTL3]+0x02000002));
			else
                SFI_WriteReg32(RW_SFI_DLY_CTL3, sfi->HWConf_78M[SFC_DLY_CTL3]);
        }
        else
        {
            ...
            /*Sample clock delay of dual SF must right shift 2 setps in comparison to Single SF*/
            SFI_WriteReg32(RW_SFI_DLY_CTL6, (sfi->HWConf_78M[SFC_DLY_CTL3]+0x02000002));
        }
#else
	#error "Undefined BB chips"
      ...
      /*--------------------------------------------------------------------------
        ...
        {   
			...
			/*Sample clock delay of dual SF must right shift 2 setps in comparison to Single SF*/
			if(CS_COUNT_SFI==2)
                SFI_WriteReg32(RW_SFI_DLY_CTL3, (sfi->HWConf_104M[SFC_DLY_CTL3]+0x02000002));
            else
                SFI_WriteReg32(RW_SFI_DLY_CTL3, sfi->HWConf_104M[SFC_DLY_CTL3]);
        }
        else
        {
            ...
            /*Sample clock delay of dual SF must right shift 2 setps in comparison to Single SF*/
            SFI_WriteReg32(RW_SFI_DLY_CTL6, (sfi->HWConf_104M[SFC_DLY_CTL3]+0x02000002));
        }
#else
	#error "Undefined BB chips"
#endif //defined(MT6250)||defined(MT6260)
       ...
       /*--------------------------------------------------------------------------
        ...
        {   
            ...
            /*Sample clock delay of dual SF must right shift 2 setps in comparison to Single SF*/
			if(CS_COUNT_SFI==2)
                SFI_WriteReg32(RW_SFI_DLY_CTL3, (sfi->HWConf_130M[SFC_DLY_CTL3]+0x02000002));
			else
                SFI_WriteReg32(RW_SFI_DLY_CTL3, sfi->HWConf_130M[SFC_DLY_CTL3]);
        }
        else
        {
            ...
            /*Sample clock delay of dual SF must right shift 2 setps in comparison to Single SF*/
            SFI_WriteReg32(RW_SFI_DLY_CTL6, (sfi->HWConf_130M[SFC_DLY_CTL3]+0x02000002));
        }
#else
	#error "Undefined BB chips"
#endif //defined(MT6250)||defined(MT6260)
       ...
       /*--------------------------------------------------------------------------
        ...
        {   
            ...
            /*Sample clock delay of dual SF must right shift 2 setps in comparison to Single SF*/
			if(CS_COUNT_SFI==2)
                SFI_WriteReg32(RW_SFI_DLY_CTL3, (sfi->HWConf_166M[SFC_DLY_CTL3]+0x02000002));
			else
                SFI_WriteReg32(RW_SFI_DLY_CTL3, sfi->HWConf_166M[SFC_DLY_CTL3]);
        }
        else
        {
            ...
            /*Sample clock delay of dual SF must right shift 2 setps in comparison to Single SF*/
            SFI_WriteReg32(RW_SFI_DLY_CTL6, (sfi->HWConf_166M[SFC_DLY_CTL3]+0x02000002));
        }
#else
	#error "Undefined BB chips"
#endif //defined(MT6250)||defined(MT6260)
