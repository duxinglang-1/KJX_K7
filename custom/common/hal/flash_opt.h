...
//Smart Phone Modem Only Load
#if defined(__SMART_PHONE_PLATFORM__) && !defined(__SMART_PHONE_MODEM__)
#define NOR_FLASH_TYPE_RAM_DISK
#define NOR_BLOCK_SIZE  0x40000
#define NOR_FLASH_BASE_ADDRESS_DEFAULT 0x03C00000
#define NOR_ALLOCATED_FAT_SPACE_DEFAULT 0x00400000
