...
#if MMI_SMS_MAX_MSG_SEG == 1
kal_uint32 ems_textBuffer[EMS_MAX_EMS_DATA][(160 * 2 + 4 + 3) / 4];  /* text buffer */
#else
kal_uint32 ems_textBuffer[EMS_MAX_EMS_DATA][(MMI_SMS_MAX_MSG_SEG * 153 * 2 + 4 + 3) / 4];  /* text buffer */
#endif
...
#define MMI_SMS_MAX_EXT_MSG_SEG   ((MMI_SMS_MAX_MSG_SEG * 153 + 66)/67)

kal_uint32 ems_textBuffer[EMS_MAX_EMS_DATA][(MMI_SMS_MAX_EXT_MSG_SEG * 67 * 2 + 4 + 3) / 4];  /* text buffer */
kal_uint8 ems_TPUDLen[EMS_MAX_EMS_DATA][MMI_SMS_MAX_EXT_MSG_SEG];
kal_uint8 ems_UDHL[EMS_MAX_EMS_DATA][MMI_SMS_MAX_EXT_MSG_SEG];
kal_uint8 ems_oridcsBuffer[EMS_MAX_EMS_DATA][MMI_SMS_MAX_EXT_MSG_SEG];
...
/*****************************************************************************
 * FUNCTION
 *  ems_is_support_non_std_char
 * DESCRIPTION
 *  This function is used to support non-standard character (Orange feature)
 * PARAMETERS
 *  void
 * RETURNS
 *  kal_uint8
 *****************************************************************************/
kal_bool ems_is_support_non_std_char(void)
{
 ...
 *  ems_max_ems_data
 * DESCRIPTION
 *  This function is used to define the maximum EMS data context.
 * PARAMETERS
 *  void
 * RETURNS
 *  kal_uint8
 *****************************************************************************/
kal_uint8 ems_max_ems_data(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
