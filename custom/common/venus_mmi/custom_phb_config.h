...
#else
#define MMI_PHB_NUMBER_FIELD_COUNT           (3)
#endif
...
#define MMI_PHB_LIST_COUNT 2

#if defined(__MMI_PHB_MULTI_OPERATION__) || defined(__MMI_PHB_GENERIC_MULTI_SELECT__)
#define MMI_PHB_LIST_MEM (15 * MMI_PHB_ENTRIES * MMI_PHB_LIST_COUNT)
#else
#define MMI_PHB_LIST_MEM (10 * MMI_PHB_ENTRIES * MMI_PHB_LIST_COUNT)
#endif
...
typedef struct
{
    mmi_phb_email_type_enum type;                             /* number type */
    kal_uint16 email[MMI_PHB_NUMBER_PLUS_LENGTH + 1];      /* WCS number data */
