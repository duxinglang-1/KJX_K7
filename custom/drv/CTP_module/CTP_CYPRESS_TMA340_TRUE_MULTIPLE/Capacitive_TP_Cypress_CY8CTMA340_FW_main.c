 ...
 * Filename:
 * ---------
 *   Capacitive_TP_Cypress_CY8CTMA340_FW_main.c
 *
 *
 * Description:
 * ------------
...
void ctp_cypress_error_handler(FS_HANDLE fp, kal_bool need_delete, const kal_wchar *path)
{

}

kal_bool ctp_cypress_upgrader(void)
{
	return KAL_FALSE;
} 
