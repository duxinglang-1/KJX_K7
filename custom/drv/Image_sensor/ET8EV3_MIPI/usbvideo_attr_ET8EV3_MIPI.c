...
const USBVideo_Attr_Info ET8EV3MipiWebcamAttrInfo[11] =      
{
...
const USBVideo_Video_Size_Info ET8EV3MipiWebcamVideoSize[3] = /// for size customization
{
...
const USBVideo_Still_Size_Info ET8EV3MipiWebcamStillSize[3] =  /// for size customization
{
...
const USBVideo_Compression_Info ET8EV3MipiWebcamStillCompression[2] = /// for compression customization
{
	//{USBVIDEO_COMPRESSION_1, JPEG_ENCODER_GOOD_QUALITY},
	{USBVIDEO_COMPRESSION_1, JPEG_ENCODE_QUALITY_POOR},
    {USBVIDEO_COMPRESSION_2, JPEG_ENCODE_QUALITY_FAIR}
};
const USBVIDEO_VIDEO_SIZE_TYPE ET8EV3MipiWebcamDefaultVideoSize = USBVIDEO_VIDEO_SIZE_1;
const USBVIDEO_STILL_SIZE_TYPE ET8EV3MipiWebcamDefaultStillSize = USBVIDEO_STILL_SIZE_1;
const USBVIDEO_COMPRESSION_TYPE ET8EV3MipiWebcamDefaultCompression = USBVIDEO_COMPRESSION_1;

const usbvideo_attr_struct ET8EV3MipiWebcamAttrPara=
{
    /* min,	max,	       res,	      def */
    {
...
MM_ERROR_CODE_ENUM ET8EV3MipiWebcamFeatureCtrl(IMAGE_SENSOR_FEATURE_ENUM FeatureId,
                                                ...
                                                kal_uint32 FeatureParaOutLen, kal_uint32 *pRealFeatureParaOutLen)
{
            ...
            else
            {
                if (AttrType >= ATTR_PU_START)
                {
                    ...
                    case USBVIDEO_REQUEST_GET_MIN:
                        pWebCamAttr->value = ET8EV3MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
                        break;
                    case USBVIDEO_REQUEST_GET_MAX:
                        pWebCamAttr->value = ET8EV3MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
                        break;
                    case USBVIDEO_REQUEST_GET_DEF:
                        pWebCamAttr->value = ET8EV3MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
                        break;
                    case USBVIDEO_REQUEST_GET_RES:
                        pWebCamAttr->value = ET8EV3MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
                        break;
                    default:
    ...
    case CAL_FEATURE_WEBCAM_SET_ATTR:
        {
            // Only for YUV sensor
            // ET8EV3_MIPI_usbvideo_set_attr((USBVideo_Attr_Value *)pFeatureParaIn);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
        {
            ...
            pWebCamAttrInfo->pWebCamAttrInfo = ET8EV3MipiWebcamAttrInfo;
            pWebCamAttrInfo->WebCamAttrInfoNum = sizeof(ET8EV3MipiWebcamAttrInfo) / sizeof(USBVideo_Attr_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
        {
            ...
            pWebCamVideoSize->pWebCamVideoSizeInfo = ET8EV3MipiWebcamVideoSize;
            pWebCamVideoSize->WebCamVideoSizeInfoNum = sizeof(ET8EV3MipiWebcamVideoSize) / sizeof(USBVideo_Video_Size_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
        {
            ...
            pWebCamStillSize->pWebCamStillSizeInfo = ET8EV3MipiWebcamStillSize;
            pWebCamStillSize->WebCamStillSizeInfoNum = sizeof(ET8EV3MipiWebcamStillSize) / sizeof(USBVideo_Still_Size_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
        {
            ...
            pWebCamCompression->pWebCamCompressionInfo = ET8EV3MipiWebcamStillCompression;
            pWebCamCompression->WebCamCompressionInfoNum = sizeof(ET8EV3MipiWebcamStillCompression) / sizeof(USBVideo_Compression_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
        {
            ...
            pWebCamDeafultIdx->WebCamVideoSizeIdx = ET8EV3MipiWebcamDefaultVideoSize;
            pWebCamDeafultIdx->WebCamStillSizeIdx = ET8EV3MipiWebcamDefaultStillSize;
            pWebCamDeafultIdx->WebCamCompressionIdx = ET8EV3MipiWebcamDefaultCompression;
        }
        break;
