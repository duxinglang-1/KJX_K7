...
const USBVideo_Attr_Info MT9P012WebcamAttrInfo[11] =      
{
...
const USBVideo_Video_Size_Info MT9P012WebcamVideoSize[3] = /// for size customization
{
...
const USBVideo_Still_Size_Info MT9P012WebcamStillSize[3] =  /// for size customization
{
...
const USBVideo_Compression_Info MT9P012WebcamStillCompression[2] = /// for compression customization
{
...
const USBVIDEO_VIDEO_SIZE_TYPE MT9P012WebcamDefaultVideoSize = USBVIDEO_VIDEO_SIZE_1;
const USBVIDEO_STILL_SIZE_TYPE MT9P012WebcamDefaultStillSize = USBVIDEO_STILL_SIZE_1;
const USBVIDEO_COMPRESSION_TYPE MT9P012WebcamDefaultCompression = USBVIDEO_COMPRESSION_1;

const usbvideo_attr_struct MT9P012WebcamAttrPara=
{
    /* min,	max,	       res,	      def */
    {
            ...
            else
            {
                if (AttrType >= ATTR_PU_START)
                {
                    ...
                    case USBVIDEO_REQUEST_GET_MIN:
                        pWebCamAttr->value = MT9P012WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
                        break;
                    case USBVIDEO_REQUEST_GET_MAX:
                        pWebCamAttr->value = MT9P012WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
                        break;
                    case USBVIDEO_REQUEST_GET_DEF:
                        pWebCamAttr->value = MT9P012WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
                        break;
                    case USBVIDEO_REQUEST_GET_RES:
                        pWebCamAttr->value = MT9P012WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
                        break;
                    default:
    ...
    case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
        {
            ...
            pWebCamAttrInfo->pWebCamAttrInfo = MT9P012WebcamAttrInfo;
            pWebCamAttrInfo->WebCamAttrInfoNum = sizeof(MT9P012WebcamAttrInfo) / sizeof(USBVideo_Attr_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
        {
            ...
            pWebCamVideoSize->pWebCamVideoSizeInfo = MT9P012WebcamVideoSize;
            pWebCamVideoSize->WebCamVideoSizeInfoNum = sizeof(MT9P012WebcamVideoSize) / sizeof(USBVideo_Video_Size_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
        {
            ...
            pWebCamStillSize->pWebCamStillSizeInfo = MT9P012WebcamStillSize;
            pWebCamStillSize->WebCamStillSizeInfoNum = sizeof(MT9P012WebcamStillSize) / sizeof(USBVideo_Still_Size_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
        {
            ...
            pWebCamCompression->pWebCamCompressionInfo = MT9P012WebcamStillCompression;
            pWebCamCompression->WebCamCompressionInfoNum = sizeof(MT9P012WebcamStillCompression) / sizeof(USBVideo_Compression_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
        {
            ...
            pWebCamDeafultIdx->WebCamVideoSizeIdx = MT9P012WebcamDefaultVideoSize;
            pWebCamDeafultIdx->WebCamStillSizeIdx = MT9P012WebcamDefaultStillSize;
            pWebCamDeafultIdx->WebCamCompressionIdx = MT9P012WebcamDefaultCompression;
        }
        break;
