 ...
 * Filename:
 * ---------
 *   camera_sensor_para_MT9P012_MIPI.h
 *
 * Project:
 * --------
 *   MAUI
 ...
 *============================================================================
 ****************************************************************************/
#ifndef _CAMERA_SENSOR_PARA_MT9P012_MIPI_H
#define _CAMERA_SENSOR_PARA_MT9P012_MIPI_H
 

#if defined(ISP_SUPPORT)
 
	/* STRUCT: SENSOR */
#define MT9P012_MIPI_CAMERA_SENSOR_REG_DEFAULT_VALUE  \
		/* ARRAY: SENSOR.reg[40] */\
		{\
			/* STRUCT: SENSOR.reg[0] */\
			{\
			...
			{\
				/* SENSOR.reg[34].addr */ 0xFFFFFFFF, /* SENSOR.reg[34].para */ 0xFFFFFFFF\
			},\
			/* STRUCT: SENSOR.reg[35] */\
			{\
				/* SENSOR.reg[35].addr */ 0xFFFFFFFF, /* SENSOR.reg[35].para */ 0xFFFFFFFF\
			},\
			/* STRUCT: SENSOR.reg[36] */\
			{\
				/* SENSOR.reg[36].addr */ 0xFFFFFFFF, /* SENSOR.reg[36].para */ 0xFFFFFFFF\
			},\
			/* STRUCT: SENSOR.reg[37] */\
			{\
				/* SENSOR.reg[37].addr */ 0xFFFFFFFF, /* SENSOR.reg[37].para */ 0xFFFFFFFF\
			},\
			/* STRUCT: SENSOR.reg[38] */\
			{\
				/* SENSOR.reg[38].addr */ 0xFFFFFFFF, /* SENSOR.reg[38].para */ 0xFFFFFFFF\
			},\
			/* STRUCT: SENSOR.reg[39] */\
			{\
				/* SENSOR.reg[39].addr */ 0xFFFFFFFF, /* SENSOR.reg[39].para */ ISP_DRIVING_2MA\
			}\
		}
