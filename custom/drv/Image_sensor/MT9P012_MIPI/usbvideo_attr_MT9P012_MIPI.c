...
const USBVideo_Attr_Info MT9P012MipiWebcamAttrInfo[11] =      
{
...
const USBVideo_Video_Size_Info MT9P012MipiWebcamVideoSize[3] = /// for size customization
{
...
const USBVideo_Still_Size_Info MT9P012MipiWebcamStillSize[3] =  /// for size customization
{
...
const USBVideo_Compression_Info MT9P012MipiWebcamStillCompression[2] = /// for compression customization
{
...
const USBVIDEO_VIDEO_SIZE_TYPE MT9P012MipiWebcamDefaultVideoSize = USBVIDEO_VIDEO_SIZE_1;
const USBVIDEO_STILL_SIZE_TYPE MT9P012MipiWebcamDefaultStillSize = USBVIDEO_STILL_SIZE_1;
const USBVIDEO_COMPRESSION_TYPE MT9P012MipiWebcamDefaultCompression = USBVIDEO_COMPRESSION_1;

const usbvideo_attr_struct MT9P012MipiWebcamAttrPara=
{
    /* min,	max,	       res,	      def */
    {
                                                ...
                                                kal_uint32 FeatureParaOutLen, kal_uint32 *pRealFeatureParaOutLen)
{
            ...
            else
            {
                if (AttrType >= ATTR_PU_START)
                {
                    ...
                    case USBVIDEO_REQUEST_GET_MIN:
                        pWebCamAttr->value = MT9P012MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
                        break;
                    case USBVIDEO_REQUEST_GET_MAX:
                        pWebCamAttr->value = MT9P012MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
                        break;
                    case USBVIDEO_REQUEST_GET_DEF:
                        pWebCamAttr->value = MT9P012MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
                        break;
                    case USBVIDEO_REQUEST_GET_RES:
                        pWebCamAttr->value = MT9P012MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
                        break;
                    default:
    ...
    case CAL_FEATURE_WEBCAM_SET_ATTR:
        {
            // Only for YUV sensor
            // MT9P012_MIPI_usbvideo_set_attr((USBVideo_Attr_Value *)pFeatureParaIn);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
        {
            ...
            pWebCamAttrInfo->pWebCamAttrInfo = MT9P012MipiWebcamAttrInfo;
            pWebCamAttrInfo->WebCamAttrInfoNum = sizeof(MT9P012MipiWebcamAttrInfo) / sizeof(USBVideo_Attr_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
        {
            ...
            pWebCamVideoSize->pWebCamVideoSizeInfo = MT9P012MipiWebcamVideoSize;
            pWebCamVideoSize->WebCamVideoSizeInfoNum = sizeof(MT9P012MipiWebcamVideoSize) / sizeof(USBVideo_Video_Size_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
        {
            ...
            pWebCamStillSize->pWebCamStillSizeInfo = MT9P012MipiWebcamStillSize;
            pWebCamStillSize->WebCamStillSizeInfoNum = sizeof(MT9P012MipiWebcamStillSize) / sizeof(USBVideo_Still_Size_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
        {
            ...
            pWebCamCompression->pWebCamCompressionInfo = MT9P012MipiWebcamStillCompression;
            pWebCamCompression->WebCamCompressionInfoNum = sizeof(MT9P012MipiWebcamStillCompression) / sizeof(USBVideo_Compression_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
        {
            ...
            pWebCamDeafultIdx->WebCamVideoSizeIdx = MT9P012MipiWebcamDefaultVideoSize;
            pWebCamDeafultIdx->WebCamStillSizeIdx = MT9P012MipiWebcamDefaultStillSize;
            pWebCamDeafultIdx->WebCamCompressionIdx = MT9P012MipiWebcamDefaultCompression;
        }
        break;
