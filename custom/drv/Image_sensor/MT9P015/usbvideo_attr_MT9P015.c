...
const USBVideo_Attr_Info MT9P015WebcamAttrInfo[11] =      
{
...
const USBVideo_Video_Size_Info MT9P015WebcamVideoSize[3] = /// for size customization
{
...
const USBVideo_Still_Size_Info MT9P015WebcamStillSize[3] =  /// for size customization
{
...
const USBVideo_Compression_Info MT9P015WebcamStillCompression[2] = /// for compression customization
{
...
const USBVIDEO_VIDEO_SIZE_TYPE MT9P015WebcamDefaultVideoSize = USBVIDEO_VIDEO_SIZE_1;
const USBVIDEO_STILL_SIZE_TYPE MT9P015WebcamDefaultStillSize = USBVIDEO_STILL_SIZE_1;
const USBVIDEO_COMPRESSION_TYPE MT9P015WebcamDefaultCompression = USBVIDEO_COMPRESSION_1;

const usbvideo_attr_struct MT9P015WebcamAttrPara=
{
    /* min,	max,	       res,	      def */
    {
                                                ...
                                                kal_uint32 FeatureParaOutLen, kal_uint32 *pRealFeatureParaOutLen)
{
            ...
            else
            {
                if (AttrType >= ATTR_PU_START)
                {
                    ...
                    case USBVIDEO_REQUEST_GET_MIN:
                        pWebCamAttr->value = MT9P015WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
                        break;
                    case USBVIDEO_REQUEST_GET_MAX:
                        pWebCamAttr->value = MT9P015WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
                        break;
                    case USBVIDEO_REQUEST_GET_DEF:
                        pWebCamAttr->value = MT9P015WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
                        break;
                    case USBVIDEO_REQUEST_GET_RES:
                        pWebCamAttr->value = MT9P015WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
                        break;
                    default:
    ...
    case CAL_FEATURE_WEBCAM_SET_ATTR:
        {
            // Only for YUV sensor
            // MT9P015_MIPI_usbvideo_set_attr((USBVideo_Attr_Value *)pFeatureParaIn);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
        {
            ...
            pWebCamAttrInfo->pWebCamAttrInfo = MT9P015WebcamAttrInfo;
            pWebCamAttrInfo->WebCamAttrInfoNum = sizeof(MT9P015WebcamAttrInfo) / sizeof(USBVideo_Attr_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
        {
            ...
            pWebCamVideoSize->pWebCamVideoSizeInfo = MT9P015WebcamVideoSize;
            pWebCamVideoSize->WebCamVideoSizeInfoNum = sizeof(MT9P015WebcamVideoSize) / sizeof(USBVideo_Video_Size_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
        {
            ...
            pWebCamStillSize->pWebCamStillSizeInfo = MT9P015WebcamStillSize;
            pWebCamStillSize->WebCamStillSizeInfoNum = sizeof(MT9P015WebcamStillSize) / sizeof(USBVideo_Still_Size_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
        {
            ...
            pWebCamCompression->pWebCamCompressionInfo = MT9P015WebcamStillCompression;
            pWebCamCompression->WebCamCompressionInfoNum = sizeof(MT9P015WebcamStillCompression) / sizeof(USBVideo_Compression_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
        {
            ...
            pWebCamDeafultIdx->WebCamVideoSizeIdx = MT9P015WebcamDefaultVideoSize;
            pWebCamDeafultIdx->WebCamStillSizeIdx = MT9P015WebcamDefaultStillSize;
            pWebCamDeafultIdx->WebCamCompressionIdx = MT9P015WebcamDefaultCompression;
        }
        break;
