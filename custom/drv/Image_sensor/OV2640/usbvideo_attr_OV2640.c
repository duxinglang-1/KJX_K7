...
static const USBVideo_Attr_Info OV2640WebcamAttrInfo[11] =
{
...
static const USBVideo_Video_Size_Info OV2640WebcamVideoSize[3] = // for size customization
{
...
static const USBVideo_Still_Size_Info OV2640WebcamStillSize[3] = // for size customization
{
...
static const USBVideo_Compression_Info OV2640WebcamStillCompression[2] = // for compression customization
{
  {USBVIDEO_COMPRESSION_1, JPEG_ENCODE_QUALITY_LOW},
  {USBVIDEO_COMPRESSION_2, JPEG_ENCODE_QUALITY_FAIR}
};

static const USBVIDEO_VIDEO_SIZE_TYPE OV2640WebcamDefaultVideoSize = USBVIDEO_VIDEO_SIZE_1;
static const USBVIDEO_STILL_SIZE_TYPE OV2640WebcamDefaultStillSize = USBVIDEO_STILL_SIZE_1;
static const USBVIDEO_COMPRESSION_TYPE OV2640WebcamDefaultCompression = USBVIDEO_COMPRESSION_1;

static const usbvideo_attr_struct OV2640WebcamAttrPara =
{
  /* min,  max,         res,        def */
{
...
MM_ERROR_CODE_ENUM OV2640WebcamFeatureCtrl(IMAGE_SENSOR_FEATURE_ENUM FeatureId,
      ...
      else
      {
        if (AttrType >= ATTR_PU_START)
        {
            ...
            case USBVIDEO_REQUEST_GET_MIN:
                pWebCamAttr->value = OV2640WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
                break;
            case USBVIDEO_REQUEST_GET_MAX:
                pWebCamAttr->value = OV2640WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
                break;
            case USBVIDEO_REQUEST_GET_DEF:
                pWebCamAttr->value = OV2640WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
                break;
            case USBVIDEO_REQUEST_GET_RES:
                pWebCamAttr->value = OV2640WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
                break;
            default:
  ...
  case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
    {
      ...
      pWebCamAttrInfo->pWebCamAttrInfo = OV2640WebcamAttrInfo;
      pWebCamAttrInfo->WebCamAttrInfoNum = sizeof(OV2640WebcamAttrInfo) / sizeof(USBVideo_Attr_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
    {
      ...
      pWebCamVideoSize->pWebCamVideoSizeInfo = OV2640WebcamVideoSize;
      pWebCamVideoSize->WebCamVideoSizeInfoNum = sizeof(OV2640WebcamVideoSize) / sizeof(USBVideo_Video_Size_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
    {
      ...
      pWebCamStillSize->pWebCamStillSizeInfo = OV2640WebcamStillSize;
      pWebCamStillSize->WebCamStillSizeInfoNum = sizeof(OV2640WebcamStillSize) / sizeof(USBVideo_Still_Size_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
    {
      ...
      pWebCamCompression->pWebCamCompressionInfo = OV2640WebcamStillCompression;
      pWebCamCompression->WebCamCompressionInfoNum = sizeof(OV2640WebcamStillCompression) / sizeof(USBVideo_Compression_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
    {
      ...
      pWebCamDeafultIdx->WebCamVideoSizeIdx = OV2640WebcamDefaultVideoSize;
      pWebCamDeafultIdx->WebCamStillSizeIdx = OV2640WebcamDefaultStillSize;
      pWebCamDeafultIdx->WebCamCompressionIdx = OV2640WebcamDefaultCompression;
    }
    break;
  default :
