...
static const USBVideo_Attr_Info OV3640WebcamAttrInfo[11] =
{
...
static const USBVideo_Video_Size_Info OV3640WebcamVideoSize[3] = // for size customization
{
...
static const USBVideo_Still_Size_Info OV3640WebcamStillSize[3] = // for size customization
{
...
static const USBVideo_Compression_Info OV3640WebcamStillCompression[2] = // for compression customization
{
  {USBVIDEO_COMPRESSION_1, JPEG_ENCODE_QUALITY_LOW},
  {USBVIDEO_COMPRESSION_2, JPEG_ENCODE_QUALITY_FAIR}
};

static const USBVIDEO_VIDEO_SIZE_TYPE OV3640WebcamDefaultVideoSize = USBVIDEO_VIDEO_SIZE_1;
static const USBVIDEO_STILL_SIZE_TYPE OV3640WebcamDefaultStillSize = USBVIDEO_STILL_SIZE_1;
static const USBVIDEO_COMPRESSION_TYPE OV3640WebcamDefaultCompression = USBVIDEO_COMPRESSION_1;
...
MM_ERROR_CODE_ENUM OV3640WebcamFeatureCtrl(IMAGE_SENSOR_FEATURE_ENUM FeatureId,
  ...
  case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
    {
      ...
      pWebCamAttrInfo->pWebCamAttrInfo = OV3640WebcamAttrInfo;
      pWebCamAttrInfo->WebCamAttrInfoNum = sizeof(OV3640WebcamAttrInfo) / sizeof(USBVideo_Attr_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
    {
      ...
      pWebCamVideoSize->pWebCamVideoSizeInfo = OV3640WebcamVideoSize;
      pWebCamVideoSize->WebCamVideoSizeInfoNum = sizeof(OV3640WebcamVideoSize) / sizeof(USBVideo_Video_Size_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
    {
      ...
      pWebCamStillSize->pWebCamStillSizeInfo = OV3640WebcamStillSize;
      pWebCamStillSize->WebCamStillSizeInfoNum = sizeof(OV3640WebcamStillSize) / sizeof(USBVideo_Still_Size_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
    {
      ...
      pWebCamCompression->pWebCamCompressionInfo = OV3640WebcamStillCompression;
      pWebCamCompression->WebCamCompressionInfoNum = sizeof(OV3640WebcamStillCompression) / sizeof(USBVideo_Compression_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
    {
      ...
      pWebCamDeafultIdx->WebCamVideoSizeIdx = OV3640WebcamDefaultVideoSize;
      pWebCamDeafultIdx->WebCamStillSizeIdx = OV3640WebcamDefaultStillSize;
      pWebCamDeafultIdx->WebCamCompressionIdx = OV3640WebcamDefaultCompression;
    }
    break;
  default :
