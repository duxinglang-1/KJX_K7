...
static const USBVideo_Attr_Info OV3647WebcamAttrInfo[11] =
{
...
static const USBVideo_Video_Size_Info OV3647WebcamVideoSize[3] = // for size customization
{
...
static const USBVideo_Still_Size_Info OV3647WebcamStillSize[3] = // for size customization
{
...
static const USBVideo_Compression_Info OV3647WebcamStillCompression[2] = // for compression customization
{
  {USBVIDEO_COMPRESSION_1, JPEG_ENCODE_QUALITY_POOR},
  {USBVIDEO_COMPRESSION_2, JPEG_ENCODE_QUALITY_FAIR}
};

static const USBVIDEO_VIDEO_SIZE_TYPE OV3647WebcamDefaultVideoSize = USBVIDEO_VIDEO_SIZE_1;
static const USBVIDEO_STILL_SIZE_TYPE OV3647WebcamDefaultStillSize = USBVIDEO_STILL_SIZE_1;
static const USBVIDEO_COMPRESSION_TYPE OV3647WebcamDefaultCompression = USBVIDEO_COMPRESSION_1;

static const usbvideo_attr_struct OV3647WebcamAttrPara =
{
  /* min,  max,         res,        def */
{
...
MM_ERROR_CODE_ENUM OV3647WebcamFeatureCtrl(IMAGE_SENSOR_FEATURE_ENUM FeatureId,
      ...
      else
      {
        if (AttrType >= ATTR_PU_START)
        {
            ...
            case USBVIDEO_REQUEST_GET_MIN:
                pWebCamAttr->value = OV3647WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
                break;
            case USBVIDEO_REQUEST_GET_MAX:
                pWebCamAttr->value = OV3647WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
                break;
            case USBVIDEO_REQUEST_GET_DEF:
                pWebCamAttr->value = OV3647WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
                break;
            case USBVIDEO_REQUEST_GET_RES:
                pWebCamAttr->value = OV3647WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
                break;
            default:
  ...
  case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
    {
      ...
      pWebCamAttrInfo->pWebCamAttrInfo = OV3647WebcamAttrInfo;
      pWebCamAttrInfo->WebCamAttrInfoNum = sizeof(OV3647WebcamAttrInfo) / sizeof(USBVideo_Attr_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
    {
      ...
      pWebCamVideoSize->pWebCamVideoSizeInfo = OV3647WebcamVideoSize;
      pWebCamVideoSize->WebCamVideoSizeInfoNum = sizeof(OV3647WebcamVideoSize) / sizeof(USBVideo_Video_Size_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
    {
      ...
      pWebCamStillSize->pWebCamStillSizeInfo = OV3647WebcamStillSize;
      pWebCamStillSize->WebCamStillSizeInfoNum = sizeof(OV3647WebcamStillSize) / sizeof(USBVideo_Still_Size_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
    {
      ...
      pWebCamCompression->pWebCamCompressionInfo = OV3647WebcamStillCompression;
      pWebCamCompression->WebCamCompressionInfoNum = sizeof(OV3647WebcamStillCompression) / sizeof(USBVideo_Compression_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
    {
      ...
      pWebCamDeafultIdx->WebCamVideoSizeIdx = OV3647WebcamDefaultVideoSize;
      pWebCamDeafultIdx->WebCamStillSizeIdx = OV3647WebcamDefaultStillSize;
      pWebCamDeafultIdx->WebCamCompressionIdx = OV3647WebcamDefaultCompression;
    }
    break;
  default :
