...
const USBVideo_Attr_Info OV5642MipiWebcamAttrInfo[11] =      
{
...
const USBVideo_Video_Size_Info OV5642MipiWebcamVideoSize[3] = /// for size customization
{
...
const USBVideo_Still_Size_Info OV5642MipiWebcamStillSize[3] =  /// for size customization
{
...
const USBVideo_Compression_Info OV5642MipiWebcamStillCompression[2] = /// for compression customization
{
...
const USBVIDEO_VIDEO_SIZE_TYPE OV5642MipiWebcamDefaultVideoSize = USBVIDEO_VIDEO_SIZE_1;
const USBVIDEO_STILL_SIZE_TYPE OV5642MipiWebcamDefaultStillSize = USBVIDEO_STILL_SIZE_1;
const USBVIDEO_COMPRESSION_TYPE OV5642MipiWebcamDefaultCompression = USBVIDEO_COMPRESSION_1;

const usbvideo_attr_struct OV5642MipiWebcamAttrPara=
{
    /* min,	max,	       res,	      def */
    {
...
MM_ERROR_CODE_ENUM OV5642MipiWebcamFeatureCtrl(IMAGE_SENSOR_FEATURE_ENUM FeatureId,
                                                ...
                                                kal_uint32 FeatureParaOutLen, kal_uint32 *pRealFeatureParaOutLen)
{
            ...
            else
            {
                if (AttrType >= ATTR_PU_START)
                {
                    ...
                    case USBVIDEO_REQUEST_GET_MIN:
                        pWebCamAttr->value = OV5642MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
                        break;
                    case USBVIDEO_REQUEST_GET_MAX:
                        pWebCamAttr->value = OV5642MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
                        break;
                    case USBVIDEO_REQUEST_GET_DEF:
                        pWebCamAttr->value = OV5642MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
                        break;
                    case USBVIDEO_REQUEST_GET_RES:
                        pWebCamAttr->value = OV5642MipiWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
                        break;
                    default:
    ...
    case CAL_FEATURE_WEBCAM_SET_ATTR:
        {
            // Only for YUV sensor
            // OV5642_MIPI_usbvideo_set_attr((USBVideo_Attr_Value *)pFeatureParaIn);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
        {
            ...
            pWebCamAttrInfo->pWebCamAttrInfo = OV5642MipiWebcamAttrInfo;
            pWebCamAttrInfo->WebCamAttrInfoNum = sizeof(OV5642MipiWebcamAttrInfo) / sizeof(USBVideo_Attr_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
        {
            ...
            pWebCamVideoSize->pWebCamVideoSizeInfo = OV5642MipiWebcamVideoSize;
            pWebCamVideoSize->WebCamVideoSizeInfoNum = sizeof(OV5642MipiWebcamVideoSize) / sizeof(USBVideo_Video_Size_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
        {
            ...
            pWebCamStillSize->pWebCamStillSizeInfo = OV5642MipiWebcamStillSize;
            pWebCamStillSize->WebCamStillSizeInfoNum = sizeof(OV5642MipiWebcamStillSize) / sizeof(USBVideo_Still_Size_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
        {
            ...
            pWebCamCompression->pWebCamCompressionInfo = OV5642MipiWebcamStillCompression;
            pWebCamCompression->WebCamCompressionInfoNum = sizeof(OV5642MipiWebcamStillCompression) / sizeof(USBVideo_Compression_Info);
        }
        break;
    ...
    case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
        {
            ...
            pWebCamDeafultIdx->WebCamVideoSizeIdx = OV5642MipiWebcamDefaultVideoSize;
            pWebCamDeafultIdx->WebCamStillSizeIdx = OV5642MipiWebcamDefaultStillSize;
            pWebCamDeafultIdx->WebCamCompressionIdx = OV5642MipiWebcamDefaultCompression;
        }
        break;
