...
static const USBVideo_Attr_Info OV5650WebcamAttrInfo[11] =
{
...
static const USBVideo_Video_Size_Info OV5650WebcamVideoSize[3] = // for size customization
{
...
static const USBVideo_Still_Size_Info OV5650WebcamStillSize[3] = // for size customization
{
...
static const USBVideo_Compression_Info OV5650WebcamStillCompression[2] = // for compression customization
{
  {USBVIDEO_COMPRESSION_1, JPEG_ENCODE_QUALITY_LOW},
  {USBVIDEO_COMPRESSION_2, JPEG_ENCODE_QUALITY_FAIR}
};

static const USBVIDEO_VIDEO_SIZE_TYPE OV5650WebcamDefaultVideoSize = USBVIDEO_VIDEO_SIZE_1;
static const USBVIDEO_STILL_SIZE_TYPE OV5650WebcamDefaultStillSize = USBVIDEO_STILL_SIZE_1;
static const USBVIDEO_COMPRESSION_TYPE OV5650WebcamDefaultCompression = USBVIDEO_COMPRESSION_1;

static const usbvideo_attr_struct OV5650WebcamAttrPara =
{
  /* min,  max,         res,        def */
{
...
MM_ERROR_CODE_ENUM OV5650WebcamFeatureCtrl(IMAGE_SENSOR_FEATURE_ENUM FeatureId,
      ...
      else
      {
        if (AttrType >= ATTR_PU_START)
        {
            ...
            case USBVIDEO_REQUEST_GET_MIN:
                pWebCamAttr->value = OV5650WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
                break;
            case USBVIDEO_REQUEST_GET_MAX:
                pWebCamAttr->value = OV5650WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
                break;
            case USBVIDEO_REQUEST_GET_DEF:
                pWebCamAttr->value = OV5650WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
                break;
            case USBVIDEO_REQUEST_GET_RES:
                pWebCamAttr->value = OV5650WebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
                break;
            default:
  ...
  case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
    {
      ...
      pWebCamAttrInfo->pWebCamAttrInfo = OV5650WebcamAttrInfo;
      pWebCamAttrInfo->WebCamAttrInfoNum = sizeof(OV5650WebcamAttrInfo) / sizeof(USBVideo_Attr_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
    {
      ...
      pWebCamVideoSize->pWebCamVideoSizeInfo = OV5650WebcamVideoSize;
      pWebCamVideoSize->WebCamVideoSizeInfoNum = sizeof(OV5650WebcamVideoSize) / sizeof(USBVideo_Video_Size_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
    {
      ...
      pWebCamStillSize->pWebCamStillSizeInfo = OV5650WebcamStillSize;
      pWebCamStillSize->WebCamStillSizeInfoNum = sizeof(OV5650WebcamStillSize) / sizeof(USBVideo_Still_Size_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
    {
      ...
      pWebCamCompression->pWebCamCompressionInfo = OV5650WebcamStillCompression;
      pWebCamCompression->WebCamCompressionInfoNum = sizeof(OV5650WebcamStillCompression) / sizeof(USBVideo_Compression_Info);
    }
    break;
  case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
    {
      ...
      pWebCamDeafultIdx->WebCamVideoSizeIdx = OV5650WebcamDefaultVideoSize;
      pWebCamDeafultIdx->WebCamStillSizeIdx = OV5650WebcamDefaultStillSize;
      pWebCamDeafultIdx->WebCamCompressionIdx = OV5650WebcamDefaultCompression;
    }
    break;
  default :
