...
#ifndef _CAMERA_AF_PARA_FOXLINK_FM50AF_04_MT9P012_MD218B_H_
#define _CAMERA_AF_PARA_FOXLINK_FM50AF_04_MT9P012_MD218B_H_

#include "camera_para.h"

 #define CAMERA_AF_DEFAULT_VALUE_FOXLINK_FM50AF_04_MT9P012_MD218B   {\
	{	0,	0 },	/* af calibration offset, af calibration data */\
   	...
   	{	{	10, 0, 9, 0, 21, 9, 1024, 1 },	\
   		{	{9,  300}, {51, 50}, {84, 30}, {129, 20},  /* 1. Normal Preview Mode*/\
   		{172, 15}, {218, 12}, {263, 10}, {294,  9},\
			{333,  8}, {554,  5}, {0x00, 0x00}, {0x00, 0x00},\
   	...
   	{	{	10, 0, 9, 0, 21, 9, 1024, 1 },	\
   		{	{9,  300}, {51, 50}, {84, 30}, {129, 20},		/* 2. Normal Video Mode*/\
			{172, 15}, {218, 12}, {263, 10}, {294,  9},\
			{333,  8}, {554,  5}, 	{0x00, 0x00}, {0x00, 0x00},\
			{0x00, 0x00}, {0x00, 0x00}, {0x00, 0x00}, {0x00, 0x00}, \
			{0x00, 0x00}, {0x00, 0x00}, {0x00, 0x00}, {0x00, 0x00}, \
