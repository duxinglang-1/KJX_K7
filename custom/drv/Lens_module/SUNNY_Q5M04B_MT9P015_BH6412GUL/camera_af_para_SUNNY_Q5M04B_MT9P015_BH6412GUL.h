 ...
 * Filename:
 * ---------
 *   camera_af_para_SUNNY_Q5M04B_MT9P015_BH6412GUL.h
 *
 * Project:
 * --------
 *   MT6238
...
#ifndef _CAMERA_AF_PARA_SUNNY_Q5M04B_MT9P015_BH6412GUL_
#define _CAMERA_AF_PARA_SUNNY_Q5M04B_MT9P015_BH6412GUL_

#include "isp_comm_if.h"

    
 #define CAMERA_AF_DEFAULT_VALUE_SUNNY_Q5M04B_MT9P015_BH6412GUL   {\
	{	0,	0 },	/* af calibration offset, af calibration data */\
   	...
   	{	{	15, 0, 14, 0, 21, 16, 1024, 1 },	\
   		{	{16,  250}, {112, 200}, {136, 180}, {160, 150}, {208, 120},  /* 1. Normal Preview Mode*/\
   		{256, 100}, {264, 90}, {304, 75}, {312,  60},\
			{352,  50}, {400,  40}, {512, 30}, {520, 20}, {760, 10},\
			{1008, 0x00}, \
			{0x00, 0x00}, {0x00, 0x00}, {0x00, 0x00}, {0x00, 0x00}, \
			{0x00, 0x00}, {0x00, 0x00}, {0x00, 0x00}, {0x00, 0x00}, \
   		}\
   	},  \
   	{	{	15, 0, 13, 0, 21, 16, 1024, 1 },	\
   		{	{16,  250}, {112, 200}, {136, 180}, {160, 150}, {208, 120},  /* 1. Normal Preview Mode*/\
   		{256, 100}, {264, 90}, {304, 75}, {312,  60},\
			{352,  50}, {400,  40}, {512, 30}, {520, 20}, {760, 10},\
			{1008, 0x00}, \
	...
	/*AF_PARAM_SLOW_BACK_MAX_STEP*/	128,\
