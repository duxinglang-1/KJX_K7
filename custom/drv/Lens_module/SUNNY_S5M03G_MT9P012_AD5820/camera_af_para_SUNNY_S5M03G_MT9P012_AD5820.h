...
#ifndef _CAMERA_AF_PARA_SUNNY_S5M03G_MT9P012_AD5820_
#define _CAMERA_AF_PARA_SUNNY_S5M03G_MT9P012_AD5820_

#include "isp_comm_if.h"
    
 #define CAMERA_AF_DEFAULT_VALUE_SUNNY_S5M03G_MT9P012_AD5820   {\
	{	0,	0 },	/* af calibration offset, af calibration data */\
   	...
   	{	{	14, 0, 13, 0, 256, 112, 1024, 1 },	\
   		{	{112,  250}, {160, 200}, {176, 180}, {208, 150}, {256, 120},  /* 1. Normal Preview Mode*/\
   		{264, 100}, {304, 90}, {352, 75}, {400,  60},\
			{448,  50}, {496,  40}, {512, 30}, {544, 20}, {760, 10},\
			{0x00, 0x00}, \
   	...
   	{	{	14, 0, 13, 0, 256, 112, 1024, 1 },	\
   		{	{112,  250}, {160, 200}, {176, 180}, {208, 150}, {256, 120},		/* 2. Normal Video Mode*/\
			{264, 100}, {304, 90}, {352, 75}, {400,  60},\
			{448,  50}, {496,  40}, {512, 30}, {544, 20}, {760, 10},\
			 {0x00, 0x00}, \
			{0x00, 0x00}, {0x00, 0x00}, {0x00, 0x00}, {0x00, 0x00}, \
   	...
   	{7,{{112,50,50},{160,50,50},{208,50,50},{304,50,50},{400,50,50},{496,60,60},{760,150,150},{0,0,0}}},\
	{	\
	...
	/*AF_PARAM_MZ_MAX_INF_DOF*/		180,\
	/*AF_PARAM_MZ_MAX_MACRO_DOF*/	180,\
	/*AF_PARAM_CONT_PAN_LUMA_DELTA*/	11,\
	/*AF_PARAM_CONT_PAN_HOLD_FRAME*/	10,\
