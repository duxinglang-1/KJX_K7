...
{      
   ...
   motion_sensor_write_data(MOTION_SENSOR_READ_CMD|MOTION_SENSOR_CTRL_REGA);
   int_status=motion_sensor_read_control();   
...
{	
   /*x axis*/
   GPIO_WriteIO(0,MS_SPI_CS_PIN);
   motion_sensor_write_data(MOTION_SENSOR_XOUT_H|MOTION_SENSOR_READ_CMD);
   *x_adc=motion_sensor_read_data();
   ...
   /*y axis*/
   GPIO_WriteIO(0,MS_SPI_CS_PIN);
   motion_sensor_write_data(MOTION_SENSOR_YOUT_H|MOTION_SENSOR_READ_CMD);
   *y_adc=motion_sensor_read_data();
   ...
   /*z axis*/
   GPIO_WriteIO(0,MS_SPI_CS_PIN);
   motion_sensor_write_data(MOTION_SENSOR_ZOUT_H|MOTION_SENSOR_READ_CMD);
...
void acc_sensor_pwr_up(void)
{
	GPIO_WriteIO(0,MS_SPI_CS_PIN);
   //motion_sensor_delay(MS_DELAY_200NS);
   motion_sensor_write_data(MOTION_SENSOR_WRITE_CMD|MOTION_SENSOR_CTRL_REGB);
   motion_sensor_write_data(0xe);
   /*delay 200ns*/
   GPIO_WriteIO(1,MS_SPI_CS_PIN);   
   motion_sensor_delay(MS_DELAY_200NS);
   ...
   GPIO_WriteIO(0,MS_SPI_CS_PIN);
   //motion_sensor_delay(MS_DELAY_200NS);
   motion_sensor_write_data(MOTION_SENSOR_WRITE_CMD|MOTION_SENSOR_CTRL_REGC);
   motion_sensor_write_data(0x0);
   /*delay 200ns*/
   GPIO_WriteIO(1,MS_SPI_CS_PIN);   
   motion_sensor_delay(MS_DELAY_200NS);
   ...
   /*read*/        
   GPIO_WriteIO(0,MS_SPI_CS_PIN);
   motion_sensor_write_data(MOTION_SENSOR_READ_CMD|MOTION_SENSOR_CTRL_REGB);
...
void acc_sensor_configure_low_g(kal_uint32 debounce, kal_uint32 threshold)
{
   ...
   /*threshold*/
   GPIO_WriteIO(0,MS_SPI_CS_PIN);   
   motion_sensor_write_data(MOTION_SENSOR_WRITE_CMD|MOTION_SENSOR_FF_INT);
   motion_sensor_write_data(threshold);   
   GPIO_WriteIO(1,MS_SPI_CS_PIN);   
   motion_sensor_delay(MS_DELAY_200NS);
   
   /*debounce time*/
   GPIO_WriteIO(0,MS_SPI_CS_PIN);   
   motion_sensor_write_data(MOTION_SENSOR_WRITE_CMD|MOTION_SENSOR_FF_DELAY);
   motion_sensor_write_data(debounce);   
   GPIO_WriteIO(1,MS_SPI_CS_PIN);   
   motion_sensor_delay(MS_DELAY_200NS);
   
   /*read*/        
   GPIO_WriteIO(0,MS_SPI_CS_PIN);
   motion_sensor_write_data(MOTION_SENSOR_READ_CMD|MOTION_SENSOR_FF_INT);
   motion_data=motion_sensor_read_control();   
	GPIO_WriteIO(1,MS_SPI_CS_PIN);   
   motion_sensor_delay(MS_DELAY_200NS);  
   
   GPIO_WriteIO(0,MS_SPI_CS_PIN);
   motion_sensor_write_data(MOTION_SENSOR_READ_CMD|MOTION_SENSOR_FF_DELAY);
   motion_data=motion_sensor_read_control();   
	GPIO_WriteIO(1,MS_SPI_CS_PIN);   
   motion_sensor_delay(MS_DELAY_200NS);     
}   
...
void acc_sensor_configure_high_g(kal_uint32 debounce, kal_uint32 threshold)
{
   ...
   /*threshold*/
   GPIO_WriteIO(0,MS_SPI_CS_PIN);   
   motion_sensor_write_data(MOTION_SENSOR_WRITE_CMD|MOTION_SENSOR_MOT_INT);
   motion_sensor_write_data(threshold);   
   GPIO_WriteIO(1,MS_SPI_CS_PIN);   
   motion_sensor_delay(MS_DELAY_200NS);
   /*debounce time*/
   GPIO_WriteIO(0,MS_SPI_CS_PIN);   
   motion_sensor_write_data(MOTION_SENSOR_WRITE_CMD|MOTION_SENSOR_MOT_DELAY);
   motion_sensor_write_data(debounce);   
   GPIO_WriteIO(1,MS_SPI_CS_PIN);   
   motion_sensor_delay(MS_DELAY_200NS);   
   ...
   /*read*/        
   GPIO_WriteIO(0,MS_SPI_CS_PIN);
   motion_sensor_write_data(MOTION_SENSOR_READ_CMD|MOTION_SENSOR_MOT_INT);
   motion_data=motion_sensor_read_control();   
	GPIO_WriteIO(1,MS_SPI_CS_PIN);   
   motion_sensor_delay(MS_DELAY_200NS);  
   
   GPIO_WriteIO(0,MS_SPI_CS_PIN);
   motion_sensor_write_data(MOTION_SENSOR_READ_CMD|MOTION_SENSOR_MOT_DELAY);
   motion_data=motion_sensor_read_control();   
	GPIO_WriteIO(1,MS_SPI_CS_PIN);   
   motion_sensor_delay(MS_DELAY_200NS);  
}   
...
{      
   ...
   GPIO_ModeSetup(MS_SPI_RESET_PIN, 0x0);  
   ...
   GPIO_InitIO(OUTPUT,MS_SPI_RESET_PIN);    
#endif /* __CUST_NEW__ */
   GPIO_WriteIO(1,MS_SPI_RESET_PIN);
   GPIO_WriteIO(0,MS_SPI_RESET_PIN);
   GPIO_WriteIO(1,MS_SPI_CS_PIN);
   motion_sensor_delay(MS_DELAY_200NS);  
#ifndef __CUST_NEW__
