...
#define MS_SPI_DIN_PIN        gpio_ms_spi_din_pin
#define MS_SPI_CLK_PIN        gpio_ms_spi_clk_pin
#define MS_SPI_DOUT_PIN       gpio_ms_spi_dout_pin
#define MS_SPI_CS_PIN         gpio_ms_spi_cs_pin
#define MS_SPI_RESET_PIN      gpio_ms_spi_reset_pin

#define SET_MS_CLK_HIGH()			(GPIO_WriteIO(1,MS_SPI_CLK_PIN))
#define SET_MS_CLK_LOW()			(GPIO_WriteIO(0,MS_SPI_CLK_PIN))
#define SET_MS_DATA_HIGH()	      GPIO_WriteIO(1,MS_SPI_DIN_PIN)
#define SET_MS_DATA_LOW()			GPIO_WriteIO(0,MS_SPI_DIN_PIN)
#define GET_MS_DATA_BIT()			GPIO_ReadIO(MS_SPI_DOUT_PIN)
