...
MM_ERROR_CODE_ENUM MC501CBWebcamFeatureCtrl(kal_uint32 Id, void *In, void *Out, kal_uint32 OutLen, kal_uint32 *RealOutLen)
{
  /* supported feature list */
  static const USBVideo_Attr_Info MC501CB_ATTR_INFO[] =
  {
  ...
  static const USBVideo_Video_Size_Info MC501CB_VIDEO_SIZE[] =
  {
  ...
  static const USBVideo_Still_Size_Info MC501CB_STILL_SIZE[] =
  {
  ...
  static const USBVideo_Compression_Info MC501CB_STILL_COMPRESSION[] =
  {
  ...
  static const USBVIDEO_VIDEO_SIZE_TYPE MC501CB_g_default_video_size = USBVIDEO_VIDEO_SIZE_1;
  static const USBVIDEO_STILL_SIZE_TYPE MC501CB_g_default_still_size = USBVIDEO_STILL_SIZE_1;
  static const USBVIDEO_COMPRESSION_TYPE MC501CB_g_default_compression = USBVIDEO_COMPRESSION_1;
  static const usbvideo_attr_struct MC501CBWebcamAttrPara =
  {
    /* min,  max,         res,        def */
    {
      ...
      else
      {
        if (AttrType >= ATTR_PU_START)
        {
          ...
          case USBVIDEO_REQUEST_GET_MIN:
            pWebCamAttr->value = MC501CBWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
            break;
          case USBVIDEO_REQUEST_GET_MAX:
            pWebCamAttr->value = MC501CBWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
            break;
          case USBVIDEO_REQUEST_GET_DEF:
            pWebCamAttr->value = MC501CBWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
            break;
          case USBVIDEO_REQUEST_GET_RES:
            pWebCamAttr->value = MC501CBWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
            break;
          default:
  ...
  case CAL_FEATURE_WEBCAM_SET_ATTR:
    {
      ...
      MC501CBSensorFunc(&pfSensorFunc);        
  ...
  case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
    ((P_CAL_FEATURE_WEBCAM_GET_ATTR_INFO_STRUCT)Out)->pWebCamAttrInfo = MC501CB_ATTR_INFO;
    ((P_CAL_FEATURE_WEBCAM_GET_ATTR_INFO_STRUCT)Out)->WebCamAttrInfoNum = sizeof(MC501CB_ATTR_INFO) / sizeof(MC501CB_ATTR_INFO[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
    ((P_CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE_STRUCT)Out)->pWebCamVideoSizeInfo = MC501CB_VIDEO_SIZE;
    ((P_CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE_STRUCT)Out)->WebCamVideoSizeInfoNum = sizeof(MC501CB_VIDEO_SIZE) / sizeof(MC501CB_VIDEO_SIZE[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
    ((P_CAL_FEATURE_WEBCAM_GET_STILL_SIZE_STRUCT)Out)->pWebCamStillSizeInfo = MC501CB_STILL_SIZE;
    ((P_CAL_FEATURE_WEBCAM_GET_STILL_SIZE_STRUCT)Out)->WebCamStillSizeInfoNum = sizeof(MC501CB_STILL_SIZE) / sizeof(MC501CB_STILL_SIZE[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
    ((P_CAL_FEATURE_WEBCAM_GET_COMPRESSION_STRUCT)Out)->pWebCamCompressionInfo = MC501CB_STILL_COMPRESSION;
    ((P_CAL_FEATURE_WEBCAM_GET_COMPRESSION_STRUCT)Out)->WebCamCompressionInfoNum = sizeof(MC501CB_STILL_COMPRESSION) / sizeof(MC501CB_STILL_COMPRESSION[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamVideoSizeIdx = MC501CB_g_default_video_size;
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamStillSizeIdx = MC501CB_g_default_still_size;
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamCompressionIdx = MC501CB_g_default_compression;
    break;
  default:
