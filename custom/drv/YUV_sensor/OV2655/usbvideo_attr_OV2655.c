...
MM_ERROR_CODE_ENUM OV2655WebcamFeatureCtrl(kal_uint32 Id, void *In, void *Out, kal_uint32 OutLen, kal_uint32 *RealOutLen)
{
  /* supported feature list */
  static const USBVideo_Attr_Info OV2655_ATTR_INFO[] =
  {
  ...
  static const USBVideo_Video_Size_Info OV2655_VIDEO_SIZE[] =
  {
  ...
  static const USBVideo_Still_Size_Info OV2655_STILL_SIZE[] =
  {
  ...
  static const USBVideo_Compression_Info OV2655_STILL_COMPRESSION[] =
  {
  ...
  static const USBVIDEO_VIDEO_SIZE_TYPE OV2655_g_default_video_size = USBVIDEO_VIDEO_SIZE_1;
  static const USBVIDEO_STILL_SIZE_TYPE OV2655_g_default_still_size = USBVIDEO_STILL_SIZE_1;
  static const USBVIDEO_COMPRESSION_TYPE OV2655_g_default_compression = USBVIDEO_COMPRESSION_1;
  static const usbvideo_attr_struct OV2655WebcamAttrPara =
  {
    /* min,  max,         res,        def */
    {
      ...
      {0,      2,  1,    1  },  /*6  USBVIDEO_ATTRIBUTE_SATURATION*/
      {0,      2,   1,    1  },  /*7  USBVIDEO_ATTRIBUTE_SHARPNESS*/
  ...
  case CAL_FEATURE_WEBCAM_SET_ATTR:
    {
	  ...
	  case USBVIDEO_ATTRIBUTE_CONTRAST:
        ...
        break;
	  case USBVIDEO_ATTRIBUTE_SATURATION:
		FeatureCtrlPara.FeatureSetValue = AttrValue;
		ErrCode = pfSensorFunc->SensorFeatureCtrl(CAL_FEATURE_CAMERA_SATURATION, &FeatureCtrlPara, NULL, 0, NULL);
		break;
	  case USBVIDEO_ATTRIBUTE_SHARPNESS:
		FeatureCtrlPara.FeatureSetValue = AttrValue;
		ErrCode = pfSensorFunc->SensorFeatureCtrl(CAL_FEATURE_CAMERA_SHARPNESS, &FeatureCtrlPara, NULL, 0, NULL);
		break;
  ...
  case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
    ((P_CAL_FEATURE_WEBCAM_GET_ATTR_INFO_STRUCT)Out)->pWebCamAttrInfo = OV2655_ATTR_INFO;
    ((P_CAL_FEATURE_WEBCAM_GET_ATTR_INFO_STRUCT)Out)->WebCamAttrInfoNum = sizeof(OV2655_ATTR_INFO) / sizeof(OV2655_ATTR_INFO[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
    ((P_CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE_STRUCT)Out)->pWebCamVideoSizeInfo = OV2655_VIDEO_SIZE;
    ((P_CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE_STRUCT)Out)->WebCamVideoSizeInfoNum = sizeof(OV2655_VIDEO_SIZE) / sizeof(OV2655_VIDEO_SIZE[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
    ((P_CAL_FEATURE_WEBCAM_GET_STILL_SIZE_STRUCT)Out)->pWebCamStillSizeInfo = OV2655_STILL_SIZE;
    ((P_CAL_FEATURE_WEBCAM_GET_STILL_SIZE_STRUCT)Out)->WebCamStillSizeInfoNum = sizeof(OV2655_STILL_SIZE) / sizeof(OV2655_STILL_SIZE[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
    ((P_CAL_FEATURE_WEBCAM_GET_COMPRESSION_STRUCT)Out)->pWebCamCompressionInfo = OV2655_STILL_COMPRESSION;
    ((P_CAL_FEATURE_WEBCAM_GET_COMPRESSION_STRUCT)Out)->WebCamCompressionInfoNum = sizeof(OV2655_STILL_COMPRESSION) / sizeof(OV2655_STILL_COMPRESSION[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamVideoSizeIdx = OV2655_g_default_video_size;
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamStillSizeIdx = OV2655_g_default_still_size;
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamCompressionIdx = OV2655_g_default_compression;
    break;
  default:
