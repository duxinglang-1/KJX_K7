...
#if (!(defined(__FLAVOR_CTP_FT5206__) || defined(__FLAVOR_CTP_NOVATEK_NT11001_FAKE_MULTIPLE__) || defined(__FLAVOR_CTP_ST1232__)))
...
#define OV3640_CAPTURE_CLK                   47666667
#else
...
#define OV3640_IMAGE_SENSOR_FULL_HBLANKING   328
#define OV3640_IMAGE_SENSOR_FULL_VBLANKING   32
#define OV3640_IMAGE_SENSOR_PV_HBLANKING     328
#define OV3640_IMAGE_SENSOR_PV_VBLANKING     312

/* SENSOR PIXEL/LINE NUMBERS IN ONE PERIOD */
#define OV3640_FULL_PERIOD_PIXEL_NUMS        (OV3640_IMAGE_SENSOR_FULL_WIDTH_DRV + OV3640_IMAGE_SENSOR_FULL_HBLANKING) /* 2376, must be even */
#define OV3640_FULL_PERIOD_LINE_NUMS         (OV3640_IMAGE_SENSOR_FULL_HEIGHT_DRV + OV3640_IMAGE_SENSOR_FULL_VBLANKING) /* 1568 */
#define OV3640_PV_PERIOD_PIXEL_NUMS          (OV3640_IMAGE_SENSOR_FULL_WIDTH_DRV + OV3640_IMAGE_SENSOR_PV_HBLANKING) /* 2376, must be even */
#define OV3640_PV_PERIOD_LINE_NUMS           (OV3640_IMAGE_SENSOR_PV_HEIGHT_DRV + OV3640_IMAGE_SENSOR_PV_VBLANKING) /* 792 */

/* SENSOR START/END POSITION */
#define OV3640_FULL_X_START                  300 /* avoid left rectangle image color abnormal */
#define OV3640_FULL_Y_START                  1
#define OV3640_PV_X_START                    92
