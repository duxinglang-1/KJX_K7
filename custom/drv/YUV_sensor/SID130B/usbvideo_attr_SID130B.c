...
MM_ERROR_CODE_ENUM SID130BWebcamFeatureCtrl(IMAGE_SENSOR_FEATURE_ENUM id, void *in, void *out, kal_uint32 out_len, kal_uint32 *r_out_len)
{
  /* supported feature list */
  static const USBVideo_Attr_Info SID130B_ATTR_INFO[] =
  {
  ...
  static const USBVideo_Video_Size_Info SID130B_VIDEO_SIZE[] =
  {
  ...
  static const USBVideo_Still_Size_Info SID130B_STILL_SIZE[] =
  {
  ...
  static const USBVideo_Compression_Info SID130B_STILL_COMPRESSION[] =
  {
  ...
  static const USBVIDEO_VIDEO_SIZE_TYPE SID130B_g_default_video_size = USBVIDEO_VIDEO_SIZE_1;
  static const USBVIDEO_STILL_SIZE_TYPE SID130B_g_default_still_size = USBVIDEO_STILL_SIZE_1;
  static const USBVIDEO_COMPRESSION_TYPE SID130B_g_default_compression = USBVIDEO_COMPRESSION_1;
  static const usbvideo_attr_struct SID130BWebcamAttrPara =
  {
    /* min,  max,         res,        def */
    {
      ...
      else
      {
        if (AttrType >= ATTR_PU_START)
        {
          ...
          case USBVIDEO_REQUEST_GET_MIN:
            pWebCamAttr->value = SID130BWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
            break;
          case USBVIDEO_REQUEST_GET_MAX:
            pWebCamAttr->value = SID130BWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
            break;
          case USBVIDEO_REQUEST_GET_DEF:
            pWebCamAttr->value = SID130BWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
            break;
          case USBVIDEO_REQUEST_GET_RES:
            pWebCamAttr->value = SID130BWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
            break;
          default:
  ...
  case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
    ((P_CAL_FEATURE_WEBCAM_GET_ATTR_INFO_STRUCT)out)->pWebCamAttrInfo = SID130B_ATTR_INFO;
    ((P_CAL_FEATURE_WEBCAM_GET_ATTR_INFO_STRUCT)out)->WebCamAttrInfoNum = sizeof(SID130B_ATTR_INFO) / sizeof(SID130B_ATTR_INFO[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
    ((P_CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE_STRUCT)out)->pWebCamVideoSizeInfo = SID130B_VIDEO_SIZE;
    ((P_CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE_STRUCT)out)->WebCamVideoSizeInfoNum = sizeof(SID130B_VIDEO_SIZE) / sizeof(SID130B_VIDEO_SIZE[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
    ((P_CAL_FEATURE_WEBCAM_GET_STILL_SIZE_STRUCT)out)->pWebCamStillSizeInfo = SID130B_STILL_SIZE;
    ((P_CAL_FEATURE_WEBCAM_GET_STILL_SIZE_STRUCT)out)->WebCamStillSizeInfoNum = sizeof(SID130B_STILL_SIZE) / sizeof(SID130B_STILL_SIZE[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
    ((P_CAL_FEATURE_WEBCAM_GET_COMPRESSION_STRUCT)out)->pWebCamCompressionInfo = SID130B_STILL_COMPRESSION;
    ((P_CAL_FEATURE_WEBCAM_GET_COMPRESSION_STRUCT)out)->WebCamCompressionInfoNum = sizeof(SID130B_STILL_COMPRESSION) / sizeof(SID130B_STILL_COMPRESSION[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)out)->WebCamVideoSizeIdx = SID130B_g_default_video_size;
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)out)->WebCamStillSizeIdx = SID130B_g_default_still_size;
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)out)->WebCamCompressionIdx = SID130B_g_default_compression;
    break;
  default:
