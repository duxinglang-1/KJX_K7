...
MM_ERROR_CODE_ENUM SIV120BWebcamFeatureCtrl(kal_uint32 Id, void *In, void *Out, kal_uint32 OutLen, kal_uint32 *RealOutLen)
{
  /* supported feature list */
  static const USBVideo_Attr_Info SIV120B_ATTR_INFO[] =
  {
  ...
  static const USBVideo_Video_Size_Info SIV120B_VIDEO_SIZE[] =
  {
  ...
  static const USBVideo_Still_Size_Info SIV120B_STILL_SIZE[] =
  {
  ...
  static const USBVideo_Compression_Info SIV120B_STILL_COMPRESSION[] =
  {
  ...
  static const USBVIDEO_VIDEO_SIZE_TYPE SIV120B_g_default_video_size = USBVIDEO_VIDEO_SIZE_1;
  static const USBVIDEO_STILL_SIZE_TYPE SIV120B_g_default_still_size = USBVIDEO_STILL_SIZE_1;
  static const USBVIDEO_COMPRESSION_TYPE SIV120B_g_default_compression = USBVIDEO_COMPRESSION_1;
  static const usbvideo_attr_struct SIV120BWebcamAttrPara =
  {
    /* min,  max,         res,        def */
    {
      ...
      else
      {
        if (AttrType >= ATTR_PU_START)
        {
          ...
          case USBVIDEO_REQUEST_GET_MIN:
            pWebCamAttr->value = SIV120BWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
            break;
          case USBVIDEO_REQUEST_GET_MAX:
            pWebCamAttr->value = SIV120BWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
            break;
          case USBVIDEO_REQUEST_GET_DEF:
            pWebCamAttr->value = SIV120BWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
            break;
          case USBVIDEO_REQUEST_GET_RES:
            pWebCamAttr->value = SIV120BWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
            break;
          default:
  ...
  case CAL_FEATURE_WEBCAM_SET_ATTR:
    {
      ...
      SIV120BSensorFunc(&pfSensorFunc);        
  ...
  case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
    ((P_CAL_FEATURE_WEBCAM_GET_ATTR_INFO_STRUCT)Out)->pWebCamAttrInfo = SIV120B_ATTR_INFO;
    ((P_CAL_FEATURE_WEBCAM_GET_ATTR_INFO_STRUCT)Out)->WebCamAttrInfoNum = sizeof(SIV120B_ATTR_INFO) / sizeof(SIV120B_ATTR_INFO[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
    ((P_CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE_STRUCT)Out)->pWebCamVideoSizeInfo = SIV120B_VIDEO_SIZE;
    ((P_CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE_STRUCT)Out)->WebCamVideoSizeInfoNum = sizeof(SIV120B_VIDEO_SIZE) / sizeof(SIV120B_VIDEO_SIZE[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
    ((P_CAL_FEATURE_WEBCAM_GET_STILL_SIZE_STRUCT)Out)->pWebCamStillSizeInfo = SIV120B_STILL_SIZE;
    ((P_CAL_FEATURE_WEBCAM_GET_STILL_SIZE_STRUCT)Out)->WebCamStillSizeInfoNum = sizeof(SIV120B_STILL_SIZE) / sizeof(SIV120B_STILL_SIZE[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
    ((P_CAL_FEATURE_WEBCAM_GET_COMPRESSION_STRUCT)Out)->pWebCamCompressionInfo = SIV120B_STILL_COMPRESSION;
    ((P_CAL_FEATURE_WEBCAM_GET_COMPRESSION_STRUCT)Out)->WebCamCompressionInfoNum = sizeof(SIV120B_STILL_COMPRESSION) / sizeof(SIV120B_STILL_COMPRESSION[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamVideoSizeIdx = SIV120B_g_default_video_size;
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamStillSizeIdx = SIV120B_g_default_still_size;
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamCompressionIdx = SIV120B_g_default_compression;
    break;
  default:
