 ...
 * Filename:
 * ---------
 *   camera_yuv_para_SIV120B_DIRECT.c
 *
 ****************************************************************************/
...
const nvram_camera_para_struct CAMERA_PARA_DEFAULT_VALUE=
{
	/* STRUCT: ISP */
	{
		/* ARRAY: ISP.reg[144+8] */
		{
			...
			0x00000000, 0x00000000, 0x00000000, 0x00000000,         // CAM+110h~11Ch ,68 disable Y_LPEN
...
const nvram_camera_para_struct CAMERA_PARA_DEFAULT_VALUE=
{
	/* STRUCT: ISP */
	{
		/* ARRAY: ISP.reg[132] */
		{
			...
			0x85FF0100, 0x00F00098, 0x00800098, 0x10203040,	//CAM+030h,12
			...
			0x01181812, 0x00000018, 0x24800F0F, 0x101F8224, 	//CAM+080h,32
			0x003D3D3F, 0x84110F04, 0x20140403, 0x00349084, 	//CAM+090h,36
			0x0089338A, 0x00839134, 0x00202020, 0x00000048, 	//CAM+0A0h,40
			0x00888888, 0x008A8A8A, 0x00408010, 0x24240000, 	//CAM+0B0h,44
			0x00FF91B8, 0x00018080, 0x284E6778, 0x91A8C0D7, 	//CAM+0C0h,48	
			...
			0x11111111, 0x11111110, 0x00000000, 0xF8000200,	// CAM+1C0~1CC ,96
			0xA0A00000, 0x00000000, 0x00000000, 0x00000000,	// CAM+1D0~1DC ,100
			...
			0x00000000, 0x127E3348, 0xD2A08E00, 0x03204163, 	// CAM+210~21C ,112
			0x8696A5B4, 0xC4D3E2F1, 0x20416386, 0x96A5B4C4,	// CAM+220~20C ,120
			0xD3E2F100, 0x20416386, 0x96A5B4C4, 0xD3E2F100, 	// CAM+230~20C ,124
...
#include "camera_para.h"
void SIV120B_DIRECT_init_camera_operation_para(camera_operation_para_struct *oper_data)
{
#if defined(__DYNAMIC_SENSOR_DELAY__)
	   oper_data->capture_delay_frame = 0;			/* Switch Preview to Capture */
#else
	   oper_data->capture_delay_frame = 3;			/* Switch Preview to Capture */
#endif
   oper_data->preview_delay_frame = 3;			/* Wait Preview Stable */
#if (defined(__DYNAMIC_SENSOR_DELAY__ )) 
   oper_data->preview_ae_stable_frame = 0;
#endif
}
