...
/*GORM*/ {   8,   1,   // power on : pin(if use GPO, please plus 100), pol
/*GORM*/     9,   1,   // gsm2bt   : pin(if use GPO, please plus 100), pol
/*GORM*/  0xFF,   1,   // bt2gsm   : pin(EINT n), pol
/*GORM*/    33,  34,   // rxd3(33), txd3(34)
/*GORM*/  0xFF,0xFF,   // cts3(35), rtx3(36)
/*GORM*/     0,   0,   // reserved
/*GORM*/     0,   0,   // reserved
/*GORM*/     0,   0    // reserved
/*GORM*/ };
