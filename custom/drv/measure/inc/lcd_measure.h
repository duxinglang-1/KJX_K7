...
#ifndef LCD_MEASURE_H
#define LCD_MEASURE_H
...
{
    /* PWMx */
    LCD_MEASURE_TYPE_MAINLCD_CONTRAST = 0,
    LCD_MEASURE_TYPE_MAINLCD_BIAS,
    LCD_MEASURE_TYPE_MAINLCD_LINERATE,
    LCD_MEASURE_TYPE_MAINLCD_TEMP,
    LCD_MEASURE_TYPE_SUBLCD_CONTRAST,
    LCD_MEASURE_TYPE_SUBLCD_BIAS,
    LCD_MEASURE_TYPE_SUBLCD_LINERATE,
    LCD_MEASURE_TYPE_SUBLCD_TEMP,
    LCD_MEASURE_TYPE_MAX_ITEM
}lcd_measure_type_enum;
