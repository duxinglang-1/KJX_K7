...
/* dual SIMIF dual SIM solution doesn't need this
	//return 0xff;
   if((0 == MT6302Interface) && 
		(MT6302_SPI_USE_GPIO == MT6302_getSPIInterface(MT6302Interface) || 
		 MT6302_SPI_USE_DEDICATED_GPIO == MT6302_getSPIInterface(MT6302Interface)))
   {		 
