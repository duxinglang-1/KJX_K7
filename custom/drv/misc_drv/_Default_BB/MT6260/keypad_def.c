...
kal_bool keypad_is_fullpress(kal_uint8 key); 
   ...
   #ifdef __KBD_2STEP_KEY_SUPPORT__
   /*the first key*/
   #define Custom_2Step_Key_Position TWO_STEP_KEY_
   /*the second key for detection*/
   #define CUSTOM_2STEP_SEC_KEY_ROW  SECOND_KEY_ROW_
   #define CUSTOM_2STEP_SEC_KEY_COL  SECOND_KEY_COLUMN_
   #endif
#else /*__CUST_NEW__*/
...
keypad_struct  keypad_custom_def = {          
      /*keypad mapping*/
      {
      #ifndef __CUST_NEW__
          /* row 0 */
...
//#ifndef __CUST_NEW__ : modify here
          0xFF, //0xFF means use GPO 0xFF as extend row
