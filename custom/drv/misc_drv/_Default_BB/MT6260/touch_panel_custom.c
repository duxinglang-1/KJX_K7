...
kal_uint8 ctp_config_list[CTP_CONFIG_MAX][CTP_CONFIG_LENGTH] =
{
    {
        ...
        /* 6D2 */ 0x30, 0x30, 0x0F, 0x0F, 0x0A, 0x50, 0x3C, 0x09,
                  0x3F, 0x00, 0x05, ((CTP_X_RES)&0xFF),((CTP_X_RES>>8)&0xFF),((CTP_Y_RES)&0xFF),(((CTP_Y_RES)>>8)&0xFF),0x00,
        /* 6E2 */ 0x00, 0x00, 0x00, 0x40, 0x40, 0x00, 0x00, 0x01,
    ...
    },
    {
        ...
        /* 6F2 */ 0x20, 0x10, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
                  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x38,
        /* 702 */ 0x00, 0x3C, 0x28, 0x00, 0x00, 0x00, 0x00, 0xC0,
                  0x08, 0x01
    }                        
};

#endif // __CTP_GOODIX_GT818_TRUE_MULTIPLE__

#ifdef __CTP_GOODIX_GT868_TRUE_MULTIPLE__

unsigned char ctp_config_list[CTP_CONFIG_MAX][CTP_CONFIG_LENGTH] =
{
    {
        /* 6A2 */ 0x00,0x02,0x04,0x06,0x08,0x0A,0x0C,0x0E,
                  0x10,0x12,0xD0,0x00,0xC4,0x44,0xB3,0x33,
        /* 6B2 */ 0xA2,0x22,0x90,0x00,0x80,0x00,0x70,0x00,
                  0x60,0x00,0x50,0x00,0x40,0x00,0x30,0x00,
        /* 6C2 */ 0x20,0x00,0x10,0x00,0x00,0x00,0xC0,0x00,
                  0xD0,0x00,0x37,0x03,0x80,0x80,0x80,0x1E,
        /* 6D2 */ 0x1E,0x1E,0x0E,0x0E,0x09,0x40,0x30,0x1C,
                  0x03,0x00,0x05,((CTP_X_RES)&0xFF),((CTP_X_RES>>8)&0xFF),((CTP_Y_RES)&0xFF),(((CTP_Y_RES)>>8)&0xFF),0x00,
        /* 6E2 */ 0x00,0x66,0x66,0x60,0x60,0x00,0x00,0x23,
                  0x14,0x05,0x29,0xC0,0x00,0x00,0x00,0x00,
        /* 6F2 */ 0x14,0x10,0x00,0x00,0x20,0x00,0x00,0x00,
...
#endif // __CTP_GOODIX_GT868_TRUE_MULTIPLE__
...
#ifdef TOUCH_PANEL_PRESSURE
    kal_uint16 touch_pressure_threshold_high = TOUCH_PRESSURE_THRESHOLD_HIGH;
    kal_uint16 touch_pressure_threshold_low = TOUCH_PRESSURE_THRESHOLD_LOW;
#endif /*TOUCH_PANEL_PRESSURE*/
...
{
     tp_Get_Data,
     (void (*)(kal_uint16 *, kal_uint16 *))tp_read_adc,
#ifdef TOUCH_PANEL_PRESSURE
#ifndef DRV_TP_SLIM
     tp_pressure_check,
#endif
