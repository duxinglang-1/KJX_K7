...
const UART_rings_struct *UART_Get_Data(void);
	 ...
	 #define L4_RX_LENGTH			   64
	 #define L4_TX_LENGTH			   64
	 #define L4_TXISR_LENGTH		   64
	 #define TST_RX_LENGTH		   64
	 #define TST_TX_LENGTH		   64
	 #define TST_TXISR_LENGTH	   64
	 #define CUSTOM_RX_LENGTH	   64
	 #define CUSTOM_TX_LENGTH	   64
	 #define CUSTOM_TXISR_LENGTH   64
#else /* defined(IC_BURNIN_TEST) */
...
#define TST_TXISR_LENGTH		1
#define CUSTOM_TXISR_LENGTH	1
#else
#define L4_TXISR_LENGTH			2048
#define TST_TXISR_LENGTH		2048
#define CUSTOM_TXISR_LENGTH	2048
#endif
...
const UART_rings_struct	UART_custom_rings = 
{
	...
	#ifdef __UART3_SUPPORT__		
	uart_port1/*which one not support VFIFO*/			
	#else
