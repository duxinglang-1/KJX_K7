 ...
 * Author:
 * -------
 *   Carlos Yeh (mtk02377)     system auto generatorv6.80 + scatFrame v0.08 + sysGenUtility v0.40
 *
 *============================================================================
 *             HISTORY
...
#define FOTA_MAUI_IMAGE_AMOUNT     (1)
      ...
      #define MAX_LENGTH_DSP_ROM  (0x100000)
            ...
            #define MAX_LENGTH_ROM  (MAX_ROM_SIZE)
         #else  /* MAX_ROM_SIZE */
            #define MAX_LENGTH_ROM  (0x00D30000)
         #endif  /* MAX_ROM_SIZE */
      #else
         #define MAX_LENGTH_ROM     (0xFFFFFFFF)
      #endif
...
#define FOTA_PACKAGE_STORAGE_BASE  (0x10E00000)

#define FOTA_PACKAGE_STORAGE_SIZE  (0x00000000)

#define FOTA_PACKAGE_BLOCK_NUMBER  (4)

#define FOTA_BACKUP_STORAGE_BASE   (0x10E00000)
