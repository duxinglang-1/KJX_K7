...
extern kal_uint32 Image$$DYNAMIC_COMP_MP4ASPDEC$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4ASPDEC_BODY$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4ASPDEC_BODY$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4ASPDEC_BODY$$ZI$$Limit;
...
kal_uint32 custom_query_dump_region(EXTSRAM_REGION_INFO_T* region)
{
    ...
    region[11].len = (kal_uint32)&Image$$DYNAMIC_COMP_BESLOUDNESS_BODY$$Base + 0x2480 - region[11].addr;
