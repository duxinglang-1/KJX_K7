...
#define MPEG4_DEC_CUSTOM_FRAME_SETTING_ENABLE
    ...
    #define MPEG4_CUSTOM_MAX_NORMAL_MODE_RESOLUTION_SP (RESOLUTION_320x240)
    //#define MPEG4_CUSTOM_SUPPORT_RESOLUTION_1_TO_2_SP  (RESOLUTION_320x240)
    #define MPEG4_CUSTOM_SUPPORT_RESOLUTION_SP         (RESOLUTION_320x240)
    #define MPEG4_CUSTOM_SUPPORT_RESOLUTION_1_TO_8_SP  (RESOLUTION_320x240)

    #ifdef __MP4_DEC_SW_SUPPORT_ASP__
        #define MPEG4_CUSTOM_EXTRA_BUFFER_NUM_ASP           (4)
        #define MPEG4_CUSTOM_MAX_NORMAL_MODE_RESOLUTION_ASP (RESOLUTION_320x240)
        //#define MPEG4_CUSTOM_SUPPORT_RESOLUTION_1_TO_2_ASP  (RESOLUTION_320x240)
        #define MPEG4_CUSTOM_SUPPORT_RESOLUTION_ASP         (RESOLUTION_320x240)
        #define MPEG4_CUSTOM_SUPPORT_RESOLUTION_1_TO_8_ASP  (RESOLUTION_320x240)
    #endif
...
#define MJPEG_DEC_CUSTOM_FRAME_SETTING_ENABLE
    ...
    #define MJPEG_CUSTOM_SUPPORT_RESOLUTION          (RESOLUTION_320x240)
    #define MJPEG_CUSTOM_MAX_QTY_MODE_RESOLUTION  (RESOLUTION_320x240)
    #define MJPEG_CUSTOM_MAX_NORMAL_MODE_RESOLUTION  (RESOLUTION_320x240)
