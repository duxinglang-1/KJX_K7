...
typedef enum
{
    ...
    DRM_RESULT_CERT_ROOT_NOT_FOUND  = -0x00270000,
    DRM_RESULT_IN_PROGRESS          = -0x00280000,
    DRM_RESULT_NO_RIGHTS_SPACE      = -0x00290000,
    DRM_RESULT_DB_LOCKED            = -0x00300000,
    DRM_RESULT_ENCRYPT_FAIL         = -0x00400000,
