...
static kal_bool   ec_task_reset(task_indx_type task_indx);
static kal_bool   ec_task_end(task_indx_type task_indx);
...
ec_task_create(comptask_handler_struct **handle)
{
    static const comptask_handler_struct ec_handler_info =
    {
        ...
        ec_task_end         /* task termination handler */
    };
...
*************************************************************************/
kal_bool
ec_task_reset(task_indx_type task_indx)
{
...
*************************************************************************/
kal_bool
ec_task_end(task_indx_type task_indx)
{
