...
struct BS_HandleStruct{
   ...
   //============================================================//
   int (*GetBufferSize)(BS_Handle *pHandle,
   ...
   //============================================================//
   int (*Close)(BS_Handle *pHandle, int bEnableOLA);
   ...
   //============================================================//
   int (*SetParameters)(BS_Handle *pHandle,
                         int cBytes,
   ...
   //============================================================//
   int (*GetEngineInfo)(BS_Handle *pHandle,
