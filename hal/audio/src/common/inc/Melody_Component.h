...
#define MULTIPLE_PASER_SINGLE_WTSYNTH 1
#define SINGLE_PASER_SINGLE_WTSYNTH 0
#define MELODY_ENABLE_DEBUGLOG 0

#if (SINGLE_PASER_SINGLE_WTSYNTH) && (MULTIPLE_PASER_SINGLE_WTSYNTH)
   #error Not allow to enable SINGLE_PASER_SINGLE_WTSYNTH and MULTIPLE_PASER_SINGLE_WTSYNTH at same time
#endif
...
#define MELODY_SYNTH_BUFNUM          2
#define PIANO_SYNTH_BUFNUM           2
...
#endif*/
typedef enum{
   MELODYUSAGE_SOUNDEFFECT = 0,
   MELODYUSAGE_MUSICSOUND = 1,
}MELODYUSAGE_T;
typedef enum{
   MELODY_REPEAT = 0x00,
   MELODY_END,
   ...
   MELODY_SYNTHDONE_SOUNDEFFECT,
   MELODY_SYNTHDONE_MUSICSOUND
