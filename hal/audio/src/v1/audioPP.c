...
{
#if defined(__BES_LOUDNESS_ON_I2S__) && !(defined(MT6250) || defined(MT6255) || defined(MT6260))
   if(I2S_is_I2S_open())
   {
      if(AFE_IsAudioLoudSpk())
      {
...
{
#if defined(MT6236) || defined(MT6236B) || defined(MT6256) || defined(MT6276) || defined(MT6255) || defined(MT6250) || defined(MT6260)
