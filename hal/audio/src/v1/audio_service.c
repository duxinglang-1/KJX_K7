...
static void Audio_Wake_DSP(kal_bool flag)
{
   kal_brief_trace( TRACE_GROUP_AUD_MD2GCTRL, L1AUDIO_MD2G_PWR_CTRL,flag);
   if(flag)
   {
#if defined(MT6260)
      ...
      kal_brief_trace( TRACE_GROUP_AUD_MD2GCTRL, L1AUDIO_MD2G_PWR_CTRL_DONE);
   } else {
      Audio_DSP_Wakeup_Eevent_Setting(flag);
