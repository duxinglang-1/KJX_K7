...
(kal_uint64 *puMiliSecond, kal_uint32 speed_scale, kal_uint8 bAudioSamplingFreqIndex, Media_Format eFormat)
{
   ...
   media_a2v.uPlaybackTimeBase = uPrevPlaybackTime + ( uCurrentInterruptCount - media_a2v.uPrevQueryInterruptCount ) * speed_scale * 10 / uAudioInterruptTimeScale;
