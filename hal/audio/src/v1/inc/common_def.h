...
#define __CTIRQ_SLEEP_PLATFORM__ ( defined(MT6250) || defined(MT6260))
#if ((defined(MT6251) || defined(MT6256_S00) || defined(MT6256_S01) || defined(MT6255) || defined(MT6250) || defined(MT6260)) && defined(__FMRADIO_I2S_SUPPORT__)) 
...
#if defined(MT6253) || defined(MT6252) || defined(MT6251) || defined(MT6252H) || defined(MT6255) || defined(MT6250) || defined(MT6260)
...
#ifdef __I2S_UNIT_TEST__ || __KARAOKE_DVT_TEST__ || __CVSD_LOOPBACK_TEST__
...
/* ----------------------------------------------------*/
#define AAC_DSP_COMP     (defined(MT6256_S01) || defined(MT6255) || defined(MT6250) || defined(MT6260))
#define AMR_DSP_COMP     (defined(MT6256_S01) || defined(MT6255) || defined(MT6250) || defined(MT6260))
...
#define TDDNC_SUPPORT (defined(MT6253) || defined(MT6251) || defined(MT6252) || defined(MT6256) || defined(MT6236) || defined(MT6260))

#if defined(MT6250) || (!TDDNC_SUPPORT && defined(MT6260))
...
#define __AM_DSP_IN_TASK__ ( defined(MT6250) || defined(MT6260) )

// For 3G
#define __SP3G_PLATFORM__ ( defined(MT6268) )

// For 65nm
#define __RELOAD_DSP_COEFF__  ( defined(MT6268) || defined(MT6236) || defined(MT6236B) || defined(MT6256_S00) || defined(MT6256_S01) || defined(MT6251) || defined(MT6255) || defined(MT6250) || defined(MT6260))
#define __RELOAD_HW_COEFF__  ( defined(MT6268) || defined(MT6236) || defined(MT6236B) || defined(MT6256_S00) || defined(MT6256_S01) || defined(MT6251) || defined(MT6255) || defined(MT6250) || defined(MT6260))

#define __KARAOKE_SUPPORT__ (defined(MT6255) || defined(MT6250) || defined(MT6260))

// For DSP-ARM separated HW
#define __DSP_WAKEUP_EVENT__ (defined(MT6250) || defined(MT6260))

#if defined(MT6256) || defined(MT6276)
    #define MAX_AUD_EQ_BAND_NUM 20
#elif defined(MT6255)
    #define MAX_AUD_EQ_BAND_NUM 10
#elif defined(MT6252) || defined(MT6250) || defined(MT6260)
...
#if (defined(MT6280) || defined(MT6260) )
...
#define DSP_DATA_CARD_INTERFACE_SUPPORT  (defined(MT6250) || defined(MT6260))
