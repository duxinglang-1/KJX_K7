...
#define AUDIO_32K_Record_CTRL                     DP2_AUDIO_PP_CTRL_BASE + 0x012 /* 0x3f35 */
...
#define AUDIO_RAMPDOWN_ENABLE                     DP2_EXTRA_APPLICATION_FILED_BASE + 0x001 /* 0x3f39 */
...
#define MT6260_SHERIF_SIZE (1376)
#if (SHERIF_SIZE > MT6260_SHERIF_SIZE)
    ¡§SHERIF SIZE exceeds limitation !! This line makes assembler stop¡¨
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6260_SHERIF_SIZE)
