...
#if defined(MT6260) || defined(MT6235) || defined(MT6235B) || defined(MT6268) || defined(MT6253) || defined(MT6236) || defined(MT6236B) || defined(MT6256_S00) || defined(MT6256_S01) || defined(MT6255) || defined(MT6250)  || defined(MT6251)  || defined(MT6253E) || defined(MT6253L)|| defined(MT6252) || defined(MT6252H)
...
#define BT_A2DP_SBC_SUPPORT ( defined(MT6260) || defined(MT6235) || defined(MT6235B) || defined(MT6268) || defined(MT6253) || defined(MT6236) || defined(MT6236B) || defined(MT6256_S00) || defined(MT6253E) || defined(MT6253L)|| defined(MT6252) || defined(MT6252H) || defined(MT6256_S01) || defined(MT6255) || defined(MT6250) )
...
// rename note: SPH_DL_VOL  DP_VOL_OUT_PCM
//=============================================================================================
//                  Keytone & Tone
//=============================================================================================
...
// note and rename
/*#if defined(MT6235) || defined(MT6235B) || defined(MT6268) || defined(MT6253) || defined(MT6236) || defined(MT6236B) || defined(MT6256_S00) || defined(MT6251) || defined(MT6253E) || defined(MT6253L)|| defined(MT6252) || defined(MT6252H)  || defined(MT6256_S01) || defined(MT6255) || defined(MT6250) 
        original                rename                            
#define DP_SD1_VM_0            DSP_SD1_VM_0                  // SID indicator [2:1] & TAF[3] & BFI[5]     
#define DP_SD1_VM_1            DSP_SD1_VM_1                  // information bits d[15:0]                  
#define DP_SD1_VM_17           DSP_SD1_VM_17                 // information bits d[275:260]               
#define DP_SD2_VM_0            DSP_SD2_VM_0                  // SP flag [1]                               
#define DP_SD2_VM_1            DSP_SD2_VM_1                  // information bits d[15:0]                  
#define DP_SD2_VM_17           DSP_SD2_VM_17                 // information bits d[275:260]               
#define DP_RX_TCH_S(m, n)      DSP_RX_TCH_S(m, n)            
#define DP_TX_TCH_S(m, n)      DSP_TX_TCH_S(m, n)        
        DP_SC_TCH_MODE   DSP_SC_TCH_MODE
        DP_SD_TCH_MODE   DSP_SD_TCH_MODE
        DP_TX_TCH_S0_0  DSP_TX_TCH_S0_0
        DP_RX_TCH_S0_0  DSP_TX_TCH_S0_0
#endif
*/
// rename note
// DP_SD2_AWB_VM_0   DSP_SD2_AWB_VM_0
// DP_SD2_AWB_VM_1   DSP_SD2_AWB_VM_1
// DP_SD2_AWB_VM_18  DSP_SD2_AWB_VM_18
// DP_AWB_SE_CTRL    DSP_AWB_SE_CTRL
// DP_AWB_SD_CTRL    DSP_AWB_SD_CTRL
...
// rename note
//DP_AUDIO_CTRL2        DSP_AUDIO_CTRL2
//DP_AUDIO_FLEXI_CTRL   DSP_AUDIO_FLEXI_CTRL
...
//------------------------
 // rename 
 //DP_AEC_CTRL DP_AEC_CONTROL
 //DP_AEC2_CTRL DP_AEC2_CONTROL 
 //DP_EES_CTRL    DP_EES_CONTROL
 //DP_DMNR_CTRL  DP_DMNR_CONTROL
 //delete: DP_AEC_DLBUF_ADDR, DP_AEC_DLBUF_LEN, DP_AEC_NP_ON, DP_EES_FE_ATTEN, DP_EES_DT_ATTEN
 
//=============================================================================================
//                  Gain/Coeff/Compensation
//=============================================================================================
#if defined(MT6260)    // for 6260 temp build pass
...
#endif   
//rename
// DP_Enh_Dynamic_Switch DP_Audio_FltCoeff_Addr 
// DP_Audio_Flt_Coeff_Len DP_Audio_FltCoeff_Len
// DP_16k_Compen_Flt_Flag DP_16k_CompenFlt_Flag
// DP_16k_Compen_Flt_Len  DP_16k_CompenFlt_Len
...
#endif   
//rename
//DP_UL_COMFORT_NOISE_THRESHOLD DSP_UL_COMFORT_NOISE_THRESHOLD
//DP_UL_COMFORT_NOISE_SHIFT DSP_UL_COMFORT_NOISE_SHIFT
...
/*doug rename
DP_UL_NR_CTRL  DSP_UL_NR_CTRL
DP_DL_NR_CTRL  DSP_DL_NR_CTRL
*/
...
//rename: DEBUG_ASSERT_CTRL DP_DEBUG_ASSERT_CTRL 
//=============================================================================================
//                  Uplink WB AMR in TCH buffer
//=============================================================================================
#if defined(MT6268) || defined(MT6236) || defined(MT6236B) || defined(MT6256_S00) || defined(MT6251) || defined(MT6256_S01) || defined(MT6255) || defined(MT6250) || defined(MT6260)
...
// rename
// DSP_DEAD_INT DSP_DEAD_INTERRUPT
//=============================================================================================
//                  CTM
//=============================================================================================
#if defined(MT6256_S01) || defined(MT6255) || defined(MT6250) || defined(MT6260)
...
//rename
//DP_CTM_AMR_CODEBOOK_GAIN_LIMIT   DP_CTM_AMRCODEBOOK_GAIN_LIMIT
//DP_CTM_AMR_CODEBOOK_GAIN_UPDATE  DP_CTM_AMRCODEBOOK_GAIN_UPDATE
//DP_CTM_COSIM_CTRL DP_CTM_COSIM_CONTROL
...
//rename DP2_SPEECH_DEBUG_MODE DSP_SPEECH_DEBUG_MODE
...
//rename  DP_TCH_S0_FLAGS  DSP_TCH_S0_FLAGS 
...
//   #define DSP_DACA_LEN_UL                    (*DPRAM2_base(SPH_DACA_LEN_UL))   // for 60 new speech sherif
//   #define DSP_DACA_LEN_DL                    (*DPRAM2_base(SPH_DACA_LEN_DL))   // for 60 new speech sherif
   #define DSP_DACA_UL_INT                    DP_SP_SPEECH_RESERVED_base(0x9)   
   #define DSP_DACA_DL_INT                    DP_SP_SPEECH_RESERVED_base(0xa) 
#endif
//rename
// DP_DACA_CTRL DSP_DACA_CTRL
// DP_DACA_PTR_UL DSP_DACA_PTR_UL
// DP_DACA_PTR_DL DSP_DACA_PTR_DL
//=============================================================================================
//                  To indicate CSD channel types
//=============================================================================================
#if TDDNC_SUPPORT
...
#endif
// rename
// DP2_AGC_CTRL DSP_AGC_CTRL
// DP2_AGC_GAIN DSP_AGC_GAIN


//=============================================================================================
//                  DSP adapt voice analog gain
//=============================================================================================
//new dual-dsp chip all use this setting
#if defined(MT6256_S01) || defined(MT6255) || defined(MT6250) || defined(MT6260)
   //#define DP2_ADAPT_VOL_INT        DP_AWB_8K_base(6)//DPRAM2_base(0x29C)
   //#define DP2_ADAPT_VOL            DP_AWB_8K_base(7)//DPRAM2_base(0x29D)
...
//                  Others
//=============================================================================================
#if defined(MT6250) || defined(MT6255) || defined(MT6260)
...
//renmae DP_GSM_MODE DSP_GSM_MODE


#define DSP_16K_SIDETONE_SUPPORT ( defined(MT6235) || defined(MT6235B) || defined(MT6268) || defined(MT6253) || defined(MT6253E) || defined(MT6253L)  || defined(MT6252H) || defined(MT6252) || defined(MT6236) || defined(MT6236B) || defined(MT6251) || defined(MT6256_S00) || defined(MT6256_S01) || defined(MT6255) || defined(MT6250) || defined(MT6260) )
