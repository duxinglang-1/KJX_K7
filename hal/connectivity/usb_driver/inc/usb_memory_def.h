...
#ifdef __USB_MODEM_CARD_F_SUPPORT__  // MT6280 temp name
#define USB_MS_5COM_FUNCTION_SIZE	 (USBMS_MAX_BUFFERSIZE + USB_2COM_FUNCTION_SIZE)
#else
...
// compare single function and multi function max size
	...
	#define USB_MAX_MEMORY_SIZE		(USB_MAX_MULTI_TEMP+ USB_DESCRIPTOR_SIZE)
#else	
	#define USB_MAX_MEMORY_SIZE		(USB_MAX_SINGLE_TEMP+ USB_DESCRIPTOR_SIZE)
#endif
