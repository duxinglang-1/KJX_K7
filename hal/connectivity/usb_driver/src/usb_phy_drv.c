...
#endif //(defined(DRV_USB_IP_V1)||defined(DRV_USB_IP_V1_PLUS)||defined(DRV_USB_IP_V2)||defined(DRV_USB_IP_V3))
...
void USB_PHY_Charger_Detect_Release(void)
{
	...
	#if defined(DRV_USB_PHY_M60_IP)||defined(DRV_USB_PHY_U40_IP)
	volatile kal_uint32 delay;
	#endif
