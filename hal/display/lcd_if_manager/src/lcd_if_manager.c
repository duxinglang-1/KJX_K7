...
static LCD_IOCTRL_RESULT_E _lcd_ioctrl_device_dbi_parallel_if_6250_series(LCD_IOCTRL_IF_INTERNAL_ACT_E act, LCD_IOCTRL_DBI_PARALLEL_IF_T *p_argu)
{
    ...
    {   
        ...
        // HW clock rate is: 104 MHz. It can't be configured.
	#if((defined(MT6250) || defined(MT6260)) && defined(__EMI_CLK_130MHZ__))//since 11BW1212, MT6250 support 130MHz EMI and 104MHz EMI, which will lead lcd HW clock change to 130Mhz
...
static LCD_IOCTRL_RESULT_E _lcd_ioctrl_device_dbi_parallel_if_6260_series(LCD_IOCTRL_IF_INTERNAL_ACT_E act, LCD_IOCTRL_DBI_PARALLEL_IF_T *p_argu)
{
    ...
    {   
        ...
        // HW clock rate is: 104 MHz. It can't be configured.
	#if(defined(MT6260) && defined(__EMI_CLK_130MHZ__))//since 11BW1212, MT6260 support 130MHz EMI and 104MHz EMI, which will lead lcd HW clock change to 130Mhz
	p_argu->if_clk_freq = 130000000;    
	#elif(defined(MT6260) && defined(__EMI_CLK_166MHZ__))//since 11BW1212, MT6260 support 130MHz EMI and 104MHz EMI, which will lead lcd HW clock change to 130Mhz
