...
lcdTear_VsyncModeInit(kal_uint32 port_id)
{
  ...
  else  if(pCtrlBlk->usedLcdSyncMode == LCDTEAR_HW_VSYNC_HW_DELAY_TIME_MODE)
  {
    if (KAL_TRUE == pCtrlBlk->lcdDelayTimeSupport)
    {
      ...
      #elif defined(MT6276) || defined(MT6256) || defined(MT6252) || defined(MT6252H) || defined(MT6255) || defined(MT6250) || defined(MT6260)
      {
        kal_uint32 lcmScanTimePerLineTmp;
      ...
      #if defined(MT6276) || defined(MT6256) || defined(MT6252) || defined(MT6252H) || defined(MT6255) || defined(MT6250) || defined(MT6260)
