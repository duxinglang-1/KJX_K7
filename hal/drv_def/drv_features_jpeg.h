...
#if defined(__DRV_GRAPHICS_JPEG_6253_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6252_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6250_SERIES__)|| defined(__DRV_GRAPHICS_JPEG_6260_SERIES__)
   #define __SW_JPEG_DECODER_BASIC_PROFILE_INTERNAL___
#else
   #define __SW_JPEG_DECODER_FULL_PROFILE_INTERNAL___
#endif

#if defined(__DRV_GRAPHICS_JPEG_6250_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6260_SERIES__)
...
#elif defined(__DRV_GRAPHICS_JPEG_6250_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6260_SERIES__)
