 ...
 * Description:
 * ------------
 *   Driver definition of JPEG codec for MT6236 series chip.
 *
 * Author:
 * -------
 * -------
 ...
 *============================================================================
 ****************************************************************************/
 #ifndef __JPEG_DRV_6236_SERIES_H__
#define __JPEG_DRV_6236_SERIES_H__
...
/// reg_base_mt6236.h defines JPEG_base instead of JPEG_CODEC_base
#define JPEG_CODEC_base JPEG_ENC_base

/* JPEG codec register offset */
/* MT6236 does not equipped with HW JPEG decoder. */ 
/*
...
#define JPEG_DRV_ENC_BURST_TYPE_BURST_16        (0x00 << 12)
#define JPEG_DRV_ENC_BURST_TYPE_SINGLE_4        (0x01 << 12)
#define JPEG_DRV_ENC_BURST_TYPE_BURST_2         (0x02 << 12)
#define JPEG_DRV_ENC_BURST_TYPE_BURST_4         (0x03 << 12)
#define JPEG_DRV_ENC_BURST_TYPE_BURST_8         (0x04 << 12)
...
#endif /// __DRV_GRAPHICS_JPEG_6236_SERIES__
#endif /// __JPEG_DRV_6236_SERIES_H__
