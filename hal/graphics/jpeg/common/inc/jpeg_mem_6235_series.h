 ...
 *============================================================================
 ****************************************************************************/
#ifndef __JPEG_MEM_6235_SERIES_H__
#define __JPEG_MEM_6235_SERIES_H__
...
#define JPEG_ENC_INT_MIN_MEM_SIZE                     JPEG_SW_ENC_INT_MIN_MEM_SIZE
#define JPEG_ENC_INT_MAX_MEM_SIZE                     JPEG_SW_ENC_INT_MAX_MEM_SIZE
#define JPEG_ENC_EXT_MIN_MEM_SIZE                     (JPEG_SW_ENC_EXT_MIN_MEM_SIZE + JPEG_SW_ENC_EXIF_EXT_MAX_MEM_SIZE + 4)
#define JPEG_ENC_EXT_MAX_MEM_SIZE                     (JPEG_SW_ENC_EXT_MAX_MEM_SIZE + JPEG_SW_ENC_EXIF_EXT_MAX_MEM_SIZE + 4)
