 ...
 *============================================================================
 ****************************************************************************/
#ifndef __JPEG_MEM_6236_SERIES_H__
#define __JPEG_MEM_6236_SERIES_H__
...
/// ******************************************************************HW Encoder******************************************************************
#define JPEG_HW_ENC_INT_MIN_MEM_SIZE                  IDP_MEM_CONSUME_JPEG_ENCODE_INTMEM
#define JPEG_HW_ENC_INT_MAX_MEM_SIZE                  IDP_MEM_CONSUME_JPEG_ENCODE_INTMEM
#if IDP_MEM_CONSUME_JPEG_ENCODE_YUV420_EXTMEM > IDP_MEM_CONSUME_JPEG_ENCODE_EXTMEM
    #define JPEG_HW_ENC_EXT_MIN_MEM_SIZE              IDP_MEM_CONSUME_JPEG_ENCODE_YUV420_EXTMEM
    #define JPEG_HW_ENC_EXT_MAX_MEM_SIZE              IDP_MEM_CONSUME_JPEG_ENCODE_YUV420_EXTMEM
#else
    #define JPEG_HW_ENC_EXT_MIN_MEM_SIZE              IDP_MEM_CONSUME_JPEG_ENCODE_EXTMEM
    #define JPEG_HW_ENC_EXT_MAX_MEM_SIZE              IDP_MEM_CONSUME_JPEG_ENCODE_EXTMEM
#endif
/// ******************************************************************HW Encoder******************************************************************
/// ******************************************************************HW Decoder******************************************************************
#define JPEG_HW_DEC_BASIC_EXT_MEM_SIZE                0
#define JPEG_HW_DEC_BASIC_EXT_MEM_SIZE                0
/// ******************************************************************HW Decoder******************************************************************
...
#define JPEG_DEC_INT_MIN_MEM_SIZE                     JPEG_SW_DEC_INT_MIN_MEM_SIZE
#define JPEG_DEC_INT_MAX_MEM_SIZE                     JPEG_SW_DEC_INT_MAX_MEM_SIZE
#define JPEG_DEC_EXT_MIN_MEM_SIZE                     JPEG_SW_DEC_EXT_MIN_MEM_SIZE
#define JPEG_DEC_EXT_MAX_MEM_SIZE                     JPEG_SW_DEC_EXT_MAX_MEM_SIZE
