 ...
 * Filename:
 * ---------
 *   jpeg_panorama_mem_6236_series.h
 *
 * Project:
 * --------
 *   Maui
 ...
 *============================================================================
 ****************************************************************************/
#ifndef __JPEG_PANORAMA_MEM_6236_SERIES_H__
#define __JPEG_PANORAMA_MEM_6236_SERIES_H__
...
/// ******************************************************************HW Encoder******************************************************************
/// ******************************************************************HW Decoder******************************************************************
#define JPEG_HW_DEC_PANORAMA_INT_MIN_MEM_SIZE               0
#define JPEG_HW_DEC_PANORAMA_INT_MAX_MEM_SIZE               0
#define JPEG_HW_DEC_PANORAMA_EXT_MIN_MEM_SIZE               0
#define JPEG_HW_DEC_PANORAMA_EXT_MAX_MEM_SIZE               0
/// ******************************************************************HW Decoder******************************************************************


#if (JPEG_HW_ENC_PANORAMA_INT_MIN_MEM_SIZE >= JPEG_SW_ENC_PANORAMA_INT_MIN_MEM_SIZE)
...
#if (JPEG_HW_ENC_PANORAMA_INT_MAX_MEM_SIZE >= JPEG_SW_ENC_PANORAMA_INT_MAX_MEM_SIZE)
...
#if (JPEG_HW_ENC_PANORAMA_EXT_MIN_MEM_SIZE >= JPEG_SW_ENC_PANORAMA_EXT_MIN_MEM_SIZE)
...
#if (JPEG_HW_ENC_PANORAMA_EXT_MAX_MEM_SIZE >= JPEG_SW_ENC_PANORAMA_EXT_MAX_MEM_SIZE)
...
#if (JPEG_HW_ENC_PANORAMA_YUV420_EXT_MIN_MEM_SIZE >= JPEG_SW_ENC_PANORAMA_EXT_MIN_MEM_SIZE)
...
#if (JPEG_HW_ENC_PANORAMA_YUV420_EXT_MAX_MEM_SIZE >= JPEG_SW_ENC_PANORAMA_EXT_MAX_MEM_SIZE)
