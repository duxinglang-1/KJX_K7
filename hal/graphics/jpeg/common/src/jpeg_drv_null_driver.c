...
/// this function is requested by system service for system crash analysis on MT6235
...
#endif /// #if !defined(__DRV_GRAPHICS_HW_JPEG_ENCODE_SUPPORTED__)
