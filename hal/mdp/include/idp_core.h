 ...
 * removed!
 * add mt6256_e2/idp_owner.h.
 *
 * 03 04 2011 chrono.wu
 * removed!
 * .
 *
 * 01 24 2011 chrono.wu
 * removed!
 * .
 *
 * 01 20 2011 hung-wen.hsieh
 * removed!
 * kal_get_current_thread_ID() prototype has changed from kal_taskid kal_get_current_thread_ID(void) to void * kal_get_current_thread_ID(void).
 *
 ...
 * removed!
 * removed!
 * ADD traced info for timeout
 *
 * removed!
 * removed!
 * MT6236 MDP image effect pixel scenario implement
 *
 * removed!
 * removed!
 * add IdpTracedAPI.
