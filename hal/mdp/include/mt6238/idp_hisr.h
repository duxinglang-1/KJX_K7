...
#ifndef __idp_hisr_mt6238_h__
#define __idp_hisr_mt6238_h__
...
extern idp_hisr_handle_t idp_hisr_register(kal_uint32 const key,
                                           idp_hisr_cb_type const type,
                                           idp_hisr_intr_cb_t const cb,
                                           idp_hisr_intr_cb_param_t const param);
extern void idp_hisr_activate(idp_hisr_handle_t const handle);
extern void idp_hisr_clear_all(kal_uint32 const key,
                               idp_hisr_cb_type const type);
