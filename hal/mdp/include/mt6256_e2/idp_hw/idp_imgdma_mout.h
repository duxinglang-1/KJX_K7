...
#ifndef __idp_imgdma_mout_mt6256_e2_h__
#define __idp_imgdma_mout_mt6256_e2_h__
...
#define IMGDMA_MOUT_SEL_MASK         0x000000F8
#define IMGDMA_MOUT_SEL_PRZ_BIT      0x00000008
#define IMGDMA_MOUT_SEL_JPEG_DMA_BIT 0x00000010
#define IMGDMA_MOUT_SEL_RGB_ROT0_BIT 0x00000020
#define IMGDMA_MOUT_SEL_VDO_ROT_BIT  0x00000040
//#define IMGDMA_MOUT_SEL_VRZ_BIT      0x00000080 // VRZ is not used
...
#define IMGDMA_MOUT_OUTPUT_TO_PRZ() \
    do { REG_IMGDMA_MOUT |= IMGDMA_MOUT_SEL_PRZ_BIT; } while(0)


#define IMGDMA_MOUT_OUTPUT_TO_JPEG_DMA() \
    do { REG_IMGDMA_MOUT |= IMGDMA_MOUT_SEL_JPEG_DMA_BIT; } while(0)
...
typedef struct
{
    ...
    kal_bool    output_jpeg_dma;
    kal_bool    output_vdo_rot;
    kal_bool    output_rgb_rot0;
    kal_bool    output_prz;
    //kal_bool    output_vrz; // VRZ is not used
} idp_imgdma_mout_struct;

kal_bool idp_imgdma_mout_start_real(
...
extern kal_bool idp_imgdma_mout_stop_real(
    idp_imgdma_mout_struct const * const p_mout_struct);
...
#endif // __idp_imgdma_mout_mt6256_e2_h__
