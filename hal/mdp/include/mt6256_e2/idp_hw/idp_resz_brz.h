...
#ifndef __idp_resz_brz_mt6256_e2_h__
#define __idp_resz_brz_mt6256_e2_h__
...
#define BRZ_CON_BLKCSSTOP_BIT 0x00000020
#define BRZ_CON_BLKCSENA_BIT 0x00000001

#define IS_BRZ_START() \
    (((REG_BRZ_CON & BRZ_CON_BLKCSENA_BIT) == 0x1) ? KAL_TRUE : KAL_FALSE)

#define BRZ_WARM_RESET() \
    do { REG_BRZ_CON |= BRZ_CON_BLKCSSTOP_BIT; \
         while(REG_BRZ_STA & 0xF0000); \
         REG_BRZ_CON &= ~BRZ_CON_BLKCSENA_BIT; \
         REG_BRZ_CON = 0; } while(0)

#define BRZ_HARD_RESET() \
...
#define BRZ_RESET() \
        do { REG_BRZ_CON |= BRZ_CON_BLKCSSTOP_BIT; \
             while(REG_BRZ_STA & 0xF0000); \
             REG_BRZ_CON &= ~BRZ_CON_BLKCSENA_BIT; \
             REG_BRZ_CON |= BRZ_CON_BLKCSRST_BIT; \
             REG_BRZ_CON = 0; } while(0)

#define BRZ_START() \
    do { REG_BRZ_CON = BRZ_CON_BLKCSENA_BIT; } while(0)

/* BRZ busy status register */
...
#endif // __idp_resz_brz_mt6256_e2_h__
