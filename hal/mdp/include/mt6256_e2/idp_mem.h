 ...
 * .
 *
 * 07 18 2011 chelun.tsai
 * removed!
 * .
 *
 * 07 15 2011 chelun.tsai
 * removed!
 * .
 *
 * 07 07 2011 chelun.tsai
 * removed!
 * .
 *
 * 07 04 2011 chelun.tsai
 * removed!
 * .
 *
...
#ifndef __idp_mem_mt6256_e2_h__
#define __idp_mem_mt6256_e2_h__
...
#define IDP_CAMERA_PREVIEW_MAX_DISPLAYED_WIDTH (864)
...
#define IDP_VIDEO_DECODE_MAX_DISPLAYED_WIDTH (864)
...
// display max size  
#define IDP_VIDEO_ENCODE_MAX_DISPLAYED_WIDTH               (864)

// video spec max size
// MDP will use 1-pass when size exceed this, and performance is not gurateed. 
#define IDP_VIDEO_ENCODE_MAX_VIDEO_SPEC_WIDTH              (864)

// video with rotation max size
#define IDP_VIDEO_ENCODE_MAX_VIDEO_ROTATION_WIDTH          (800)

// to disinguish video width is 640(& below) or 800, the intmem allocation for VDOROT
// & RGBROT are different
#define IDP_VIDEO_ENCODE_640_WIDTH                         (640)
 ...
 */
   ...
   #define IDP_MEM_CONSUME_MJPEG_DECODE_EXTMEM (4096 * 24 + 32)
   #define IDP_MEM_CONSUME_MJPEG_DECODE_YUV422V_EXTMEM (4096 * 32 + 32)
#endif
...
#define IDP_MEM_CONSUME_VIDEO_ENCODE_EXTMEM (864 * 480 * 3 / 2 + 32)
...
#endif // #ifndef __idp_mem_mt6256_e2_h__
