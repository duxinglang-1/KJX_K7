...
#ifndef __idp_imgdma_ovl_mt6276_h__
#define __idp_imgdma_ovl_mt6276_h__
...
#define IMGDMA_OVL_ULTRA_HIGH_EN_BIT      0x00000080
#define IMGDMA_OVL_PROTECT_EN_BIT         0x00000100
