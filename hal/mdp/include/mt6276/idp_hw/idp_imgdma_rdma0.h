...
#ifndef __idp_imgdma_rdma0_mt6276_h__
#define __idp_imgdma_rdma0_mt6276_h__
...
#elif defined(DRV_IDP_MT6256_SERIES)
...
#define IMGDMA_RDMA_WARM_RESET() \
  do { REG_IMGDMA_RDMA_RESET = 0x2; } while(0)
...
#define IMGDMA_RDMA_RGB565_ROUND_ENABLE() \
    do { REG_IMGDMA_RDMA_CON |= IMGDMA_RDMA_CON_RGB_ROUND_BIT; } while(0)

#define IMGDMA_RDMA_RGB565_ROUND_DISABLE() \
    do { REG_IMGDMA_RDMA_CON &= ~IMGDMA_RDMA_CON_RGB_ROUND_BIT; } while(0)

#define IMGDMA_RDMA_SET_INPUT_YUV444() \
    do { REG_IMGDMA_RDMA_CON = \
        ((REG_IMGDMA_RDMA_CON & (~0x0fff0007)) | 0x05550005); } while(0)

#define IMGDMA_RDMA_SET_INPUT_YUV422() \
    do { REG_IMGDMA_RDMA_CON = \
        ((REG_IMGDMA_RDMA_CON & (~0x0fff0007)) | 0x05690005); } while(0)

#define IMGDMA_RDMA_SET_INPUT_YUV420() \
    do { REG_IMGDMA_RDMA_CON = \
        ((REG_IMGDMA_RDMA_CON & (~0x0fff0007)) | 0x0a690005); } while(0)

#define IMGDMA_RDMA_SET_INPUT_YUV411() \
    do { REG_IMGDMA_RDMA_CON = \
        ((REG_IMGDMA_RDMA_CON & (~0x0fff0007)) | 0x057d0005); } while(0)

#define IMGDMA_RDMA_SET_INPUT_YUV400() \
    do { REG_IMGDMA_RDMA_CON = \
        ((REG_IMGDMA_RDMA_CON & (~0x0fff0007)) | 0x00410005); } while(0)
...
#define IMGDMA_RDMA_BYTE_SWAP_ENABLE() \
    do { REG_IMGDMA_RDMA_CON |= 0x0100; } while(0)
		  
#define IMGDMA_RDMA_BYTE_SWAP_DISABLE() \
    do { REG_IMGDMA_RDMA_CON &= ~0x0100; } while(0)
		
#define IMGDMA_RDMA_RGB_SWAP_ENABLE() \
    do { REG_IMGDMA_RDMA_CON |= 0x0200; } while(0)
...
#define IMGDMA_RDMA_SET_QUEUE_BASE_ADDR(n)   \
    do {REG_IMGDMA_RDMA_QUEUE_BASE= (n&0xFFFFFFFF); } while(0)

#define IMGDMA_RDMA_PUSH_QUEUE_DATA(n)   \
    do {while(0x0 == (REG_IMGDMA_RDMA_QUEUE_WSTA&0x1)) {} \
		REG_IMGDMA_RDMA_QUEUE_DATA= (n&0xFFFFFFFF); } while(0)
...
#define IMGDMA_RDMA_SET_DESCIPTOR_SEG(n)   \
    do {REG_IMGDMA_RDMA_CFG = \
        (REG_IMGDMA_RDMA_CFG | (n&0x07FF0000)); } while(0)
...
#endif // __idp_imgdma_rdma_mt6276_h__
