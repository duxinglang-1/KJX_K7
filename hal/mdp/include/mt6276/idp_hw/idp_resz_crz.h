...
#ifndef __idp_resz_crz_mt6276_h__
#define __idp_resz_crz_mt6276_h__
...
#define CRZ_CROPCNT_REG             (CRZ_BASE + 0xD0)
...
#define REG_CRZ_CROPCNT             *((volatile unsigned int *)(CRZ_CROPCNT_REG))
...
#define CRZ_STA_BUSYO               (0x0001)
/*Input interface busy*/
#define CRZ_STA_BUSYI               (0x0002)
/*Crop interface busy*/
#define CRZ_STA_BUSYC               (0x0004)
/* Input pixel number is not enough */
#define CRZ_STA_ERR0                 (0x0010)
/* Output too slow */
#define CRZ_STA_ERR1                 (0x0020)
#define CRZ_STA_ERR2                 (0x0040)
#define CRZ_STA_ERR3                 (0x0080)
...
typedef struct
{
    ...
    idp_module_enum_t         input_src; /**< IDP_MODULE_IMGDMA_RDMA0 or IDP_MODULE_OUTER_ISP */
...
#endif // __idp_resz_crz_mt6276_h__
