...
#ifndef __idp_resz_vrz_mt6276_h__
#define __idp_resz_vrz_mt6276_h__
...
#define VRZ_PRWMBASE_REG        (VRZ_BASE + 0x005C)
...
#define REG_VRZ_PRWMBASE     *((volatile unsigned int *)(VRZ_PRWMBASE_REG))   
...
#define REG_VRZ_PRWMBASE     (VRZ_PRWMBASE)   
...
#define VRZ_FRCFG_WMSZ_MASK     0x03ff0000
#define VRZ_FRCFG_PCSF_MASK     0x00030000
...
#define VRZ_SET_COARSE_RATIO(n) \
  do { REG_VRZ_FRCFG = ((REG_VRZ_FRCFG & (~VRZ_FRCFG_PCSF_MASK)) | (n << 8)); } while(0)
...
#endif // __idp_resz_vrz_mt6276_h__
