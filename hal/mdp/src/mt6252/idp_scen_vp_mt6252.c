    ...
    while (KAL_FALSE == finish)
    {
        ...
        switch (para_type)
        {
            ...
            case IDP_VIDEO_DECODE_VIDEO_Y_BUFFER_ADDRESS:
                crz_struct.src_buff_y_addr = va_arg(ap, kal_uint32) + idp_scen_vp_sm_y_offset;
                break;

            case IDP_VIDEO_DECODE_VIDEO_U_BUFFER_ADDRESS:
                crz_struct.src_buff_u_addr = va_arg(ap, kal_uint32) + idp_scen_vp_sm_uv_offset;
                break;

            case IDP_VIDEO_DECODE_VIDEO_V_BUFFER_ADDRESS:
                crz_struct.src_buff_v_addr = va_arg(ap, kal_uint32) + idp_scen_vp_sm_uv_offset;
                break;
