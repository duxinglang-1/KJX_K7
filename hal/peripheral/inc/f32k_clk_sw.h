...
#define HW_E1_IDLE_VAL_WITH_WINSET_LV1  (0x52)        //26M meter 32K with winset=0xffff

#define HW_E2_IDLE_VAL_WITH_WINSET_LV1  (0x633)		  //26M meter 32K with winset=1
#define HW_E2_IDLE_VAL_WITH_WINSET_LV2  (0x34B1)	  //26M meter 32K with winset=16
#elif defined(DRV_F32K_FQMTR_AS_6260)
#define IDLE_VAL_WITH_WINSET_LV1  (0x633)		      //26M meter 32K with winset=1
#define IDLE_VAL_WITH_WINSET_LV2  (0x34B1)	          //26M meter 32K with winset=16
#endif
