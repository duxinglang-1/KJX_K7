...
#if defined(MT6256) || defined(MT6276)|| defined(MT6255) || defined(MT6250)|| defined(MT6260)
...
//#if (defined(MT6256_S03) || defined(MT6575_S01)) && defined(__AST_TL1_TDD__)
//#define HIF_ECO_SOLUTION_SUPPORT
//#endif

//#if defined(MT6255)
//#define QUERY_HIF_SUPPORT_DMA
//#endif
/****************************************************************************
...
//#if defined (HIF_ECO_SOLUTION_SUPPORT)
#define SET_HIF_MCU_ACS_REQ(n)                  (*(volatile kal_uint32*)HIF_ACS_ARB_REG(n)) =1  //|= (1<<MCU_ACS_REQ_OFFSET)
#define SET_HIF_MCU_ACS_STA(n)                  (*(volatile kal_uint32*)HIF_ACS_ARB_REG(n)) =5  //|= (1<<MCU_ACS_STR_OFFSET)
...
#elif defined(MT6250)
//on MT6250,REG_MCU_CG_CLR2,clock gating
#define REG_HIF_POWER_CLR         *((volatile unsigned int *)(CONFIG_base + 0x0324))
#define REG_HIF_POWER_SET         *((volatile unsigned int *)(CONFIG_base + 0x0314))
#define HIF0_POWER_BIT    0x200
#define HIF1_POWER_BIT    0x400
#define NLIARB_POWER_BIT  0x800
//on MT6256,MT6255,MT6250,need not to enable NLI clock,it enable when enable HIF clock ,or enable LCD clock
#define NLI_ARB_POWER_ON        //REG_HIF_POWER_CLR = (NLIARB_POWER_BIT);																								
#define HIF_POWER_ON(n)         REG_HIF_POWER_CLR = (HIF0_POWER_BIT << (n));																								
#define HIF_POWER_OFF(n)        REG_HIF_POWER_SET = (HIF0_POWER_BIT << (n));
...
//HIF_RESULT hif_mcu_write_internal(HIF_HANDLE handle, HIF_TYPE type, kal_uint32 addr, kal_uint32 size);
HIF_RESULT hif_dma_write_internal(HIF_HANDLE handle, HIF_TYPE type, kal_uint32 addr, kal_uint32 size, HIF_CALLBACK fCB);
//HIF_RESULT hif_mcu_read_internal(HIF_HANDLE handle, HIF_TYPE type, kal_uint32 addr, kal_uint32 size);
