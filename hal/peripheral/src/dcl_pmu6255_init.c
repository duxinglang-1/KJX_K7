...
void dcl_pmu6255_internal_init(void)
{
	...
	//0x0818[1:1] = 0x0
		PMU_DRV_SetData16(0x801B0818,0x2,0x0);
	//VBT_CON0
	//disable  BT function
	//0x0870[0:0] = 0x0
		PMU_DRV_SetData16(0x801B0870,0x1,0x0);
	//VIBR_CON0
	//Maxwell's request (2.8V)
	//0x08B0[6:4] = 0x4
		PMU_DRV_SetData16(0x801B08B0,0x70,0x40);
	//VIBR_CON1
	//Fandy's request
	//0x08B4[12:12] = 0x1
		PMU_DRV_SetData16(0x801B08B4,0x1000,0x1000);
	//VMC_CON0
	//disable MSDC function
	//0x08C0[0:0] = 0x0
		PMU_DRV_SetData16(0x801B08C0,0x1,0x0);
	//VCORE_CON0
	//smaller SS+LV corner margin
	//0x0900[8:4] = 0x2
		PMU_DRV_SetData16(0x801B0900,0x1F0,0x20);
	//VCORE_CON1
	//sleep mode vcore voltage 1V
	//0x0904[8:4] = 0x18
	...
	//smaller SS+LV corner margin
	//0x0914[3:0] = 0x3
		PMU_DRV_SetData16(0x801B0914,0xF,0x3);
	//CHR_CON0
