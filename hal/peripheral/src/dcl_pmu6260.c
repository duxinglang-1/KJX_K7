...
#if defined(__KJX_FUN__)
void custom_isink_control(kal_bool open,PMU_ISINK_LIST_ENUM ISINK_X)
{
	...
	if (open ==KAL_TRUE)  //¿ª 
	{
		...
		isink_step.isink = ISINK_X;
		pmu_set_isink((PMU_ISINK_LIST_ENUM)isink_step.isink,ISINK_EN,(DCL_UINT32)isink_en.enable);
