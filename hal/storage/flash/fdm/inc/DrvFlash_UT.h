...
#if defined(__MTK_INTERNAL__) && (!defined(__NOR_FLASH_HARDWARE_TEST__) && !defined(__MAUI_BASIC__))
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
#include "Drvflash.h"
extern kal_uint32 (*LocateSector_ext)(NOR_FTL_DATA *, kal_uint32); //nor_test.c
#else
