...
#define RAM_SIZE	SIZE_3MB
#elif defined(__SMART_PHONE_MODEM__)
#define RAM_SIZE	SIZE_512KB
#endif

#if defined(__SMART_PHONE_PLATFORM__) || defined(__SMART_PHONE_MODEM__)
#pragma arm section rwdata = "STATICRW" , rodata = "STATICCONST" , zidata = "STATICZI"
kal_uint8 ram_disk[RAM_SIZE];
#pragma arm section
#endif
...
{
   //ASSERT(0);
   EraseBlock_RAM(DriveData, BlockIndex);
   return FS_NO_ERROR;
}
