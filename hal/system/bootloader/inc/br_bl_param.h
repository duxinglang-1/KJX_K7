...
typedef struct BL_Param_v4 {
    ...
    // shared flash driver index
    U32                         m_sd_flash_drv_idx;

    // shared flash driver table
    U32                         m_sd_flash_drv_tbl_addr;

} BL_Param_v4;

#if defined(__BOOTROM__)
extern BL_Param_v4  g_BROM_BL_Param;
#endif
