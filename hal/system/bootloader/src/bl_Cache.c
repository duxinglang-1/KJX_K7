...
extern void CustomizedCacheInit(kal_uint32 rom_start_addr, kal_uint32 rom_end_addr,  kal_uint32 rom_len);
extern void CustomizedCacheDeInit(void);
extern void CodeCacheClearAllSetting(void);
extern void MPUClearAllSetting(void);
...
#if defined(__CRYPTO_SHARED_DRV__) && !defined(__COPY_BROM_BL_PARAM_TO_EXTERNAL_RAM__)
...
#pragma arm section zidata = "BL_PAGETABLE"
