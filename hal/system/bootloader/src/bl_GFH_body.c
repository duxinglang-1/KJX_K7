...
#define BL_DEVICE_TYPE           F_SPI_NAND_SEQUENTIAL
#define EXT_BL_DEVICE_TYPE       F_SPI_NAND_SEQUENTIAL
...
#pragma arm section rodata = "BOOTLOADER_GFH"

const BOOTLOADER_GFH g_bootloader_gfh = 
{
      //GFH_FILE_INFO_v1
      {  
...
# if defined(MT6250)
	    BL_ATTR_LOAD_BY_BOOTROM | BL_ATTR_INTERNAL_RAM, 
#else       
...
#pragma arm section rodata = "BL_SIGNATURE_SECTION"
const kal_uint32 g_bootloader_sig[SIGNATURE_LEN>>2] = {SIG_HASH_VER};
#pragma arm section rodata
...
#pragma arm section rodata = "EXT_BOOTLOADER_GFH"

const EXT_BOOTLOADER_GFH g_ext_bootloader_gfh = 
{
      //FILE_INFO
      {  
         GFH_HEADER(GFH_FILE_INFO, 1),
...
#pragma arm section rodata = "EXT_BL_SIGNATURE_SECTION"
const kal_uint32 g_ext_bootloader_sig[SIGNATURE_LEN>>2] = {SIG_HASH_VER};
#pragma arm section rodata
