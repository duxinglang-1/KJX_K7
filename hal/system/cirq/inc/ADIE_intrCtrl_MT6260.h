...
#define ADIE_EINT_STATUS0           ((volatile UINT16P)(ADIE_CIRQ_base+0x0300)) /*  external interrupt control */
#define ADIE_EINT_STATUS1           ((volatile UINT16P)(ADIE_CIRQ_base+0x0304)) /*  external interrupt control */
#define ADIE_EINT_INTACK0           ((volatile UINT16P)(ADIE_CIRQ_base+0x0308))
#define ADIE_EINT_INTACK1           ((volatile UINT16P)(ADIE_CIRQ_base+0x030C))

#define ADIE_EINT_EEVT              ((volatile UINT16P)(ADIE_CIRQ_base+0x0310))

#define ADIE_EINT_MASK0             ((volatile UINT16P)(ADIE_CIRQ_base+0x0318)) /*  external interrupt control */
#define ADIE_EINT_MASK1             ((volatile UINT16P)(ADIE_CIRQ_base+0x031C)) /*  external interrupt control */
#define ADIE_EINT_MASK_SET0         ((volatile UINT16P)(ADIE_CIRQ_base+0x0320)) /*  external interrupt control */
#define ADIE_EINT_MASK_SET1         ((volatile UINT16P)(ADIE_CIRQ_base+0x0324)) /*  external interrupt control */
#define ADIE_EINT_MASK_CLR0         ((volatile UINT16P)(ADIE_CIRQ_base+0x0328)) /*  external interrupt control */
#define ADIE_EINT_MASK_CLR1         ((volatile UINT16P)(ADIE_CIRQ_base+0x032C)) /*  external interrupt control */

#define ADIE_EINT_SENS0             ((volatile UINT16P)(ADIE_CIRQ_base+0x0330)) /*  external interrupt control */ 
#define ADIE_EINT_SENS1             ((volatile UINT16P)(ADIE_CIRQ_base+0x0334)) /*  external interrupt control */ 
#define ADIE_EINT_SENS_SET0         ((volatile UINT16P)(ADIE_CIRQ_base+0x0338)) /*  external interrupt control */ 
#define ADIE_EINT_SENS_SET1         ((volatile UINT16P)(ADIE_CIRQ_base+0x033C)) /*  external interrupt control */ 
#define ADIE_EINT_SENS_CLR0         ((volatile UINT16P)(ADIE_CIRQ_base+0x0340)) /*  external interrupt control */ 
#define ADIE_EINT_SENS_CLR1         ((volatile UINT16P)(ADIE_CIRQ_base+0x0344)) /*  external interrupt control */ 

#define ADIE_EINT_SOFT0             ((volatile UINT16P)(ADIE_CIRQ_base+0x0348)) /*  external interrupt control */   
#define ADIE_EINT_SOFT1             ((volatile UINT16P)(ADIE_CIRQ_base+0x034C)) /*  external interrupt control */  
#define ADIE_EINT_SOFT_SET0         ((volatile UINT16P)(ADIE_CIRQ_base+0x0350)) /*  external interrupt control */   
#define ADIE_EINT_SOFT_SET1         ((volatile UINT16P)(ADIE_CIRQ_base+0x0354)) /*  external interrupt control */  
#define ADIE_EINT_SOFT_CLR0         ((volatile UINT16P)(ADIE_CIRQ_base+0x0358)) /*  external interrupt control */   
#define ADIE_EINT_SOFT_CLR1         ((volatile UINT16P)(ADIE_CIRQ_base+0x035C)) /*  external interrupt control */  

#define ADIE_EINT_D0EN0             ((volatile UINT16P)(ADIE_CIRQ_base+0x0360)) /*  external interrupt control */
#define ADIE_EINT_D0EN1             ((volatile UINT16P)(ADIE_CIRQ_base+0x0364)) /*  external interrupt control */
...
#define ADIE_EINT14_CON             ((volatile UINT16P)(ADIE_CIRQ_base+0x03B8)) /*  external interrupt control */
#define ADIE_EINT15_CON             ((volatile UINT16P)(ADIE_CIRQ_base+0x03BC)) /*  external interrupt control */
#define ADIE_EINT16_CON             ((volatile UINT16P)(ADIE_CIRQ_base+0x03C0)) /*  external interrupt control */
#define ADIE_EINT_CON(i)            ((volatile UINT16P)(ADIE_EINT0_CON+0x4*i))  /*  external interrupt control */

#define ADIE_EINT_DBCRST0           ((volatile UINT16P)(ADIE_CIRQ_base+0x0400)) /*  external interrupt control */         
#define ADIE_EINT_DBCRST1           ((volatile UINT16P)(ADIE_CIRQ_base+0x0404)) /*  external interrupt control */     

#define ADIE_EINT_WAKE_MASK0        ((volatile UINT16P)(ADIE_CIRQ_base+0x0418)) /*  external interrupt control */         
#define ADIE_EINT_WAKE_MASK1        ((volatile UINT16P)(ADIE_CIRQ_base+0x041C)) /*  external interrupt control */  
#define ADIE_EINT_WAKE_MASK_SET0    ((volatile UINT16P)(ADIE_CIRQ_base+0x0420)) /*  external interrupt control */         
#define ADIE_EINT_WAKE_MASK_SET1    ((volatile UINT16P)(ADIE_CIRQ_base+0x0424)) /*  external interrupt control */  
#define ADIE_EINT_WAKE_MASK_CLR0    ((volatile UINT16P)(ADIE_CIRQ_base+0x0428)) /*  external interrupt control */         
#define ADIE_EINT_WAKE_MASK_CLR1    ((volatile UINT16P)(ADIE_CIRQ_base+0x042C)) /*  external interrupt control */

//#define ADIE_EINTaddr(_no)          (*(volatile kal_uint32 *)(EINT0_CON+_no))
...
#define ADIE_EINT_RTC_INDEX          (7)    /* RTC */
#define ADIE_EINT_TP_INDEX           (8)   /* TP */
#define ADIE_EINT_ACCDET_INDEX       (9)   /* ACCDET */
...
#define  ADIE_EINT_MAX_CHANNEL          17
#define  ADIE_EINT_TOTAL_CHANNEL        17
#define  ADIE_EINT_HARDWARE_DEBOUNCE    0x1FFFF
#define  ADIE_EINT_TOTAL_MASK           0x1FFFF
