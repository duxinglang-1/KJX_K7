...
#define EINT_STATUS            ((volatile UINT32P)(CIRQ_base+0x0300)) /*  external interrupt control */   
#define EINT_INTACK            ((volatile UINT32P)(CIRQ_base+0x0308))
#define EINT_EEVT              ((volatile UINT32P)(CIRQ_base+0x0310))
#define EINT_MASK              ((volatile UINT32P)(CIRQ_base+0x0318)) /*  external interrupt control */
#define EINT_MASK_SET          ((volatile UINT32P)(CIRQ_base+0x0320)) /*  external interrupt control */
#define EINT_MASK_CLR          ((volatile UINT32P)(CIRQ_base+0x0328)) /*  external interrupt control */

#define EINT_SENS              ((volatile UINT32P)(CIRQ_base+0x0330)) /*  external interrupt control */ 
#define EINT_SENS_SET          ((volatile UINT32P)(CIRQ_base+0x0338)) /*  external interrupt control */ 
#define EINT_SENS_CLR          ((volatile UINT32P)(CIRQ_base+0x0340)) /*  external interrupt control */ 

#define EINT_SOFT              ((volatile UINT32P)(CIRQ_base+0x0348)) /*  external interrupt control */   
#define EINT_SOFT_SET          ((volatile UINT32P)(CIRQ_base+0x0350)) /*  external interrupt control */   
#define EINT_SOFT_CLR          ((volatile UINT32P)(CIRQ_base+0x0358)) /*  external interrupt control */   

#define EINT_D0EN              ((volatile UINT32P)(CIRQ_base+0x0360)) /*  external interrupt control */
...
#define IRQ_GPI_CODE                (3)
#define IRQ_GPII_CODE               (4)
#define IRQ_HIF_CODE                (5)
#define IRQ_SW_LISR1_CODE           (6)
#define IRQ_SW_LISR2_CODE        	(7)
#define IRQ_MD_SLEEP_CODE           (8)
#define IRQ_RESERVED_9_CODE        	(9)  //IRQ_HIF_1_CODE
#define IRQ_DIE2DIE_CODE        	(10)
...
#define IRQ_RESERVED_24_CODE        (24)  //IRQ_UART3_CODE
...
#define IRQ_RESERVED_39_CODE        (39)  //IRQ_LZMA_CODE
#define IRQ_NFI_CODE                (40)  //IRQ_RESERVED_40_CODE
#define IRQ_RESERVED_41_CODE        (41)
#define IRQ_FM_CODE                 (42)  //IRQ_RESERVED_42_CODE
#define IRQ_MSDC2_CODE              (43)  //IRQ_RESERVED_43_CODE
#define IRQ_MSDC2_CD_CODE           (44)  //IRQ_RESERVED_44_CODE
#define IRQ_RESERVED_45_CODE        (45)
#define IRQ_RESERVED_46_CODE        (46)
...
#define IRQ3_CODE           IRQ_GPI_CODE
#define IRQ4_CODE           IRQ_GPII_CODE
#define IRQ5_CODE           IRQ_HIF_CODE
...
#define IRQ1D_CODE          IRQ_RESERVED_24_CODE  //IRQ_UART3_CODE
...
#define IRQ2D_CODE          IRQ_NFI_CODE  //IRQ_RESERVED_40_CODE
...
#define IRQ32_CODE          IRQ_RESERVED_45_CODE
#define IRQ33_CODE          IRQ_RESERVED_46_CODE
 ...
 * EINT Configuration
 *************************************************************************/
#define  EINT_MAX_CHANNEL          (20)
#define  EINT_TOTAL_CHANNEL        (20)
#define  EINT_HARDWARE_DEBOUNCE    (0x000FFFFF)
