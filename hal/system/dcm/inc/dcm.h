...
/* *MCUCLK_CON initial value should be set as 0x0007 */
#define DCM_ENABLE_CHECK ((DRV_Reg32(DMA_GLBSTA) & 0x00000141)==0) && \
	                     (DRV_Reg16(PDN_CON1) & 0x80000000)  &&       \
	                     (DRV_Reg16(PDN_CON2) & 0x0002)  &&           \
...
#define DCM_ENABLE_CHECK ((DRV_Reg32(DMA_GLBSTA) & 0x00155555)==0) &&  \
                         ((DRV_Reg16(PDN_CON0) & 0x0048) == 0x0048) && \
	                     (DRV_Reg16(PDN_CON1) & 0x0080) &&             \
                         ((DRV_Reg16(PDN_CON3) & 0x1805) == 0x1805) && \
...
#define DCM_ENABLE_CHECK ((DRV_Reg32(DMA_GLBSTA) & 0x00055555)==0) &&    \
                         ((DRV_Reg16(PDN_CON0) & 0x0078) == 0x0078) &&   \
                         (DRV_Reg16(PDN_CON1) & 0x0080) &&               \
                         (DRV_Reg16(PDN_CON3) == 0xFFFF) &&              \
...
#define DCM_ENABLE_CHECK ((DRV_Reg32(DMA_GLBSTA) & 0x00055555)==0) &&  \
                         ((DRV_Reg16(PDN_CON0) & 0x0878) == 0x0878) && \
                         ((DRV_Reg16(PDN_CON1) & 0x2080) == 0x2080) && \
                         (DRV_Reg16(PDN_CON3) == 0xFFFF) &&            \
                         (DRV_Reg16(MCUCLK_CON) == 0x7F37)  
#elif defined(MT6228)
/* Check power down: Check DMA1~10, IRDMA, PPP, CHE, WAVETABLE, LCD, and GMC*/
#define DCM_ENABLE_CHECK ((DRV_Reg32(DMA_GLBSTA) & 0x00055555)==0) &&  \
                         ((DRV_Reg16(PDN_CON0) & 0x0038) == 0x0038) &&  \
                         (DRV_Reg16(PDN_CON1) & 0x0080) &&              \
                         (DRV_Reg16(PDN_CON3) == 0xFFFF) &&             \
                         (DRV_Reg16(MCUCLK_CON) == 0x0703)
...
#define DCM_ENABLE_CHECK ((DRV_Reg32(DMA_GLBSTA) & 0x00055555)==0) &&  \
                         (DRV_Reg16(PDN_CON0) & 0x0008) &&              \
                         (DRV_Reg16(PDN_CON1) & 0x0080) &&              \
                         ((DRV_Reg16(PDN_CON3) & 0x7F91) == 0x7F91)&&   \
...
#define DCM_ENABLE_CHECK ((DRV_Reg32(DMA_GLBSTA) & 0x00015555)==0) &&  \
                         ((DRV_Reg16(PDN_CON0) & 0x0008) == 0x0008) && \
	                     (DRV_Reg16(PDN_CON1) & 0x0080) &&             \
                         (DRV_Reg16(PDN_CON3) == 0xF807) &&            \
                         ((DRV_Reg16(MCUCLK_CON )& 0xFF7F) ==0x3703)
#elif defined(MT6573)
#define __HW_DCM__
...
#elif defined(MT6255)
/* Check power down: DMA1~10, LCD, NFI, MM sys, MD2G sys */
#define __DCM_AUTO_MODE__   /* if defined, MT6255 goes through SW_DCM flow to decide HW/SW DCM mode at runtime. */
#if !defined __DCM_AUTO_MODE__
#define __HW_DCM__          // force HWDCM mode, if not AUTOmatically decide DCM HW/SW mode.
