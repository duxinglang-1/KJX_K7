...
#if defined(MT6208) || defined(MT6205B) || defined(MT6219) \
    || defined(MT6227) || defined(MT6226) || defined(MT6226M) || defined(MT6226D) \
    || defined(MT6228) || defined(MT6229) || defined(MT6230) || defined(MT6225) \
    || defined(MT6223) || defined(MT6223P) || defined(MT6227D) \
    || defined(MT6238) || defined(MT6239) || defined(MT6235) || defined(MT6235B) \
    || defined(MT6268T) || defined(MT6268A) || defined(MT6268) \
    || defined(TK6516) || defined(MT6516)

#define __OLD_PDN_ARCH__
#include "drvpdn_oldpdnarch.h"
