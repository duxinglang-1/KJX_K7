...
#ifndef __REG_BASE_MT6225_H__
#define __REG_BASE_MT6225_H__
...
#define IRDBG_base               (0x80320000)
#define AFE_base                 (0x80400000)
#define BFE_base                 (0x80410000)
#define DIGRF_base               (0x80430000)
...
#define IRDBG_SD_base               (0x80320000)
#define AFE_SD_base                 (0x80400000)
#define BFE_SD_base                 (0x80410000)
#define DIGRF_SD_base               (0x80430000)
