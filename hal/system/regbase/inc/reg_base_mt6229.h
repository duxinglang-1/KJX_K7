...
#ifndef __REG_BASE_MT6229_H__
#define __REG_BASE_MT6229_H__
...
#define PRZ_base                 (0x80610000)
#define CAMERA_base              (0x80620000)
#define IMGPROC_base             (0x80630000)
#define PNGDEC_base              (0x80640000)
#define GIFDEC_base              (0x80650000)
#define GCMQ_base                (0x80660000)
#define G2D_base                 (0x80670000)
#define MP4_base                 (0x80680000)
#define IMGDMA_base              (0x80690000)
#define CRZ_base                 (0x806a0000)
#define DRZ_base                 (0x806b0000)
#define TVENC_base               (0x806c0000)
#define TVCON_base               (0x806d0000)
#define GMC_base                 (0x806e0000)
...
#define PRZ_SD_base                 (0x80610000)
#define CAMERA_SD_base              (0x80620000)
#define IMGPROC_SD_base             (0x80630000)
#define PNGDEC_SD_base              (0x80640000)
#define GIFDEC_SD_base              (0x80650000)
#define GCMQ_SD_base                (0x80660000)
#define G2D_SD_base                 (0x80670000)
#define MP4_SD_base                 (0x80680000)
#define IMGDMA_SD_base              (0x80690000)
#define CRZ_SD_base                 (0x806a0000)
#define DRZ_SD_base                 (0x806b0000)
#define TVENC_SD_base               (0x806c0000)
#define TVCON_SD_base               (0x806d0000)
#define GMC_SD_base                 (0x806e0000)
#define L1C_SD_base                 (0x80700000)
#define LCD_SD_base                 (0x90000000)



#endif  /* __REG_BASE_MT6229_H__ */
