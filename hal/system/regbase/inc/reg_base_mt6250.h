...
#ifndef __REG_BASE_MT6250_H__
#define __REG_BASE_MT6250_H__
...
#define UART3_base                  (0xA00A0000) /*UART 3                                                             */
...
#define AUXADC_base                 (0xA0150000) /*Auxiliary ADC Unit                                                 */
#define ABB_D_base                  (0xA0160000) /*Analog baseband (ABB) controller                                   */ 
...
#define HIF0_base                   (0xA0190000) /*HIF0                                                               */
#define HIF1_base                   (0xA01A0000) /*HIF1                                                               */
#define NLI_ARB_base                (0xA01B0000) /*NLI_arbiter                                                        */
...
#define LZMA_base                   (0xA0230000) /*lzma                                                               */
//MMSYS
...
#define FSPI_MAS_base               (0xA0770000) /*FMSYS FSPI_MAS                                                   */  
#define FM_RBIST_base               (0xA0780000) /*FMSYS RBist                                                      */  
//APSYS Bridge
#define USB_base                    (0xA0900000) /*USB */
#define DMA_AHB_base                (0xA0920000) /*DMA */  
//Multimedia System
#define JPEG_base                   (0xA1000000) /*Hybrid JPEG */
//BT System
...
#define UART3_SD_base                  (0xA00A0000) /*UART 3                                                             */
...
#define AUXADC_SD_base                 (0xA0150000) /*Auxiliary ADC Unit                                                 */
#define ABB_D_SD_base                  (0xA0160000) /*Analog baseband (ABB) controller                                   */ 
...
#define HIF0_SD_base                   (0xA0190000) /*HIF0                                                               */
#define HIF1_SD_base                   (0xA01A0000) /*HIF1                                                               */
#define NLI_ARB_SD_base                (0xA01B0000) /*NLI_arbiter                                                        */
...
#define LZMA_SD_base                   (0xA0230000) /*lzma                                                               */
//MMSYS
...
#define FSPI_MAS_SD_base               (0xA0770000) /*FMSYS FSPI_MAS                                                   */  
#define FM_RBIST_SD_base               (0xA0780000) /*FMSYS RBist                                                      */  
//APSYS Bridge
#define USB_SD_base                    (0xA0900000) /*USB */
#define DMA_AHB_SD_base                (0xA0920000) /*DMA */  
//Multimedia System
#define JPEG_SD_base                   (0xA1000000) /*Hybrid JPEG */
//BT System
...
#define DPRAM_CPU_SD_base              (0x82200000) /*MD2GSYS */
