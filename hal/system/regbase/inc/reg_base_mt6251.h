...
#ifndef __REG_BASE_MT6251_H__
#define __REG_BASE_MT6251_H__
...
#define SFI_base                 (0x81140000)
#define TDMA_base                (0x81150000)
#define AUXADC_base              (0x81160000)
#define SHAREG1_base             (0x81170000)
#define SHAREG2_base             (0x81180000)
#define ACCDET_base              (0x81190000)
#define MCUCONFG_base       		 (0x811A0000)
...
#define FMSYS_base               (0x82110000)

#define PLL_base           			 (0x83000000)
#define MIXED_base               (0x83010000)

#define MMCONFG_base              (0x84000000)
...
#define SFI_SD_base                 (0x81140000)
#define TDMA_SD_base                (0x81150000)
#define AUXADC_SD_base              (0x81160000)
#define SHAREG1_SD_base             (0x81170000)
#define SHAREG2_SD_base             (0x81180000)
#define ACCDET_SD_base              (0x81190000)
#define MCUCONFG_SD_base       		 (0x811A0000)
...
#define SHARE1_SD_base               (0x820a0000)
...
#define FMSYS_SD_base               (0x82110000)

#define PLL_SD_base           			 (0x83000000)
#define MIXED_SD_base               (0x83010000)

#define MMCONFG_SD_base              (0x84000000)
//#define PRZ_SD_base                 (0x84010000) /*spec : RESZ_base*/
//#define CAMERA_SD_base              (0x84020000) /*spec: CAM_base*/
