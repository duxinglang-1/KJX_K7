...
#ifndef __REG_BASE_MT6268T_H__
#define __REG_BASE_MT6268T_H__
...
#define FPGA_DMA_base            (0xC0030000)
#define FPGA_UART1_base          (0xC0050000)
#define FPGA_UART2_base          (0xc0060000)
#define RTR_base                 (0xB0000000)
#define TXBRP_base               (0xB0010000)
#define TXCRP_base               (0xB0020000)
#define SRCHR_base               (0xB0030000)
#define RXBFE_base               (0xC0040000)
#define RXBRP_base               (0xB00A0000)
#define BITCP_base               (0xB00B0000)
#define F8F9_base                (0xB00C0000)
#define RXSRP_base               (0xC0000000)
#define RAKE_base                (0xC0010000)
#define LOG3G_base               (0xB00E0000)
#define LOG3G_USB1_base          (0xC0080000)
#define FPGA_BSI_base            (0xB0070000)
...
#define FPGA_DMA_SD_base            (0xC0030000)
#define FPGA_UART1_SD_base          (0xC0050000)
#define FPGA_UART2_SD_base          (0xc0060000)
...
#define RXBFE_SD_base               (0xC0040000)
#define RXBRP_SD_base               (0xB00A0000)
...
#define LOG3G_SD_base               (0xB00E0000)
#define LOG3G_USB1_SD_base          (0xC0080000)
#define FPGA_BSI_SD_base            (0xB0070000)
#define LPBK_SD_base                (0xB00F0000)

#endif  /* __REG_BASE_MT6268T_H__ */
