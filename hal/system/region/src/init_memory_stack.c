...
#if defined(SUPPORT_DSP_TXRX_BUFF)
#if defined(MT6251)
extern kal_uint32 Image$$INTSRAM_DSP_TX_RX$$Base;
extern kal_uint32 Image$$INTSRAM_DSP_TX_RX$$Length;
extern kal_uint32 Image$$INTSRAM_DSP_TX_RX$$ZI$$Length;
#else
...
{
    kal_uint32 RemappedFlashBase;
#if defined(TK6516) || defined(MT6516)

#if !defined(_NAND_FLASH_BOOTING_) && !defined(__EMMC_BOOTING__)

#if defined(TK6516) || defined(MT6516)
    RemappedFlashBase = ( ((kal_uint32)(&Image$$ROM$$Base) & 0xf0000000));
#else /* TK6516 || MT6516 */     
    RemappedFlashBase = ( ((kal_uint32)(&Image$$ROM$$Base) & 0xf8000000) | 0x04000000 );
#endif /* TK6516 || MT6516 */     
...
#if defined(MT6268A) || defined(MT6268) || defined(MT6276) || defined(MT6573) || defined(MT6575)

    RemappedFlashBase = (kal_uint32)(&Image$$ROM$$Base) & 0xf0000000;

#endif /* MT6268A || MT6268 || MT6276 || MT6573 || MT6575 */

#if defined(MT6268T) || defined(MT6268H)

    RemappedFlashBase = ( (kal_uint32)&Image$$ROM$$Base | 0x0C000000 ); 

#endif  /* MT6268T || MT6268H */

#if defined(MT6253T) || defined(MT6253) || defined(MT6253E) || defined(MT6253L) || defined(MT6252) || defined(MT6252H) || defined(MT6250) || defined(MT6260)

    RemappedFlashBase = ( ((kal_uint32)(&Image$$ROM$$Base) & 0xf8000000));

#endif  /* MT6253T || MT6253 || MT6253E || MT6253L || MT6252 || MT6252H || MT6250 || MT6260*/

#if defined(TK6516) || defined(MT6516)
    RemappedFlashBase = (kal_uint32)((kal_uint32)(&Image$$ROM$$Base) & 0xf0000000) ;
#else /* TK6516 || MT6516 */     

    RemappedFlashBase = (kal_uint32)((kal_uint32)(&Image$$ROM$$Base) & 0xf8000000) ;
#endif /* TK6516 || MT6516 */        
...
#endif /* MT6236 || MT6236B || MT6256 */

#if defined(MT6276) || defined(MT6573) || defined(MT6575)

    RemappedFlashBase = (kal_uint32)(&Image$$ROM$$Base) & 0xf0000000;

#endif /* MT6276 || MT6573 || MT6575 */
    return RemappedFlashBase;
}
                                     ...
                                     kal_uint32 *TX_Size, kal_uint32 *RX_Size)
{
...
#elif defined(_NAND_FLASH_BOOTING_) || defined(__NOR_FLASH_BOOTING__) || defined(__EMMC_BOOTING__) /* IC_BURNIN_TEST */
   ...
   *RX_Size = region_sz;
/*Get bit27~29 to fill the 3-bit BANK_SEL field that indicates which bank is used for MPU in region1
NOTE: the "bank" mentioned here is different from ours*/
#if defined(MT6235) || defined(MT6235B) || defined(MT6268A) || defined(MT6268) || defined(MT6236) || defined(MT6236B) || defined(MT6276) || defined(MT6573) || defined(MT6575)
   chipSelect = (*TX_Base&0xF0000000) >> 27;
#else
   chipSelect = (*TX_Base&0xF8000000) >> 27;
#endif	// #if defined(MT6238)
   
#if defined(MT6235) || defined(MT6235B) || defined(MT6268A) || defined(MT6268) || defined(MT6236) || defined(MT6236B) || defined(MT6256) || defined(MT6255) || defined(MT6260) || defined(MT6276) || defined(MT6573) || defined(MT6575)
   ASSERT(chipSelect<=2);
#else
   ASSERT(chipSelect<2);
#endif
...
#if defined(MT6251) /* DSP TX/RX buffer is in internal RAM */
   chipSelect = 0;
#elif defined(MT6235) || defined(MT6235B) || defined(MT6268A) || defined(MT6516) || defined(MT6268) || defined(MT6236) || defined(MT6236B) || defined(MT6276) || defined(MT6573) || defined(MT6575)
   chipSelect = (*TX_Base&0xF0000000) >> 27;
#else   
   chipSelect = (*TX_Base&0xF8000000) >> 27;
#endif	/* MT6251 */
   
#if defined(MT6235) || defined(MT6235B) || defined(MT6268A) || defined(MT6516) || defined(MT6268) || defined(MT6236) || defined(MT6236B) || defined(MT6256) || defined(MT6255) || defined(MT6276) || defined(MT6573) || defined(MT6575)
   ASSERT(chipSelect<=2);
#else
   ASSERT(chipSelect<2);
#endif
...
#error SYSRAM length should be determined for new chipset
