...
typedef struct
{
    ...
    STFSAL* pt_fsal_stsz[SOURCE_PROVIDER_PORT_MAX-1]; /* FSAL handle pointer to read STSZ */
    STFSAL* pt_fsal_stco[SOURCE_PROVIDER_PORT_MAX-1]; /* FSAL handle pointer to read STCO */
    ...
    kal_uint32* p_fsal_buf_stsz[SOURCE_PROVIDER_PORT_MAX-1]; /* FSAL working buffer pointer to read STSZ */
    kal_uint32* p_fsal_buf_stco[SOURCE_PROVIDER_PORT_MAX-1]; /* FSAL working buffer pointer to read STCO */
