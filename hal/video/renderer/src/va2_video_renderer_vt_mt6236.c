 ...
 * Filename:
 * ---------
 *    va2_video_renderer_vt_mt6236.c
 *
 * Project:
 * --------
 *    MAUI
 ...
 *    video telephony playback on MT6236 platform.
 *
 * Author:
 * -------
 * -------
 ...
 *
 ****************************************************************************/
/// \ingroup va2_video_renderer_vt_mt6236
/// @{
 ...
 ****************************************************************************/
//#define VA2_VR_VT_6236_MAX_BH_COUNT             (16)
// TODO: check this size and color format
//#define VA2_VR_VT_6236_DISPLAY_BUFFER_SIZE      (320*240*2) // QVGA RGB565 or UYVY422 color format
#define VA2_VR_VT_6236_RENDER_TIME_MAX          (1100) // (32768/1000)*33.3 ~ 1091

#define VA2_VR_VT_6236_DEBUG_TRACE_SIZE         (64)
#define IDP_VIDEO_TELEPHONY_2PASS_ARCHI
...
_va2_vr_vt_6236_init(void);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_send_command(
  VIDEO_COMMAND_TYPE_T eCmd, 
  kal_uint32 u4Param);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_get_parameter(
  VIDEO_PARAM_TYPE_T eCmd, 
  void *pParam);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_set_parameter(
  VIDEO_PARAM_TYPE_T eCmd, 
  void *pParam);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_use_buffer(
  kal_uint8 *pu1Buff, 
  kal_uint32 u4Size);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_empty_this_buffer(
  VIDEO_BUFFERHEADER_TYPE_T *prBuffHeader);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_empty_this_buffer_real(
  VIDEO_BUFFERHEADER_TYPE_T *prBuffHeader);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_fill_this_buffer(
  VIDEO_BUFFERHEADER_TYPE_T *prBuffHeader);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_set_callbacks(
  VIDEO_CALLBACK_TYPE_T *prCallback);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_deinit(void);

static kal_uint32 
_va2_vr_vt_6236_render_display_frame_buffer(
  va2_comp_video_renderer_cb_t *cb, 
  kal_bool blocking);

static kal_bool 
_va2_vr_vt_6236_check_params_configs(
  va2_comp_video_renderer_cb_t *cb);

static kal_bool 
_va2_vr_vt_6236_config_idp_by_render_mode(
  va2_comp_video_renderer_cb_t *cb, 
  VA2_VIDEO_FRAME_T *video_frame);

static void
_va2_vr_vt_6236_display_timer_hdlr(
  void *param);

static void
_va2_vr_vt_6236_idp_frame_done_cb(
  void *param);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_t01_close_to_init(
  va2_comp_video_renderer_cb_t *cb);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_t03_init_to_idle(
  va2_comp_video_renderer_cb_t *cb);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_t04_idle_to_run(
  va2_comp_video_renderer_cb_t *cb);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_t05_run_to_stop(
  va2_comp_video_renderer_cb_t *cb);

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_t06_stop_to_run(
  va2_comp_video_renderer_cb_t *cb);    

static VIDEO_ERROR_TYPE_T 
_va2_vr_vt_6236_t10_idle_to_close(
  va2_comp_video_renderer_cb_t *cb);
 ...
 *  @status OK
 */
static VIDEO_COMPONENT_TYPE_T _va2_vr_vt_6236_primitives = 
{
    _va2_vr_vt_6236_init
  , _va2_vr_vt_6236_send_command
  , _va2_vr_vt_6236_get_parameter
  , _va2_vr_vt_6236_set_parameter
  , _va2_vr_vt_6236_use_buffer
  ...
  , _va2_vr_vt_6236_fill_this_buffer
  , _va2_vr_vt_6236_set_callbacks
  , _va2_vr_vt_6236_deinit
};

static struct va2_comp_video_renderer_cb _va2_vr_vt_6236_cb = 
  {
    {
      _va2_vr_vt_6236_t01_close_to_init, 
      ...
      _va2_vr_vt_6236_check_params_configs, 
      _va2_vr_vt_6236_config_idp_by_render_mode, 
      (va2_vr_dspl_timer_hdlr_func_t) _va2_vr_vt_6236_display_timer_hdlr, 
      (va2_vr_hw_frame_done_cb_func_t) _va2_vr_vt_6236_idp_frame_done_cb, 
      _va2_vr_vt_6236_render_display_frame_buffer, 
      NULL,
      NULL
    }, 
...
#if defined(DRV_DISPLAY_DRIVER_V2)
static WFCDevice _va2_vr_vt_6236_ddv2_dev = WFC_INVALID_HANDLE;
static WFCContext _va2_vr_vt_6236_ddv2_ctx = WFC_INVALID_HANDLE;
static WFCElement _va2_vr_vt_6236_ddv2_element = WFC_INVALID_HANDLE;
static WFCSource _va2_vr_vt_6236_ddv2_src = WFC_INVALID_HANDLE;
static WFCSource _va2_vr_vt_6236_ddv2_img_src = WFC_INVALID_HANDLE;
static OWFNativeStreamType _va2_vr_vt_6236_ddv2_stream = OWF_INVALID_HANDLE;
static kal_uint32 _va2_vr_vt_6236_dspl_fbs[3][2] = { 0 };
static kal_bool _va2_vr_vt_6236_disp_buffer_init = KAL_FALSE;
 ...
 *  
 */
static volatile kal_uint32 _va2_vr_vt_6236_curr_dspl_frame_buf_idx = 0;

static kal_bool _va2_vr_vt_6236_bypass_config_src_rect = KAL_FALSE;

static va2_vr_debug_trace_entry_t _va2_vr_vt_6236_debug_trace[VA2_VR_VT_6236_DEBUG_TRACE_SIZE] = {0};
...
#if 0   // only 4x4 block based YUV420 is allowed in MT6236 VT
/* under construction !*/
/* under construction !*/
#endif  // #if 0
  {
  ...
  {
    // Ignore this problem...since this is not supported on MT6236
    //ASSERT(0);
    //return KAL_FALSE;
#if 0   // src clip is unsupported in MT6236 VT
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
#if 0
/* under construction !*/
#else   // only RGB565 is allowed in MT6236 VT...
...
static void
_va2_vr_vt_6236_hisr_empty_this_buffer(void)
{
    va2_comp_video_renderer_cb_t *cb = &_va2_vr_vt_6236_cb;
    _va2_vr_vt_6236_empty_this_buffer_real(&_va2_comp_video_renderer_rNewBuffHeader);
  ...
  void *param)
{
  ...
  {
    va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_INTERNAL____DSPL_TIMER_ASSERT, 0);
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_INTERNAL____DSPL_TIMER_TIMEOUT, 0);
  //_va2_comp_vr_add_trace(, 0);
#if !defined(IDP_VIDEO_TELEPHONY_2PASS_ARCHI)
...
void
_va2_vr_vt_6236_lcd_frame_done_cb(void *param)
{
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_INTERNAL____LCD_HW_FRAME_DONE_CB, 0);
  ...
  ASSERT(KAL_TRUE == idp_video_call_decode_is_busy(_va2_comp_video_renderer_idp_key, &hw_busy));

  if((KAL_FALSE == hw_busy) && (item != cb->vr_q_handle.curr_dspl_buf_hdr))
  {
#if defined(VA2_VR_VT_6236_ENABLE_SWLA_TRACE)
    SLA_CustomLogging("LFR", 1);
#endif	// #if defined(VA2_VR_VT_6236_ENABLE_SWLA_TRACE)
    va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_INTERNAL____LCD_HW_FRAME_DONE_CB__TRIGGER_HW, (kal_uint32) (cb->vr_q_handle.curr_dspl_buf_hdr->buffer_header.pu1Buffer));
    va2_util_buf_hdr_advance_to_the_latest_buffer_header(&(cb->vr_q_handle));

    _va2_vr_vt_6236_render_display_frame_buffer(cb, KAL_FALSE);

//    _va2_vr_render_display_buffer_cnt++;

    va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_INTERNAL____LCD_HW_FRAME_DONE_CB__TRIGGER_HW_DONE, 0);
  
#if defined(VA2_VR_VT_6236_ENABLE_SWLA_TRACE)
    SLA_CustomLogging("LFR", 0);
#endif	// #if defined(VA2_VR_VT_6236_ENABLE_SWLA_TRACE)
  }
#if defined(VA2_VR_VT_6236_ENABLE_SWLA_TRACE)
  SLA_CustomLogging("LFD", 0);
#endif	// #if defined(VA2_VR_VT_6236_ENABLE_SWLA_TRACE)
}

#if defined(DRV_DISPLAY_DRIVER_V2)
void _va2_vr_vt_6236_wfc_frame_done_cb(
  WFCContextEventTypeMTK event, 
  void* param)
{
#if !defined(IDP_VIDEO_TELEPHONY_2PASS_ARCHI)
  _va2_vr_vt_6236_lcd_frame_done_cb(param);
#endif
}
#endif  // #if defined(DRV_DISPLAY_DRIVER_V2)

static void
_va2_vr_vt_6236_trigger_display(
  kal_uint32 dspl_fb, 
  va2_comp_video_renderer_cb_t *cb)
{
#if defined(DRV_DISPLAY_DRIVER_V2)
//  if ((KAL_TRUE == cb->trigger_display) && 
//      (OWF_INVALID_HANDLE != _va2_vr_vt_6236_ddv2_stream))
    if (OWF_INVALID_HANDLE != _va2_vr_vt_6236_ddv2_stream)
  {
    OWFNativeStreamBuffer buf;
    if (dspl_fb == _va2_vr_vt_6236_dspl_fbs[0][0])
    {
      buf = (OWFNativeStreamBuffer) _va2_vr_vt_6236_dspl_fbs[0][1];
      owfNativeStreamReleaseWriteBuffer(_va2_vr_vt_6236_ddv2_stream, 
                                      buf/* (OWFNativeStreamBuffer) 0x100 */, 
                                      NULL /* (EGLDisplay) */, 
                                      NULL /* (EGLSyncKHR) */);
      _va2_vr_vt_6236_dspl_fbs[0][1] = 0x0;
      if (0x0 == _va2_vr_vt_6236_dspl_fbs[1][1])
      {
        _va2_vr_vt_6236_dspl_fbs[1][1] = (kal_uint32) owfNativeStreamAcquireWriteBuffer(_va2_vr_vt_6236_ddv2_stream);
      }
    }
    else
    {
      buf = (OWFNativeStreamBuffer) _va2_vr_vt_6236_dspl_fbs[1][1];
      owfNativeStreamReleaseWriteBuffer(_va2_vr_vt_6236_ddv2_stream, 
                                      buf/* (OWFNativeStreamBuffer) 0x100 */, 
                                      NULL /* (EGLDisplay) */, 
                                      NULL /* (EGLSyncKHR) */);

      _va2_vr_vt_6236_dspl_fbs[1][1] = 0x0;
      if (0x0 == _va2_vr_vt_6236_dspl_fbs[0][1])
      {
        _va2_vr_vt_6236_dspl_fbs[0][1] = (kal_uint32) owfNativeStreamAcquireWriteBuffer(_va2_vr_vt_6236_ddv2_stream);
      }
    }
  }
#endif  // #if defined(DRV_DISPLAY_DRIVER_V2)
 ...
 */
static void 
_va2_vr_vt_6236_config_n_activate_ddv2( 
  va2_comp_video_renderer_cb_t *cb)
{
#if defined(DRV_DISPLAY_DRIVER_V2)
  kal_check_stack();
  ...
  // TODO: [m] Which variable can decide if display needs to work? 
  {
    ...
    _va2_vr_vt_6236_ddv2_dev = (WFCDevice) cb->display_surface.dspl_dev_handle;
    _va2_vr_vt_6236_ddv2_ctx = (WFCContext) cb->display_surface.dspl_ctx_handle;
    _va2_vr_vt_6236_ddv2_element = (WFCElement) cb->display_surface.dspl_element_handle;

    if ((WFC_INVALID_HANDLE == _va2_vr_vt_6236_ddv2_dev) || 
        (WFC_INVALID_HANDLE == _va2_vr_vt_6236_ddv2_ctx) || 
        (WFC_INVALID_HANDLE == _va2_vr_vt_6236_ddv2_element))
    {
    ...
    if (WFC_FALSE == wfcGetElementAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_element, WFC_ELEMENT_VIDEO_LAYER_MTK))
    {
      // TODO: [m] Make GDI add this line...
      wfcMMSetElementAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_element, WFC_ELEMENT_VIDEO_LAYER_MTK, WFC_TRUE);
      //VRNDRR_DD_ASSERT(0);
    }

    if (KAL_TRUE == cb->trigger_display)
    {
      wfcMMSetContextAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, WFC_CONTEXT_AUTONOMOUS_SYNC_MODE_MTK, (WFCint) WFC_AUTONOMOUS_SYNC_TO_ELEMENT);
      wfcMMSetContextAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, WFC_CONTEXT_AUTONOMOUS_PERIOD_MTK, (WFCint) 30);
      wfcMMSetContextAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, WFC_CONTEXT_AUTONOMOUS_SYNC_ELEMENT_MTK, (WFCint) _va2_vr_vt_6236_ddv2_element);
      wfcMMSetContextAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, WFC_CONTEXT_CURRENT_REFRESH_RATE_MTK, 0);
    }
    ...
    // Config Display Rotation angle & flip
    {
      ...
      //wfcGetElementAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_element, WFC_ELEMENT_SOURCE_ROTATION);
    
      wfcMMSetElementAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_element, WFC_ELEMENT_SOURCE_ROTATION, WFC_ROTATION_0);
    }
    ...
    if (_va2_vr_vt_6236_bypass_config_src_rect == KAL_FALSE)
    {
      WFCint srcRect[4];
      WFCint ClipX, ClipY, Width, Height;

      wfcGetElementAttribiv(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_element, WFC_ELEMENT_SOURCE_RECTANGLE, 4, &srcRect[0]);
      ...
      srcRect[2] = Width;
      srcRect[3] = Height;
      wfcMMSetElementAttribiv(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_element, WFC_ELEMENT_SOURCE_RECTANGLE, 4, &srcRect[0]);
    }
    else
     {
       _va2_vr_vt_6236_bypass_config_src_rect = KAL_FALSE;
     }  
    ...
    // Create stream...
    {
      ...
      _va2_vr_vt_6236_dspl_fbs[0][0] = bufs[0] = cb->dst_fb_addr_array[0].u4_fb_addr_plane0;
      _va2_vr_vt_6236_dspl_fbs[1][0] = bufs[1] = cb->dst_fb_addr_array[1].u4_fb_addr_plane0;
      // TODO: [m] When to destroy the stream? Where is the exit function?
      // TODO: [o] magical number here...
      _va2_vr_vt_6236_ddv2_stream = 
      ...
      // This code segment is used to do buffer control...
      {
        ...
        buf = owfNativeStreamAcquireWriteBuffer(_va2_vr_vt_6236_ddv2_stream);
        bufPtr = owfNativeStreamGetBufferPtr(_va2_vr_vt_6236_ddv2_stream, buf);
        VRNDRR_DD_ASSERT(NULL != bufPtr);

        if (_va2_vr_vt_6236_dspl_fbs[0][0] == (kal_uint32) bufPtr)
        {
          _va2_vr_vt_6236_dspl_fbs[0][1] = (kal_uint32) buf;
          _va2_vr_vt_6236_dspl_fbs[1][1] = owfNativeStreamAcquireWriteBuffer(_va2_vr_vt_6236_ddv2_stream);
        }
        else
        {
          _va2_vr_vt_6236_dspl_fbs[1][1] = (kal_uint32) buf;
          _va2_vr_vt_6236_dspl_fbs[0][1] = owfNativeStreamAcquireWriteBuffer(_va2_vr_vt_6236_ddv2_stream);
        }
      }

      _va2_vr_vt_6236_ddv2_src = wfcCreateSourceFromStream(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, (WFCNativeStreamType) _va2_vr_vt_6236_ddv2_stream, NULL);

      // TODO: [m] Need an API to set buffers into the stream...

      if (WFC_INVALID_HANDLE == _va2_vr_vt_6236_ddv2_src)
      {
        VRNDRR_DD_ASSERT(0); // TODO: [m] remove this after IT done...need error handling...
      }
    }
    ...
    // Set Element source
    wfcMMSetElementAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_element, WFC_ELEMENT_SOURCE, (WFCint) _va2_vr_vt_6236_ddv2_src);
    ...
    // Add cb function
    {
      ...
      array[1] = (WFCint) _va2_vr_vt_6236_wfc_frame_done_cb;
      array[2] = (WFCint) cb;
      array[3] = (WFCint) WFC_TRUE;
      wfcMMSetContextAttribiv(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, WFC_CONTEXT_CALLBACK_MTK, 4, &array[0]);
    }

    // Commmit
    wfcMMCommit(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, _va2_vr_vt_6236_ddv2_element, WFC_COMMIT_CONTEXT_AND_ELEMENT);                
    ...
    if (KAL_FALSE == cb->trigger_display)
    {
      ...
      if (KAL_FALSE == _va2_vr_vt_6236_disp_buffer_init)
      {
        kal_uint32 addr;
        kal_uint32 size = cb->dst_fb_size.u4_width * 
                          cb->dst_fb_size.u4_height * 
                          va2_util_get_bpp(cb->dst_color_format);
        if (0x0 != (addr = cb->dst_fb_start_addr_array[1].u4_fb_addr_plane0))
        {
        ...
        _va2_vr_vt_6236_disp_buffer_init = KAL_TRUE;
      }
  
      // use 2nd buffer to trigger display one time to confirm that lcd won't bypass this video layer
      // 2nd buffer contains the latest content and won't be overwritten by get frame operation
      _va2_vr_vt_6236_trigger_display(
...
static void 
_va2_vr_vt_6236_stop_n_deactivate_ddv2( 
  va2_comp_video_renderer_cb_t *cb)
{
#if defined(DRV_DISPLAY_DRIVER_V2)
  kal_check_stack();
  ...
  if (OWF_INVALID_HANDLE != _va2_vr_vt_6236_ddv2_stream)
  {
    ...
    {
      wfcMMSetContextAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, WFC_CONTEXT_AUTONOMOUS_SYNC_MODE_MTK, (WFCint) WFC_AUTONOMOUS_SYNC_TO_TIMER);
      wfcMMSetContextAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, WFC_CONTEXT_AUTONOMOUS_PERIOD_MTK, (WFCint) 0);
      wfcMMSetContextAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, WFC_CONTEXT_AUTONOMOUS_SYNC_ELEMENT_MTK, (WFCint) 0);
      wfcMMSetContextAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, WFC_CONTEXT_CURRENT_REFRESH_RATE_MTK, 30);
    }
    ...
    // Set an image source back to element
    {
      ...
      if (_va2_vr_vt_6236_ddv2_img_src != WFC_INVALID_HANDLE)
      {
        wfcDestroySource(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_img_src);
      }
      ...
      if (_va2_vr_vt_6236_dspl_fbs[1][1] == 0x0)
      {
      ...
      image.data = (void*)_va2_vr_vt_6236_dspl_fbs[0][0];
#else
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
      ...
      _va2_vr_vt_6236_ddv2_img_src = wfcCreateSourceFromImage(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, (WFCHandle) &image, NULL);
      VRNDRR_DD_ASSERT(_va2_vr_vt_6236_ddv2_img_src != WFC_INVALID_HANDLE);
      wfcMMSetElementAttribi(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_element, WFC_ELEMENT_SOURCE, _va2_vr_vt_6236_ddv2_img_src);
      wfcMMCommit(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_ctx, _va2_vr_vt_6236_ddv2_element, WFC_COMMIT_CONTEXT_AND_ELEMENT);                
    }

    // destroy the stream source used by VR
    wfcDestroySource(_va2_vr_vt_6236_ddv2_dev, _va2_vr_vt_6236_ddv2_src);
    _va2_vr_vt_6236_ddv2_src = WFC_INVALID_HANDLE;

    _va2_vr_vt_6236_ddv2_element = WFC_INVALID_HANDLE;
    _va2_vr_vt_6236_ddv2_ctx = WFC_INVALID_HANDLE;
    _va2_vr_vt_6236_ddv2_dev = WFC_INVALID_HANDLE;
    
    owfNativeStreamDestroy(_va2_vr_vt_6236_ddv2_stream);
    _va2_vr_vt_6236_ddv2_stream = OWF_INVALID_HANDLE;

    kal_mem_set((void*) _va2_vr_vt_6236_dspl_fbs, 0x0, sizeof(kal_uint32)*3*2);
  }
  kal_check_stack();
#endif  // #if defined(DRV_DISPLAY_DRIVER_V2)
}
...
#if defined(IDP_VIDEO_TELEPHONY_2PASS_ARCHI)
static void
_va2_vr_vt_6236_blocking_idp_frame_done_cb(
  void *param)
{
  va2_comp_video_renderer_cb_t *cb = (va2_comp_video_renderer_cb_t*) param;
  ASSERT(NULL != cb);
  ...
  void *param)
{
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_INTERNAL____MDP_HW_FRAME_DONE_CB, 0);
...
#if defined(DRV_DISPLAY_DRIVER_V2)
  {
    ...
    if (KAL_TRUE == cb->trigger_display)
    {
      ...
      {
        _va2_vr_vt_6236_trigger_display(
        cb->dst_fb_start_addr_array[_va2_vr_vt_6236_curr_dspl_frame_buf_idx^0x1].u4_fb_addr_plane0, 
        cb);
      }
      else
      {
        ...
        _va2_vr_vt_6236_curr_dspl_frame_buf_idx ^= 0x1;
...
//No need to render any buffer if 2 PASS
#if !defined(IDP_VIDEO_TELEPHONY_2PASS_ARCHI)
  // if buffer header received while HW doing a frame...use the latest frame buffer for the next update...
  if (0 != cb->vr_q_handle.to_be_processed_q.size)
  {
  ...
  if((KAL_FALSE == hw_busy) && (item != cb->vr_q_handle.curr_dspl_buf_hdr))
  {
    {
      va2_util_buf_hdr_advance_to_the_latest_buffer_header(&(cb->vr_q_handle));
      va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_INTERNAL____MDP_HW_FRAME_DONE_CB__TRIGGER_HW, (kal_uint32) (cb->vr_q_handle.curr_dspl_buf_hdr));
      _va2_vr_vt_6236_render_display_frame_buffer(cb, KAL_FALSE);
    }
    _va2_vr_render_display_buffer_cnt++;

    va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_INTERNAL____MDP_HW_FRAME_DONE_CB__TRIGGER_HW_DONE, 0);
  }
#endif
  ...
  kal_bool blocking)
{
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_INTERNAL____RENDER, (kal_uint32) curr_dspl_buf_hdr);
  ...
  if (KAL_FALSE == _va2_vr_vt_6236_check_params_configs(cb))
  {
  ...
  {
    saved_mask = SaveAndSetIRQMask();
    curr_dspl_buf_idx = _va2_vr_vt_6236_curr_dspl_frame_buf_idx;
    _va2_vr_vt_6236_curr_dspl_frame_buf_idx ^= 0x1;
    RestoreIRQMask(saved_mask);
  }
  ...
  //  5.1. config MDP driver [OK]
  {
    ...
    if(KAL_FALSE == blocking)
    {
      ptr_FrmDoneCBFunc = _va2_vr_vt_6236_idp_frame_done_cb;
    }
    else
    {
      ...
      {
        ptr_FrmDoneCBFunc = _va2_vr_vt_6236_blocking_idp_frame_done_cb;
      }
...
#endif
      //IDP_VIDEO_CALL_DECODE_DECODE_ROT_ANGLE, IMG_ROT_ANGLE_0,
  ...
  // config LCD...I think this implementation sucks!
    ...
    LCD_config_fullvideo_layer_address(lcd_layer, 
                                       (kal_uint32) cb->dst_fb_start_addr_array[_va2_vr_vt_6236_curr_dspl_frame_buf_idx].u4_fb_addr_plane0);
    }
  }
#endif
  ...
  if (KAL_TRUE == blocking)
  {
    ...
    do
    {
      ...
      // TODO: sleep ?
             ...
             (VA2_VR_VT_6236_RENDER_TIME_MAX > drv_get_duration_tick(start_time, drv_get_current_time())));
...
static void
_va2_vr_vt_6236_hisr_general(void)
{
  va2_comp_video_renderer_cb_t *cb = &_va2_vr_vt_6236_cb;
...
static void
_va2_vr_vt_6236_disp_timer_visu_hisr_cb_func(void)
{
  kal_bool idp_busy;
  ...
  if ((KAL_FALSE == idp_busy) && 
      ...
      (KAL_FALSE == cb->bypass))
  {
    va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_INTERNAL____DSPL_TIMER_TRIGGER_RENDER_IN_VHISR, (kal_uint32) cb->vr_q_handle.curr_dspl_buf_hdr);
...
#if defined(IDP_VIDEO_TELEPHONY_2PASS_ARCHI)
void
_va2_vr_vt_6236_video_decode_empty_this_buffer(
  void *user_data)
{
//    va2_comp_video_renderer_cb_t *cb = &_va2_vr_vt_6236_cb;
    
    _va2_vr_vt_trigger_empty_this_buffer(&_va2_vr_vt_6236_cb,
                   &_va2_comp_video_renderer_idp_key,
                   &_va2_vr_vt_6236_debug_trace[0]);
}
#endif
/**
 *  @status OK
  ...
  va2_comp_video_renderer_cb_t *cb)
{
  ...
  idp_set_video_call_decode_cb(&_va2_vr_vt_6236_video_decode_empty_this_buffer);
#endif

  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_TRANSITION__T01_CLOSE_TO_INIT, 0);
  ...
  _va2_vr_vt_6236_curr_dspl_frame_buf_idx = 0;
  _va2_vr_vt_6236_bypass_config_src_rect = KAL_FALSE;
  ...
  va2_comp_video_renderer_cb_t *cb)
{
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_TRANSITION__T03_INIT_TO_IDLE, 0);
  ...
  if (
#if defined(IDP_VIDEO_TELEPHONY_2PASS_ARCHI)
      KAL_TRUE == cb->trigger_display && 
#endif
      0 == _va2_comp_video_renderer_idp_key)
  {
    ...
    {
      // set internal memory for only once!!
      kal_bool result;

#if 0 //defined(VA2_VIDEO_RENDERER_VT_MT6236)
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
      ...
      result = idp_video_call_decode_config(
        ...
        IDP_VIDEO_CALL_DECODE_DONE_CB, _va2_vr_vt_6236_idp_frame_done_cb, 
        IDP_VIDEO_CALL_DECODE_DONE_CB_PARAM, cb, 
        0);
      ASSERT(KAL_TRUE == result);
    }
  ...
  VISUAL_Register_HISR(VISUAL_RENDERER_HISR_ID, _va2_vr_vt_6236_hisr_general);

  VISUAL_Register_HISR(VISUAL_RENDERER_EMPTY_THIS_BUFFER_HISR_ID, _va2_vr_vt_6236_hisr_empty_this_buffer);
  ...
  VISUAL_Register_HISR(VISUAL_RENDERER_TIMER_HISR_ID, _va2_vr_vt_6236_disp_timer_visu_hisr_cb_func);  

  //  Create a timer for periodically update display device
  if (0 == cb->display_timer)
  {
    cb->display_timer = kal_create_timer("VA2_VR_VT_6236_TIMER");
    if (0 == cb->display_timer)
    {
  ...
  va2_comp_video_renderer_cb_t *cb)
{
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_TRANSITION__T04_IDLE_TO_RUN, 0);
...
#if defined(IDP_VIDEO_TELEPHONY_2PASS_ARCHI)
    //  if VT decode only mode, open decode path at run state
    if (KAL_TRUE == cb->trigger_display && 
        0 == _va2_comp_video_renderer_idp_key)
    {
      if (KAL_FALSE == idp_video_call_decode_open(&_va2_comp_video_renderer_idp_key))
...
#if defined(DRV_DISPLAY_DRIVER_V2)
        _va2_vr_vt_6236_config_n_activate_ddv2(cb);
#endif  // #if defined(DRV_DISPLAY_DRIVER_V2)
        va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_DEBUG_______START_LCD_HW_TRIGGER_MODE, 0);
  ...
  va2_comp_video_renderer_cb_t *cb)
{
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_TRANSITION__T05_RUN_TO_STOP, 0);
  ...
  {
#if defined(IDP_VIDEO_TELEPHONY_2PASS_ARCHI)
    // if VT decode only mode, stop and close decode scenario at stop state
    if (KAL_TRUE == cb->trigger_display &&
        0 != _va2_comp_video_renderer_idp_key)
    {
#endif
...
#if defined(DRV_DISPLAY_DRIVER_V2)
      _va2_vr_vt_6236_stop_n_deactivate_ddv2(cb);
#endif
      va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_DEBUG_______STOP_LCD_HW_TRIGGER_MODE, 0);
  ...
  va2_comp_video_renderer_cb_t *cb)
{
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_TRANSITION__T06_STOP_TO_RUN, 0);
  ...
  va2_comp_video_renderer_cb_t *cb)
{
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_TRANSITION__T10_IDLE_TO_CLOSE, 0);
...
_va2_vr_vt_6236_init(void)
{
  ...
  va2_vr_init_trace(VA2_VR_VT_6236_DEBUG_TRACE_SIZE, &_va2_vr_vt_6236_debug_trace[0]);

  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_API_________INIT, 0);
...
_va2_vr_vt_6236_send_command(
  ...
  kal_uint32 u4Param)
{
  return va2_vr_send_command(&_va2_vr_vt_6236_cb, eCmd, u4Param);
}
  ...
  void *pParam)
{
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_API_________GET_PARAMETER, (kal_uint32) eCmd);
  ...
  case VIDEO_PARAM_RENDERER_RENDER_DISPLAY_BUFFER: /**< arg type: kal_uint32* */
    {
          ...
          (0 == cb->vr_q_handle.to_be_processed_q.size))
      {
        ...
        va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_DEBUG_______NO_VIDEO_FRAME_TO_DRAW, 0);
...
#endif
        //MAUI_02908562 reset buffer pointer to ensure renderer will use buffer 0 for get frame
        _va2_vr_vt_6236_curr_dspl_frame_buf_idx = 0;
        *(kal_uint32*)pParam = _va2_vr_vt_6236_render_display_frame_buffer(cb, KAL_TRUE);
      ...
      else
      {
        ...
        _va2_vr_vt_get_frame = KAL_TRUE;
        {
          ...
          } while (VA2_VR_VT_6236_RENDER_TIME_MAX > drv_get_duration_tick(start_time, drv_get_current_time()));
        }
        *(kal_uint32*)pParam = cb->dst_fb_start_addr_array[0].u4_fb_addr_plane0;
      }
    _va2_vr_vt_6236_bypass_config_src_rect = KAL_TRUE;  
#endif
    }
    break;
  ...
  void *pParam)
{
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_API_________SET_PARAMETER, (kal_uint32) eCmd);
...
/* under construction !*/
      ...
      case VIDEO_PARAM_RENDERER_INTERNAL_MEMORY: /**< arg type: VA2_MEMORY_BLOCK_T* */
        {
          ...
          kal_mem_cpy(&(cb->internal_memory), pParam, sizeof(VA2_MEMORY_BLOCK_T));
        }
        i4Ret = VIDEO_ERROR_NONE;
        break;
    ...
    case VIDEO_CONFIG_RENDERER_SRC_CLIP: /**< arg type: VA2_CLIP_WINDOW_T* */
#if 0   // This config is unsupported in MT6236 VT
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
    ...
    // TODO: Add MP4 DEBLK params for MT6236 VT...
...
_va2_vr_vt_6236_use_buffer(
  ...
  kal_uint32 u4Size)
{
  return va2_vr_use_buffer(&_va2_vr_vt_6236_cb, pu1Buff, u4Size);
}
  ...
  VIDEO_BUFFERHEADER_TYPE_T *prBuffHeader)
{
  ...
  {
    _va2_vr_vt_6236_empty_this_buffer_real(prBuffHeader);
  }
...
/* under construction !*/
  ...
  va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_API_________EMPTY_THIS_BUFFER, (kal_uint32) prBuffHeader);
  ...
  switch(cb->state.eState)
  {
    ...
    case VIDEO_STATE_RUN:
    {
      kal_bool busy;
#if defined(IDP_VIDEO_TELEPHONY_2PASS_ARCHI)
     if (KAL_FALSE == cb->trigger_display) {break;}
#endif
      ASSERT(KAL_TRUE == idp_video_call_decode_is_busy(_va2_comp_video_renderer_idp_key, &busy));
      if (KAL_FALSE == busy)
      {
        va2_util_buf_hdr_advance_to_the_latest_buffer_header(&(cb->vr_q_handle));
        va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_API_________EMPTY_THIS_BUFFER__TRIGGER_HW, (kal_uint32) (cb->vr_q_handle.curr_dspl_buf_hdr));
        //render frame if decode only mode
        _va2_vr_vt_6236_render_display_frame_buffer(cb, KAL_FALSE);
      }
      else
      {
        va2_vr_add_trace(&_va2_vr_vt_6236_debug_trace[0], VA2_VR_API_________EMPTY_THIS_BUFFER__ENQUEUE_ONLY, (kal_uint32) (cb->vr_q_handle.to_be_processed_q.tail));
      }
    }
      break;
...
_va2_vr_vt_6236_fill_this_buffer(
  VIDEO_BUFFERHEADER_TYPE_T *prBuffHeader)
{
  return va2_vr_fill_this_buffer(&_va2_vr_vt_6236_cb, prBuffHeader);
}
...
_va2_vr_vt_6236_set_callbacks(
  VIDEO_CALLBACK_TYPE_T *prCallback)
{
  return va2_vr_set_callbacks(&_va2_vr_vt_6236_cb, prCallback);
}
...
{
  VIDEO_ERROR_TYPE_T ret;
  ret = va2_vr_deinit(&_va2_vr_vt_6236_cb);
...
va2_video_renderer_vt_mt6236_get_handle(
  VA2_VIDEO_RENDERER_TYPE_T e_type)
{
  ...
  case VIDEO_RENDERER_VIDEO_TELEPHONY: 
    pr_video_renderer_comp = &_va2_vr_vt_6236_primitives;
    _va2_vr_vt_6236_cb.renderer_type = VIDEO_RENDERER_VIDEO_TELEPHONY;
    break;
...
VIDEO_ERROR_TYPE_T 
va2_video_renderer_vt_mt6236_release_handle(
  VIDEO_COMPONENT_TYPE_T *pr_handle)
{
  ...
  if ((NULL == pr_handle) || 
      (&_va2_vr_vt_6236_primitives != pr_handle) || 
...
#endif  // #if defined(VA2_VIDEO_RENDERER_VT_MT6236)
