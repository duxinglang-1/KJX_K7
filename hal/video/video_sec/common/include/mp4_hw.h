 ...
 * Description:
 * ------------
 *    This file defines mp4 HW register.
 *
 * Author:
 * -------
 * -------
...
#define MP4_SWITCH_GMC_PORT                           (GMC_base+0x20)
...
#ifdef __VE_ENABLE_CBR__
    #define MP4_ENC_DCT_CUT_LEVLE   (volatile unsigned long *)(MP4_base+0x1A0)
    #define MP4_ENC_MD_THREA        (volatile unsigned long *)(MP4_base+0x1A4)
    #define MP4_ENC_MD_THREB        (volatile unsigned long *)(MP4_base+0x1A8)
    #define MP4_ENC_MD_THREC        (volatile unsigned long *)(MP4_base+0x1AC)
    #define MP4_ENC_MD_THRED        (volatile unsigned long *)(MP4_base+0x1B0)
    #define MP4_ENC_MD_THREE        (volatile unsigned long *)(MP4_base+0x1B4)
    #define MP4_ENC_MD_THREF        (volatile unsigned long *)(MP4_base+0x1B8)
    #define MP4_ENC_MBRC_INFO       (volatile unsigned long *)(MP4_base+0x1BC)
    #define MP4_ENC_MBRC_Q_LIMIT    (volatile unsigned long *)(MP4_base+0x1C0)
    #define MP4_ENC_MBRC_Q_SUM      (volatile unsigned long *)(MP4_base+0x1C4)
    #define MP4_ENC_EIS_MB_INFO     (volatile unsigned long *)(MP4_base+0x1D0)
    #define MP4_ENC_EIS_VOP_ADDR    (volatile unsigned long *)(MP4_base+0x1D4)
    #define MP4_ENC_EIS_GMV         (volatile unsigned long *)(MP4_base+0x1D8)   
#endif
   /*DEC register*/
...
#ifdef __VE_ENABLE_CBR__
    #define MP4_ENC_CODEC_CONF_CBR_EN       0x40000
    #define MP4_ENC_CODEC_CONF_MD_EN        0x100000
#endif
   ...
   #define MP4_DEC_CODEC_CONF_PMV                     0x0800
    #define MP4_DEC_CODEC_CONF_HECFIX               0x20000
    #define MP4_DEC_CODEC_CONF_DQFIX                0x40000
