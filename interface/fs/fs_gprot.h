...
//-- Compile directives
#if defined(GEN_FOR_PC)             /* Code Gen  */ //TODO: This shall be removed
...
#define FS_BTYPE_INDEX(i) ((i>>16)&0xFF)
...
// Priority configuration of FS async job
typedef enum
{
...
{
    kal_int16 line_size[FS_BTYPE_INDEX(FS_BTYPE_MAX)];
    kal_int16 consumed_size[FS_BTYPE_INDEX(FS_BTYPE_MAX)];
} FS_CacheProfile;
...
#define fs_file_tbl_struct FS_File __attribute__((aligned(4))) __attribute__((__section__("_fs_filetable_zi")))
#elif defined(__MTK_TARGET__)
#define fs_file_tbl_struct FS_File __attribute__((section("_fs_filetable_zi"), zero_init))
#else
#define fs_file_tbl_struct __pragma(section("_fs_filetable_zi_content")) \
                            FS_File __declspec(allocate("_fs_filetable_zi_content"))
...
typedef struct
{
    ...
    kal_uint8   DeferredMount;  // Needs Deferred Mount Procedure
} FS_CardDeviceInfo;
...
typedef struct
{
    fs_prioity_enum         priority;   // priority configuration of this job
