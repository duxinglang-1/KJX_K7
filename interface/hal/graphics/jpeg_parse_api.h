 ...
 * Description:
 * ------------
 *   Prototypes of parser API for JPEG codec unified interface.
 *
 * Author:
 * -------
 * -------
...
#ifndef __JPEG_PARSE_API_H__
#define __JPEG_PARSE_API_H__

// Forward declaration for making compiler happy
typedef struct JPEG_FILE_INFO_T  *JPEG_FILE_INFO;
