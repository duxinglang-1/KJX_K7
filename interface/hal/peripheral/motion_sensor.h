...
#define MOTION_SENSOR_CALI_TIMEOUT_MS   5000 // 5sec
...
typedef enum {
    ...
    MS_FLIP,
    MS_HW_GESTURE_MAX
} Motion_Sensor_Gesture_enum;

typedef enum {
    MS_ACC_DATA_RESOLUTION = 0x0
} Motion_Sensor_General_Params_enum;

typedef enum {
    MS_DEV_STATUS = 0x100, 
    MS_TAP_PULSE = 0x101,
    MS_TAP_THRESHOLD = 0x102
} mCube_Sensor_Params_enum;

typedef enum {
    MS_CALI_FINISHED,
    MS_CALI_TIMEOUT
} Motion_Sensor_Cali_Status_enum;
...
typedef struct
{
   ...
   kal_int16 	y_acc;
   kal_int16 	z_acc;
   kal_uint32   timeStampMs;
   kal_uint32   motion_info;
}MotionSensorDataStruct;

typedef struct
{
    kal_int16   x_cali_acc;
    kal_int16 	y_cali_acc;
    kal_int16 	z_cali_acc;    
    kal_uint16  cali_info;
}MotionSensorCaliNVRamStruct;
...
typedef void (*MS_CALI_CB_FUNC)(void *parameter, Motion_Sensor_Cali_Status_enum state);
...
typedef struct {  
   ...
   /*read device status*/
   kal_bool (*ms_query_gesture)(kal_uint16 ms_gest_type);
   kal_bool (*ms_get_sensor_params)(kal_uint16 ms_params_type, MotionSensorQueryStruct *ms_params);
   kal_bool (*ms_set_sensor_params)(kal_uint16 ms_params_type, kal_uint32 ms_params);
...
extern void motion_sensor_cali_cb_registration(MS_CALI_CB_FUNC ms_cali_cb_func);
extern kal_bool motion_sensor_query_gesture(kal_uint16 ms_gest_type);
extern kal_bool motion_sensor_get_sensor_params(kal_uint16 ms_params_type, MotionSensorQueryStruct *ms_params);
extern kal_bool motion_sensor_set_sensor_params(kal_uint16 ms_params_type, kal_uint32 ms_params);
extern kal_bool motion_sensor_write_cali_to_nvram(void);
extern kal_bool motion_sensor_read_cali_from_nvram(void);
