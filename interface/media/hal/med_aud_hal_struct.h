 ...
 * Description:
 * ------------
 *   split HAL related media audio structure / enum to this file for HAL reference.
 *
 * Author:
 * -------
 * -------
...
#ifndef _MED_AUD_STRUCT_HAL_H
#define _MED_AUD_STRUCT_HAL_H
...
typedef struct
{
	...
	kal_uint8 src_id;
    kal_uint32 channel; 
	kal_uint32* p_strength;
}
media_aud_get_intensity_req_struct;

typedef struct
{
    LOCAL_PARA_HDR
	kal_uint8 src_id;
    kal_uint32* max_value; 
	kal_uint32* min_value;
}
media_aud_get_intensity_limit_req_struct;
