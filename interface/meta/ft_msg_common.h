...
typedef enum
{
  ...
  /* GPS test command category */
  FT_GPS_CMD_REQ_ID = 89,
  FT_GPS_CMD_CNF_ID = 90,
...
#define FT_ALLOC_MSG(size)          _FT_ALLOC_MSG(size, KAL_TRUE)
#define FT_ALLOC_OTHER_MSG(size)    _FT_ALLOC_MSG(size, KAL_FALSE)
