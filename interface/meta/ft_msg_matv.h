 ...
 * Description:
 * ------------
 *   Messages definition of MATV category of FT Library
 *
 * Author:
 * -------
 * -------
...
#ifndef __FT_MSG_MATV_H__
#define __FT_MSG_MATV_H__
...
typedef struct
{
    ...
    ft_matv_ch_entry m_rmatv_ch_entry;
...
typedef struct
{
    ...
    ft_matv_ch_entry m_rmatv_ch_entry[70];
...
#endif // #ifndef __FT_MSG_MATV_H__
