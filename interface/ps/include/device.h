...
typedef enum {
	...
	EXT_DEV_BLE_MOD_SPI_OPEN,
	EXT_DEV_BLE_MOD_SPI_CLOSE,
#endif
	MAX_EXT_DEVICE_NUM   
}ext_device_enum;
...
typedef enum 
{
   ...
   BATTERY_LEVEL_2,
   BATTERY_LEVEL_3, 
#if defined(__KJX_FUN__)	//xb add 2016-10-12 电池为4格显示
   BATTERY_LEVEL_4,
   BATTERY_LEVEL_5 = BATTERY_LEVEL_4, /* BATTERY_LEVEL_5 */
   BATTERY_LEVEL_6 = BATTERY_LEVEL_4, /* BATTERY_LEVEL_6 */
#else
