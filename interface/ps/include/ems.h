...
typedef enum
{
   ...
   EMS_INVALID_SEG_NUM,       /* Segment number exceeds the limitation.  */
   EMS_INVALID_LANGUAGE,      /* National Language looking shift table or single shift table unspecific */
...
/* based on 23.080 table 6.2.1.2.4.1 */
typedef enum
{
    EMS_NL_DEFAULT          = 0x00,
    EMS_NL_TURKISH          = 0x01,
    EMS_NL_SPANISH          = 0x02,
    EMS_NL_PORTUGUESE       = 0x03,
    EMS_NL_END
} EMSNationalLanguageType;
...
{
    // default 7-bit table
    EMSNationalLanguageType locking_shift;

    // default 7-bit extension table
    EMSNationalLanguageType single_shift;
...
typedef struct 
{
   ...
   EMSNationalLanguage     NLTable;

#ifndef __ULC_SLIM_EMS__
   kal_uint16	  ObjMemPoolRemainSize;

   EMSObject	  *TheSwithchedTFObj; /* used to point to the switched object when AddTextFormat sorting*/
#endif
...
extern
EMSTATUS AddStringNoCheckSpace(EMSData       *emsData,
                               kal_uint8     *string,
                               kal_uint16    num_char,
                               EMSTextFormat *txt_fmt);
...
extern
EMSTATUS EMSCancelRedundancyData(EMSData *emsData, kal_uint8 SegNum);

/* Miscellaneous Category */
extern
EMSTATUS EMSSetDCSandCancelRedundancyData(EMSData *emsData, kal_uint8 dcs);
...
extern
EMSTATUS EMSSetEditSegs(EMSData *emsData, kal_uint8 SegNum);

extern
EMSTATUS EMSGetEditSegs(EMSData *emsData, kal_uint8 *SegNum);

extern
EMSTATUS EMSRegNonStdCharCallback(kal_uint16(*)(kal_uint8, kal_uint8));
...
extern
EMSTATUS EMSSetNationalLanguage(EMSData *emsData, EMSNationalLanguage *lang);

extern
EMSTATUS EMSSetNationalLanguageandCancelRedundancy(EMSData *emsData, EMSNationalLanguage *lang);

extern
EMSTATUS EMSGetNationalLanguage(EMSData *emsData, EMSNationalLanguage *lang);

extern
EMSTATUS EMSRegNLtoUCS2Callback( kal_uint16(*)(EMSNationalLanguage lang,
                                               kal_uint8 *,
                                               kal_uint8 *,
                                               kal_uint16,
                                               kal_uint8) );    
extern
EMSTATUS EMSRegUCS2toNLCallback( kal_uint16(*)(EMSNationalLanguage lang,
                                               kal_uint8 *,
                                               kal_uint8 *,
                                               kal_uint16,
                                               kal_uint8) );
...
extern EMSTATUS EMSSetCompressMode(kal_bool mode, void *(*)(kal_uint32 mem_size), void (*)(void *mem_ptr));
