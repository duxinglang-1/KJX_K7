...
#define W_IMMDT_REG              RX_W_FRC
      #elif IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
...
#if IS_SOC_CHIP || IS_CHIP_MT6236 || IS_CHIP_MT6276_S01 || IS_CHIP_MT6250 || IS_CHIP_MT6260
...
#define APC_OFS(n)               ((APBADDR)(APC_base+0x0018+((n)*32)))  /* Rampdown Profile #n                           */
   #if IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6276) || IS_CHIP_MT6250 || IS_CHIP_MT6260
...
#elif IS_CHIP_MT6236 || IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
...
#elif IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
#define TDMA_FHSTR(n)            ((APBADDR)(TDMA_base+0x0320+(4*(n))))
#define DSPCLK_CON               ((APBADDR)(MD2GCONFG_base+0x040))      /* DSP Clock Control Register                    */
...
#define CFG_PIN_IES0             ((APBADDR32)(0xA0730124))   //CFG_PIN_IES0
#define CFG_PIN_IES1             ((APBADDR32)(0xA0730128))   //CFG_PIN_IES1
#define ACFG_GPIO_MODE0          ((APBADDR32)(0xA0730140))   //ACFG_GPIO_MODE0
#define ACFG_GPIO_MODE1          ((APBADDR32)(0xA0730144))   //ACFG_GPIO_MODE1
#define GPIO_IES0                ((APBADDR32)(0xA0020900))   //GPIO_IES0
#define GPIO_IES1                ((APBADDR32)(0xA0020910))   //GPIO_IES1
#define ACFG_TEST_CON0           ((APBADDR32)(0xA0730028))
#define MODEM_DBG_SEL            ((APBADDR32)(0x83000284))
#define DEBUG_MODED0             ((APBADDR32)(0xA0010238))
#define ACFG_DCXO_PCON0          ((APBADDR32)(0xA0730030))
   #endif
