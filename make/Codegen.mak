...
ifeq ($(strip $(MODIS_CONFIG)),FALSE)
 #caoweijie 20131022
 ifneq ($(strip $(CUSTOMER_NAME)),NONE)
  BPLGUINFOCUSTOMSRCP = BPLGUInfoCustomAppSrcP_$(strip $(PLATFORM))_$(strip $(CHIP_VER))_$(strip $(CUSTOMER_NAME))_$(strip $(PURE_VERNO))
 else
...
#caoweijie 20130921
ifneq ($(strip $(CUSTOMER_NAME)),NONE)
	@copy /Y custom\system\$(strip $(call Upper,$(BOARD_VER)))\custom_memorydevice_$(strip $(CUSTOMER)).h custom\system\$(strip $(call Upper,$(BOARD_VER)))\custom_memorydevice.h	
endif
