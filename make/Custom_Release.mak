...
FORBIDDEN_COMP = dp_engine opengl opengl16 fdm nvram_sec sst btadp btprofiles btstack supc wndrv ecompass external_mmi 
  else
FORBIDDEN_COMP = dp_engine opengl opengl16 fdm nvram_sec sst btstack supc wndrv external_mmi 
  endif
else
FORBIDDEN_COMP = dp_engine opengl opengl16 fdm nvram_sec sst btstack supc wndrv external_mmi 
endif
