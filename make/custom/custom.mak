...
ifneq ($(call Upper,$(strip $(PROJECT))),BASIC)
  ifneq ($(call Upper,$(strip $(PROJECT))),L1S)
    ...
    ifdef HEART_RATE_SUPPORT
  	  ifneq ($(strip $(HEART_RATE_SUPPORT)),NONE)
  	    FOLDER_LIST += custom\drv\rate_sensor\PAH8001EI_2G
  	    INC_DIR += custom\drv\rate_sensor\PAH8001EI_2G
  	    SRC_LIST += custom\drv\rate_sensor\PAH8001EI_2G\rate_sensor_custom.c
  	    SRC_LIST += custom\drv\rate_sensor\PAH8001EI_2G\rate_sensor_I2C.c
		SRC_LIST += custom\drv\rate_sensor\PAH8001EI_2G\rate_i2c.c
  	  endif
    endif
...
ifneq ($(filter __BOSCH_BMP280_PRESSURE__, $(strip $(MODULE_DEFS))),)
INC_DIR  +=  custom\drv\Press_sensor\BMP280_driver
SRC_LIST +=  custom\drv\Press_sensor\BMP280_driver\bmp280.c \
			 custom\drv\Press_sensor\BMP280_driver\bmp280_support.c

#INC_DIR  +=  custom\drv\Press_sensor\MSP880_driver
#SRC_LIST +=  custom\drv\Press_sensor\MSP880_driver\msp880.c \
#			 custom\drv\Press_sensor\MSP880_driver\st_bas_msp880.c

#INC_DIR  +=  custom\drv\Press_sensor\FBM320_driver
#SRC_LIST +=  custom\drv\Press_sensor\FBM320_driver\fbm320.c \
#			 custom\drv\Press_sensor\FBM320_driver\fbm320_support.c
endif

ifneq ($(filter __BLE_MODULE_SUPPORT__, $(strip $(MODULE_DEFS))),)
    INC_DIR += custom\drv\Ble_mod
	SRC_LIST += custom\drv\Ble_mod\ble_mod.c
endif

ifneq ($(filter __MOTION_SENSOR_MC3451_SUPPORT__, $(strip $(MODULE_DEFS))),)
    INC_DIR += custom\drv\Motion_sensor\MC3451_I2C
    SRC_LIST += custom\drv\Motion_sensor\MC3451_I2C\motion_sensor_I2C.c \
          	    custom\drv\Motion_sensor\MC3451_I2C\motion_sensor_custom.c          
endif
