...
typedef enum
{
    ...
    AUD_CACHE_EVT_STOP      = 0x02,
    AUD_CACHE_EVT_CLOSE     = 0x04,
    AUD_CACHE_EVT_RESET     = 0x08,
    AUD_CACHE_EVT_STOP_SEEK = 0x10
}
...
/*audio build cache*/
extern void aud_build_cache_start_seek_req_hdlr(ilm_struct *ilm_ptr);
extern void aud_build_cache_stop_seek_req_hdlr(ilm_struct *ilm_ptr);
extern void aud_build_cache_async_start_req_hdlr(ilm_struct *ilm_ptr);
extern void aud_build_cache_start_req_hdlr(ilm_struct *ilm_ptr);
extern void aud_build_cache_stop_req_hdlr(ilm_struct *ilm_ptr);
extern void aud_build_cache_async_close_req_hdlr(ilm_struct *ilm_ptr);
extern void aud_build_cache_close_req_hdlr(ilm_struct *ilm_ptr);
extern void aud_build_cache_reset_req_hdlr(ilm_struct *ilm_ptr);
extern void aud_build_cache_stop(void);
extern kal_bool aud_build_cache_is_seeking(void);


/* audio record in low priority task */
extern void med_v_aud_read_data_ind_hdlr(ilm_struct *ilm_ptr);

/* background sound read data to buffer in low priority task */
#ifdef AUD_BGSND_PLAY_FROM_MEDV
extern void med_v_aud_bgsnd_init(void);
extern void med_v_aud_bgsnd_play_req_hdlr(ilm_struct *ilm_ptr);
extern void med_v_aud_bgsnd_stop_req_hdlr(ilm_struct *ilm_ptr);
extern void med_v_aud_bgsnd_process_event_ind_hdlr(ilm_struct *ilm_ptr);
...
extern void vis_send_record_finish_ind(kal_int16 result, kal_int32 line);
extern void vis_send_seek_done_ind(kal_int16 result);
extern void vis_send_play_finish_ind(kal_int16 result, kal_int32 line);
