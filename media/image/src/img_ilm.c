...
void img_send_decode_event_ind(kal_uint8 cause, kal_uint32 arg0, kal_uint32 arg1)
{
    ...
    ilm_ptr = allocate_ilm(MOD_GFXHISR);
    ilm_ptr->src_mod_id = MOD_GFXHISR;
    ilm_ptr->dest_mod_id = MOD_MED;
    ilm_ptr->sap_id = MED_SAP;
...
void img_send_encode_req(module_type src_mod_id, void *data)
{
    ...
    msg_p->expected_encode_size = encode->expected_encode_size;
    ...
    msg_p->input_type = encode->input_type;
    msg_p->background_encode = encode->background_encode;
