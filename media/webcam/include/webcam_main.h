...
typedef enum
{
    ...
    WEBCAM_EVT_ROTATE = 0x0020,
    WEBCAM_EVT_SET_CAMID = 0x0040,
    WEBCAM_EVT_CONNECT = 0x0080,   
}
...
/* msg hander */
extern void webcam_set_camera_id_req_hdlr(ilm_struct *ilm_ptr);
...
extern void webcam_pause_connect_req_hdlr(ilm_struct *ilm_ptr);
extern void webcam_resume_connect_req_hdlr(ilm_struct *ilm_ptr);
...
/* ilm */
extern void webcam_send_set_camera_id_req(module_type src_mod_id, void *data);
...
extern void webcam_send_pause_connect_req(module_type src_mod_id);
extern void webcam_send_resume_connect_req(module_type src_mod_id);
...
extern void webcam_send_usb_pause_connect_req(void);
extern void webcam_send_usb_resume_connect_req(void *data);
