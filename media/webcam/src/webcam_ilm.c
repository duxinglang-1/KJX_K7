 ...
 *  void
 *****************************************************************************/
void webcam_send_set_camera_id_req(module_type src_mod_id, void *data)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    media_webcam_set_camera_id_req_struct *msg_p = NULL;
    ilm_struct *ilm_ptr = NULL;
    
    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    msg_p = (media_webcam_set_camera_id_req_struct*) construct_local_para(sizeof(media_webcam_set_camera_id_req_struct), TD_CTRL);
    
    kal_mem_cpy(
        ((kal_uint8*) msg_p) + sizeof(local_para_struct),
        ((kal_uint8*) data) + sizeof(local_para_struct),
        sizeof(media_webcam_set_camera_id_req_struct) - sizeof(local_para_struct));
    ...
    ilm_ptr->msg_id = (msg_type) MSG_ID_MEDIA_WEBCAM_SET_CAMERA_ID_REQ;
 ...
 *  void
 *****************************************************************************/
void webcam_send_pause_connect_req(module_type src_mod_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    ilm_ptr->msg_id = (msg_type) MSG_ID_MEDIA_WEBCAM_PAUSE_CONNECT_REQ;
...
/*****************************************************************************
 * FUNCTION
 *  webcam_send_resume_connect_req
 * DESCRIPTION
 *  
 * PARAMETERS
 *  data        [?]     
 ...
 *  void
 *****************************************************************************/
void webcam_send_resume_connect_req(module_type src_mod_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    ilm_ptr->msg_id = (msg_type) MSG_ID_MEDIA_WEBCAM_RESUME_CONNECT_REQ;
    ilm_ptr->local_para_ptr = NULL;
    ilm_ptr->peer_buff_ptr = NULL;
 ...
 *  void
 *****************************************************************************/
void webcam_send_usb_pause_connect_req(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    ilm_ptr->msg_id = (msg_type)MSG_ID_MED_USB_DISCONNECT_REQ;
    ilm_ptr->local_para_ptr = NULL;
    ilm_ptr->peer_buff_ptr = NULL;
...
/*****************************************************************************
 * FUNCTION
 *  webcam_send_usb_resume_connect_req
 * DESCRIPTION
 *  
 * PARAMETERS
 *  data        [?]     
 ...
 *  void
 *****************************************************************************/
void webcam_send_usb_resume_connect_req(void *data)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    ilm_ptr->msg_id = (msg_type) MSG_ID_MED_USB_CONNECT_REQ;
    ilm_ptr->local_para_ptr = (local_para_struct*) msg_p;
    ilm_ptr->peer_buff_ptr = NULL;
