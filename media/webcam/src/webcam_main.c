...
void webcam_main(ilm_struct *ilm_ptr)
{
    ...
    {
        case MSG_ID_MEDIA_WEBCAM_SET_CAMERA_ID_REQ:
            webcam_set_camera_id_req_hdlr(ilm_ptr);
            break;
        ...
        case MSG_ID_MEDIA_WEBCAM_ROTATE_REQ:
            ...
            break;
        case MSG_ID_MEDIA_WEBCAM_PAUSE_CONNECT_REQ:
            webcam_pause_connect_req_hdlr(ilm_ptr);
            break;
        case MSG_ID_MEDIA_WEBCAM_RESUME_CONNECT_REQ:
            webcam_resume_connect_req_hdlr(ilm_ptr);
            break;
