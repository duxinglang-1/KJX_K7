...
#ifndef VMCAMERA_H_
#define VMCAMERA_H_
#include "vmcamera_sdk.h"


/*****************************************************************************
 * FUNCTION
 *    vm_camera_get_max_capture_size
 * DESCRIPTION
 *  get camera's max capture size.
 * PARAMETERS
 *  handle : [IN] camera's handle which is created by vm_create_camera_instance.
 *  size : [OUT] max capture size(480*640).
 * RETURNS
 *  get camera's max capture size success or not.
 * RETURN VALUES
