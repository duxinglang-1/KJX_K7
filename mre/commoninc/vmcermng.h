...
MRECert * vm_ce_load_app( VMWSTR filename, VMINT cert_type);
...
VMINT vm_ce_get_app_digest( VMWSTR filename, VMINT* cert_type, VMUCHAR * cache_buf, VMINT cache_len, unsigned char digest[DIG_MAX_LEN] );
