 ...
 * Filename:
 * ---------
 * mre_gameloft_games_gb_package1.c
 *
 * Project:
 * --------
 * MAUI
 ...
 * Description:
 * ------------
 * GameLoft games package1 having all 4 games for global billing system
 * ASPHALT6
 * Brain Challenge
 * Block Breaker
 * Assassin Creed
...
#if defined __MMI_MRE_APP_GAMELOFT_GB_PACKAGE1__
...
#endif /* __MMI_MRE_APP_GAMELOFT_GB_PACKAGE1__ */
