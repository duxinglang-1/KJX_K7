 ...
 * Filename:
 * ---------
 * mre_gameloft_games_gb_package2.c
 *
 * Project:
 * --------
 * MAUI
 ...
 * Description:
 * ------------
 * GameLoft games package2 having following games for global billing system
 * ASPHALT6
 * Brain Challenge
 * Block Breaker
 *
...
#if defined __MMI_MRE_APP_GAMELOFT_GB_PACKAGE2__
...
#include "include\BlockBreaker3_GB_QVGA.h"
...
#include "include\BlockBreaker3_GB_WQVGA.h"
...
#include "include\BlockBreaker3_GB_HVGA.h"
...
#include "include\BlockBreaker3_GB_WVGA.h"
...
#endif /* __MMI_MRE_APP_GAMELOFT_GB_PACKAGE2__ */
