 ...
 * Filename:
 * ---------
 * mre_gameloft_games_gb_package3.c
 *
 * Project:
 * --------
 * MAUI
 ...
 * Description:
 * ------------
 * GameLoft games package3 having following games for global billing system
 * ASPHALT6
 * BlockBreaker
 * Assassin Creed
 *
...
#if defined __MMI_MRE_APP_GAMELOFT_GB_PACKAGE3__
...
#endif /* __MMI_MRE_APP_GAMELOFT_GB_PACKAGE3__ */
