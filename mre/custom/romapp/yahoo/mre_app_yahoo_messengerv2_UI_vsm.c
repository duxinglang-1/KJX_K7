 ...
 * Filename:
 * ---------
 * mre_app_yahoo_messengerv2_UI_vsm.c
 *
 * Project:
 * --------
 * MAUI
...
#define __align(x)
const __align(4) VMUINT8 mre_app_yahoo_messenger_ui_vsm[] = {0x00};
...
#include "include\yahoomessengerv2_normal_ui_vsm.h"

#endif /* normal resolutions */

#if defined (__MMI_MAINLCD_480X800__)

#include "include\yahoomessengerv2_wvga_ui_vsm.h"

#endif /* WVGA resolution */

#if defined (__MMI_MAINLCD_128X160__)

#include "include\yahoomessengerv2_qqvga_ui_vsm.h"
