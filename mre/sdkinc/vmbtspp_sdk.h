...
/*spp connect type*/
typedef enum{
	VM_SRV_SPP_CONNECT_WITH_SCO = 0x01,
	VM_SRV_SPP_CONNECT_WITHOUT_SCO = 0x02
}vm_srv_spp_connect_type;

/*spp return error type*/
typedef enum
{
    VM_BT_SPP_ERR_LOGICAL = -5,
    VM_BT_SPP_ERR_BAD_PARAM,
    VM_BT_SPP_ERR_NO_RESOURCE, 
    VM_BT_SPP_ERR_NOT_SUPPORT,
    VM_BT_SPP_ERR_NO_AUTHORIZATION,
    VM_BT_SPP_ERR_SUCCESS = 0
}vm_btspp_error_t;

/*spp security level*/
typedef enum{
	VM_SRV_SPP_SEC_NAN = 0x00,
	VM_SRV_SPP_SEC_AUTHENTICATION = 0x01,
	VM_SRV_SPP_SEC_AUTHORIZATION = 0x04,
	VM_SRV_SPP_SEC_ENCRYPTION = 0x10,
	VM_SRV_SPP_SEC_ALL = 0xff
}vm_srv_spp_security_level;

/*spp srv for app event enum*/
typedef enum{
	VM_SRV_SPP_EVENT_START = 0x0001,
	VM_SRV_SPP_EVENT_BIND_FAIL = 0x0002,
	VM_SRV_SPP_EVENT_AUTHORIZE = 0x0004,
	VM_SRV_SPP_EVENT_CONNECT = 0x0008,
	VM_SRV_SPP_EVENT_SCO_CONNECT = 0x0010,
	VM_SRV_SPP_EVENT_READY_TO_WRITE = 0x0020,
	VM_SRV_SPP_EVENT_READY_TO_READ = 0x0040,
	VM_SRV_SPP_EVENT_DISCONNECT = 0x0080,
