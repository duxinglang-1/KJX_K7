...
#ifdef __KJX_FUN__	//xb add 2016-12-10	Ä¬ÈÏIMEI´®ºÅ
static kal_uint8 const NVRAM_EF_IMEI_DEFAULT[] = {0x59,0x66,0x08,0x16,0x00,0x00,0x30,0xf3,0x00,0x01};
#endif
...
/* under construction !*/
	...
	#ifdef __KJX_FUN__	//xb add 2016-12-10
