...
S32 cui_inline_convert_type_to_cui(S32 pluto_type)
{
    ...
    switch (pluto_type & 0xFF)
    {
        ...
        {
            item_type = CUI_INLINE_ITEM_TYPE_TIME_PEROID;
            break;
        }
#endif 
#if defined (__MMI_INLINE_ITEM_IP4__)		
...
#if defined (__MMI_INLINE_ITEM_IMAGETEXT__)		
        case CUI_INLINE_ITEM_TYPE_IMAGE_TEXT:
        {
...
#if defined (__MMI_INLINE_ITEM_TIME_PEROID__)		
        case CUI_INLINE_ITEM_TYPE_TIME_PEROID:
        {
            item_type = INLINE_ITEM_TYPE_TIME_PERIOD;
            break;
        }
#endif 
#if defined (__MMI_INLINE_ITEM_IP4__)
                ...
                cui_inline_item_data_union *special_data)
{
        ...
        switch (common_data->flag & 0xFF)
        {
            ...
            case INLINE_ITEM_IMAGE_TEXT_TYPE:
            {
                cui_inline_image_text_struct *p_data = (cui_inline_image_text_struct*) special_data;
                ...
                SetInlineImageTextPenHandler(
                    &wgui_inline_items[index],
                    cui_inline_evt_item_image_text_pen_down_0,
                    cui_inline_evt_item_image_text_pen_down_0);
            ...
            {
            #if defined (__MMI_INLINE_ITEM_TIME_PEROID__)
                cui_inline_time_period_struct *p_data = (cui_inline_time_period_struct*) special_data;

                ReConfigureInlineItemTimePeriod(
                    &wgui_inline_items[index],
                    (PU8) &p_data->time_data1->hour_buffer[0],
                    (PU8) &p_data->time_data1->minute_buffer[0],
                    (PU8) &(p_data->time_data1->am_pm_flag),
                    (PU8) &p_data->time_data2->hour_buffer[0],
                    (PU8) &p_data->time_data2->minute_buffer[0],
                    (PU8) & (p_data->time_data2->am_pm_flag),
                    cui_inline_format_time_period);
 ...
 *  void
 *****************************************************************************/
void cui_inline_format_time_period(
        U8 *string_buffer,
        U8 *hour1,
        U8 *min1,
        U8 *am_pm_flag1,
...
void cui_inline_set_item_convert_app_to_cui(mmi_id gid, U16 item_id, const cui_inline_set_item_struct *app_item)
{
    ...
    switch (app_item->item_flag & 0xff)
    {
        ...
        case CUI_INLINE_ITEM_TYPE_IMAGE_TEXT:
        {
            cui_inline_item_image_text_struct *item_data;
            cui_inline_set_item_image_text_struct temp_cui_data;

            item_data = (cui_inline_item_image_text_struct*) (app_item->item_data);
            temp_cui_data.buffer = (PU8) get_string(item_data->string_id);
            temp_cui_data.buffer_size = item_data->buffer_size;
            temp_cui_data.image1 = (PU8) GetImage(item_data->image1_id);
            temp_cui_data.image2 = (PU8) GetImage(item_data->image2_id);
            temp_cui_data.image3 = (PU8) GetImage(item_data->image3_id);
            temp_cui_data.input_type = item_data->input_type;
            temp_cui_data.title = item_data->title;
            temp_cui_data.title_icon = item_data->title_icon;
            cui_inline_set_item_image_text(gid, item_id, &temp_cui_data);
            break;
        }
#endif /* defined (__MMI_INLINE_ITEM_IMAGETEXT__) */ 		
        case CUI_INLINE_ITEM_TYPE_DATE:
        ...
        case CUI_INLINE_ITEM_TYPE_TIME_PEROID:
        {
            cui_inline_item_time_period_struct *item_data;
            cui_inline_set_item_time_period_struct temp_cui_data = {0};
            item_data = (cui_inline_item_time_period_struct*) (app_item->item_data);
            if (item_data != NULL)
            {
                temp_cui_data.date_time1 = item_data->date_time1;
                temp_cui_data.date_time2 = item_data->date_time2;
                temp_cui_data.date_format = item_data->date_format;
            }
            cui_inline_set_item_time_period(gid, item_id, &temp_cui_data);
            break;
        }
#endif /* defined (__MMI_INLINE_ITEM_TIME_PEROID__) */ 		
        case CUI_INLINE_ITEM_TYPE_IP4:
...
void cui_inline_delete_item_data(cui_inline_item_struct *item_data)
{
    ...
    switch (common_data->flag & 0xff)
    {
        ...
        {
        #if defined (__MMI_INLINE_ITEM_IMAGETEXT__)
            cui_inline_image_text_struct *special_data = (cui_inline_image_text_struct*) & (item_data->special_data);
        ...
        {
        #if defined (__MMI_INLINE_ITEM_TIME_PEROID__)
            cui_inline_time_period_struct *special_data = (cui_inline_time_period_struct*) & (item_data->special_data);

            cui_inline_free_date_time_buffer(special_data->time_data1);
            cui_inline_free_date_time_buffer(special_data->time_data2);
            special_data->time_data1 = NULL;
            special_data->time_data2 = NULL;
        #endif /* defined (__MMI_INLINE_ITEM_TIME_PEROID__) */ 
            break;
        }
        case INLINE_ITEM_TYPE_IP4_EDIT:
    ...
    if ((operation == CUI_INLINE_SET_ATTRIBUTE))
    {
        ...
        if (cui_inline_is_edit_main_screen(p_instance->gid))
        {
			...
			if (flag & CUI_INLINE_ITEM_YEAR_ONLY)
			{
			    ...
			    SetInlineItemYearOnly(&(wgui_inline_items[index]));
...
void cui_inline_entry_screen_ext(mmi_scrn_essential_struct *scrn_data)
{
         ...
         MMI_FRM_FULL_SCRN))
    {
        ...
        Category57AppendTopInfoBox( p_instance->info_box_draw.num_of_info_box_rows,
                                    p_instance->info_box_draw.draw_info_callback,
                                    p_instance->info_box_draw.hide_info_callback,
                                    p_instance->info_box_draw.is_draw_once);
#endif
...
/*****************************************************************************
 * FUNCTION
 *  cui_inline_set_item_image_text
 * DESCRIPTION
 *  
 * PARAMETERS
 *  gid                 [IN]        
...
void cui_inline_set_item_image_text(mmi_id gid, U16 item_id, cui_inline_set_item_image_text_struct *imagetext_attr)
{
    ...
    /*----------------------------------------------------------------*/
    U16 index = 0;
    cui_inline_image_text_struct *imagetxt_data = NULL;
    cui_inline_item_common_data_struct *common_data = NULL;
    cui_inline_instance_struct *inline_instance = (cui_inline_instance_struct*) mmi_frm_group_get_user_data(gid);
    ...
    /* get instance pointer; */
    imagetxt_data = (cui_inline_image_text_struct*) & (inline_instance->cui_inline_items[index].special_data);
    common_data = (cui_inline_item_common_data_struct*) & (inline_instance->cui_inline_items[index].common_data);

    /* set instance value; */
    cui_inline_set_item_type(common_data, INLINE_ITEM_IMAGE_TEXT_TYPE);
    cui_inline_set_item_default_activation(CUI_INLINE_ITEM_TYPE_IMAGE_TEXT, common_data);

    imagetxt_data->buffer_size = imagetext_attr->buffer_size;
    imagetxt_data->input_type = imagetext_attr->input_type;
    imagetxt_data->title = imagetext_attr->title;
    imagetxt_data->title_icon = imagetext_attr->title_icon;
    imagetxt_data->image1 = imagetext_attr->image1;
    imagetxt_data->image2 = imagetext_attr->image2;
    imagetxt_data->image3 = imagetext_attr->image3;
    imagetxt_data->ucs2_count = -1;
    cui_inline_set_text_buffer(
        &(imagetxt_data->buffer),
        imagetext_attr->buffer,
        &(imagetxt_data->memory_mode),
        imagetext_attr->buffer_size);

    if (cui_inline_is_edit_main_screen(inline_instance->gid))
    {
        cui_inline_set_item_to_pluto_inline(index, common_data, (cui_inline_item_data_union*) imagetxt_data);
        cui_inline_redraw_item(gid, index);
    }
...
/*****************************************************************************
 * FUNCTION
 *  cui_inline_set_item_time_period
 * DESCRIPTION
 *  
 * PARAMETERS
 *  gid             [IN]        
...
void cui_inline_set_item_time_period(mmi_id gid, U16 item_id, cui_inline_set_item_time_period_struct *time_attr)
{
    ...
    /*----------------------------------------------------------------*/
    U16 index = 0;
    cui_inline_time_period_struct *time_period_data = NULL;
    cui_inline_item_common_data_struct *common_data = NULL;
    cui_inline_instance_struct *inline_instance = (cui_inline_instance_struct*) mmi_frm_group_get_user_data(gid);
    ...
    /* get instance pointer; */
    time_period_data = (cui_inline_time_period_struct*) & (inline_instance->cui_inline_items[index].special_data);
    common_data = (cui_inline_item_common_data_struct*) & (inline_instance->cui_inline_items[index].common_data);

    cui_inline_set_item_type(common_data, INLINE_ITEM_TYPE_TIME_PERIOD);
    cui_inline_set_item_default_activation(CUI_INLINE_ITEM_TYPE_TIME_PEROID, common_data);

    if (time_period_data->time_data1 != NULL)
    {
        cui_inline_free_date_time_buffer((void*)time_period_data->time_data1);
    }
    if (time_period_data->time_data2 != NULL)
    {
        cui_inline_free_date_time_buffer((void*)time_period_data->time_data2);
    }
    time_period_data->time_data1 = cui_inline_malloc_time_date_buffer();
    time_period_data->time_data2 = cui_inline_malloc_time_date_buffer();
    MMI_ASSERT((time_period_data->time_data1 != NULL) && (time_period_data->time_data2 != NULL));
    {
        kal_wsprintf((kal_wchar*)time_period_data->time_data1->hour_buffer, "%02d", time_attr->date_time1.hour);
        kal_wsprintf((kal_wchar*)time_period_data->time_data1->minute_buffer, "%02d", time_attr->date_time1.minute);
        kal_wsprintf((kal_wchar*)time_period_data->time_data1->second_buffer, "%02d", time_attr->date_time1.second);
        
        //app_ucs2_itow(time_attr->date_time1.hour, time_period_data->time_data1->hour_buffer, 10);
       // app_ucs2_itow(time_attr->date_time1.minute, time_period_data->time_data1->minute_buffer, 10);
        //app_ucs2_itow(time_attr->date_time1.second, time_period_data->time_data1->second_buffer, 10);
        time_period_data->time_data1->am_pm_flag = time_attr->date_format;

        kal_wsprintf((kal_wchar*)time_period_data->time_data2->hour_buffer, "%02d", time_attr->date_time2.hour);
        kal_wsprintf((kal_wchar*)time_period_data->time_data2->minute_buffer, "%02d", time_attr->date_time2.minute);
        kal_wsprintf((kal_wchar*)time_period_data->time_data2->second_buffer, "%02d", time_attr->date_time2.second);
        
        //app_ucs2_itow(time_attr->date_time2.hour, time_period_data->time_data2->hour_buffer, 10);
        //app_ucs2_itow(time_attr->date_time2.minute, time_period_data->time_data2->minute_buffer, 10);
        //app_ucs2_itow(time_attr->date_time2.second, time_period_data->time_data2->second_buffer, 10);
    }

    if (cui_inline_is_edit_main_screen(inline_instance->gid))
    {
        //cui_inline_set_item_to_pluto_inline(index, common_data, (cui_inline_item_data_union*) time_period_data);
        cui_inline_reconfig_item_to_pluto_inline(index, common_data, (cui_inline_item_data_union*) time_period_data);
        cui_inline_redraw_item(gid, index);
    }
...
S32 cui_inline_set_value(mmi_id gid, U16 item_id, void *value)
{
    ...
    switch (common_data->flag & 0xff)
    {
        ...
        case INLINE_ITEM_IMAGE_TEXT_TYPE:
        {
            cui_inline_image_text_struct *imagetxt_data =
                (cui_inline_image_text_struct*) & (inline_instance->cui_inline_items[index].special_data);
            cui_inline_set_item_image_text_struct item_data;

            item_data.buffer = (U8*) value;
            item_data.buffer_size = imagetxt_data->buffer_size;
            item_data.image1 = imagetxt_data->image1;
            item_data.image2 = imagetxt_data->image2;
            item_data.image3 = imagetxt_data->image3;
            item_data.input_type = imagetxt_data->input_type;
            item_data.title = imagetxt_data->title;
            item_data.title_icon = imagetxt_data->title_icon;
            cui_inline_set_item_image_text(gid, item_id, &item_data);
            break;
        }
 #endif /* defined (__MMI_INLINE_ITEM_IMAGETEXT__) */ 		
        case INLINE_ITEM_TYPE_DATE:
        ...
        case INLINE_ITEM_TYPE_TIME_PERIOD:
        {
            cui_inline_set_item_time_period(gid, item_id, (cui_inline_set_item_time_period_struct*) value);
            break;
        }
#endif 	
#if defined (__MMI_INLINE_ITEM_IP4__)
...
S32 cui_inline_get_value(mmi_id gid, U16 item_id, void *value)
{
    ...
    switch (common_data->flag & 0xff)
    {
        ...
        case INLINE_ITEM_IMAGE_TEXT_TYPE:
        {
            ...
            cui_inline_image_text_struct *imagetxt_data =
                (cui_inline_image_text_struct*) & (inline_instance->cui_inline_items[index].special_data);
            mmi_ucs2cpy((S8*) return_buf, (S8*) (imagetxt_data->buffer));
            break;
        }
#endif /* defined (__MMI_INLINE_ITEM_IMAGETEXT__) */ 		
        case INLINE_ITEM_TYPE_DATE:
        ...
        case INLINE_ITEM_TYPE_TIME_PERIOD:
        {
            cui_inline_item_time_period_struct *return_buf = (cui_inline_item_time_period_struct*) value;
            cui_inline_time_period_struct *item_data =
                (cui_inline_time_period_struct*) & (inline_instance->cui_inline_items[index].special_data);
            return_buf->date_time1.hour = app_ucs2_wtoi(item_data->time_data1->hour_buffer);
            return_buf->date_time1.minute = app_ucs2_wtoi(item_data->time_data1->minute_buffer);
            return_buf->date_format = item_data->time_data1->am_pm_flag;
            return_buf->date_time2.hour = app_ucs2_wtoi(item_data->time_data2->hour_buffer);
            return_buf->date_time2.minute = app_ucs2_wtoi(item_data->time_data2->minute_buffer);        
            break;
        }
#endif /* defined (__MMI_INLINE_ITEM_TIME_PEROID__) */ 		
        case INLINE_ITEM_TYPE_IP4_EDIT:
...
S32 cui_inline_set_text_len(mmi_id gid, U16 item_id, U32 len)
{
    ...
    switch (common_data->flag & 0xff)
    {
        ...
        case INLINE_ITEM_IMAGE_TEXT_TYPE:
        {
            ...
            if ((len * 2) > (CUI_INLINE_TEXT_BUFFER_SIZE))
            {
                item_data.buffer = imagetxt_data->buffer;
            }
            else
            {
                item_data.buffer = NULL;
...
U32 cui_inline_get_text_len(mmi_id gid, U16 item_id)
{
    ...
    switch (common_data->flag & 0xff)
    {
        ...
        case INLINE_ITEM_IMAGE_TEXT_TYPE:
        {
            cui_inline_image_text_struct *imagetxt_data =
                (cui_inline_image_text_struct*) & (inline_instance->cui_inline_items[index].special_data);
            return imagetxt_data->buffer_size;
...
void cui_inline_item_replace_gui_buffer(S32 index, wgui_inline_item *inline_item, PU8 *history_buffer)
{
        ...
        g_cui_inline_current_instance->cui_inline_items[index].common_data.item_id)
    {
        switch ((inline_item->flags) & 0xff)
        {
            ...
            {
            #if defined (__MMI_INLINE_ITEM_TIME_PEROID__)
                cui_inline_time_period_struct *p_data;

                p_data =
                    (cui_inline_time_period_struct*) & (g_cui_inline_current_instance->cui_inline_items[index].
                                                         special_data);
                if (p_data->invalid_gui_buffer == 0)
                {
                    inline_time_period_edit_set_history(INLINE_TIME_PERIOD_HISTORY_ID, *history_buffer);
                }
                wgui_inline_time_period_input.input.flags = p_data->wgui_flag_attr;
            #endif /* defined (__MMI_INLINE_ITEM_TIME_PEROID__) */ 
                break;
            }
            case INLINE_ITEM_TYPE_IP4_EDIT:
            ...
            case INLINE_ITEM_IMAGE_TEXT_TYPE:
            {
                cui_inline_image_text_struct *p_data;

                p_data =
                    (cui_inline_image_text_struct*) & (g_cui_inline_current_instance->cui_inline_items[index].
                                                        special_data);
                /* inline_image_text_edit_flag = p_data->is_open; */
                if (p_data->invalid_gui_buffer == 0)
                {
                    inline_image_text_set_history(INLINE_IMAGE_TEXT_HISTORY_ID, *history_buffer);
                }
                break;
            }
#endif /* defined (__MMI_INLINE_ITEM_IMAGETEXT__) */ 			
...
void cui_inline_evt_item_image_text_pen_down_0(void)
{
    ...
    // cui_event_inline_image_text_pen_down_struct image_text_stru = {0};
    //image_text_stru.image_index = image_index;
    MMI_FRM_INIT_GROUP_EVENT(&evt, EVT_ID_CUI_INLINE_NOTIFY, p_instance->gid);
    evt.event_type = CUI_INLINE_NOTIFY_IMAGE_TEXT_PEN_DOWN;
    evt.item_id = p_instance->cui_inline_items[p_instance->highlight_item].common_data.item_id;
    evt.param = 0;
    mmi_frm_group_send_to_parent(p_instance->gid, (mmi_group_event_struct*) & evt);
}
...
/*****************************************************************************
 * FUNCTION
 *  cui_inline_evt_item_image_text_pen_down_1
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
