 ...
 *==============================================================================
 *******************************************************************************/
#ifndef __SMS_PROT_CUI_H__
#define __SMS_PROT_CUI_H__
...
}cui_sms_address_type_enum;

typedef struct
{
    mmi_id editor_gid;
    U16 phone_number_title_id;
    SmsFullEditFuncPtr phone_number_done_func;
    MMI_BOOL phone_number_search_flag;
    cui_sms_address_type_enum phone_number_addr_type;
    U16 phone_number_max_addr_len;
    S8 *phone_number_buff;
    MMI_BOOL is_refresh_scrn;
} cui_sms_edit_phone_number_struct;


#endif /* __SMS_PROT_CUI_H__ */ 
