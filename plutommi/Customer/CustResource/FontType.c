...
stFontAttribute		MMI_virtual_keyboard_hint_font=			{	0,0,0,VIRTUAL_KEYBOARD_LARGE_FONT,0,1	};
#else
stFontAttribute		MMI_virtual_keyboard_hint_font=			{	0,0,0,MEDIUM_FONT,0,1	};
#endif
