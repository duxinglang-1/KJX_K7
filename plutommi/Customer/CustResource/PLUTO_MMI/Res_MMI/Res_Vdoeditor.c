...
void PopulateVdoEdtStrRes(void)
{
    ...
    ADD_APPLICATION_STRING2(STR_ID_VDOEDT_PLZ_INS_VDO, "Insert Video", "[empty preview screen string]");
    ...
    ADD_APPLICATION_STRING2(STR_ID_VDOEDT_NO_FRAME, "No Frame", "frame string");
    ADD_APPLICATION_STRING2(STR_ID_VDOEDT_FRAME1, "Frame 1", "frame 1 string");
    ADD_APPLICATION_STRING2(STR_ID_VDOEDT_FRAME2, "Frame 2", "frame 2 string");
    ADD_APPLICATION_STRING2(STR_ID_VDOEDT_FRAME3, "Frame 3", "frame 3 string");
    ADD_APPLICATION_STRING2(STR_ID_VDOEDT_FRAME4, "Frame 4", "frame 4 string");
    ADD_APPLICATION_STRING2(STR_ID_VDOEDT_FRAME5, "Frame 5", "frame 5 string");
    ADD_APPLICATION_STRING2(STR_ID_VDOEDT_NEW_W7E_CNF, "New workspace?", "notify - create new workspace");
    ADD_APPLICATION_STRING2(STR_ID_VDOEDT_CANCELED, "Canceled", "notify - cancel saving operation");
    ADD_APPLICATION_STRING2(STR_ID_VDOEDT_EDIT_FILENAME, "Edit filename", "title - Edit filename");
}
...
#ifndef __MMI_MAINLCD_176X220__
...
#endif /* ifndef __MMI_MAINLCD_176X220__ */
...
//                              SHOW,NONMOVEABLE,1,STR_GLOBAL_PREVIEW,0));
...
//                              SHOW,NONMOVEABLE,1,STR_GLOBAL_SAVE,0));
    ...
    ADD_APPLICATION_MENUITEM((MENU_ID_VDOEDT_AUD_PLAY, MENU_ID_VDOEDT_AUD_OPTION,0,
                                SHOW,NONMOVEABLE,1,STR_GLOBAL_PLAY,0));
 ...
 *  void
 *****************************************************************************/
void PopulateVdoEdtHilightHdlr(void)
{
        /* main menu */
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_APP, mmi_vdoedt_hilight_app);
    /* edit */
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_SAVE, mmi_vdoedt_hilight_save);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_NEW_W7E, mmi_vdoedt_hilight_new_w7e);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_INS_VDO, mmi_vdoedt_hilight_ins_vdo);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_INS_IMG, mmi_vdoedt_hilight_ins_img);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_REMOVE, mmi_vdoedt_hilight_remove);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_EFFECT, mmi_vdoedt_hilight_effect);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_CUT_VDO, mmi_vdoedt_hilight_cut_vdo);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_SET_DUR, mmi_vdoedt_hilight_set_dur);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_FRAME, mmi_vdoedt_hilight_edt_frame);
    /* frame */
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_FRAME_SEL, mmi_vdoedt_hilight_frame_sel);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_FRAME_CLEAR, mmi_vdoedt_hilight_frame_clear);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_FRAME_TXT, mmi_vdoedt_hilight_frame_text);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_FRAME_EDT, mmi_vdoedt_hilight_frame_edit);
    /* insert image */
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_INS_IMG_FROM_FILE, mmi_vdoedt_hilight_img_ins_file);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_INS_IMG_LAST_FRAME, mmi_vdoedt_hilight_img_ins_last_frame);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_INS_IMG_FIRST_FRAME, mmi_vdoedt_hilight_img_ins_first_frame);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_INS_IMG_COLOR, mmi_vdoedt_hilight_img_ins_color);
    /* filename editor option */
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_DONE, mmi_vdoedt_hilight_text_edit_done);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_CANCEL, mmi_vdoedt_hilight_text_edit_cancel);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_INPUT_METHOD, mmi_vdoedt_hilight_text_sel_inp_method);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_TEXT_E4R_DONE, mmi_vdoedt_hilight_text_edit_done);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_TEXT_E4R_CANCEL, mmi_vdoedt_hilight_text_edit_cancel);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_VDOEDT_TEXT_E4R_INPUT_METHOD, mmi_vdoedt_hilight_text_sel_inp_method);
}
