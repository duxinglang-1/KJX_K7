...
*****************************************************************************/
	...
	barcodereader_osd_layeout_struct g_barcodereader_osd_cntx =
	{
		...
		/****** softkey layer ******/
		{FALSE,
		 {255,255,255,0,0,0,MMI_BARCODEREADER_TEXT_STYLE_BORDER}, 	/* lsk */
		 {255,255,255,0,0,0,MMI_BARCODEREADER_TEXT_STYLE_BORDER}},	/* rsk */
		/****** preview wnd ******/
...
/* under construction !*/
		...
		{TRUE,0,110,240,70,
    #endif
		 {255,255,255,0,0,0,MMI_BARCODEREADER_TEXT_STYLE_BORDER}},		
		/****** remain storage ******/
		{TRUE,TRUE,136,7,
		 {255,255,255,0,0,0,MMI_BARCODEREADER_TEXT_STYLE_BORDER}}
	};
...
*****************************************************************************/
	...
	barcodereader_osd_layeout_struct g_barcodereader_osd_cntx =
	{
		...
		{TRUE,5,40},		/* zoom_inc */			
		{TRUE,5,153},		/* zoom_dec */
		{TRUE,169,314},	    /* storage */
		{TRUE,20,314},		/* focus_mode */
		{TRUE,5,188},		/* zoom_mf_toggle */
		{TRUE,105,373},	/* capture */
		/****** hint box ******/
#ifdef __MMI_OP11_BARCODEREADER__
/* under construction !*/
#else
...
*****************************************************************************/
	...
	barcodereader_osd_layeout_struct g_barcodereader_osd_cntx =
	{
		...
		{TRUE,5,40},		/* zoom_inc ??*/			
		{TRUE,5,153},		/* zoom_dec ??*/
		{TRUE,230,375},	    /* storage */
		{TRUE,33,375},		/* focus_mode */
		{FALSE,0, 0},		/* zoom_mf_toggle */
		{TRUE,147,450},	/* capture */
		/****** hint box ******/
    #ifdef __MMI_OP11_BARCODEREADER__
/* under construction !*/
    #else
...
*****************************************************************************/
	...
	camera_osd_layeout_struct g_camera_osd_cntx =
	{
		...
		/****** softkey layer ******/
		{FALSE,
		 {255,255,255,0,0,0,CAMERA_TEXT_STYLE_BORDER}, 	/* lsk */
		 {255,255,255,0,0,0,CAMERA_TEXT_STYLE_BORDER}},	/* rsk */
		/****** preview wnd ******/
		{0,0,128,128},
		/****** status icons ******/
		{FALSE,0,0},		/* flash */
