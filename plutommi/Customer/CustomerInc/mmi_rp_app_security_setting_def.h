...
typedef enum
{
    MENU_ID_SECSET_MAIN_MENU = 34407 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_SECSET_APP_NAME = 34407 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_SECSET = 34407 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    IMG_SECSET_MENU_ENTRY = 34407 + 1, /* BASE_ID + 1 */
