...
typedef enum
{
    MENU_ID_VCARD_RECV_OPTION_TO_SIM = 45618 + 1, /* BASE_ID + 1 */
    MENU_ID_VCARD_RECV_OPTION_TO_PHONE,
    MENU_ID_VCARD_RECV_OPTION_FMGR,
    MENU_ID_VCARD_RECV_OPTION,
    MMI_RP_SRV_VCARD_MENU_MAX
}mmi_rp_srv_vcard_menu_enum;
...
typedef enum
{
    SCR_ID_VCARD_FORWARD_OPTION = 45618 + 1, /* BASE_ID + 1 */
    ...
    GRP_ID_VCARD_RECEVE,
    GRP_ID_VCARD_END,
    GRP_ID_VCARD_ENUM_TOTAL,
    MMI_RP_SRV_VCARD_SCR_MAX
}mmi_rp_srv_vcard_scr_enum;
