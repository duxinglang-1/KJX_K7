...
int main(int argc, char* argv[])
{
    ...
    AddFont(
     ...
     AddFont(
        ...
        MCT_MEDIUM_FONT | MCT_LARGE_FONT, 0, 0);
#else
#ifdef __KJX_FUN__	//xb add 2018-04-27 中英文在一个字库文件里面
	AddFont(
		("English"), ("*#0044#"), ("en-US"), 
		FONT_DATA_FILE_PATH(Chinese\\jp_en042600.bdf),
   ...
   // AddFont(
    ...
    //    MCT_DIALER_FONT,  0, 0);
	  ...
	  AddFont(
		   ("English"), ("*#0044#"), ("en-US"), 
		   FONT_DATA_FILE_PATH(Latin\\latin14.bdf),
		   MCT_SMALL_FONT | MCT_SUBLCD_FONT, 0, 0);
	  AddFont(
		  ("English"), ("*#0044#"), ("en-US"), 
		  FONT_DATA_FILE_PATH(Latin\\latin14.bdf),
...
/* No such bdf file now. */
    ...
    AddFont(
        ("Korean"), ("*#0082#"), ("ko"), 
        FONT_DATA_FILE_PATH(Korean\\KORE_14.bdf),
        MCT_SMALL_FONT, 
        1, 0);
    AddFont(
        ("Korean"), ("*#0082#"), ("ko"), 
    ...
    AddFont(
        ("Japanese"), ("*#0081#"), ("jp"), 
        FONT_DATA_FILE_PATH(Japanese\\jp_14.bdf),
        MCT_SMALL_FONT, 
        1, 0);
    AddFont(
        ("Japanese"), ("*#0081#"), ("jp"), 
...
/* Thai language */
    ...
    AddFont(
        ("Russian"), ("*#0007#"), ("ru-RU"), 
        FONT_DATA_FILE_PATH(Russian\\russ_14.bdf),
...
/* Chinese  */
    ...
    AddFont(
        ("Chinesec"), ("*#0086#"), ("zh-CN"), 
        FONT_DATA_FILE_PATH(Chinese\\GB2312_CN_EN.bdf),
        MCT_SMALL_FONT | MCT_MEDIUM_FONT | MCT_LARGE_FONT | MCT_SUBLCD_FONT |MCT_DIALER_FONT , 
        1, 0);
#endif
