...
(color*)&calendar_more_task_color_defaultTheme,
...
(PU8)inilne_item_select_left_arrow_normal_image,
/*inline_edit_right_arrow_image*/
(PU8)inilne_item_select_right_arrow_normal_image,
...
(color*)&calendar_title_text_for_idle_venus_DefaultTheme,
#else
...
#ifdef __MMI_VUI_HOMESCREEN__
(color*)&calendar_cell_valid_text_for_idle_venus_DefaultTheme,
#else
(color*)&calendar_cell_valid_text_for_idle_color_defaultTheme,
#endif
/*calendar_cell_invalid_text_for_idle_color*/
#ifdef __MMI_VUI_HOMESCREEN__
(color*)&calendar_cell_invalid_text_for_idle_venus_DefaultTheme,
#else
...
#ifdef __MMI_VUI_HOMESCREEN__
(color*)&calendar_cell_current_text_for_idle_venus_DefaultTheme,
#else
...
(PU8)img_dialing_screen_bg_image_defaultTheme,
/*dialing_screen_skey_up_image*/
(PU8)img_dialing_screen_skey_up_image_defaultTheme,
/*dialing_screen_skey_down_image*/
(PU8)img_dialing_screen_skey_down_image_defaultTheme,
/*dialing_screen_lkey_up_image*/
(PU8)img_dialing_screen_lkey_up_image_defaultTheme,
/*dialing_screen_lkey_down_image*/
(PU8)img_dialing_screen_lkey_down_image_defaultTheme,
...
(PU8)img_CM_screen_popup_bkg_image_defaultTheme,
...
#ifdef __MMI_VUI_HOMESCREEN__
(PU8)img_calendar_idle_bg_image_venus_defaultTheme,
#else
(PU8)img_calendar_idle_bg_image_defaultTheme,
#endif
#else
(PU8)NULL,
#endif
...
(PU8)img_dialing_screen_lkey_disable_image_defaultTheme,
...
(UI_filled_area*)&inline_datatime_focussed_filler_defaultTheme,
/*inline_datatime_unfocussed_filler*/
(UI_filled_area*)&inline_datatime_unfocussed_filler_defaultTheme,
...
(PU8)img_uce_left_arrow_normal_defaultTheme,
/* the disabled image of pre button in UCE screen */
(PU8)img_uce_left_arrow_disable_defaultTheme,
/* the image of next button in UCE screen */
(PU8)img_uce_right_arrow_normal_defaultTheme,
/* the disabled image of next button in UCE screen */
(PU8)img_uce_right_arrow_disable_defaultTheme,
...
(PU8)&gui_virtual_keyboard_normal_popup_background,
...
(PU8)inilne_item_select_left_arrow_push_image,
/* inilne_item_select_right_arrow_push_image */
(PU8)inilne_item_select_right_arrow_push_image,
/* ime_cand_background_small */
(PU8)img_ime_normal_background_small,
/* ime_cand_background_medium */
(PU8)img_ime_normal_background_medium,
/* ime_cand_background_large */
(PU8)img_ime_normal_background_large,
/* ime_cand_focus_frame_small */
(PU8)img_ime_highlight_background_small,
/* ime_cand_focus_frame_medium */
(PU8)img_ime_highlight_background_medium,
/* ime_cand_focus_frame_large */
(PU8)img_ime_highlight_background_large,
/* ime_cand_separator_small */
(PU8)img_ime_separator_small,
/* ime_cand_separator_medium */
(PU8)img_ime_separator_medium,
/* ime_cand_separator_large */
(PU8)img_ime_separator_large,
/* ime_cand_left_arrow_down_small */
(PU8)img_ime_left_pressed_arrow_small,
/* ime_cand_left_arrow_down_medium */
(PU8)img_ime_left_pressed_arrow_medium,
/* ime_cand_left_arrow_down_large */
(PU8)img_ime_left_pressed_arrow_large,
/* ime_cand_left_arrow_up_small */
(PU8)img_ime_left_normal_arrow_small,
/* ime_cand_left_arrow_up_medium */
(PU8)img_ime_left_normal_arrow_medium,
/* ime_cand_left_arrow_up_large */
(PU8)img_ime_left_normal_arrow_large,
/* ime_cand_left_arrow_disable_small */
(PU8)img_ime_left_disabled_arrow_small,
/* ime_cand_left_arrow_disable_medium */
(PU8)img_ime_left_disabled_arrow_medium,
/* ime_cand_left_arrow_disable_large */
(PU8)img_ime_left_disabled_arrow_large,
/* ime_cand_right_arrow_down_small */
(PU8)img_ime_right_pressed_arrow_small,
/* ime_cand_right_arrow_down_medium */
(PU8)img_ime_right_pressed_arrow_medium,
/* ime_cand_right_arrow_down_large */
(PU8)img_ime_right_pressed_arrow_large,
/* ime_cand_right_arrow_up_small */
(PU8)img_ime_right_normal_arrow_small,
/* ime_cand_right_arrow_up_medium */
(PU8)img_ime_right_normal_arrow_medium,
/* ime_cand_right_arrow_up_large */
(PU8)img_ime_right_normal_arrow_large,
/* ime_cand_right_arrow_disable_small */
(PU8)img_ime_right_disabled_arrow_small,
/* ime_cand_right_arrow_disable_medium */
(PU8)img_ime_right_disabled_arrow_medium,
/* ime_cand_right_arrow_disable_large */
(PU8)img_ime_right_disabled_arrow_large,
/* ime_cand_highlight_small */
(PU8)img_ime_focused_highlight_background_small,
/* ime_cand_highlight_medium */
(PU8)img_ime_focused_highlight_background_medium,
/* ime_cand_highlight_large */
(PU8)img_ime_focused_highlight_background_large,
/* ime_cand_dull_highlight_small */
(PU8)img_ime_unfocused_highlight_background_small,
/* ime_cand_dull_highlight_medium */
(PU8)img_ime_unfocused_highlight_background_medium,
/* ime_cand_dull_highlight_large */
(PU8)img_ime_unfocused_highlight_background_large,
/* ime_input_background_small */
(PU8)img_ime_input_box_background_small,
/* ime_input_background_medium */
(PU8)img_ime_input_box_background_medium,
/* ime_input_background_large */
(PU8)img_ime_input_box_background_large,

/* thin vertical scrollbar image */
(PU8)img_scrollbar_v_scroll_button_defaultTheme,
/* thin horizontal scrollbar image */
(PU8)img_scrollbar_h_scroll_button_defaultTheme,
...
(PU8)img_wider_scrollbar_v_background_button_defaultTheme,
/* wider vertical scrollbar scroll button image */
(PU8)img_wider_scrollbar_v_scroll_button_defaultTheme,
/* wider vertical scrollbar scroll clicked button image */
(PU8)img_wider_scrollbar_v_scroll_clicked_button_defaultTheme,
...
(PU8)img_wider_scrollbar_h_background_button_defaultTheme,
/* wider horizontal scrollbar scroll button image */
(PU8)img_wider_scrollbar_h_scroll_button_defaultTheme,
/* wider horizontal scrollbar scroll clicked button image */
(PU8)img_wider_scrollbar_h_scroll_clicked_button_defaultTheme,


/* slide bar background image */
(PU8)img_slide_bar_normal_bg_defaultTheme,
/* slide bar indicator image */
(PU8)img_slide_bar_normal_indicator_defaultTheme,

/* tab bar left button image */
(PU8)img_tab_bar_left_indicator_defaultTheme,
/* tab bar right button image */
(PU8)img_tab_bar_right_indicator_defaultTheme,

/* inputbox_default_text_color */
(color*)&input_box_default_text_color,
...
(PU8)ccp_fm_down_arrow_n,
/* clipboard_floating_menu_arrow_button_pressed_bg */
(PU8)ccp_fm_down_arrow_h,
/* clipboard_floating_menu_text_color */
(color*)&ccp_fm_menu_text_color,
/* inputbox_remaining_counter_bg */
(PU8)img_remaining_counter_bg_defaultTheme,
...
(PU8)img_slide_bar_focused_bg_defaultTheme,
/* slide_bar_focused_indicator_image */
(PU8)img_slide_bar_focused_indicator_defaultTheme,
/* horizontal_select_bg_filler */
(UI_filled_area*)&horizontal_select_background_defaultTheme,
/* horizontal_select_focused_bg_filler */
(UI_filled_area*)&horizontal_select_focused_background_defaultTheme,
...
(UI_filled_area*)&inline_item_button_highlight_down_filler,
/* inline_item_button_highlighted_normal_bg_filler */
(UI_filled_area*)&inline_item_button_highlight_up_filler,
/* inline_item_button_unhighlighted_pressed_bg_filler */
(UI_filled_area*)&inline_item_button_normal_down_filler,
/* inline_item_button_unhighlighted_normal_bg_filler */
(UI_filled_area*)&inline_item_button_normal_up_filler,
