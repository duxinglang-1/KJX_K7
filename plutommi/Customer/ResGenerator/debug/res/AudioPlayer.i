...
# 56 "temp/res/AudioPlayer.c"
    <IMAGE id="IMG_ID_AUDPLY_PLAY_ANIMATION">"..\\\\..\\\\Customer\\\\Images\\\\PLUTO""\\\\MainLCD\\\\AudioPlayer\\\\PLAY\\\\AP_PLAY_ANIMATION.gif"</IMAGE>

        <SCREEN id="SCR_ID_AUDPLY_BASE"/>
        <SCREEN id="SCR_ID_AUDPLY_PLAY_ANIMATION"/>
# 864 "temp/res/AudioPlayer.c"
        <SCREEN id="GRP_ID_AUDPLY_PLAY_ANIMATION"/>
# 947 "temp/res/AudioPlayer.c"
