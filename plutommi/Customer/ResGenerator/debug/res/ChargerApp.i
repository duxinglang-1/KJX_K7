...
<!-----------------------------------------------------String Resource Area----------------------------------------------------->
    ...
    <!-----------------------------------------------------Image Resource Area------------------------------------------------------>
# 65 "temp/res/ChargerApp.c"
        <IMAGE id="IMG_ID_CHARGER_CHARGING">"..\\\\..\\\\Customer\\\\Images\\\\PLUTO""\\\\MainLCD\\\\UIELEMENT\\\\charger\\\\Charging.gif"</IMAGE>
        <IMAGE id="IMG_ID_CHARGER_DONE">"..\\\\..\\\\Customer\\\\Images\\\\PLUTO""\\\\MainLCD\\\\UIELEMENT\\\\charger\\\\Charge_Done.gif"</IMAGE>
# 76 "temp/res/ChargerApp.c"
    <!------------------------------------------------------Menu Resource Area------------------------------------------------------>
