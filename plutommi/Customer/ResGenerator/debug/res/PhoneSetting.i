...
# 415 "temp/res/PhoneSetting.c" 2
# 1 "../customerinc/CustResDef.h" 1
# 191 "../customerinc/CustResDef.h"
# 1 "../../mmi/inc/MMI_features.h" 1
# 192 "../customerinc/CustResDef.h" 2
# 416 "temp/res/PhoneSetting.c" 2
...
# 418 "temp/res/PhoneSetting.c" 2
# 1 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h" 1
# 310 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h"
# 1 "../../mmi/inc/MMI_features.h" 1
# 311 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h" 2
...
# 313 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h" 2
...
# 314 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h" 2
# 378 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h"
enum MAIN_MENU_IMG_ID
{
    IMG_MAIN_MENU_BG = ((U16) RESOURCE_BASE_APP_MAINMENU) + 1,

    IMG_SUBLCD_SYSTEM_SHUTDOWN,
# 392 "../../mmi/mainmenu/mainmenuinc/MainMenuDef.h"
...
# 723 "temp/res/PhoneSetting.c"
    <!-- main menu style string-->
# 748 "temp/res/PhoneSetting.c"
...
# 791 "temp/res/PhoneSetting.c"
    <!-- image ------------------------------------------------------------------------------------>
    <!--------------------------------------------------------------------------------------------->

    <!-- phone setting image----------------------------------------------------------------------->
    <IMAGE id = "IMG_SETTING_PHONE">"..\\\\..\\\\Customer\\\\Images\\\\PLUTO""\\\\MainLCD\\\\SubMenu\\\\Settings\\\\SB_SPH.bmp"</IMAGE>
    ...
    <IMAGE id = "IMG_SCR_SETTING_CAPTION">"..\\\\..\\\\Customer\\\\Images\\\\PLUTO""\\\\MainLCD\\\\TitleBar\\\\TB_ST.PNG"</IMAGE>
...
# 1150 "temp/res/PhoneSetting.c"
    <!-- Show owner number setting menu (sub menu of Display) -->
# 1168 "temp/res/PhoneSetting.c"
<!-- widget setting main menu ---------------------------------------------------------->
# 1196 "temp/res/PhoneSetting.c"
...
# 1323 "temp/res/PhoneSetting.c"
    <CACHEDATA type="byte" id="NVRAM_AUTOUPDATE_DT_STATUS" restore_flag="TRUE">
        <DEFAULT_VALUE> [0x00] </DEFAULT_VALUE>
        <DESCRIPTION> Byte Cache </DESCRIPTION>
    </CACHEDATA>
# 1341 "temp/res/PhoneSetting.c"
    <!--------------------------------------------------------------------------------------------->
    <!-- call back function------------------------------------------------------------------------>
    <!--------------------------------------------------------------------------------------------->
# 1352 "temp/res/PhoneSetting.c"
</APP>
