...
# 1150 "../../mmi/inc/GlobalResDef.h"
    ...
    IMG_GLOBAL_TOOLBAR_VIDEO_CALL_DISABLED,
        ...
        IMG_GLOBAL_BW_9,
        IMG_GLOBAL_BW_DOT,
        IMG_GLOBAL_BW_FENHAO,
        IMG_GLOBAL_BW_BAT1,
        IMG_GLOBAL_BW_BAT2,
        IMG_GLOBAL_BW_BAT3,
        IMG_GLOBAL_BW_BAT4,
        IMG_GLOBAL_BW_BAT_ON_CHARGIMG,
        IMG_GLOBAL_BW_BAT_ON_FULL,
        IMG_GLOBAL_BW_BAT_OFF_CHARGING,
        IMG_GLOBAL_BW_BAT_OFF_FULL,
        IMG_GLOBAL_BW_NO_SIM_CARD,
        IMG_GLOBAL_BW_SIGNAL1,
        IMG_GLOBAL_BW_SIGNAL2,
        IMG_GLOBAL_BW_SIGNAL3,
        IMG_GLOBAL_BW_SIGNAL4,
        IMG_GLOBAL_BW_GPS_ON,
        IMG_GLOBAL_BW_GPS_OFF,
        IMG_GLOBAL_BW_CONNECT,
        IMG_GLOBAL_BW_RADAR,

        IMG_GLOBAL_BW_SOS,
        IMG_GLOBAL_BW_NO_SOS,
        ...
        IMG_GLOBAL_BW_SPEED,
        IMG_GLOBAL_BW_DANWEI,
        IMG_GLOBAL_BW_XIANSU,
        IMG_GLOBAL_BW_KUANG,
        IMG_GLOBAL_BW_FENHAO_L,
        IMG_GLOBAL_BW_METER,
        IMG_GLOBAL_BW_DISTANCE,
        IMG_GLOBAL_BW_DISTANCE_H,
        IMG_GLOBAL_BW_SPEED_H,
        IMG_GLOBAL_BW_LIMIT_SPEED_H,

        IMG_GLOBAL_EDOG_VOL_SET,
        IMG_GLOBAL_EDOG_VOL_LEVEL0,
        IMG_GLOBAL_EDOG_VOL_LEVEL1,
        IMG_GLOBAL_EDOG_VOL_LEVEL2,
        IMG_GLOBAL_EDOG_VOL_LEVEL3,
        IMG_GLOBAL_EDOG_VOL_LEVEL4,
        IMG_GLOBAL_EDOG_VOL_LEVEL5,
        IMG_GLOBAL_EDOG_VOL_LEVEL6,
        IMG_GLOBAL_EDOG_OBD_SHOW,
        IMG_GLOBAL_EDOG_SHAKE_ALERT,
        IMG_GLOBAL_EDOG_SHAKE_ALERT_C,
        IMG_GLOBAL_EDOG_SHAKE_ALERT_O,
        IMG_GLOBAL_EDOG_ROAD_CONDITION,
        IMG_GLOBAL_EDOG_SIM_INFO,
        IMG_GLOBAL_EDOG_WEATHER,
        IMG_GLOBAL_EDOG_OIL_INFO,
        IMG_GLOBAL_EDOG_MOVE_DISTANCE_ALERT,
        IMG_GLOBAL_EDOG_MOVE_DISTANCE_C,
        IMG_GLOBAL_EDOG_MOVE_DISTANCE_O,
        IMG_GLOBAL_EDOG_PUSH_MSG,
        IMG_GLOBAL_EDOG_SILENT_SET,
        IMG_GLOBAL_EDOG_SILENT,
        IMG_GLOBAL_EDOG_LOUD,
        IMG_GLOBAL_EDOG_SEND_DATA,
        IMG_GLOBAL_EDOG_SEND_OK,
        IMG_GLOBAL_EDOG_SEND_FAIL,
        IMG_GLOBAL_EDOG_RADAR_CTRL,
        IMG_GLOBAL_EDOG_RADAR_OPEN,
        IMG_GLOBAL_EDOG_RADAR_CLOSE,

        IMG_GLOBAL_EDOG_LIMIT_SPEED_SET,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_CLOSE,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_30,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_40,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_50,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_60,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_70,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_80,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_90,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_100,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_110,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_120,
        IMG_GLOBAL_EDOG_LIMIT_SPEED_130,
...
# 93 "temp/res/editor.c"
    <STRING id="STR_INPUT_METHOD_ADVANCED_OPTIONS"/>
# 107 "temp/res/editor.c"
    <STRING id="STR_INPUT_METHOD_HANDWRITING_SPEED"/>
    <STRING id="STR_INPUT_METHOD_SETTINGS"/>
# 143 "temp/res/editor.c"
    <STRING id="STR_ID_INPUT_MODE_PINYIN"/>
    <STRING id="STR_ID_INPUT_MODE_BIHUA"/>

    <STRING id="STR_INPUT_METHOD_PREFERED_INPUT_METHOD"/>
# 156 "temp/res/editor.c"
        <SCREEN id = "GRP_ID_PHNSET_HANDWRITING"/>

    <!-----------------------------------------------------Image Resource Area------------------------------------------------------>
# 170 "temp/res/editor.c"
        <IMAGE id="IMG_ID_IME_VK_CHANGE_MODE" >"..\\\\..\\\\Customer\\\\Images\\\\PLUTO""\\\\MainLCD\\\\UIElement\\\\VK3\\\\PopupList_ChangeMode.png"</IMAGE>
        <IMAGE id="IMG_ID_IME_VK_CHANGE_SETTING" >"..\\\\..\\\\Customer\\\\Images\\\\PLUTO""\\\\MainLCD\\\\UIElement\\\\VK3\\\\PopupList_Setting.png"</IMAGE>

    <!------------------------------------------------------Menu Resource Area------------------------------------------------------>
# 270 "temp/res/editor.c"
...
# 343 "temp/res/editor.c"
         </MENU>
# 410 "temp/res/editor.c"
