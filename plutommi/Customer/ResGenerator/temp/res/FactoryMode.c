...
<APP id="APP_FACTORYMODE">
    ...
    <MENU id="MENU_ID_FM_ROOT" type = "APP_SUB" str="STR_ID_FM_ROOT">
    ...
    #ifndef __KJX_FUN__		//xb add 2018-08-06 ∆¡±Œ—Ô…˘∆˜≤‚ ‘œÓ
    ...
    #endif          
    #ifndef __KJX_FUN__		//xb add 2018-08-06 ∆¡±ŒÃ˝Õ≤≤‚ ‘œÓ
	  ...
	  #endif
	  #ifdef __BLE_MODULE_SUPPORT__
		<MENUITEM id="MENU_ID_FM_BLE" str="STR_ID_FM_BLE"/>
	  #endif
	  #ifdef __BOSCH_BMP280_PRESSURE__
