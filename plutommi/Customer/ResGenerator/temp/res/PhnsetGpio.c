...
--> 
    ...
    <STRING id="STR_ID_PHNSET_GPIO_BACKLITE_5SEC"/>
    <STRING id="STR_ID_PHNSET_GPIO_BACKLITE_15SEC"/>
    <STRING id="STR_ID_PHNSET_GPIO_BACKLITE_30SEC"/>
    <STRING id="STR_ID_PHNSET_GPIO_BACKLITE_45SEC"/>    
#endif
...
#ifdef __MMI_MAINLCD_96X64__
    <MENU id = "MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT" type = "APP_SUB" str = "STR_ID_PHNSET_GPIO_BACKLITE" >
        <MENUITEM id = "MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_5" str = "STR_ID_PHNSET_GPIO_BACKLITE_5SEC" />
        <MENUITEM id = "MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_15" str = "STR_ID_PHNSET_GPIO_BACKLITE_15SEC"/>
		<MENUITEM id = "MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_30" str ="STR_ID_PHNSET_GPIO_BACKLITE_30SEC"/>
        <MENUITEM id = "MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_45" str = "STR_ID_PHNSET_GPIO_BACKLITE_45SEC"/>
    </MENU>
#endif
