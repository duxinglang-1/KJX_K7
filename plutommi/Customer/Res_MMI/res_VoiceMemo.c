...
void populateVoiceMemoMenu(void)
{
    ...
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU3104_VOICE_MEMO, HighlightVoiceMemo);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(VM_RECORD_MENUID, HighlightVoiceMemoRecord);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(VM_PLAY_MENUID, HighlightVoiceMemoPlay);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(VM_APPEND_MENUID, HighlightVoiceMemoAppend);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(VM_DELETE_MENUID, HighlightVoiceMemoDelete);
 	ADD_APPLICATION_MENUITEM_HILITE_HANDLER(VM_DELETE_ALL_MENUID, HighlightVoiceMemoDeleteAll);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(VM_RENAME_MENUID, HighlightVoiceMemoRename);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(VM_RENAME_OPTION_SAVE_MENUID, HighlightVoiceMemoOptionSave);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(VM_RENAME_OPTION_INPUT_METHOD_MENUID, HighlightVoiceMemoOptionInputMethod);
