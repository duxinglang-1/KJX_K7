...
const BIDICHAR_TYPE_MAP bidiCharTypeMap[] = 
{
    ...
    {NSM, 0x01, 0x0e31},
    {BIDI_L, 0x02, 0x0e32},
    {BIDI_L, 0x07, 0x0e34}, /* adjust from NSM to BIDI_L for Thai */
    {ET, 0x01, 0x0e3f},
    {BIDI_L, 0x07, 0x0e40},
    {BIDI_L, 0x08, 0x0e47}, /* adjust from NSM to BIDI_L for Thai */
    {BIDI_L, 0x0d, 0x0e4f},
    {BIDI_L, 0x9c, 0x1e00},
    {BIDI_L, 0x5a, 0x1ea0},
    {WS, 0x0b, 0x2000},
...
U16 nMaxIndexBidiOverride = sizeof(bidiOverrideLMap)/ sizeof(CHAR*);
