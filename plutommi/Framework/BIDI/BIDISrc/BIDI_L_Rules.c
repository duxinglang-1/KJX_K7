        ...
        U16* p_visual_to_logic)
{
    ...
    do
    {
        ...
        bidi_reorder(paragraphEmbeddingLevel, inputString, pInput_Levels, lineCount, p_visual_to_logic);
 ...
 *  
 *****************************************************************************/
U16 bidi_reorder(U8 base_level, U8 *pinput, U8 *input_level, U16 cCount, U16* p_visual_to_logic)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    while (iCount < cCount)
    {
        ...
        iCount += bidi_reorder_level(
                    ...
                    (U16) (cCount - iCount),
                    FALSE,
                    p_visual_to_logic ? (p_visual_to_logic + iCount) : NULL);
    }
    return iCount;
}
 ...
 *  
 *****************************************************************************/
U16 bidi_reorder_level(U8 level, U8 *pinput, U8 *input_level, U16 cCount, pBOOL reverse_flag, U16* p_visual_to_logic)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    for (iCount = 0; iCount < cCount; iCount++)
    {
        ...
        else if (input_level[iCount] > level)
        {
            ...
            iCount += bidi_reorder_level(
                        ...
                        (U16) (cCount - iCount),
                        reverse_flag,
                        p_visual_to_logic ? (p_visual_to_logic + iCount) : NULL) - 1;
        }
    }
    //START Changed by Yogesh 20041224
    //    if (reverse_flag)
    if (reverse_flag && iCount)
        /* END Changed by Yogesh 20041224 */
    {
        bidi_reverse(pinput, iCount, p_visual_to_logic);
    }
    /* START Changed by Yogesh 20041224 */
    if (!iCount)
    {
 ...
 *  void
 *****************************************************************************/
void bidi_reverse(U8 *pinput, U16 cCount, U16* p_visual_to_logic)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    while (iCount < cCount)
    {
        ...
        for (kCount = iCount; kCount < (iCount + (jCount - iCount) / 2); kCount++)
        {
            ...
            if (p_visual_to_logic != NULL)
            {
                index = p_visual_to_logic[kCount];
                p_visual_to_logic[kCount] = p_visual_to_logic[jCount - 1 - kCount];
                p_visual_to_logic[jCount - 1 - kCount] = index;
            }
        }
        if (bFlag)
        {
