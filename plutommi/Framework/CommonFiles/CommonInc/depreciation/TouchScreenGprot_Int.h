...
/* The threshold for identifying double-click event */
#define MMI_PEN_DOUBLE_CLICK_THRESHOLD  (KAL_TICKS_500_MSEC)     /*  500ms */
...
extern void GetInputEventInfo(U16 *device, U16 *keyCode, U16 *keyType, mmi_pen_event_type_enum *pen_type, mmi_pen_stroke_type_enum *stroke_type);
