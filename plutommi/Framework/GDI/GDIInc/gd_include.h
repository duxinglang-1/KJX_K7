...
extern GDI_RESULT gdi_layer_copy_1_to_16(gdi_handle src_handle, gdi_handle dst_handle);
#endif
...
extern void gd_fill_dot_rect_32PARGB(U8 *dest,S32 dw,S32 dh,S32 dx1,S32 dy1,S32 dx2,S32 dy2,S32 clipx1,S32 clipy1,S32 clipx2,S32 clipy2,gdi_color c);
extern void gd_fill_dot_rect_PARGB6666(U8 *dest,S32 dw,S32 dh,S32 dx1,S32 dy1,S32 dx2,S32 dy2,S32 clipx1,S32 clipy1,S32 clipx2,S32 clipy2,gdi_color c);
...
extern void gd_memset_32PARGB(U8 *dest, U32 value, U32 len);
extern void gd_memset_PARGB6666(U8 *dest, U32 value, U32 len);
...
extern void gd_image_bits_draw_32PARGB(U8 *dest,S32 dw, S32 dh, S32 dx1, S32 dy1, S32 dx2, S32 dy2, U8 *src, S32 sw,S32 sh,S32 sx1,S32 sy1, S32 sx2, S32 sy2, S32 src_size,S32 bits_per_pixel,gdi_color palette[],S32 clipx1, S32 clipy1, S32 clipx2, S32 clipy2);
extern void gd_image_bits_draw_PARGB6666(U8 *dest,S32 dw, S32 dh, S32 dx1, S32 dy1, S32 dx2, S32 dy2, U8 *src, S32 sw,S32 sh,S32 sx1,S32 sy1, S32 sx2, S32 sy2, S32 src_size,S32 bits_per_pixel,gdi_color palette[],S32 clipx1, S32 clipy1, S32 clipx2, S32 clipy2);
