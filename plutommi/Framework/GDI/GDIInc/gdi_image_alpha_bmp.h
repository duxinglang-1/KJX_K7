 ...
 * Global Function 
 *****************************************************************************/
extern void gdi_image_abm_init(void);
...
extern void gdi_image_abm_draw_vector_font(S32 offset_x, S32 offset_y, U8 *abm_header_ptr, U8 *font_data);
#endif /* __MMI_VECTOR_FONT_SUPPORT__ */

extern U32 gdi_image_abm_get_info(U8 *data_ptr, BOOL is_file);

extern GDI_RESULT gdi_image_abm_check_alpha_mem(const U8 *data_ptr, kal_bool *with_alpha);

extern GDI_RESULT gdi_image_abm_check_alpha_file(S8 *filename, kal_bool *with_alpha);
