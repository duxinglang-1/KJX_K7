...
kal_bool gdd_init(task_indx_type task_indx)
{
    ...
    gdd_context.event_scheduler_ptr = evshed_create(
                                            "GDD Base Timer",
                                            MOD_GDD,                                            
                                            0,
                                            0);
...
kal_bool gdd_register_msg_handler(msg_type msg,gdd_msg_handler_func func)
{
    ...
    else if (i < gdd_context.msg_count)
    {
        // delete
        gdd_context.msg_count--;
        ...
        gdd_context.msg_handler_id[gdd_context.msg_count] = MSG_ID_INVALID_TYPE;
        gdd_context.msg_handler[gdd_context.msg_count] = NULL;
    }
    return KAL_TRUE;
}
