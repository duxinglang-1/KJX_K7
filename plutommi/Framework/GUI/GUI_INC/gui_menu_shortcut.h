...
extern void gui_shortcut_create_ex(
...
extern void gui_shortcut_set_target_layer(gui_shortcut_struct *sc, gdi_handle target_layer);
extern gdi_handle gui_shortcut_get_target_layer(gui_shortcut_struct *sc);
extern void gui_shortcut_set_target_lcd(gui_shortcut_struct *sc, gdi_handle target_lcd);
...
extern void gui_shortcut_set_alpha_blend_layer(gui_shortcut_struct *sc, gdi_handle alpha_blend_layer);
...
extern void gui_shortcut_register_hide_callback(gui_shortcut_struct *sc, void(*hide_callback)(S32 x1, S32 y1, S32 x2, S32 y2));
