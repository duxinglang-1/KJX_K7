...
/* Enum values of panel which are used to describe different element state of panel. */
typedef enum
{
    /* Is an enum value which represents normal state of element */
    GUI_PANEL_ELEM_STATE_NORMAL = 1,
    /* Is an enum value which represents down state of element */
    GUI_PANEL_ELEM_STATE_DOWN,
    /* Is an enum value which represents focussed state of element */
    GUI_PANEL_ELEM_STATE_FOCUSSED,
    /* Is an enum value which represents disabled state of element */
...
extern void gui_panel_set_element_callback(
             gui_panel_struct *panel,
             S32 element_index,
             U16 keycode,
             FuncPtr down_event_callback,
