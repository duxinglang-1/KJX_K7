...
typedef enum
{
    ENUM_TAP_ON_NONHIGHLIGHTED_ITEM,
...
typedef MMI_BOOL (*wgui_pen_pre_hdlr_funcptr)(U16 dm_control_id, mmi_pen_point_struct point, mmi_pen_event_type_enum pen_event);

typedef U8*(*wgui_search_control_set_callback_function)(void);

extern void wgui_pen_register_pre_hdlr(wgui_pen_pre_hdlr_funcptr pen_pre_hdlr);
...
extern MMI_BOOL wgui_general_pen_dynamic_matrix_menu_hdlr(mmi_pen_point_struct point, mmi_pen_event_type_enum pen_event);
extern MMI_BOOL wgui_general_pen_asyncdynamic_list_menu_hdlr(
                    mmi_pen_point_struct point,
                    mmi_pen_event_type_enum pen_event);
extern MMI_BOOL wgui_general_pen_asyncdynamic_matrix_menu_hdlr(
                    mmi_pen_point_struct point,
                    mmi_pen_event_type_enum pen_event);
...
extern void wgui_register_list_item_selected_callback(void (*pen_event_selected_callback_function) (void));
extern void wgui_register_list_item_selected_callback_all(void (*pen_event_selected_callback_function) (void));
extern void wgui_register_list_tap_callback(void (*tap_callback_funtion)(mmi_tap_type_enum tap_type,S32 index));
extern void wgui_reset_list_item_selected_callback(void);
extern void wgui_register_matrix_item_selected_callback(void (*pen_event_selected_callback_function) (void));
extern void wgui_register_matrix_item_selected_callback_all(void (*pen_event_selected_callback_function) (void));
extern void wgui_register_matrix_tap_callback(void (*tap_callback_funtion)(mmi_tap_type_enum tap_type,S32 index));
extern void wgui_reset_matrix_item_selected_callback(void);

extern void wgui_pen_reset_pre_hdlr(void);
extern void wgui_pen_restore_pre_hdlr(void);

extern void wgui_register_search_control_set_callback_function(wgui_search_control_set_callback_function f);
#else
