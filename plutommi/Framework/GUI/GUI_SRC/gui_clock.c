             ...
             S32 date_format)
{
    ...
    switch (flags)
    {
      ...
      case GUI_CLOCK_MAINLCD_TYPE_DIGITAL_TIME:
		...
		#if defined(__KJX_FUN__)	//xb add 2017-07-20 Ìí¼ÓÐÇÆÚÏÔÊ¾
			mmi_ucs2cat((S8*)string, (CHAR*)L"  ");
			mmi_ucs2cat((S8*)string, (CHAR*)GetString(STR_KJX_IDLE_WEEK_SUNDAY+day_index));
		#endif
        }
            break;
