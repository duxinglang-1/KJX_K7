        ...
        color border_color)
{
	...
	gui_create_scrolling_text_int(s, x, y, width, height,
		text, timer_callback, draw_background, text_color, border_color);
#if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
void gui_layer_show_animation(void)
{
   ...
   // gdi_layer_push_clip();
    gdi_layer_push_and_set_clip(gui_image_clip_x1, gui_image_clip_y1, gui_image_clip_x2, gui_image_clip_y2);
