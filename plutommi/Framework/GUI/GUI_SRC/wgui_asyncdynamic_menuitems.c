...
fixed_icontext_list_menuitem_type *get_asyncdynamic_item_from_buffer(S32 index)
{
    ...
    MMI_ASSERT(offset >= 0);
    if (asyncdynamic_item_buffer.count)
        MMI_ASSERT(offset < asyncdynamic_item_buffer.count);
...
S32 load_chunk_asyncdynamic_item_buffer(S32 start_index, S32 n_items)
{
    ...
    if (wgui_list_menu_slow_data_mode 
//hujin
...
//	#ifdef GUI_LIST_MENU_SMOOTH_SCROLLING_BY_PEN
    ...
    {
        gui_asyncdynamic_list_loading_error = 1;
    ...
    {
        gui_asyncdynamic_list_loading_error = 0;
    }
//	#else
//	    if (count != n_items)
//	    {
...
//	#endif
    ...
    if (wgui_asyncdynamic_menuitem_load_complete_callback)
    {
        wgui_asyncdynamic_menuitem_load_complete_callback(start_index, n_items);
    }
 ...
 *  void
 *****************************************************************************/
void wgui_asyncdynamic_menuitem_register_load_complete_callback(wgui_asyncdynamic_menuitem_load_complete_funcptr_type callback)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    wgui_asyncdynamic_menuitem_load_complete_callback = callback;
}
