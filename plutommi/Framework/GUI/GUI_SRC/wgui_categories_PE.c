...
/* scale color from range 0 ~ 31 to value 0 ~ 255 */
#define SCALE_COLOR_R2V(v)  ((((S32)(v)) * 255 + 15)/ 31)
#define SCALE_COLOR_V2R(v)  ((((S32)(v)) * 31 + 127)/ 255)
 ...
 */
    ...
    #define SLIDER_BAR_WIDTH                  (230)
    #define SLIDER_BAR_HEIGHT                 (17)
    #define SLIDER_BAR_GAP                    (17)
    #define SELECTED_COLOR_AREA_WIDTH         (46)
    #define SELECTED_COLOR_AREA_HEIGHT        (45)
#elif defined (__MMI_MAINLCD_320X240__)
    #define SLIDER_BAR_WIDTH                  (302)
    ...
    #define SLIDER_BAR_WIDTH                  (230)
    #define SLIDER_BAR_HEIGHT                 (17)
    #define SLIDER_BAR_GAP                    (15)
    #define SELECTED_COLOR_AREA_WIDTH         (75)
    #define SELECTED_COLOR_AREA_HEIGHT        (68)
#elif defined (__MMI_MAINLCD_176X220__)
    #define SLIDER_BAR_WIDTH                  (168)
    #define SLIDER_BAR_HEIGHT                 (15)
    #define SLIDER_BAR_GAP                    (12)
    #define SELECTED_COLOR_AREA_WIDTH         (46)
    #define SELECTED_COLOR_AREA_HEIGHT        (45)
#else
 ...
 *  void
 *****************************************************************************/
static void cat91_draw_highlight(S32 x1, S32 y1, S32 x2, S32 y2)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
static void cat91_redraw_selected_color(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if ((cat91_color_slider[RED_COLOR].value == 0) && (cat91_color_slider[GREEN_COLOR].value == 0))
    {
        if (cat91_color_slider[BLUE_COLOR].value == 31)
        {
            *cat91_color_value[BLUE_COLOR] = 247;
        }
        else if (cat91_color_slider[BLUE_COLOR].value == 30)
        {
            *cat91_color_value[BLUE_COLOR] = 246;
        }
    }
...
static void cat91_setup_color_sliders(U8 *R, U8 *G, U8 *B)
{
    ...
    gui_color_slider_set_value(&cat91_color_slider[RED_COLOR], (S32)SCALE_COLOR_V2R(*R));
    ...
    gui_color_slider_set_value(&cat91_color_slider[GREEN_COLOR], (S32)SCALE_COLOR_V2R(*G));
    ...
    gui_color_slider_set_range(&cat91_color_slider[BLUE_COLOR], 32);
    gui_color_slider_set_value(&cat91_color_slider[BLUE_COLOR], (S32)SCALE_COLOR_V2R(*B));
 ...
 *  void
 *****************************************************************************/
static void cat91_redraw_content_area(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    x1 = MMI_content_x;
    y1 = MMI_content_y;
    x2 = x1 + MMI_content_width - 1;
    y2 = y1 + MMI_content_height - 1;
 ...
 *  void
 *****************************************************************************/
static void cat91_increase_current_value(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    *cp = (U8) SCALE_COLOR_R2V(cs->value);
 ...
 *  void
 *****************************************************************************/
static void cat91_decrease_current_value(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
static void cat91_goto_previous_slider(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
static void cat91_goto_next_slider(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
static void cat91_keyboard_key_handler(S32 vkey_code, S32 key_state)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    switch (pen_event)
    {
        case MMI_PEN_EVENT_DOWN:
        {
            ...
            if (pen_down_slider >= 0)
            {
                ...
                {
                    *cat91_highlighted_slider = (mmi_cat91_color_slider_enum)pen_down_slider;
                    cat91_redraw_content_area();
                }
        ...
        default:
            ...
            if (current_color_slider)
            {
                ...
                if (GUI_SLIDE_CONTROL_PEN_JUMP_TO_I == slide_event)
                {
                    ...
                    *current_color_pointer = (U8) SCALE_COLOR_R2V(current_color_slider->value);
                    cat91_redraw_selected_color();
                    gui_unlock_double_buffer();
                    gui_BLT_double_buffer(
                        MMI_content_x,
 ...
 *  void
 *****************************************************************************/
static void DrawCate91CategoryControlArea(dm_coordinates *coordinate)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/* For detail description, please refer to wgui_categories_PE.h */
static U8 *GetCategory91History(U8 *history_buffer)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
        ...
        U8 *history_buffer)
{
    ...
    dm_add_rectangle(gui_color(255, 255, 255), DM_RECTANGLE_FILL_COLOR);
