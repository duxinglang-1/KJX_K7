...
void dm_redraw_category_screen(void)
{
	...
	//bwl_dbg_print("dm_redraw_category_screen g_dm_data.s32CatId = %d, %d\r\n",g_dm_data.s32CatId,MMI_CATEGORY171_ID);
	//return;
 ...
 *  void
 *****************************************************************************/
void dm_add_image_2(PU8 img, S32 img_size, UI_filled_area *background, U32 dyn_prop, U8 img_type, S32 image_width, S32 image_height)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if (act_lcd_handle == GDI_LCD_SUB_LCD_HANDLE)
    {
        ...
        dm_image_array_sub[dm_image_count_sub].name = NULL;
...
#endif /* __MMI_SUBLCD__ */ 
    {
        ...
        dm_image_array[dm_image_count].name = NULL;
...
void dm_add_image(PU8 img, UI_string_type image_name, UI_filled_area *background)
{
    ...
    if (act_lcd_handle == GDI_LCD_SUB_LCD_HANDLE)
    {
        ...
        dm_image_array_sub[dm_image_count_sub].image_size = 0;
        dm_image_array_sub[dm_image_count_sub].dyn_prop_flag = DM_IMAGE_WITH_HEADER;
        dm_image_array_sub[dm_image_count_sub].image_type = GDI_IMAGE_TYPE_INVALID;
        dm_image_array_sub[dm_image_count_sub++].image_handle = GDI_ERROR_HANDLE;
...
#endif /* __MMI_SUBLCD__ */ 
    {
        ...
        dm_image_array[dm_image_count].image_size = 0;
        dm_image_array[dm_image_count].dyn_prop_flag = DM_IMAGE_WITH_HEADER;
        dm_image_array[dm_image_count].image_type = GDI_IMAGE_TYPE_INVALID;
        dm_image_array[dm_image_count++].image_handle = GDI_ERROR_HANDLE;
    }
}
