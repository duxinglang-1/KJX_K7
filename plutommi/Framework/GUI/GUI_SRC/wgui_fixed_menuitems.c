...
void gui_show_two_line_inline_level_select(void)
{
    ...
    {
        gui_draw_filled_area(x1 + 1, y1, x2, y2, MMI_fixed_icontext_menuitem.focussed_without_sc_filler);
    }
    else
    {
...
void wgui_move_and_set_keyhandlers_two_line_level_select(S32 x, S32 y)
{
    ...
    SetKeyHandler(wgui_two_line_level_select_volume_move_next_item, KEY_RIGHT_ARROW, KEY_EVENT_REPEAT);
    SetKeyHandler(wgui_two_line_level_select_volume_move_previous_item, KEY_LEFT_ARROW, KEY_EVENT_REPEAT);
...
void wgui_move_and_set_keyhandlers_two_line_horizontal_select(S32 x, S32 y)
{
    ...
    if (two_line_horizontal_select_menuitem.no_of_items > 1)
    {
        ...
        SetKeyHandler(wgui_two_line_horizontal_select_move_next_item, KEY_RIGHT_ARROW, KEY_EVENT_REPEAT);
        SetKeyHandler(wgui_two_line_horizontal_select_move_previous_item, KEY_LEFT_ARROW, KEY_EVENT_REPEAT);
