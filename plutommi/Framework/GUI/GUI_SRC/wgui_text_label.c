...
void wgui_text_label_show(U32 text_label_id)
{
    ...
    gdi_layer_blt_previous(
        wgui_text_label_list[text_label_id].x,
        wgui_text_label_list[text_label_id].y,
        wgui_text_label_list[text_label_id].x + wgui_text_label_list[text_label_id].width - 1,
        wgui_text_label_list[text_label_id].y + wgui_text_label_list[text_label_id].height - 1);
