...
static pBOOL IsBackSubLCDHistory = MMI_FALSE;
...
static SubLCDHistoryInternalNode SubLCDHistoryData_slave[MAX_HISTORY]; /* array of history data */
static pBOOL IsBackSubLCDHistory_slave = MMI_FALSE;
...
static SubLCDHistoryInternalNode SubLCDHistoryData_master[MAX_HISTORY]; /* array of history data */
static pBOOL IsBackSubLCDHistory_master = MMI_FALSE;
...
static SubLCDHistoryInternalNode SubLCDHistoryData[MAX_HISTORY]; /* array of history data */
static pBOOL IsBackSubLCDHistory = MMI_FALSE;
static signed char NodeIndex = -1;
static U16 gCurrTopSubLCDScrnID = 0;
static U16 gCurrExitSubLCDScrnID = 0;
...
void ExecSubLCDCurrExitHandler(void)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_EXE_SUBLCD_CUR_EXIT_HDLR);
#ifdef __MMI_SUBLCD_MASTER_MODE__
    if (srv_clam_is_close() && (g_sublcd_master_cntx.state == SUBLCD_MODE_S2M ||
                            g_sublcd_master_cntx.state == SUBLCD_MODE_M2S))
    {
	    IsBackSubLCDHistory = MMI_FALSE;
        return;
    }
#endif/*__MMI_SUBLCD_MASTER_MODE__*/
...
void AddSubLCDHistory(SubLCDHistoryNode *CurrSubLCDHistory)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_ADD_SUBLCD_HIST_HDLR);

    /* MTK added by JL for back history. */
    if (IsBackSubLCDHistory != MMI_TRUE)
    {
...
void AddSubLCDHistoryWithScrIDEx(SubLCDHistoryNodeEx *CurrSubLCDHistory, U16 scrID)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_ADD_SUBLCD_HIST_WITHSCRID_HDLR, scrID);
...
void SetSubLCDExitHandler(FuncPtr CurrSubLCDFn)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_ADD_SUBLCD_EXIT_HDLR, CurrSubLCDFn);
...
void SetSubLCDEntryHandler(FuncPtr CurrSubLCDFn)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_ADD_SUBLCD_ENTRY_HDLR, CurrSubLCDFn);
...
void InitSubLCDHistory(SubLcdHistoryCBPtr sublcd_root_screen_cb_ptr)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_INIT, sublcd_root_screen_cb_ptr);
    ...
    g_sublcd_master_cntx.is_sublcd_force_add_history = MMI_TRUE;
    g_sublcd_master_cntx.state = SUBLCD_MODE_M2S;
    SwitchSubLCDHistory();
...
mmi_ret sub_lcd_evt_handler(mmi_event_struct *evt)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void DinitSubLCDHistory(void)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_DEINIT);
...
void ShowSubLCDScreen(FuncPtr SubLCDEntryFn)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_SHOW_SUBLCD_HDLR, SubLCDEntryFn);
#ifdef __MMI_SUBLCD_MASTER_MODE__
    gCurrSubLCDUpdateBy = SUBLCD_PREPARE_TO_UPDATE_BY_MAIN_LCD_APP;
#endif/*__MMI_SUBLCD_MASTER_MODE__*/
    DisplaySubLCDScreen((U16)SUB_LCD_DUMMY_SCRNID, SubLCDEntryFn, MMI_FALSE);
...
void ForceSubLCDScreen(FuncPtr SubLCDEntryFn)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_FORCE_SUBLCD_HDLR, SubLCDEntryFn);
#ifdef __MMI_SUBLCD_MASTER_MODE__
    gCurrSubLCDUpdateBy = SUBLCD_PREPARE_TO_UPDATE_BY_MAIN_LCD_APP;
#endif/*__MMI_SUBLCD_MASTER_MODE__*/
    DisplaySubLCDScreen((U16)SUB_LCD_DUMMY_SCRNID, SubLCDEntryFn, MMI_TRUE);
...
void DisplaySubLCDScreen(U16 scrnId, FuncPtr SubLCDEntryFn, MMI_BOOL is_force)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_DISPLAY_SUBLCD_HDLR, SubLCDEntryFn, scrnId, is_force);
...
void GoBackSubLCDHistoryInt(void)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_GO_BACK_SUBLCD_HDLR);

    if (NodeIndex >= 0)
    {
        IsBackSubLCDHistory = MMI_TRUE;
...
void GoBacknSubLCDHistory(U16 nHistory)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_GO_BACK_N_SUBLCD_HDLR, nHistory);
...
U8 GoBackToSubLCDHistory(U16 scrnid)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_GO_BACK_TO_SUBLCD_HDLR, scrnid);
...
U8 GoBeyondSubLCDMarkerScr(U16 scrnid)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_GO_BEYOND_SUBLCD_HDLR, scrnid);
...
void GoBackBothLCDHistory(void)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_BACK_BOTHLCD_HIST_HDLR);
#ifdef __MMI_SUBLCD__
    GoBackSubLCDHistory();
#endif 
    GoBackHistory();
...
U8 DeleteUptoSubLCDScrID(U16 scrnid)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_DEL_UPTO_SUBLCD_SCR_HDLR, scrnid);
...
U8 DeleteNSubLCDScrId(U16 scrnid)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_DEL_N_SUBLCD_SCR_HDLR, scrnid);
...
U16 DeleteSubLCDScreen(U16 ScrId)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_DEL_SUBLCD_SCR_HDLR, ScrId);
...
void DeleteNSubLCDHistory(U16 DeleteCount)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_DEL_SUBLCD_SCR_NUM, DeleteCount);
...
U8 DeleteBeyondSubLCDScrTillScr(U16 beyondScrnid, U16 tillScrnid)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_DEL_BEYOND_TILL_SUBLCD_SCR_HDLR, beyondScrnid, tillScrnid);
...
U16 DeleteBetweenSubLCDScreen(U16 StartScrId, U16 EndScrId)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_DEL_BETWEEN_SUBLCD_SCR_HDLR, StartScrId, EndScrId);
...
pBOOL SubLCDHistoryReplace(U16 out_scrn_id, U16 in_scrn_id, FuncPtr in_src_func)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_REPLACE_SUBLCD_SCR_HDLR, out_scrn_id, in_scrn_id, in_src_func);

    for (count = 0; ((count < MAX_HISTORY) && ((count <= NodeIndex) && (NodeIndex != -1))); count++)
    {
...
void SubLCDHistoryDump(void)
{
    ...
    if (NodeIndex >= 0)
    {
        ...
        do
        {
            MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_DUMP_HDLR,
    ...
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_INFO_SUBHIST_DUMP_ROOTHDLR);
...
void SwitchSubLCDHistory(void)
{
    if (g_sublcd_master_cntx.state == SUBLCD_MODE_S2M)
    {
        MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_SUBHIST_SWITCH_MODE_S2M);
    ...
    {
        MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_SUBHIST_SWITCH_MODE_M2S);
...
{
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_SUBHIST_CLEAR_MASTER_HIST);

    IsBackSubLCDHistory_master = MMI_FALSE;
    NodeIndex_master = -1;
 ...
 *  FuncPtr
 *****************************************************************************/
MMI_BOOL IsSubLCDMasterHistoryEmpty(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void ForceExitCurrScr(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_SUBHIST_FORCE_EXIT_CURR_SCR);
    ...
    if (gCurrEntrySubLCDFn != NULL && g_sublcd_master_cntx.is_sublcd_force_add_history == MMI_TRUE)
    {
...
void SubLCDMasterGoBackHistory(void)
{
	if (srv_clam_is_close())
	{
        MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_FRM_SUBHIST_MASTER_GOBACK_HIST);
