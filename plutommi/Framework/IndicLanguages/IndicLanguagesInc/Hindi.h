...
#define IRE_HINDI_PROPRIETRY_END_RANGE    	0xE9C4
...
typedef enum
{
    ...
    HINDI_L_PB_C_BINDU = 0xE95B,
    HINDI_L_PB_SUP_RA = 0xE95C,
    HINDI_L_PB_DVCE = 0xE95D,
    HINDI_L_PB_SUPRA_C_BINDU = 0xE95E,
    HINDI_L_PB_BINDU = 0xE95F,
    HINDI_L_DYA = 0xE948,   
    HINDI_L_DVA = 0xE94E,   
    HINDI_L_DDYA = 0xE94d,  
	...
	HINDI_L_NNA_RA = 0XE9C2,
	HINDI_L_NYA_RA = 0XE9C3,
	HINDI_L_LA_RA = 0XE9C4,
...
extern UI_character_type *get_hindi_multitap_string_for_vk(S32 i);
