...
#define IRE_PUNJABI_PROPRIETRY_END_RANGE     	0xEB1C
...
typedef enum
{
    ...
    PUNJABI_L_ZA_VA = 0xEB16,
    PUNJABI_L_HU = 0xEB17,
    PUNJABI_L_HUU = 0xEB18,
    PUNJABI_L_VU = 0xEB19,
    PUNJABI_L_VUU = 0xEB1A,
    PUNJABI_L_RU = 0xEB1B,
    PUNJABI_L_RUU = 0xEB1C,
...
extern UI_string_type get_punjabi_multitap_string(S32 index);
extern UI_character_type *get_punjabi_multitap_string_for_vk(S32 i);
