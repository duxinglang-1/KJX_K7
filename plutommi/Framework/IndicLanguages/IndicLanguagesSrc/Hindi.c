...
const ire_character_info_table_struct hindi_character_info_table[] = 
{
    ...
    /* GENERIC ADDITIONS */
    {0, 0, IRE_INDEP_VOWEL, 0, 0, 0, IRE_POSTBASE_POSITION, 0, IRE_CHAR_TYPE_1, 0},    /* 0x0960 */
...
const ire_character_info_table_struct hindi_ligature_info_table[] = 
{
    ...
    {0, 0, 0, 0, IRE_NORMAL_LIGATURE, 0, IRE_POSTBASE_POSITION, 0, 0, 0},  		/* 0xE95B */
    {0, 0, 0, IRE_NORMAL_SIGN, 0, 0, IRE_POSTBASE_POSITION, 0, 0, 0},  			/* 0xE95C */
    {0, 0, 0, 0, IRE_NORMAL_LIGATURE, 0, IRE_POSTBASE_POSITION, 0, 0, 0},  		/* 0xE95D */
    {0, 0, 0, 0, IRE_NORMAL_LIGATURE, 0, IRE_POSTBASE_POSITION, 0, 0, 0},  		/* 0xE95E */
    {0, 0, 0, 0, IRE_NORMAL_LIGATURE, 0, IRE_POSTBASE_POSITION, 0, 0, 0},  		/* 0xE95F */
    ...
    {0, 0, 0, 0, IRE_NORMAL_LIGATURE, 0, IRE_POSTBASE_POSITION, 0, 0, 0},     /* 0xE9C1 */
    {0, 0, 0, 0, IRE_NORMAL_LIGATURE, 0, IRE_POSTBASE_POSITION, 0, 0, 0},     /* 0xE9C2 */
    {0, 0, 0, 0, IRE_NORMAL_LIGATURE, 0, IRE_POSTBASE_POSITION, 0, 0, 0},     /* 0xE9C3 */
    {0, 0, 0, 0, IRE_NORMAL_LIGATURE, 0, IRE_POSTBASE_POSITION, 0, 0, 0},     /* 0xE9C4 */
};
...
const ire_glyph_info_table_struct JA_Tbl[] = 
{
    ...
    {0, 4, 1, MMI_ALL_LANG, {HINDI_C_JA, HINDI_S_HALANT, HINDI_C_NYA, HINDI_S_HALANT, 0x0}, {HINDI_H_GYA, 0x0}},
...
const ire_glyph_info_table_struct NYA_Tbl[] = 
{
    ...
    {0, 3, 1, MMI_ALL_LANG, {HINDI_C_NYA, HINDI_S_HALANT, HINDI_C_RA, 0x0}, {HINDI_L_NYA_RA, 0x0}},
};
...
const ire_glyph_info_table_struct TTHA_Tbl[] = 
{
	...
	{0, 4, 4, MMI_ALL_LANG, {HINDI_C_TTHA, HINDI_S_HALANT, HINDI_C_TTHA, HINDI_DV_U, 0x0},
     {HINDI_C_TTHA, HINDI_S_HALANT, HINDI_C_TTHA, HINDI_DV_U, 0x0}},
    {0, 4, 4, MMI_ALL_LANG, {HINDI_C_TTHA, HINDI_S_HALANT, HINDI_C_TTHA, HINDI_DV_UU, 0x0},
     {HINDI_C_TTHA, HINDI_S_HALANT, HINDI_C_TTHA, HINDI_DV_UU, 0x0}},
    {0, 4, 4, MMI_ALL_LANG, {HINDI_C_TTHA, HINDI_S_HALANT, HINDI_C_TTHA, HINDI_DV_R, 0x0},
     {HINDI_C_TTHA, HINDI_S_HALANT, HINDI_C_TTHA, HINDI_DV_R, 0x0}},
...
const ire_glyph_info_table_struct NNA_Tbl[] = 
{
    ...
    {0, 3, 1, MMI_ALL_LANG, {HINDI_C_NNA, HINDI_S_HALANT, HINDI_C_RA, 0x0}, {HINDI_L_NNA_RA, 0x0}},
};
...
const ire_glyph_info_table_struct DA_Tbl[] = 
{
    ...
    {0, 3, 1, MMI_ALL_LANG, {HINDI_C_DA, HINDI_S_HALANT, HINDI_C_BA, 0x0}, {HINDI_L_DABA, 0x0}},
    ...
    {1, 4, 4, MMI_ALL_LANG, {HINDI_C_DA, HINDI_S_HALANT, HINDI_C_BA, HINDI_S_HALANT, 0x0},
     {HINDI_C_DA, HINDI_S_HALANT, HINDI_C_BA, HINDI_S_HALANT, 0x0}},
    ...
    {0, 4, 4, MMI_ALL_LANG, {HINDI_C_DA, HINDI_S_HALANT, HINDI_C_BA, HINDI_DV_U, 0x0},
     {HINDI_C_DA, HINDI_S_HALANT, HINDI_C_BA, HINDI_DV_U, 0x0}},
    ...
    {0, 4, 4, MMI_ALL_LANG, {HINDI_C_DA, HINDI_S_HALANT, HINDI_C_BA, HINDI_DV_UU, 0x0},
     {HINDI_C_DA, HINDI_S_HALANT, HINDI_C_BA, HINDI_DV_UU, 0x0}},
    ...
    {0, 4, 4, MMI_ALL_LANG, {HINDI_C_DA, HINDI_S_HALANT, HINDI_C_BA, HINDI_DV_R, 0x0},
     {HINDI_C_DA, HINDI_S_HALANT, HINDI_C_BA, HINDI_DV_R, 0x0}},
    ...
    {1, 6, 5, MMI_ALL_LANG, {HINDI_C_DA, HINDI_S_HALANT, HINDI_C_BA, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_HALANT, 0x0},
     {HINDI_C_DA, HINDI_S_HALANT, HINDI_C_BA, HINDI_SUP_RA, HINDI_S_HALANT, 0x0}},
...
const ire_glyph_info_table_struct RA_Tbl[] = 
{
    ...
    {0, 3, 2, MMI_ALL_LANG, {HINDI_C_RA, HINDI_S_HALANT, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_SUP_RA, HINDI_L_PB_C_BINDU, 0x0}},
    //{0, 3, 2, MMI_ALL_LANG, {HINDI_C_RA, HINDI_S_HALANT, HINDI_DV_CE, 0x0}, {HINDI_SUP_RA, HINDI_L_PB_DVCE, 0x0}},
    //{0, 4, 3, MMI_ALL_LANG, {HINDI_C_RA, HINDI_S_HALANT, HINDI_DV_CE, HINDI_S_BINDU, 0x0}, {HINDI_SUP_RA, HINDI_L_PB_DVCE, HINDI_L_PB_SUPRA_C_BINDU, 0x0}},
...
const ire_glyph_info_table_struct RRA_Tbl[] = 
{
    ...
    {0, 2, 2, MMI_ALL_LANG, {HINDI_C_RRA, HINDI_DV_U, 0x0}, {HINDI_L_RU, HINDI_S_NUKTA, 0x0}},
    {0, 2, 2, MMI_ALL_LANG, {HINDI_C_RRA, HINDI_DV_UU, 0x0}, {HINDI_L_RUU, HINDI_S_NUKTA, 0x0}},
};
...
const ire_glyph_info_table_struct LA_Tbl[] = 
{
    ...
    {0, 3, 1, MMI_ALL_LANG, {HINDI_C_LA, HINDI_S_HALANT, HINDI_C_RA, 0x0}, {HINDI_L_LA_RA, 0x0}},
	#if defined(__MMI_LANG_MARATHI__)
...
const ire_glyph_info_table_struct LLA_Tbl[] = 
{
    ...
    {0, 3, 2, MMI_ALL_LANG, {HINDI_C_LLA, HINDI_S_HALANT, HINDI_C_RA, 0x0}, {HINDI_C_LLA, HINDI_SUB_RA, 0x0}},
    {1, 4, 3, MMI_ALL_LANG, {HINDI_C_LLA, HINDI_S_HALANT, HINDI_C_RA, HINDI_S_HALANT, 0x0}, {HINDI_H_LLA, HINDI_C_RA, HINDI_S_HALANT, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_C_LLA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_U, 0x0}, {HINDI_H_LLA, HINDI_L_RU, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_C_LLA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_UU, 0x0}, {HINDI_H_LLA, HINDI_L_RUU, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_C_LLA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_R, 0x0}, {HINDI_H_LLA, HINDI_C_RA, HINDI_DV_R, 0x0}},
    {1, 6, 4, MMI_ALL_LANG, {HINDI_C_LLA, HINDI_S_HALANT, HINDI_C_RA, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_HALANT, 0x0}, {HINDI_H_LLA, HINDI_C_RA, HINDI_SUP_RA, HINDI_S_HALANT, 0x0}},
...
const ire_glyph_info_table_struct SSA_Tbl[] = 
{
    ...
    {0, 3, 2, MMI_ALL_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_RA, 0x0}, {HINDI_C_SSA, HINDI_SUB_RA, 0x0}},
    {0, 4, 2, MMI_ALL_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_U, 0x0}, {HINDI_H_SSA, HINDI_L_RU, 0x0}},
    {0, 4, 2, MMI_ALL_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_UU, 0x0}, {HINDI_H_SSA, HINDI_L_RUU, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_R, 0x0}, {HINDI_H_SSA, HINDI_C_RA, HINDI_DV_R, 0x0}},
    {1, 4, 3, MMI_ALL_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_RA, HINDI_S_HALANT, 0x0}, {HINDI_H_SSA, HINDI_C_RA, HINDI_S_HALANT, 0x0}},
    #if defined(__MMI_LANG_MARATHI__)
    {0, 5, 1, MMI_MARATHI_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_TTA, HINDI_S_HALANT, HINDI_C_RA, 0x0}, {HINDI_L_SSA_TTA_RA, 0x0}},
    #endif
    {1, 6, 4, MMI_ALL_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_RA, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_HALANT, 0x0}, {HINDI_H_SSA, HINDI_C_RA, HINDI_SUP_RA, HINDI_S_HALANT, 0x0}},
    #if defined(__MMI_LANG_MARATHI__)
    {0, 6, 3, MMI_MARATHI_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_TTA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_U, 0x0}, {HINDI_L_SSA_TTA, HINDI_S_HALANT, HINDI_L_RU, 0x0}},
    {0, 6, 3, MMI_MARATHI_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_TTA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_UU, 0x0}, {HINDI_L_SSA_TTA, HINDI_S_HALANT, HINDI_L_RUU, 0x0}},
    {0, 6, 4, MMI_MARATHI_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_TTA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_R, 0x0}, {HINDI_L_SSA_TTA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_R, 0x0}},
    {1, 6, 4, MMI_MARATHI_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_TTA, HINDI_S_HALANT, HINDI_C_RA, HINDI_S_HALANT, 0x0}, {HINDI_L_SSA_TTA, HINDI_S_HALANT, HINDI_C_RA, HINDI_S_HALANT, 0x0}},
    {1, 8, 5, MMI_MARATHI_LANG, {HINDI_C_SSA, HINDI_S_HALANT, HINDI_C_TTA, HINDI_S_HALANT, HINDI_C_RA, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_HALANT, 0x0}, {HINDI_L_SSA_TTA, HINDI_S_HALANT, HINDI_C_RA, HINDI_SUP_RA, HINDI_S_HALANT, 0x0}},
    #endif /* defined(__MMI_LANG_MARATHI__) */ 
...
const ire_glyph_info_table_struct HA_Tbl[] = 
{
    ...
    {0, 4, 3, MMI_ALL_LANG, {HINDI_C_HA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_U, 0x0},
     {HINDI_C_HA, HINDI_S_HALANT, HINDI_L_RU, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_C_HA, HINDI_S_HALANT, HINDI_C_RA, HINDI_DV_UU, 0x0},
     {HINDI_C_HA, HINDI_S_HALANT, HINDI_L_RUU, 0x0}},
...
const ire_glyph_info_table_struct II_Tbl[] = 
{
    ...
    {0, 2, 2, MMI_ALL_LANG, {HINDI_IV_II, HINDI_S_BINDU, 0x0}, {HINDI_IV_II, HINDI_L_PB_BINDU, 0x0}},
};
...
const ire_glyph_info_table_struct NCE_Tbl[] = 
{
    ...
    {0, 2, 2, MMI_ALL_LANG, {HINDI_NIV_CE, HINDI_S_BINDU, 0x0}, {HINDI_NIV_CE, HINDI_L_PB_BINDU, 0x0}}
};
...
const ire_glyph_info_table_struct NCO_Tbl[] = 
{
    ...
    {0, 2, 2, MMI_ALL_LANG, {HINDI_NIV_CO, HINDI_S_BINDU, 0x0}, {HINDI_NIV_CO, HINDI_L_PB_BINDU, 0x0}}
};

const ire_glyph_info_table_struct NCSO_Tbl[] = 
{
    {0, 1, 1, MMI_ALL_LANG, {HINDI_NIV_SO, 0x0}, {HINDI_NIV_SO, 0x0}},
    {0, 2, 2, MMI_ALL_LANG, {HINDI_NIV_SO, HINDI_S_BINDU, 0x0}, {HINDI_NIV_SO, HINDI_L_PB_BINDU, 0x0}}
};

const ire_glyph_info_table_struct O_Tbl[] = 
{
    {0, 1, 1, MMI_ALL_LANG, {HINDI_IV_O, 0x0}, {HINDI_IV_O, 0x0}},
    {0, 2, 2, MMI_ALL_LANG, {HINDI_IV_O, HINDI_S_BINDU, 0x0}, {HINDI_IV_O, HINDI_L_PB_BINDU, 0x0}}
};

const ire_glyph_info_table_struct AU_Tbl[] = 
{
    {0, 1, 1, MMI_ALL_LANG, {HINDI_IV_AU, 0x0}, {HINDI_IV_AU, 0x0}},
    {0, 2, 2, MMI_ALL_LANG, {HINDI_IV_AU, HINDI_S_BINDU, 0x0}, {HINDI_IV_AU, HINDI_L_PB_BINDU, 0x0}}
};
...
const ire_glyph_info_table_struct MAA_Tbl[] = 
{
    ...
    {0, 3, 1, MMI_ALL_LANG, {HINDI_DV_AA, HINDI_C_RA, HINDI_S_HALANT, 0x0}, {HINDI_L_DVAARA , 0x0}},
    {0, 4, 2, MMI_ALL_LANG, {HINDI_DV_AA, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_BINDU, 0x0}, {HINDI_L_DVAARA, HINDI_L_PB_BINDU, 0x0}},
    {0, 4, 2, MMI_ALL_LANG, {HINDI_DV_AA, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_L_DVAARA, HINDI_L_PB_C_BINDU, 0x0}}
};
...
const ire_glyph_info_table_struct MII_Tbl[] = 
{
    ...
    {0, 4, 2, MMI_ALL_LANG, {HINDI_DV_II, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_L_MIIRA, HINDI_L_PB_C_BINDU, 0x0}}
};
...
const ire_glyph_info_table_struct MC_Tbl[] = 
{
    ...
    {0, 2, 2, MMI_ALL_LANG, {HINDI_DV_CE, HINDI_S_BINDU, 0x0}, {HINDI_DV_CE, HINDI_L_PB_BINDU, 0x0}},
    {0, 2, 2, MMI_ALL_LANG, {HINDI_DV_CE, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_DV_CE, HINDI_L_PB_C_BINDU, 0x0}},
    {0, 3, 2, MMI_ALL_LANG, {HINDI_DV_CE, HINDI_C_RA, HINDI_S_HALANT, 0x0}, {HINDI_DV_CE, HINDI_L_PB_SUP_RA, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_DV_CE, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_BINDU, 0x0}, {HINDI_DV_CE, HINDI_L_PB_SUP_RA, HINDI_L_PB_BINDU, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_DV_CE, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_DV_CE, HINDI_L_PB_SUP_RA, HINDI_L_PB_C_BINDU, 0x0}},
};

const ire_glyph_info_table_struct MNDVE_Tbl[] = 
{
    {0, 1, 1, MMI_ALL_LANG, {HINDI_NDV_E, 0x0}, {HINDI_NDV_E, 0x0}},
    {0, 2, 2, MMI_ALL_LANG, {HINDI_NDV_E, HINDI_S_BINDU, 0x0}, {HINDI_NDV_E, HINDI_L_PB_BINDU, 0x0}},
    {0, 2, 2, MMI_ALL_LANG, {HINDI_NDV_E, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_NDV_E, HINDI_L_PB_C_BINDU, 0x0}},
    {0, 3, 2, MMI_ALL_LANG, {HINDI_NDV_E, HINDI_C_RA, HINDI_S_HALANT, 0x0}, {HINDI_NDV_E, HINDI_L_PB_SUP_RA, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_NDV_E, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_BINDU, 0x0}, {HINDI_NDV_E, HINDI_L_PB_SUP_RA, HINDI_L_PB_BINDU, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_NDV_E, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_NDV_E, HINDI_L_PB_SUP_RA, HINDI_L_PB_C_BINDU, 0x0}},
};
...
const ire_glyph_info_table_struct ME_Tbl[] = 
{
    ...
    {0, 3, 2, MMI_ALL_LANG, {HINDI_DV_E, HINDI_C_RA, HINDI_S_HALANT, 0x0}, {HINDI_DV_E, HINDI_L_PB_SUP_RA, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_DV_E, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_BINDU, 0x0}, {HINDI_DV_E, HINDI_L_PB_SUP_RA, HINDI_L_PB_BINDU, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_DV_E, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_DV_E, HINDI_L_PB_SUP_RA, HINDI_L_PB_C_BINDU, 0x0}}
};
...
const ire_glyph_info_table_struct MAI_Tbl[] = 
{
    ...
    {0, 3, 2, MMI_ALL_LANG, {HINDI_DV_AI, HINDI_C_RA, HINDI_S_HALANT, 0x0}, {HINDI_DV_AI, HINDI_L_PB_SUP_RA, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_DV_AI, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_BINDU, 0x0}, {HINDI_DV_AI, HINDI_L_PB_SUP_RA, HINDI_L_PB_BINDU, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_DV_AI, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_DV_AI, HINDI_L_PB_SUP_RA, HINDI_L_PB_C_BINDU, 0x0}}
};

const ire_glyph_info_table_struct MCO_Tbl[] = 
{
    {0, 1, 1, MMI_ALL_LANG, {HINDI_NDV_CO, 0x0}, {HINDI_NDV_CO, 0x0}},
    {0, 2, 2, MMI_ALL_LANG, {HINDI_NDV_CO, HINDI_S_BINDU, 0x0}, {HINDI_NDV_CO, HINDI_L_PB_BINDU, 0x0}},
    {0, 2, 2, MMI_ALL_LANG, {HINDI_NDV_CO, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_NDV_CO, HINDI_L_PB_C_BINDU, 0x0}},
    {0, 3, 2, MMI_ALL_LANG, {HINDI_NDV_CO, HINDI_C_RA, HINDI_S_HALANT, 0x0}, {HINDI_NDV_CO, HINDI_L_PB_SUP_RA, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_NDV_CO, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_NDV_CO, HINDI_L_PB_SUP_RA, HINDI_L_PB_C_BINDU, 0x0}},
    {0, 4, 3, MMI_ALL_LANG, {HINDI_NDV_CO, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_BINDU, 0x0}, {HINDI_NDV_CO, HINDI_L_PB_SUP_RA, HINDI_L_PB_BINDU, 0x0}},
};
...
const ire_glyph_info_table_struct MO_Tbl[] = 
{
    ...
    {0, 4, 2, MMI_ALL_LANG, {HINDI_DV_O, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_L_DVORA, HINDI_L_PB_C_BINDU, 0x0}}
};
...
const ire_glyph_info_table_struct MAU_Tbl[] = 
{
    ...
    {0, 4, 2, MMI_ALL_LANG, {HINDI_DV_AU, HINDI_C_RA, HINDI_S_HALANT, HINDI_S_CHANDRA_BINDU, 0x0}, {HINDI_L_DVAURA, HINDI_L_PB_C_BINDU, 0x0}}
};
...
const ire_main_glyph_table_struct hfDvngTbl[] = 
{
    ...
    ,
    {II_Tbl, sizeof(II_Tbl) / sizeof(II_Tbl[0]), 2}
    ,
    ...
    ,
    {NCSO_Tbl, sizeof(NCSO_Tbl) / sizeof(NCSO_Tbl[0]), 2}
    ,
    ...
    ,
    {LLA_Tbl, sizeof(LLA_Tbl) / sizeof(LLA_Tbl[0]), 6}
    ,
    ...
    ,
    #if defined (__MMI_LANG_MARATHI__)
    {SSA_Tbl, sizeof(SSA_Tbl) / sizeof(SSA_Tbl[0]), 8}
    #else
    {SSA_Tbl, sizeof(SSA_Tbl) / sizeof(SSA_Tbl[0]), 6}
    #endif
    ,
    ...
    {NULL, 0, 0}
    ,
    {MC_Tbl, sizeof(MC_Tbl) / sizeof(MC_Tbl[0]), 4}
    ,
    {MNDVE_Tbl, sizeof(MNDVE_Tbl) / sizeof(MNDVE_Tbl[0]), 4}
    ,
    {ME_Tbl, sizeof(ME_Tbl) / sizeof(ME_Tbl[0]), 4}
    ,
    {MAI_Tbl, sizeof(MAI_Tbl) / sizeof(MAI_Tbl[0]), 4}
    ,
    {MCO_Tbl, sizeof(MCO_Tbl) / sizeof(MCO_Tbl[0]), 4}
    ,
    {NULL, 0, 0}
    ,
...
#elif 0//defined(__MMI_GB_HINDI__)
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
UI_character_type *get_hindi_multitap_string_for_vk(S32 i)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
