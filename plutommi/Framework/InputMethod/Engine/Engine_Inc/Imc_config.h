...
#define MULTITAP_SIM_NUMERIC_MAX_KEY_CHAR (3)
#define MULTITAP_PHONE_NUMBER_MAX_KEY_CHAR (5)
#else
#define MULTITAP_SIM_NUMERIC_MAX_KEY_CHAR (2)
#define MULTITAP_PHONE_NUMBER_MAX_KEY_CHAR (4)
#endif
