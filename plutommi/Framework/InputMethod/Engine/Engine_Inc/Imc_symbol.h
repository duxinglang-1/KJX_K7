 ...
 *****************************************************************************/
typedef enum {
    MMI_IMC_KEY_BASE    = 0x01,
    MMI_IMC_KEY_SYM_0       = MMI_IMC_KEY_BASE,
    MMI_IMC_KEY_SYM_1,
    MMI_IMC_KEY_SYM_2,
    MMI_IMC_KEY_SYM_3,
    MMI_IMC_KEY_SYM_4,
    ...
    MMI_IMC_KEY_SYM_Y,
    MMI_IMC_KEY_SYM_Z,
    MMI_IMC_KEY_SYM_PERIOD,  //THis sequence is being used in x9 (period immediately after z, so dont change this) 
    MMI_IMC_KEY_SYM_DOLLAR,
    MMI_IMC_KEY_SYM_QUESTION,
    MMI_IMC_KEY_SYM_END,
    MMI_IMC_KEY_UP,
    MMI_IMC_KEY_DOWN,
    MMI_IMC_KEY_PAGE_UP,
    MMI_IMC_KEY_PAGE_DOWN,
    MMI_IMC_KEY_LEFT,
    MMI_IMC_KEY_RIGHT,
    MMI_IMC_KEY_LSK,
    MMI_IMC_KEY_RSK,
    ...
    MMI_IMC_KEY_NEW_LINE,
    MMI_IMC_KEY_NUM_LOCK,
    MMI_IMC_KEY_FN,
    MMI_IMC_KEY_SWITCH_BETWEEN_SMART_AND_MULTITAP,
    MMI_IMC_KEY_SYM_QWERTY,
    #if defined(__MMI_GUOBI__)
    MMI_IMC_KEY_SEEMLESS_SWITCH,
    #endif
    MMI_IMC_KEY_MAX,
    MMI_IMC_KEY_INVALID
}   mmi_imc_key_custom_value;

#undef MMI_IMC_SYMB_MAX
#define MMI_IMC_SYMB_MAX 0

typedef enum {
    MMI_IMC_SYMB_TONE_BASE = MMI_IMC_SYMB_MAX + 1,
...
#undef MMI_IMC_SYMB_MAX
#define MMI_IMC_SYMB_MAX MMI_IMC_SYMB_TONE_MAX

#if defined(__MMI_LANG_SM_CHINESE__) || defined(__MMI_LANG_TR_CHINESE__) || defined(__MMI_LANG_HK_CHINESE__)

typedef enum {
    MMI_IMC_SYMB_STROKE_ZEROTH,    // FOR RESOLVING THE BUILD WARNING
    MMI_IMC_SYMB_STROKE_BASE        = MMI_IMC_SYMB_MAX + 1,
...
#undef MMI_IMC_SYMB_MAX
#define MMI_IMC_SYMB_MAX MMI_IMC_SYMB_STROKE_MAX

#endif /* defined(__MMI_LANG_SM_CHINESE__) || defined(__MMI_LANG_TR_CHINESE__) || defined(__MMI_LANG_HK_CHINESE__) */

typedef enum {
    MMI_IMC_SYMB_KEY_BASE   = MMI_IMC_SYMB_MAX + 1,
    ...
    MMI_IMC_SYMB_KEY_MULTITAP_MAX,
    MMI_IMC_SYMB_KEY_A = MMI_IMC_SYMB_KEY_MULTITAP_MAX,
    MMI_IMC_SYMB_KEY_B,
    MMI_IMC_SYMB_KEY_C,
    MMI_IMC_SYMB_KEY_D,
    MMI_IMC_SYMB_KEY_E,
    ...
    MMI_IMC_SYMB_KEY_Y,
    MMI_IMC_SYMB_KEY_Z,
    MMI_IMC_SYMB_KEY_PERIOD,
    MMI_IMC_SYMB_KEY_MAX,
    MMI_IMC_SYMB_KEY_INVALID
}   mmi_imc_symbol_key_enum;

#undef MMI_IMC_SYMB_MAX
#define MMI_IMC_SYMB_MAX MMI_IMC_SYMB_KEY_INVALID


#if defined(__MMI_LANG_SM_CHINESE__)
typedef enum {
    MMI_IMC_SYMB_PY_BASE    = MMI_IMC_SYMB_MAX + 1,
...
#undef MMI_IMC_SYMB_MAX
#define MMI_IMC_SYMB_MAX MMI_IMC_SYMB_PY_MAX

#endif /* #if defined(__MMI_LANG_SM_CHINESE__) */

#if defined(__MMI_LANG_TR_CHINESE__)
typedef enum {
    MMI_IMC_SYMB_ZY_BASE    = MMI_IMC_SYMB_MAX + 1,
...
#undef MMI_IMC_SYMB_MAX
#define MMI_IMC_SYMB_MAX MMI_IMC_SYMB_ZY_MAX

#endif /* #if defined(__MMI_LANG_TR_CHINESE__) */

/* The API  mmi_ime_word_code_to_symbol() used 0xFF as error , Make sure not to use it here in this enum */
#define MMI_IMC_SYMB_SEPARATER    (MMI_IMC_SYMB_MAX + 1)
