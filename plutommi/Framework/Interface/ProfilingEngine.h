...
#define MMI_FRM_PROFILING_MASK_4 (0x08)
...
#define MMI_FRM_BENCHMARK_MAX_RULE          33
...
typedef enum
{
    ...
    MMI_FRM_BENCHMARK_BORDER_STRING_DISPLAY,                    /*Print border text */
...
extern void mmi_frm_profiling_interactive_start4(void);
...
extern void mmi_frm_profiling_interactive_end4(void);
...
typedef void (*frm_show_func) (U8 *str, void *user_data);
extern void mmi_frm_profiling_interactive_register_show_callback(frm_show_func show_func, void* user_data);
#endif /* PROFILING_H */ 
