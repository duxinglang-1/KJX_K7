 ...
 * PARAMETERS
 *  outstr: [IN] the output string address
 *  fmt :   [IN] the format string id
 * RETURNS
 *  the output string address
 *****************************************************************************/
extern WCHAR* mmi_wsprintf(WCHAR *buff, U32 buf_size, MMI_STR_ID fmt, ...);
 ...
 * PARAMETERS
 *  outstr: [IN] the output string address
 *  fmt :   [IN] the format string, such as "hello%d"
 * RETURNS
 *  the output string address
 *****************************************************************************/
extern WCHAR*  mmi_wsprintf_ex(WCHAR *buff, U32 buf_size, const WCHAR *fmt, ...);
