...
extern MMI_BOOL is_thai_valid_input_int(UI_string_type candidate, U8 strlen, UI_string_type previous_string);
extern MMI_BOOL is_thai_valid_input(U16 *Unicode, U8 strlen);
