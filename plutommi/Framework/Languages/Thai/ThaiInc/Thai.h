...
#define THAI_IS_UCS2_CHARACTER_RANGE(ch) (((ch) >= 0x0E01 && (ch) <= 0x0E7F)? 1 : 0)
...
/* character type (use 16 bit) */
#define THAI_CHAR_NONE 0
#define THAI_CHAR_LONGTAIL_CONSONANT 1
#define THAI_CHAR_UNDERTAIL_CONSONANT  (1<<1)
#define THAI_CHAR_NORMAL_CONSONANT (1<<2)
#define THAI_CHAR_SPLITTAIL_CONSONANT (1<<3)
#define THAI_CHAR_LEAD_VOWEL (1<<4)
#define THAI_CHAR_FOLLOW_VOWEL (1<<5)
#define THAI_CHAR_ABOVE_VOWEL (1<<6)
#define THAI_CHAR_BELOW_VOWEL (1<<7)
#define THAI_CHAR_TONE_MARK (1<<8)
#define THAI_CHAR_DIGIT (1<<9)
#define THAI_CHAR_SIGN (1<<10)
#define THAI_CHAR_CURRENCY_SYMBOL (1<<11)

#define THAI_CHAR_CONSONANT (THAI_CHAR_LONGTAIL_CONSONANT | THAI_CHAR_UNDERTAIL_CONSONANT |THAI_CHAR_NORMAL_CONSONANT | THAI_CHAR_SPLITTAIL_CONSONANT)


/* character position (use 16 bit) */
#define THAI_CHAR_POSITION_NONE 0
#define THAI_CHAR_POSITION_BASELINE 1
#define THAI_CHAR_POSITION_BELOW (1<<1)
#define THAI_CHAR_POSITION_UPGRADEABLE (1<<2)
#define THAI_CHAR_POSITION_ABOVE_L1 (1<<3)
#define THAI_CHAR_POSITION_ABOVE_L2 (1<<4)

#define THAI_CHAR_POSITION_ABOVE (THAI_CHAR_POSITION_ABOVE_L1|THAI_CHAR_POSITION_ABOVE_L2)
...
*****************************************************************************/
extern void mmi_lm_thai_get_current_cluster(
            PU8 start, 
            PU8 end, 
            ...
            MMI_BOOL pos_only);
extern void mmi_lm_thai_get_next_cluster(
            PU8 start, 
            PU8 end, 
            PU8 cursor, 
            MMI_BOOL pos_only,
            mmi_lm_cluster_info_p next_cluster);
extern void mmi_lm_thai_get_prev_cluster(
            PU8 start, 
            PU8 end, 
            PU8 cursor, 
            MMI_BOOL pos_only,
...
extern void mmi_lm_thai_draw_cluster(mmi_lm_show_cluster_param_p param);

extern S32 mmi_lm_thai_cluster_translate(UI_string_type src, UI_string_type dst, S32 len);
