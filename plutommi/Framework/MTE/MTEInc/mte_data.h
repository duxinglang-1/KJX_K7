...
static S32 mmi_mte_category_filter_108[] = {MMI_CATEGORY264_ID, -1};
static S32 mmi_mte_category_filter_164[] = {MMI_CATEGORY12_ID, MMI_CATEGORY140_ID, MMI_CATEGORY186_ID, MMI_CATEGORY384_ID, -1};
static S32 mmi_mte_category_filter_165[] = {MMI_CATEGORY12_ID, MMI_CATEGORY140_ID, MMI_CATEGORY186_ID, MMI_CATEGORY384_ID, -1};
static S32 mmi_mte_category_filter_166[] = {MMI_CATEGORY36_ID, MMI_CATEGORY109_ID, MMI_CATEGORY172_ID, -1};
static S32 mmi_mte_category_filter_167[] = {MMI_CATEGORY36_ID, MMI_CATEGORY109_ID, MMI_CATEGORY172_ID, -1};
...
static mmi_mte_theme_component_struct g_mmi_mte_theme_component_info[MMI_MTE_THEME_COMPONENT_NUM] =
{
    ...
    {"popup_text_color", 108, 18, MMI_MTE_THEME_DATA_TYPE_COLOR, NULL, 1, 0, 0, 0, 0, {432, 0, "", {0}, mmi_mte_category_filter_108}},
    ...
    {"idle_scr_sim2_network_name_color", 247, 10, MMI_MTE_THEME_DATA_TYPE_COLOR, NULL, 1, 0, 0, 0, 0, {988, 0, "", {0}, NULL}},
#else
    {"idle_scr_sim2_network_name_color", 247, 10, MMI_MTE_THEME_DATA_TYPE_COLOR, NULL, 0, 0, 0, 0, 0, {988, 0, "", {0}, NULL}},
#endif
#if defined(__MMI_DUAL_SIM_MASTER__)
    {"idle_scr_sim2_network_name_border_color", 248, 10, MMI_MTE_THEME_DATA_TYPE_TEXT_BORDER_COLOR, NULL, 1, 0, 0, 0, 0, {992, 0, "", {0}, NULL}},
#else
    {"idle_scr_sim2_network_name_border_color", 248, 10, MMI_MTE_THEME_DATA_TYPE_TEXT_BORDER_COLOR, NULL, 0, 0, 0, 0, 0, {992, 0, "", {0}, NULL}},
#endif
#if defined(__MMI_DUAL_SIM_MASTER__)
    {"idle_scr_sim2_network_status_color", 249, 10, MMI_MTE_THEME_DATA_TYPE_COLOR, NULL, 1, 0, 0, 0, 0, {996, 0, "", {0}, NULL}},
#else
    {"idle_scr_sim2_network_status_color", 249, 10, MMI_MTE_THEME_DATA_TYPE_COLOR, NULL, 0, 0, 0, 0, 0, {996, 0, "", {0}, NULL}},
#endif
#if defined(__MMI_DUAL_SIM_MASTER__)
    {"idle_scr_sim2_network_status_border_color", 250, 10, MMI_MTE_THEME_DATA_TYPE_TEXT_BORDER_COLOR, NULL, 1, 0, 0, 0, 0, {1000, 0, "", {0}, NULL}},
#else
