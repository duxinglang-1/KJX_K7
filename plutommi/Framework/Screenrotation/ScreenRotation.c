...
static mmi_frm_screen_rotate_enum g_mmi_frm_real_prev_screen_rotate = MMI_FRM_SCREEN_ROTATE_0;
static U32 g_mmi_frm_real_current_screen_blt_counter = 0xffffffff;
...
void mmi_frm_screen_rotate(mmi_frm_screen_rotate_enum rotation)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gdi_lcd_get_blt_counter(&blt_counter);
    if (g_mmi_frm_real_current_screen_blt_counter != blt_counter)
    {
        g_mmi_frm_real_prev_screen_rotate = g_mmi_frm_screen_rotate;
        g_mmi_frm_real_current_screen_blt_counter = blt_counter;
    }
...
/*****************************************************************************
 * FUNCTION
 *  mmi_frm_get_real_prev_screen_rotate
 * DESCRIPTION
 *  Get the previous screen rotation value
 *  
 *  It is typically used screens like popup dialog because they need to preserve the display of the previous screens.
 ...
 *  mmi_frm_screen_rotate_enum
 *****************************************************************************/
mmi_frm_screen_rotate_enum mmi_frm_get_real_prev_screen_rotate(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    return g_mmi_frm_real_prev_screen_rotate;
}
