...
/*********  function prototypes ***************/
extern MMI_BOOL mmi_tc_convert_theme_file_to_mmi_theme(MMI_theme **theme_p, U32 file_handle);
...
extern U8 mmi_tc_ascii_to_hex_convert(CHAR character);
