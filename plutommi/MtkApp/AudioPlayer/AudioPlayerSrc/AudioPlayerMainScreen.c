...
*/
    ...
    //gdi_layer_push_and_set_clip(x1-1, y1-1, x2+2, y2+2);
...
/* under construction !*/
	...
	gdi_layer_push_and_set_clip(x, y, audply_main_time.x2, audply_main_time.y2 + offset_y);
    for (i = 0; i < 16; i++)
    {
...
void mmi_audply_redraw_main_time(void)
{
	if(g_audply.in_main_screen)
	{
		wgui_cat223_update_duration(g_audply.new_play_time);
	}
}
