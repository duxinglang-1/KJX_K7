...
void mmi_camera_highlight_custom_fx_set(void)
{
    ...
    SetRightSoftkeyFunction((mmi_void_funcptr_type)mmi_frm_scrn_close_active_id, KEY_EVENT_UP);
    SetKeyHandler((mmi_void_funcptr_type)mmi_frm_scrn_close_active_id, KEY_LEFT_ARROW, KEY_EVENT_DOWN);
}
...
void mmi_camera_image_setting_set_value(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    cui_inline_get_value(g_camera_cntx.setting_img_inline_gid, MMI_CAMERA_SETTING_IMG_IL_QUALITY_SELECT, (void*)&value);
    g_camera_cntx.setting.image_qty = value;
    cui_inline_get_value(g_camera_cntx.setting_img_inline_gid, MMI_CAMERA_SETTING_IMG_IL_SIZE_SELECT, (void*)&value);
    if (g_camera_cntx.setting.image_size != value)
    {
        /* reset zoom to default since image size might changed */
        g_camera_cntx.setting.zoom_idx = CAMERA_DEFAULT_SETTING_ZOOM_IDX;
    }
    g_camera_cntx.setting.image_size = value;
...
static const Category11_data_struct Category11_data_wb = {
    SCR_ID_CAMERA_WB,
    MENU_ID_CAMERA_WB,
    STR_ID_CAMERA_WB,
...
{
    g_pAct_Cat11_data = &Category11_data_wb;
...
*  void
*****************************************************************************/
static S32 mmi_camera_set_dsc_mode_value(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if(g_camera_cntx.selected_dsc_mode == CAMERA_SETTING_DSC_MODE_NIGHT)
