...
void mmi_em_3g_info_tracer_key(void)
{
   ...
   // SetKeyHandler(mmi_em_3g_info_tracer_key_up, KEY_UP_ARROW, KEY_EVENT_DOWN);
    ...
    mmi_frm_set_key_handler(mmi_em_3g_info_tracer_key_up,KEY_UP_ARROW,KEY_EVENT_DOWN);
   
   // SetKeyHandler(mmi_em_3g_info_tracer_key_down, KEY_DOWN_ARROW, KEY_EVENT_DOWN);

   mmi_frm_set_key_handler(mmi_em_3g_info_tracer_key_down, KEY_DOWN_ARROW, KEY_EVENT_DOWN);
  ...
  //  SetKeyHandler(mmi_em_3g_info_tracer_key_down, KEY_VOL_DOWN, KEY_EVENT_DOWN);
   ...
   mmi_frm_set_key_handler(mmi_em_3g_info_tracer_key_up, KEY_VOL_UP, KEY_EVENT_DOWN);
   mmi_frm_set_key_handler(mmi_em_3g_info_tracer_key_down,KEY_VOL_DOWN,KEY_EVENT_DOWN);
