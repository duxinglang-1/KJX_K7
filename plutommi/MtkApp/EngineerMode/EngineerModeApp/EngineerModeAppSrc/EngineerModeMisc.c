...
extern void mmi_em_misc_dm_self_register_result_sim_main(void);
#endif
#ifdef __OP02_DM__
...
/* under construction !*/
        ...
        event->highlighted_menu_id == MENU_ID_EM_FALSE)
    {
        ...
        case MENU_ID_EM_MISC_DM_SELF_REGISTER:
            ...
            break;
    #ifdef __MMI_DUAL_SIM_MASTER__
        case MENU_ID_EM_MISC_DM_SELF_REGISTER_RESULT_DUAL:
    #else
...
#ifdef __MMI_DUAL_SIM_MASTER__
    case MENU_ID_EM_MISC_DM_SELF_REGISTER_RESULT_SIM:
        mmi_em_misc_dm_self_register_result_sim_main();
        break;
#endif /*__MMI_DUAL_SIM_MASTER__*/
#endif /*__MMI_EM_MISC_DM_REGISTER__*/
