 ...
 * removed!
 * removed!
It should set frequency before set volume

[boli.li, 2012/3/11]
Dear kinse,
请帮忙看一下这个issue，
在index为7992和13283分别有set volume的操作，第一次是在FM Radio的widget界面，第二次是在其他widget界面，但是没有看到意外的mute操作，请帮忙看一下第二次设置volume之后为什么仍然处于mute状态
...
[Load Path]
\\mtksfs07\Public3\11B_branch_load\W12.10_Stage1\CHAMPAGNE55N_V2_DEMO_GPRS(FTE_HVGA)\12.10_official_release
