...
void mmi_fmrdo_set_channel(S16 channel_index, U16 freq, UI_string_type name)
{
    ...
    mmi_ucs2cpy((CHAR *) g_fmrdo.channel_list.name[channel_index], (CHAR *) name);
...
#if defined(__MMI_FM_RADIO_MONO__)
    WriteValue(NVRAM_FMRDO_CHANNEL_MONO, &g_fmrdo.mono, DS_BYTE, &error);
#endif 
#if defined(__MMI_FM_RADIO_RECORD__)
...
#endif 
#ifdef __MMI_FM_RADIO_RDS__
    WriteValue(NVRAM_FMRDO_RDS_SETTING, &g_fmrdo.rds.rds_setting.is_rds_on, DS_BYTE, &error);
    WriteValue(NVRAM_FMRDO_RDS_TP_SETTING, &g_fmrdo.rds.rds_setting.is_tp_on, DS_BYTE, &error);
    WriteValue(NVRAM_FMRDO_RDS_AF_SETTING, &g_fmrdo.rds.rds_setting.is_af_on, DS_BYTE, &error);
#endif/*__MMI_FM_RADIO_RDS__*/
...
void mmi_fmrdo_inc_volume(void)
{
    ...
    {
        g_fmrdo.mute = 0;
        WriteValue(NVRAM_FMRDO_MUTE, &g_fmrdo.mute, DS_BYTE, &error);
    }
...
void mmi_fmrdo_init_nvram(void)
{
    ...
    ReadValue(NVRAM_FMRDO_MUTE, &g_fmrdo.mute, DS_BYTE, &error);
    if (g_fmrdo.mute != 1)
    {
        g_fmrdo.mute = 0;
    }
...
#if defined(__MMI_FM_RADIO_MONO__)
    ReadValue(NVRAM_FMRDO_CHANNEL_MONO, &g_fmrdo.mono, DS_BYTE, &error);
...
#ifdef __MMI_FM_RADIO_RDS__
#ifndef __MMI_FM_PLUTO_SLIM__
    ReadValue(NVRAM_FMRDO_RDS_SETTING, (U8*)&g_fmrdo.rds.rds_setting.is_rds_on, DS_BYTE, &error);
    ReadValue(NVRAM_FMRDO_RDS_AF_SETTING, (U8*)&g_fmrdo.rds.rds_setting.is_af_on, DS_BYTE, &error);
    ReadValue(NVRAM_FMRDO_RDS_TP_SETTING, (U8*)&g_fmrdo.rds.rds_setting.is_tp_on, DS_BYTE, &error);
...
void mmi_fmrdo_main_register_keys(void)
{
    ...
    SetKeyHandler(button_long_press_hdlr[skin_p->left_key_mapping], KEY_LEFT_ARROW, KEY_LONG_PRESS);
    SetKeyHandler(button_long_press_hdlr[skin_p->right_key_mapping], KEY_RIGHT_ARROW, KEY_LONG_PRESS);
    SetKeyHandler(button_long_press_hdlr[skin_p->up_key_mapping], KEY_UP_ARROW, KEY_LONG_PRESS);
    SetKeyHandler(button_long_press_hdlr[skin_p->down_key_mapping], KEY_DOWN_ARROW, KEY_LONG_PRESS);
#endif /* __MMI_FTE_SUPPORT__ */
...
#else
    SetKeyHandler(button_release_hdlr[skin_p->center_key_mapping], KEY_CSK, KEY_EVENT_UP);
    SetKeyHandler(button_release_hdlr[skin_p->left_key_mapping], KEY_LEFT_ARROW, KEY_EVENT_UP);
    SetKeyHandler(button_release_hdlr[skin_p->right_key_mapping], KEY_RIGHT_ARROW, KEY_EVENT_UP);
    SetKeyHandler(button_release_hdlr[skin_p->up_key_mapping], KEY_UP_ARROW, KEY_EVENT_UP);
    SetKeyHandler(button_release_hdlr[skin_p->down_key_mapping], KEY_DOWN_ARROW, KEY_EVENT_UP);
    SetKeyHandler(button_press_hdlr[skin_p->center_key_mapping], KEY_CSK, KEY_EVENT_DOWN);
    SetKeyHandler(button_press_hdlr[skin_p->left_key_mapping], KEY_LEFT_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(button_press_hdlr[skin_p->right_key_mapping], KEY_RIGHT_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(button_press_hdlr[skin_p->up_key_mapping], KEY_UP_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(button_press_hdlr[skin_p->down_key_mapping], KEY_DOWN_ARROW, KEY_EVENT_DOWN);    
    ...
    SetKeyHandler(mmi_fmrdo_inc_volume, KEY_VOL_UP, KEY_EVENT_REPEAT);
    SetKeyHandler(mmi_fmrdo_dec_volume, KEY_VOL_DOWN, KEY_EVENT_REPEAT);

    SetKeyHandler(mmi_fmrdo_inc_volume, KEY_POUND, KEY_EVENT_DOWN);
    SetKeyHandler(mmi_fmrdo_dec_volume, KEY_STAR, KEY_EVENT_DOWN);
    SetKeyHandler(mmi_fmrdo_inc_volume, KEY_POUND, KEY_EVENT_REPEAT);
    SetKeyHandler(mmi_fmrdo_dec_volume, KEY_STAR, KEY_EVENT_REPEAT);
#endif

#ifdef __MMI_SLIM_IMG_RES__
    SetKeyHandler(button_release_hdlr[FMRDO_BUTTON_POWER], KEY_ENTER, KEY_EVENT_UP);
    SetKeyHandler(button_press_hdlr[FMRDO_BUTTON_POWER], KEY_ENTER, KEY_EVENT_DOWN);
#endif /* __MMI_SLIM_IMG_RES__ */
    ...
    SetKeyHandler(mmi_fmrdo_LSK_up_hdlr, KEY_LSK, KEY_EVENT_UP);
    SetKeyHandler(mmi_fmrdo_RSK_up_hdlr, KEY_RSK, KEY_EVENT_UP);
    SetKeyHandler(MMI_dummy_function, KEY_LSK, KEY_EVENT_REPEAT);
    SetKeyHandler(MMI_dummy_function, KEY_RSK, KEY_EVENT_REPEAT);
    ...
    SetKeyHandler(mmi_fmrdo_repeat_volume_up, KEY_VOL_UP, KEY_EVENT_REPEAT);
    SetKeyHandler(mmi_fmrdo_repeat_volume_down, KEY_VOL_DOWN, KEY_EVENT_REPEAT);
#endif /* MULTIMIDIA_FTE2_KEY_ONLY_SUPPORT */
...
pBOOL mmi_fmrdo_channel_list_item(S32 item_index, UI_string_type str_buff, PU8 *img_buff_p, U8 str_img_mask)
{
    ...
    *img_buff_p = wgui_get_list_menu_icon(item_index,IMG_GLOBAL_L1);
...
S32 mmi_fmrdo_channel_list_item_hint(S32 item_index, UI_string_type *hint_array)
{
    ...
    mmi_ucs2cpy((CHAR *) hint_array[0], (CHAR *) name);
...
void mmi_fmrdo_entry_preset_list_confirm(void)
{
    ...
    mmi_confirm_display_ext(STR_ID_FMRDO_PRESET_LIST,
                            MMI_EVENT_QUERY,
                            &confirm_arg);
}
...
void mmi_fmrdo_entry_main_record_screen(void)
{
    ...
    SetKeyHandler(mmi_fmrdo_release_rsk_stop, KEY_RSK, KEY_EVENT_UP);
    ...
    SetKeyHandler(mmi_fmrdo_release_rsk_stop, KEY_RSK, KEY_EVENT_UP);
#ifndef __MMI_SLIM_IMG_RES__
    SetKeyHandler(mmi_fmrdo_release_pause_button, KEY_CSK, KEY_EVENT_UP);
#endif /* __MMI_SLIM_IMG_RES__ */
#endif 
...
#ifndef __MMI_SLIM_IMG_RES__
    SetKeyHandler(mmi_fmrdo_release_resume_button, KEY_CSK, KEY_EVENT_UP);
#endif /*__MMI_SLIM_IMG_RES__*/    
#endif 
...
void mmi_fmrdo_entry_hw_searching_screen(void)
{
    ...
    ClearInputEventHandler(MMI_DEVICE_KEY);
    SetKeyHandler(mmi_fmrdo_redraw_main_LSK_down, KEY_LSK, KEY_EVENT_DOWN);
    SetKeyHandler(mmi_fmrdo_hw_stop_searching, KEY_LSK, KEY_EVENT_UP);
}
