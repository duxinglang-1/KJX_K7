...
#ifdef __KJX_FUN__
#ifdef __KJX_BAT_STATUS_LED_SHOW__
	mmi_fm_bat_led_struct		bat_led_contxt;
#endif
#ifdef __KJX_FUN_GPS__
	mmi_fm_gps_struct			gps_contxt;
#endif
#ifdef __KJX_RFID__
	mmi_fm_rfid_struct			rfid_contxt;
#endif
#ifdef __BLE_MODULE_SUPPORT__
	mmi_fm_ble_struct			ble_contxt;
#endif
#ifdef __BOSCH_BMP280_PRESSURE__
	mmi_fm_pressure_struct		pressure_contxt;
#endif
#ifdef __MOTION_SENSOR_MC3451_SUPPORT__
	mmi_fm_sensor_struct		sensor_contxt;
#endif
#endif/*__KJX_FUN__*/
