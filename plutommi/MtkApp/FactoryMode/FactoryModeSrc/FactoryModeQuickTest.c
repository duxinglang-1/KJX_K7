...
static void mmi_fm_enter_auto_test(void)
{
	...
	SetKeyHandler(EntryFMAutoTestReport, KEY_BACK, KEY_EVENT_UP);
#endif
...
#if defined(__KJX_FUN__)&&defined(__SLC_FACTORY_TEST__)
/*****************************************************************************
 * FUNCTION
 *	FM_AutoTest_MIC
 * DESCRIPTION
 ...
 *	void
 *****************************************************************************/
void slc_mmi_fm_enter_quick_test_mic(void)
{
	/*----------------------------------------------------------------*/
	/* Local Variables												  */
	/*----------------------------------------------------------------*/
...
void FM_AutoTest_Battery(void)
{
	...
	mmi_frm_set_protocol_event_handler(MSG_ID_MMI_EQ_ADC_ALL_CHANNEL_IND, 
									(PsIntFuncPtr)FM_AutoTestUpdateADCHdlr, MMI_FALSE);
