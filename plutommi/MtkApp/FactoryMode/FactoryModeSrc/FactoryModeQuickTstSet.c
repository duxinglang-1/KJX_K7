...
static S32 mmi_fm_misc_auto_test_update_nvram()
{
   ...
   // nvram_ef_autotest_struct testdata;
    ...
    return WriteRecord(NVRAM_EF_QUICKTEST_LID, 1, &testdata2, NVRAM_EF_QUICKTEST_SIZE, &ErrorCode);
}
...
void mmi_fm_WriteTestResultToNVRAM(void)
{
   ...
   // nvram_ef_autotest_struct testdata;
    ...
    WriteRecord(NVRAM_EF_QUICKTEST_LID, 2, &testdata2, NVRAM_EF_QUICKTEST_SIZE, &ErrorCode);
...
//    memset(&testdata, 0, sizeof(testdata));
    ReadRecord(NVRAM_EF_QUICKTEST_LID, 1, &testdata2, NVRAM_EF_QUICKTEST_SIZE, &ErrorCode);
...
//    memset(&testdata, 0, sizeof(testdata));
    ...
    WriteRecord(NVRAM_EF_QUICKTEST_LID, 1, &testdata2, NVRAM_EF_QUICKTEST_SIZE, &ErrorCode);
...
extern void mmi_fm_ReadSettingsFromNVRAM(U8 Type)
{
    ...
    ReadRecord(NVRAM_EF_QUICKTEST_LID, i, &testdata2, NVRAM_EF_QUICKTEST_SIZE, &ErrorCode);
