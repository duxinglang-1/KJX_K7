...
void mmi_fm_camera_test_play_finish_hdlr(MDI_RESULT result, void *user_data)
{
    ...
    if (mmi_fm_camera_test_cntx.state == MMI_FM_CAMERA_TEST_STATE_AVR_PLAY)
    {
        ...
        /* flush key event */
        ClearKeyEvents();
        SetKeyHandler(mmi_fm_camera_test_stop_preview, KEY_ENTER, KEY_EVENT_DOWN);
    }
}
...
static void mmi_fm_camera_test_save_result_hdlr_callback(MDI_RESULT result, void* user_data)
{
    ...
    else
    {
        ...
        /* flush key event */
        ClearKeyEvents();
        SetKeyHandler(mmi_fm_camera_test_play_video, KEY_ENTER, KEY_EVENT_DOWN);
    }
}
...
void mmi_fm_camera_test_start_avr_preview(void)
{
    ...
    SetKeyHandler(mmi_fm_camera_test_capture_video, KEY_ENTER, KEY_EVENT_DOWN);
}
#endif
...
void mmi_fm_camera_test_capture_and_save_image(void)
{
    ...
    else
    {
        ...
        else
        {
            ...
            gdi_layer_blt_previous(0, 0, LCD_WIDTH, LCD_HEIGHT);
            SetKeyHandler(mmi_fm_camera_test_delete_image, KEY_ENTER, KEY_EVENT_DOWN);
...
void mmi_fm_camera_test_start_cam_preview(void)
{
    ...
    SetKeyHandler(mmi_fm_camera_test_capture_and_save_image, KEY_ENTER, KEY_EVENT_DOWN);
...
void mmi_fm_camera_test_entry_preview_screen(void)
{
    ...
    SetKeyHandler(mmi_fm_camera_test_dummy_func, KEY_LSK, KEY_EVENT_UP);
