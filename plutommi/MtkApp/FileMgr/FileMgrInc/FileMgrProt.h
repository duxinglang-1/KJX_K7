...
#define FMGR2_DisplayPopup(i, str_id, popup_type)        mmi_fmgri_instance_display_popup(i, str_id, popup_type, __LINE__)
#define FMGR2_DisplayPopupStr(i, str_buf, popup_type)    mmi_fmgri_instance_display_popup_str(i, (S8*)str_buf, popup_type, __LINE__)
#define FMGR2_DisplayPopupCB(i, str_id, popup_type)      mmi_fmgri_instance_display_popup_cb(i, str_id, popup_type, __LINE__)
#define FMGR3_DisplayPopup(id, str_id, popup_type)       mmi_fmgri_instance_displaypopup(id, (UI_string_type)GetString(str_id), popup_type, 0, __LINE__)
