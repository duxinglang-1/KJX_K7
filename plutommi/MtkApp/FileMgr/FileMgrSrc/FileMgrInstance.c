...
static void fmgr_general_register_key_hdlr(mmi_fmgr_instance_struct *instance)
{
    ...
    {
        SetKeyHandler(fmgr_general_send_key_hdlr, KEY_SEND, KEY_EVENT_DOWN);
    }
}
...
MMI_BOOL mmi_fmgri_instance_display_popup(mmi_fmgr_instance_struct* instance, U16 string_id, mmi_event_notify_enum popup_type, S32 line)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
MMI_BOOL mmi_fmgri_instance_display_popup_cb(mmi_fmgr_instance_struct* instance, U16 string_id, mmi_event_notify_enum popup_type, S32 line)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
MMI_BOOL mmi_fmgri_instance_displaypopup(U16 parent_id, UI_string_type string, mmi_event_notify_enum event_id, U32 flag, S32 line)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    mmi_popup_display((WCHAR*)string, event_id, &arg);
