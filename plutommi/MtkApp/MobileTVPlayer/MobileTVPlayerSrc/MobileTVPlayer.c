...
MMI_BOOL mmi_mtv_player_rename_channel_post(void);
MMI_BOOL mmi_mtv_player_rename_channel_pre(void);
...
mmi_ret mmi_mtv_player_group_proc(mmi_event_struct *evt)
{
    ...
    switch (evt->evt_id)
    {
        ...
        case EVT_ID_CUI_FSEDITOR_SUBMMIT:
        {
            ...
            if (mmi_mtv_player_rename_channel_pre())
            {
...
#endif
                mmi_mtv_player_rename_channel_post();
            }
            break;
        }
 ...
 void mmi_mtv_player_service_ready_hdlr(mdi_mtv_service_info_struct* service_info)
{
    ...
    if(MMI_FALSE == matv_resz_timer_seted)
    {
        ...
        kal_set_timer(resz_cp_ESD_timeout_timer, (kal_timer_func_ptr)resz_cp_ESD_timeout_timer_hdlr,NULL, KAL_TICKS_3_SEC, KAL_TICKS_3_SEC);
