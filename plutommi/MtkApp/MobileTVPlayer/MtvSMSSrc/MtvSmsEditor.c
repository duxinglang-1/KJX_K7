...
#ifdef __MMI_DUAL_SIM_MASTER__
static void mmi_mtv_sms_check_dual_sim_save_entry(void);
static void mmi_mtv_sms_save_select_sim_hilite(void);

static void mmi_mtv_sms_save_by_sim1(void);
static void mmi_mtv_sms_save_by_sim2(void);
#endif
...
#ifdef __MMI_DUAL_SIM_MASTER__
            srv_sms_sim_enum msg_sim_id = srv_sms_get_msg_sim_id(g_mtv_sms_cntx.curr_msg_id);
            srv_sms_sim_enum select_sim_id = mmi_mtv_sms_get_send_sim_type();
#endif /* __MMI_DUAL_SIM_MASTER__ */
        
           if ((send_case == MTV_SMS_SEND_CASE_EDIT_DRAFT)
#ifdef __MMI_DUAL_SIM_MASTER__
            && (msg_sim_id == select_sim_id)
#endif /* __MMI_DUAL_SIM_MASTER__ */
            )
            {
                srv_sms_delete_msg(
...
#ifdef __MMI_DUAL_SIM_MASTER__
    mmi_mtv_sms_check_dual_sim_save_entry();
#else
    g_mtv_sms_cntx.sim_id = SRV_SMS_SIM_1;
 ...
 *  MMI_BOOL
 *****************************************************************************/
void mmi_mtv_sms_check_dual_sim_save_entry(void)
{
    ...
    {
        mmi_mtv_sms_entry_common_options(SCR_ID_MTV_SMS_SAVE_SIM_SELECTT, MENU_ID_MTV_SMS_SAVE_SELECT_SIM);
    }
    else if (is_sim1_available)
    {
        mmi_mtv_sms_save_by_sim1();
    }
    else if (is_sim2_available)
    {
        mmi_mtv_sms_save_by_sim2();
    } 
    else
    {
        mmi_mtv_sms_save_by_sim1();
 ...
 *  MMI_BOOL
 *****************************************************************************/
void mmi_mtv_sms_save_select_sim_hilite(void)
{
}
 ...
 *  MMI_BOOL
 *****************************************************************************/
void mmi_mtv_sms_save_hilite_sim1(void)
{
    SetLeftSoftkeyFunction(mmi_mtv_sms_save_by_sim1, KEY_EVENT_UP);
        SetCenterSoftkeyFunction(mmi_mtv_sms_save_by_sim1, KEY_EVENT_UP);
}
 ...
 *  MMI_BOOL
 *****************************************************************************/
void mmi_mtv_sms_save_hilite_sim2(void)
{
    SetLeftSoftkeyFunction(mmi_mtv_sms_save_by_sim2, KEY_EVENT_UP);
    SetCenterSoftkeyFunction(mmi_mtv_sms_save_by_sim2, KEY_EVENT_UP);
}
 ...
 *  MMI_BOOL
 *****************************************************************************/
void mmi_mtv_sms_save_by_sim1(void)
{
   g_mtv_sms_cntx.sim_id = SRV_SMS_SIM_1;
   /* mmi_mtv_sms_entry_confirm_SC(); */
   
   mmi_mtv_sms_scrn_close(SCR_ID_MTV_SMS_SAVE_SIM_SELECTT);
   mmi_mtv_sms_editor_save();
 ...
 *  MMI_BOOL
 *****************************************************************************/
void mmi_mtv_sms_save_by_sim2(void)
{
    g_mtv_sms_cntx.sim_id = SRV_SMS_SIM_2;
   /* mmi_mtv_sms_entry_confirm_SC(); */
    mmi_mtv_sms_scrn_close(SCR_ID_MTV_SMS_SAVE_SIM_SELECTT);
    mmi_mtv_sms_editor_save();
