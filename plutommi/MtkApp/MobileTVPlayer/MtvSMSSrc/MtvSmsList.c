...
U16 mmi_mtv_sms_get_icon(U16 msg_id)
{
    ...
    /*----------------------------------------------------------------*/
    {
        ...
        mmi_mtv_sms_icon_sim_enum sim_id = SMS_SIM_1;
        U16 status_icon[SMS_SIM_TOTAL][SMS_STORAGE_TOTAL][STATUS_ICON_TOTAL] = 
                {
                    {
                        {
                            IMG_ID_MTV_SMS_MASTER_MESSAGE_READ,
                            IMG_ID_MTV_SMS_MASTER_MESSAGE_UNREAD,
                            IMG_ID_MTV_SMS_MASTER_MESSAGE_SENT,
                            IMG_ID_MTV_SMS_MASTER_MESSAGE_UNSENT,
                            IMG_ID_MTV_SMS_MASTER_MESSAGE_SS_NCOMP
                    ...
                    {
                       {
                           IMG_ID_MTV_SMS_SLAVE_MESSAGE_READ,
                           IMG_ID_MTV_SMS_SLAVE_MESSAGE_UNREAD,
                           IMG_ID_MTV_SMS_SLAVE_MESSAGE_SENT,
                           IMG_ID_MTV_SMS_SLAVE_MESSAGE_UNSENT,
                           IMG_ID_MTV_SMS_SLAVE_MESSAGE_SS_NCOMP
   ...
   #ifdef __MMI_DUAL_SIM_MASTER__
        if (srv_sms_get_msg_sim_id(msg_id) == SRV_SMS_SIM_2)
        {
            sim_id = SMS_SIM_2;
        }
   #endif /* __MMI_DUAL_SIM_MASTER__ */
   ...
   #ifdef __MMI_DUAL_SIM_MASTER__
        icon_id = status_icon[sim_id][storage_id][status_index];
   #else /* __MMI_DUAL_SIM_MASTER__ */
