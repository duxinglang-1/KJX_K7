...
#ifdef __MMI_DUAL_SIM_MASTER__
static void mmi_mtv_sms_dm_pre_send_msg(void);
static void mmi_mtv_sms_check_dual_sim_entry(void);
static void mmi_mtv_sms_sending_by_sim2(void);
static void mmi_mtv_sms_sending_by_sim1(void);
        ...
        switch (send_case)
        {
            ...
            case MTV_SMS_SEND_CASE_FORWARD:
            {
               ...
               /* copy view content to edit buffer maybe fail due to EMS LIB virtual pack fail */
                ...
                #ifdef __MMI_DUAL_SIM_MASTER__
                    mmi_mtv_sms_set_send_sim_type(srv_sms_get_msg_sim_id(g_mtv_sms_cntx.curr_msg_id));
                #endif
                }
                break;
            }
...
/*****************************************************************************
 * FUNCTION
 *  mmi_mtv_sms_get_send_sim_type
 * DESCRIPTION
 *  Get the SIM Type for Sending
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
srv_sms_sim_enum mmi_mtv_sms_get_send_sim_type(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    return send_info_data.sim_id;
}


/*****************************************************************************
 * FUNCTION
 *  mmi_mtv_sms_set_send_sim_type
 * DESCRIPTION
 *  Set the prefer SIM Card when sending
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_mtv_sms_set_send_sim_type(srv_sms_sim_enum sim_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    else
    {
        if (mmi_mtv_sms_init_send_handle_data())
        {
            ...
            if (mtv_recipient_data.total_num > 0)
            {
                ...
                {
                #ifdef __MMI_DUAL_SIM_MASTER__
                    mmi_mtv_sms_check_dual_sim_entry();
 ...
 *  MMI_BOOL
 *****************************************************************************/
void mmi_mtv_sms_check_dual_sim_entry(void)
{

    MMI_BOOL  is_sim1_available;
    MMI_BOOL  is_sim2_available;
    is_sim1_available = srv_nw_usab_is_usable(MMI_SIM1);
    is_sim2_available = srv_nw_usab_is_usable(MMI_SIM2);

    if (is_sim1_available && is_sim2_available)
    {
        if (mmi_mtv_sms_get_send_msg_case() != MTV_SMS_SEND_CASE_RESEND)
        {
            mmi_mtv_sms_entry_dual_sim_select(SCR_ID_MTV_SMS_SEND_SIM_SELECTT, MENU_ID_MTV_SMS_SEND_SELECT_SIM);
        }
        else
        {
            mmi_mtv_sms_entry_common_options(SCR_ID_MTV_SMS_SEND_SIM_SELECTT, MENU_ID_MTV_SMS_SEND_SELECT_SIM);
        }
    }
    else if (is_sim1_available)
    {
        mmi_mtv_sms_sending_by_sim1();
    }
    else
    {
        mmi_mtv_sms_sending_by_sim2();
    }
}

/*****************************************************************************
 * FUNCTION
 *  mmi_mtv_sms_entry_dual_sim_select
 * DESCRIPTION
 ...
 *  void
 *****************************************************************************/
void mmi_mtv_sms_entry_dual_sim_select(MMI_ID scr_id, MMI_ID root_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/*****************************************************************************
 * FUNCTION
 *  mmi_mtv_sms_sending_hilite_sim1
 * DESCRIPTION
 *  hilite send by sim1
 * PARAMETERS
 *  dummy
 ...
 *  MMI_BOOL
 *****************************************************************************/
void mmi_mtv_sms_sending_hilite_sim1(void)
{
    SetLeftSoftkeyFunction(mmi_mtv_sms_sending_by_sim1, KEY_EVENT_UP);
#ifdef __MMI_WGUI_CSK_ENABLE__
        SetCenterSoftkeyFunction(mmi_mtv_sms_sending_by_sim1, KEY_EVENT_UP);
#endif /*__MMI_WGUI_CSK_ENABLE__*/
}
...
/*****************************************************************************
 * FUNCTION
 *  mmi_mtv_sms_sending_hilite_sim2
 * DESCRIPTION
 *  hilite send by sim2
 * PARAMETERS
 *  dummy
 ...
 *  MMI_BOOL
 *****************************************************************************/
void mmi_mtv_sms_sending_hilite_sim2(void)
{
    SetLeftSoftkeyFunction(mmi_mtv_sms_sending_by_sim2, KEY_EVENT_UP);
#ifdef __MMI_WGUI_CSK_ENABLE__
    SetCenterSoftkeyFunction(mmi_mtv_sms_sending_by_sim2, KEY_EVENT_UP);
#endif /*__MMI_WGUI_CSK_ENABLE__*/
}
 ...
 *  MMI_BOOL
 *****************************************************************************/
void mmi_mtv_sms_sending_by_sim1(void)
{
   mmi_mtv_sms_set_send_sim_type(SRV_SMS_SIM_1);
   mmi_mtv_sms_send_single_sms();
 ...
 *  MMI_BOOL
 *****************************************************************************/
void mmi_mtv_sms_sending_by_sim2(void)
{
    mmi_mtv_sms_set_send_sim_type(SRV_SMS_SIM_2);
    mmi_mtv_sms_send_single_sms();
}
...
#ifdef __MMI_DUAL_SIM_MASTER__
           handle->sim_id = 0;
           mmi_mtv_sms_scrn_close(SCR_ID_MTV_SMS_SEND_SIM_SELECTT);
#endif
