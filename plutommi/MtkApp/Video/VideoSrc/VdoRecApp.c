...
static void mmi_vdorec_enter_state(U16 state)
{
    ...
    */
    ...
    {
        SetKeyHandler(mmi_vdorec_switch_to_camera_hdlr, (U16)VDOREC_SWITCH_TO_CAMERA_KEY, KEY_EVENT_DOWN);
    }
...
/* under construction !*/
    ...
    if (g_vdorec_cntx.is_support_toggle_osd)
    {
        ...
        {
                SetKeyHandler(mmi_vdorec_toggle_osd_key_press_hdlr, (U16)VDOREC_TOGGLE_HIDE_OSD_KEY, KEY_EVENT_DOWN);
        }
    }
#endif
#endif
    ...
    switch (state)
    {
        ...
        case VDOREC_STATE_VIDEO_PREVIEW_PLAY:
            ...
            if (VDOREC_SWITCH_TO_CAMERA_KEY != -1 && !g_vdorec_cntx.is_ext_req)
            {
                SetKeyHandler(UI_dummy_function, (U16)VDOREC_SWITCH_TO_CAMERA_KEY, KEY_EVENT_DOWN);
            }
        #endif /* __MMI_CAMERA__ */
            ...
            SetKeyHandler((mmi_void_funcptr_type)mmi_frm_scrn_close_active_id, VDOREC_RECORD_KEY, KEY_EVENT_UP);
...
static void mmi_vdorec_draw_panel_timer(void)
{
    ...
    mmi_vdorec_draw_panel_timer_ext((void*)&g_vdorec_cntx.timer, rec_time, MMI_TRUE);
...
static void mmi_vdorec_init_ui_region(video_rect_struct *rect_ptr,S32 region,PU8 gdi_layer_buffer_ptr)
{
	...
	#else
  {
		gdi_layer_create_cf_double_using_outside_memory(
            ...
            (PU8)g_vdorec_cntx.osd_layer_region_handle_ptr[region],
            region_buf_size,
            (PU8)gdi_layer_buffer_ptr+total_pre_region_size,
            region_buf_size);		
 	}
	#endif
