...
#define AVK_FRAMEWORK_POOL_SIZE (1024*1024 > mmi_frm_asm_get_total_left_size_r(APPLIB_MEM_AP_ID_TEST_SDK)?mmi_frm_asm_get_total_left_size_r(APPLIB_MEM_AP_ID_TEST_SDK):1024*1024)
 ...
 *  void
*****************************************************************************/
void avk_framework_init_app_mem()
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                                                         */
    /*----------------------------------------------------------------*/
...
void avk_framework_core_init(void)
{
    avk_framework_init_app_mem();
}
