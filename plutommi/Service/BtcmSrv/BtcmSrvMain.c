...
//     /*----------------------------------------------------------------*/
//     U32 conn_index;
//     U32 paired_index = 0, table_index;
...
//         conn_id,
//         conn_type);
//     for (conn_index = 0; conn_index < SRV_BT_CM_MAX_CONNECTION; ++conn_index)
//     {
//         if (g_srv_bt_cm_cntx.existed_conn[conn_index].conn_id == conn_id)
//         {
//             paired_index = g_srv_bt_cm_cntx.existed_conn[conn_index].index_of_dev_list;
//             supported_profile_uuid = g_srv_bt_cm_cntx.existed_conn[conn_index].profile_id;
//             break;
//         }
//     }

//     g_srv_bt_cm_cntx.is_background_disconnecting = 1;
...
// //             supported_profile_uuid = SRV_BT_CM_SPP_PROFILE_UUID;
// //             break;

// //         case SRV_BT_CM_DUN_CONNECTION:
// //             supported_profile_uuid = SRV_BT_CM_DUN_PROFILE_UUID;
// //             break;

// //         case SRV_BT_CM_OPP_CONNECTION:
// //             supported_profile_uuid = SRV_BT_CM_OBEX_OBJECT_PUSH_SERVICE_UUID;
// //             break;

// //         case SRV_BT_CM_OPPC_CONNECTION:
// //             supported_profile_uuid = SRV_BT_CM_OBEX_OBJECT_PUSH_CLIENT_UUID;
// //             break;

// //         case SRV_BT_CM_FTP_CONNECTION:
// //             supported_profile_uuid = SRV_BT_CM_OBEX_FILE_TRANSFER_UUID;
// //             break;

// //         case SRV_BT_CM_FTPC_CONNECTION:
// //             supported_profile_uuid = SRV_BT_CM_OBEX_FILE_TRANSFER_CLIENT_UUID;
// //             break;

// //         case SRV_BT_CM_A2DP_CONNECTION:
// //             supported_profile_uuid = SRV_BT_CM_ADVANCED_AUDIO_PROFILE_UUID;
// //             break;

// //         case SRV_BT_CM_AVRCP_CONNECTION:
// //             supported_profile_uuid = SRV_BT_CM_AV_REMOTE_CONTROL_TARGET_UUID;
// //             break;

// //         case SRV_BT_CM_AVRCP_CT_CONNECTION:            
// //             supported_profile_uuid = SRV_BT_CM_AV_REMOTE_CONTROL_UUID;
// //             break;

// //         case SRV_BT_CM_SIMAP_CONNECTION:            
// //             supported_profile_uuid = SRV_BT_CM_SIM_ACCESS_PROFILE_UUID;
// //             break;

// //         case SRV_BT_CM_HID_CONNECTION:            
// //             supported_profile_uuid = SRV_BT_CM_HID_PROFILE_UUID;
// //             break;

// //         case SRV_BT_CM_FAX_CONNECTION:
// //             supported_profile_uuid = SRV_BT_CM_FAX_PROFILE_UUID;
// //             break;

// //         case SRV_BT_CM_BPP_CONNECTION:            
// //             supported_profile_uuid = SRV_BT_CM_BASIC_PRINTING;
// //             break;

// //         /* BIP */
// //         case SRV_BT_CM_BIP_CONNECTION:            
// //             supported_profile_uuid = SRV_BT_CM_OBEX_IMAGING_RESPONDER_UUID;
// //             break;

// //         case SRV_BT_CM_BIPC_CONNECTION:            
// //             supported_profile_uuid = SRV_BT_CM_OBEX_IMAGING_UUID;
// //             break;

// //         case SRV_BT_CM_PBAP_CONNECTION:
// //             supported_profile_uuid = SRV_BT_CM_OBEX_PBA_PROFILE_UUID;
// //             break;

// //         case SRV_BT_CM_SYNCML_CONNECTION:
// //             supported_profile_uuid = SRV_BT_CM_SYNCML_DEV_PROFILE_UUID;
// //             break;
...
//     {
//         if ((g_srv_bt_cm_profile_tbl[table_index].profile_id == supported_profile_uuid))
//         {
...
//     if (app_id == MMI_DMUI_APP_ID_BLUETOOTH)
//     {
//         switch (cmd)
//         {
//             /* LOCK command, reset BT module */
...
//                 }
//                 else if (srv_bt_cm_get_power_status() == SRV_BT_CM_POWER_SWITCHING_ON)
//                 {
//                     SRV_BT_CM_SET_FLAG(SRV_BT_CM_MASK_DM_RESET);
//                     srv_bt_cm_nvram_write_info(NVRAM_EF_BT_INFO_LID, (void*)0);
//                 }
...
//             /* UNLOCK command, set IS_READY flag, and report to LAWMO */
