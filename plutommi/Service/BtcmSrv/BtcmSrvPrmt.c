...
static void srv_bt_cm__add_devname_addr( btbm_bd_addr_t bd_addr,kal_uint8 name[BTBM_ADP_MAX_NAME_LEN], kal_uint8 name_len, kal_uint8 name_req_result)
{
	U32 i;
        name_len = name_len > (SRV_BT_CM_BD_UCS2_NAME_LEN - 1) ?
        (SRV_BT_CM_BD_UCS2_NAME_LEN - 1) :
...
/*----------------------------------------------------------------*/
	...
	srv_bt_cm__add_devname_addr( msg_p->bd_addr,msg_p->name, msg_p->name_len, msg_p->name_req_result);
