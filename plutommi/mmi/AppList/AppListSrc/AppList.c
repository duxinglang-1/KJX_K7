...
{    
    ...
    RANFOW_TRACE("[APPLIST]MMI_APPLIST_MEM_SIZE=%d,MMI_APPLIST_APP_CACHE_NUM=%d\n", MMI_APPLIST_MEM_SIZE, MMI_APPLIST_APP_CACHE_NUM);
        ...
        case EVT_ID_ALERT_QUIT:
        {
            ...
            switch (confirm_evt->result)
            {
                ...
                case MMI_ALERT_CNFM_YES:
                {
                    ...
                    srv_appmgr_get_app_package_name_by_id(applist_p->hilight_frame.cell_p->app_id, app_name);
                    #else
                    srv_appmgr_get_app_package_name_by_id(applist_p->focus_cell.cell_p->app_id, app_name);
                    #endif
 ...
 *  void
 *****************************************************************************/
static void mmi_applist_uninstall_app_by_name(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	else
	{
        ...
        #ifdef __MMI_APPLIST_KEY_SUPPORT__
        kal_wsprintf(display_str, "%w %w \0\?\0 ", GetString(STR_ID_APPLIST_UNINSTALL), applist_p->hilight_frame.cell_p->name);
        #else
        kal_wsprintf(display_str, "%w %w \0\?\0 ", GetString(STR_ID_APPLIST_UNINSTALL), applist_p->focus_cell.cell_p->name);
        #endif
...
/* disable animation when loop */
#if defined(__MMI_APPLIST_KEY_SUPPORT__) && defined(__MMI_APPLIST_KEY_LOOP__)
    if (applist_p->slide_type == MMI_APPLIST_SLIDE_BY_KEY && applist_p->is_loop)
    {
...
void mmi_applist_pen_move_hdlr(mmi_pen_point_struct pos)
{
    ...
    RANFOW_TRACE("[APPLIST]pen move:down_pos[%d,%d], curr_pos[%d,%d]\n", applist_p->pen_down_pos.x, applist_p->pen_down_pos.y, pos.x, pos.y);
...
void mmi_applist_pen_up_hdlr(mmi_pen_point_struct pos)
{
    ...
    if (applist_p->mode == MMI_APPLIST_MODE_EDIT && cur_time - applist_p->pen_down_tick < MMI_APPLIST_ENTER_EDIT_MODE_DELAY &&
        applist_p->focus_cell.cell_p != NULL && mmi_applist_is_installed_app(applist_p->focus_cell.cell_p->app_id) &&
        (pos.x % MMI_APPLIST_CELL_WIDTH <= MMI_APPLIST_APP_UNINSTALL_ICON_WIDTH) &&
        ((pos.y >= MMI_APPLIST_SLIDE_AREA_Y && pos.y <= MMI_APPLIST_INDICATOR_BAR_Y + MMI_APPLIST_APP_UNINSTALL_ICON_HEIGHT - MMI_APPLIST_CELL_HEIGHT && (pos.y - MMI_APPLIST_SLIDE_AREA_Y) % MMI_APPLIST_CELL_HEIGHT <= MMI_APPLIST_APP_UNINSTALL_ICON_HEIGHT) ||
        (pos.y >= MMI_APPLIST_SHORTCUT_BAR_Y && pos.y <= LCD_HEIGHT - MMI_APPLIST_APP_UNINSTALL_ICON_HEIGHT)))
    {
        mmi_applist_uninstall_app_by_name();
        return;
    }
...
/*****************************************************************************
 * FUNCTION
 *  mmi_applist_up_arraw_key_press
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_applist_up_arraw_key_press(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_applist_arraw_key_press(MMI_APPLIST_DIR_UP);    
}


/*****************************************************************************
 * FUNCTION
 *  mmi_applist_down_arraw_key_press
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_applist_down_arraw_key_press(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_applist_arraw_key_press(MMI_APPLIST_DIR_DOWN);
}
...
/*****************************************************************************
 * FUNCTION
 *  mmi_applist_arraw_key_press_cyclic
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_applist_arraw_key_press_cyclic(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    switch (applist_p->long_press_dir)
    {
        ...
        case MMI_APPLIST_DIR_DOWN:
            mmi_applist_arraw_key_press(applist_p->long_press_dir);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_applist_left_arraw_key_press
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_applist_left_arraw_key_press(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    #ifdef __MMI_APPLIST_KEY_SUPPORT__
    mmi_applist_arraw_key_press(MMI_APPLIST_DIR_LEFT);
    #else
...
/*****************************************************************************
 * FUNCTION
 *  mmi_applist_right_arraw_key_press
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_applist_right_arraw_key_press(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    #ifdef __MMI_APPLIST_KEY_SUPPORT__
    mmi_applist_arraw_key_press(MMI_APPLIST_DIR_RIGHT);
    #else
    //reject key operation when sliding
    if (applist_p->state != MMI_APPLIST_STATE_NORMAL)
        return;
...
/*****************************************************************************
 * FUNCTION
 *  mmi_applist_up_arraw_key_release
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_applist_arraw_key_release(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    gui_cancel_timer(mmi_applist_arraw_key_press_cyclic);
...
void mmi_applist_register_event_handler(void)
{
    ...
    SetKeyHandler(mmi_applist_left_arraw_key_press, KEY_LEFT_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(mmi_applist_right_arraw_key_press, KEY_RIGHT_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(mmi_applist_arraw_key_release, KEY_LEFT_ARROW, KEY_EVENT_UP);
    SetKeyHandler(mmi_applist_arraw_key_release, KEY_RIGHT_ARROW, KEY_EVENT_UP);  
...
#ifdef __MMI_APPLIST_KEY_SUPPORT__    
    SetKeyHandler(mmi_applist_up_arraw_key_press, KEY_UP_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(mmi_applist_down_arraw_key_press, KEY_DOWN_ARROW, KEY_EVENT_DOWN);
    
    SetKeyHandler(mmi_applist_arraw_key_release, KEY_UP_ARROW, KEY_EVENT_UP);
    SetKeyHandler(mmi_applist_arraw_key_release, KEY_DOWN_ARROW, KEY_EVENT_UP);  
...
void mmi_applist_enter(MMI_ID group_id)
{
    ...
    //enter again
    if (applist_p->state != MMI_APPLIST_STATE_NONE && applist_p->app_mem_pool != NULL && applist_p->panel_layer_handle != GDI_LAYER_EMPTY_HANDLE)
    {
        RANFOW_TRACE("[APPLIST]enter again, applist_p->slide_region.x:%d\n", applist_p->slide_region.x);
        return;
    }
    
    RANFOW_TRACE("[APPLIST]enter first, applist_p->slide_region.x:%d\n", applist_p->slide_region.x);
