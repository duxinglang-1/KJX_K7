...
typedef enum
{
    MMI_APPLIST_BARREL_SLIDE_DIR_LEFT,
    MMI_APPLIST_BARREL_SLIDE_DIR_RIGHT
}mmi_applist_barrel_slide_dir_enum;


U16 g_barrel_type;
mmi_applist_barrel_slide_dir_enum g_barrel_pre_dir;
...
void mmi_applist_barrel_auto_slide_back()
{
    ...
    if (g_barrel_pre_dir == MMI_APPLIST_BARREL_SLIDE_DIR_LEFT)
    {
...
void mmi_applist_barrel_change_transform()
{
    ...
    {
        g_barrel_pre_dir = MMI_APPLIST_BARREL_SLIDE_DIR_LEFT;
        mmi_applist_slide_to_page(curr_page - 1);
    }
    else
    {
        g_barrel_pre_dir = MMI_APPLIST_BARREL_SLIDE_DIR_RIGHT;
        mmi_applist_slide_to_page(curr_page + 1);
    }
