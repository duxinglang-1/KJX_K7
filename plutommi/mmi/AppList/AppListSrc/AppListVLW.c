...
void mmi_applist_interactive_video_wallpaper_draw_frame()
{
    ...
    source_buffer/*IVLW_Play_Struct.sourceBuffer*/ = mmi_frm_asm_alloc_r(mmi_frm_group_get_active_id(),size); //mmi_applist_ivlw_mem_alloc(NULL, 1, size);
    ...
    dest_buffer_ptr = mmi_frm_asm_alloc_r(mmi_frm_group_get_active_id(),size);  //mmi_applist_ivlw_mem_alloc(NULL, 1, size);
