...
#if 0//defined(__GGT_TASK__)&&defined(CUSTOMER_NAME_B602)
   extern void wrt_led_set_bootup(void);

    //U_PutUARTBytes(0,"mmi_bootup_notify_before_idle\r\n",strlen("mmi_bootup_notify_before_idle\r\n"));
    wrt_led_set_bootup();
#endif
