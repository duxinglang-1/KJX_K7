...
/*****************************************************************************
 * FUNCTION
 *  mmi_brw_app_dmgr_add_this_link_to_bookmark
 * DESCRIPTION
 ...
 *  void
 *****************************************************************************/
void mmi_brw_app_dmgr_add_this_link_to_bookmark(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    mmi_chset_utf8_to_ucs2_string(
        (U8*) g_brw_current_url,
        (SRV_BRW_MAX_URL_LEN + 1) * ENCODING_LENGTH,
        (U8*) g_srv_brw_cntx.srv_brw_dynamic_cntx_p->focused_element_info_p->url);
