...
mmi_ret mmi_brw_app_bookmarks_options_menu_cui_proc(mmi_event_struct *evt)
{
    ...
    switch (menu_evt->evt_id)
    {
        ...
        case EVT_ID_CUI_MENU_ITEM_SELECT:
        case EVT_ID_CUI_MENU_ITEM_TAP:
            if(menu_evt->highlighted_menu_id == MENU_ID_BRW_BKM_ADD_BOOKMARK)
            {
        ...
        #endif
            else if(menu_evt->highlighted_menu_id == MENU_ID_BRW_BKM_MEMORY_STATUS)
            {
...
mmi_ret mmi_brw_app_bookmark_in_fmgr_menu_cui_proc(mmi_event_struct *evt)
{
    ...
    switch (menu_evt->evt_id)
    {
        ...
        #endif
            else if(menu_evt->highlighted_menu_id == MENU_ID_BRW_BKM_ADD_TO_BOOKMARK_FROM_FMGR)
            {
