...
void mmi_brw_app_ui_callback_show_bookmarks_toolbar(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    item_icon[0] = get_image(IMG_ID_BRW_FTE_ADD_BOOKMARK_ENABLE);
    item_icon[1] = get_image(IMG_ID_BRW_FTE_INPUT_ADDRESS_ENABLE);
    item_icon[2] = get_image(IMG_GLOBAL_TOOLBAR_DELETE);

    item_disabled_icon[0] = get_image(IMG_ID_BRW_FTE_ADD_BOOKMARK_DISABLE);
    ...
    string[0] = (PU8) get_string(STR_ID_BRW_ADD_BOOKMARK);
