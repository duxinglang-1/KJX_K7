...
MMI_BOOL mmi_wap_push_scrhdlr_post_nuknwn_addr_opt (U16 screen_id)
{
    ...
    SetKeyHandler(mmi_wap_push_end_key_sia_dlg_screen, KEY_END, KEY_EVENT_DOWN);
    return MMI_TRUE;
}
#endif
...
MMI_BOOL mmi_wap_push_scrhdlr_draw_message_screen (U16 screen_id)
{
    ...
    {
        SetKeyHandler(screen->lnk_func, KEY_LEFT_ARROW, KEY_EVENT_UP);
#ifdef __MMI_PUSH_IN_UM__
#ifdef __MMI_UM_ITERATOR_VIEWER__
    ...
    {
        SetKeyHandler(screen->rnk_func, KEY_RIGHT_ARROW, KEY_EVENT_UP);
#ifdef __MMI_PUSH_IN_UM__
#ifdef __MMI_UM_ITERATOR_VIEWER__
