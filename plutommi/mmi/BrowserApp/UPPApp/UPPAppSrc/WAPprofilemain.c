...
S32 mmi_wap_prof_app_show_popup_hdlr(mmi_event_struct* param)
{
	...
	case SRV_WAP_PROF_GLOBAL_NOT_AVAILABLE:
		...
		break;
	case SRV_WAP_PROF_GLOBAL_MULTIMEDIA_MESSAGE:
		//action = ;
		break;
	case SRV_WAP_PROF_CBM_BROWSER:
		// action = STR_ID_WAP_PROF_CBM_BROWSER;
		break;
	case SRV_WAP_PROF_DTCNT_ALREADY_CONFIGURED:
		action = STR_ID_WAP_PROF_DTCNT_ALREADY_CONFIGURED;
		break;
	default:
