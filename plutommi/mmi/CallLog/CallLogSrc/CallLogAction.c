...
static void mmi_clog_act_dlr_evt_dialer_before_call_hdlr(mmi_event_struct *evt);
static void mmi_clog_act_dlr_free_phb_udata(MMI_ID dlr_gid);
...
static const mmi_clog_act_hdlr_struct g_mmi_clog_act_hdlr_tbl[] = 
{
	...
	{MMI_CLOG_OP_MID_SEL_SIM_2,      mmi_clog_act_sim_filter},
#endif
...
static void mmi_clog_act_sim_filter(mmi_clog_act_inst_struct *inst)
{
	switch (inst->op_mid)
	{
		case MMI_CLOG_OP_MID_SEL_SIM_1:
			...
			break;
	#ifdef __MMI_DUAL_SIM__
		case MMI_CLOG_OP_MID_SEL_SIM_2:
			g_clog_sim_support = MMI_SIM2;
			break;
	#endif
	#if (MMI_MAX_SIM_NUM >= 3)
