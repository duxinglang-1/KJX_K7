...
//.REVIEW
    ...
    else if (avail_sim_id == MMI_SIM2)
    {
        cui_menu_set_item_hidden(menu_gid, MENU_ID_CLOG_CCOST_LAST, MMI_TRUE);
        cui_menu_set_item_hidden(menu_gid, MENU_ID_CLOG_CCOST_TOTAL, MMI_TRUE);
        cui_menu_set_item_hidden(menu_gid, MENU_ID_CLOG_CCOST_RESET, MMI_TRUE);
        cui_menu_set_item_hidden(menu_gid, MENU_ID_CLOG_CCOST_MAX, MMI_TRUE);
        cui_menu_set_item_hidden(menu_gid, MENU_ID_CLOG_CCOST_PPU, MMI_TRUE);
    }
    else if (avail_sim_id == MMI_SIM1)
    {
        cui_menu_set_item_hidden(menu_gid, MENU_ID_CLOG_CCOST_SIM2_LAST, MMI_TRUE);
        cui_menu_set_item_hidden(menu_gid, MENU_ID_CLOG_CCOST_SIM2_TOTAL, MMI_TRUE);
        cui_menu_set_item_hidden(menu_gid, MENU_ID_CLOG_CCOST_SIM2_RESET, MMI_TRUE);
        cui_menu_set_item_hidden(menu_gid, MENU_ID_CLOG_CCOST_SIM2_MAX, MMI_TRUE);
        cui_menu_set_item_hidden(menu_gid, MENU_ID_CLOG_CCOST_SIM2_PPU, MMI_TRUE);
    }
