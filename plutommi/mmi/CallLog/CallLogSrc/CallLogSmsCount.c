...
static MMI_RET mmi_clog_enter_sms_proc(mmi_event_struct *evt)
{
    ...
    switch (menu_evt->evt_id)
    {
        ...
        case EVT_ID_CUI_MENU_ITEM_HILITE:
        {
            ...
            else if (menu_evt->highlighted_menu_id == MENU_ID_CLOG_SMS_SIM2_SENT)
            {
                mmi_clog_sms_menu_item_hilite(SRV_SMS_SIM_2, SRV_SMS_COUNT_SENT, MENU_ID_CLOG_SMS_SIM2_SENT);
            }
            else    /* (menu_evt->highlighted_menu_id == MENU_ID_CLOG_SMS_SIM2_RECVED) */
            {
                mmi_clog_sms_menu_item_hilite(SRV_SMS_SIM_2, SRV_SMS_COUNT_RECV, MENU_ID_CLOG_SMS_SIM2_RECVED);
            }
