...
const static mmi_clog_sub_menu_map_struct g_clog_gprs_menu_map[] = 
{
    ...
    , {MMI_SIM2, MENU_ID_CLOG_GPRS_SIM2_LAST_SENT}
    , {MMI_SIM2, MENU_ID_CLOG_GPRS_SIM2_LAST_RECVED}
    , {MMI_SIM2, MENU_ID_CLOG_GPRS_SIM2_ALL_SENT}
    , {MMI_SIM2, MENU_ID_CLOG_GPRS_SIM2_ALL_RECVED}
    , {MMI_SIM2, MENU_ID_CLOG_GPRS_SIM2_RESET}
...
#ifdef __MMI_DUAL_SIM__
    else if (menu_id == MENU_ID_CLOG_GPRS_SIM2_RESET)
    {
        sim = 1;    /* means sim2 */
    }
#endif /* __MMI_DUAL_SIM__ */ 
...
#ifdef __MMI_DUAL_SIM__
        || cntx->hilite_menu_id == MENU_ID_CLOG_GPRS_SIM2_RESET
#endif 
        )
    {
        mmi_clog_confirm(
...
#ifdef __MMI_DUAL_SIM__
    else if (cntx->hilite_menu_id == MENU_ID_CLOG_GPRS_SIM2_RESET)
    {
        req.sim_id = MMI_SIM2;
    }
#endif /* __MMI_DUAL_SIM__ */ 
