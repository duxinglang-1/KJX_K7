...
static const cui_inline_set_item_struct advanced_common_inline_edit_items[ADVANCED_SUBNET_IP4_ID - CUI_INLINE_ITEM_ID_BASE] =
{
...
static const cui_inline_set_item_struct advanced_common_inline_view_items[ADVANCED_SUBNET_IP4_ID - CUI_INLINE_ITEM_ID_BASE] =
{
    {ADVANCED_HOMEPAGE_CAPTION_ID, CUI_INLINE_ITEM_TYPE_CAPTION, IMG_GLOBAL_L1, (void*)&homepage_caption},
        ...
        {            
            ...
            for (i = 0; i < g_data_account_display_cntx.list_number; i++)
            {
                ...
                if (mmi_ucs2strlen((CHAR*) g_comm_disp_name_addr_arr[i].data_account_addr) > 0)
                {
                    ...
                    {                
                        g_data_account_display_cntx.main_list_icon[i] = IMG_ID_DTCNT_DEFAULT_ACCOUNT_ID;
                    }
                    else
                    {
                        g_data_account_display_cntx.main_list_icon[i] = IMG_ID_DTCNT_NON_DEFAULT_ACCOUNT_ID;
                    }
                }
            }
...
void mmi_dtcnt_entry_advanced_settings(void)
{
    ...
    advanced_inline_struct.items_count = ADVANCED_SUBNET_IP4_ID - CUI_INLINE_ITEM_ID_BASE;
