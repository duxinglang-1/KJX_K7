...
#define __CALC_96_64_SOLUTION_SLIM__
#endif
...
#if defined(__MMI_MAINLCD_320X240__) && !defined(__MMI_FTE_SUPPORT__) && defined(__MMI_TOUCH_SCREEN__)
...
#define CALC_MEM_SUPPORT        1
    ...
    (defined(__MMI_MAINLCD_176X220__) && defined(__MMI_DUAL_SIM_MASTER__))
