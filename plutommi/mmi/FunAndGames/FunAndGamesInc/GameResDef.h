...
#if defined(__MMI_GAME_MAJUNG_240x320__) || defined(__MMI_GAME_MAJUNG_176x220__) || defined(__MMI_GAME_MAJUNG_320x240__) || defined(__MMI_GAME_MAJUNG_240x400__) || defined(__MMI_GAME_MAJUNG_320x480__)
...
#if defined(__MMI_GAME_PUZZLE_128x128__) || defined(__MMI_GAME_PUZZLE_128x160__) || defined(__MMI_GAME_PUZZLE_176x220__) || defined(__MMI_GAME_PUZZLE_240x320__)  || defined(__MMI_GAME_PUZZLE_320x240__) || defined(__MMI_GAME_PUZZLE_240x400__) || defined(__MMI_GAME_PUZZLE_320x480__)
...
#if defined(__MMI_GAME_MAGICSUSHI_240x320__) || defined(__MMI_GAME_MAGICSUSHI_320x240__) || defined (__MMI_GAME_MAGICSUSHI_240x400__) || defined (__MMI_GAME_MAGICSUSHI_320x480__)
...
#if defined(__MMI_GAME_VSMJ_240x320__) || defined(__MMI_GAME_VSMJ_320x240__) || defined(__MMI_GAME_VSMJ_240x400__) || defined(__MMI_GAME_VSMJ_320x480__)
#define IS_VSMJ_BASE_GAME
#endif 

#if defined(__MMI_MOTIONGAME_DICE_176x220__) || defined(__MMI_MOTIONGAME_DICE_240x320__) || defined(__MMI_MOTIONGAME_DICE_240x400__) || defined(__MMI_MOTIONGAME_DICE_320x240__) || defined(__MMI_MOTIONGAME_DICE_320x480__)
#define IS_DICE_BASE_MOTIONGAME
#endif 

#if defined(__MMI_MOTIONGAME_DJ_176x220__) || defined(__MMI_MOTIONGAME_DJ_240x320__) || \
    defined(__MMI_MOTIONGAME_DJ_240x400__) || defined(__MMI_MOTIONGAME_DJ_320x240__) || \
    defined(__MMI_MOTIONGAME_DJ_320x480__)
