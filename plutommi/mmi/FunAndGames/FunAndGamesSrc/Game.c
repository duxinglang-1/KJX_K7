...
static const cui_inline_set_item_struct game_setting_inline_item[] = 
{
    ...
    {CUI_INLINE_ITEM_ID_BASE + MMI_GAME_SETTING_AUD_SELECTOR,           CUI_INLINE_ITEM_TYPE_CAPTION,       0,                                               (void*)&game_setting_audio_selector},
#endif
...
static void mmi_game_highlight_hdlr(S32 index)
{
    ...
    #ifdef IS_STAIR_BASE_GAME
            GAME_SWITCH(game_stair, mmi_gx_stair_enter_gfx);
    #endif 
