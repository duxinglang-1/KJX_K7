...
void Majung_Draw_Exit(void)
{
    ...
    #if defined(__MMI_GAME_MAJUNG_240x400__)
...
void Majung_Draw_Score(void)
{
    ...
    if (majung_game_level == LEVEL_EASY)
    {
#if defined(__MMI_GAME_MAJUNG_240x400__) || defined(__MMI_GAME_MAJUNG_320x480__)
        level_idx_shift_x = 1;  
#else
...
#ifdef __MMI_GAME_MAJUNG_320x240__
...
void Majung_Render_Energy(void)
{
    ...
    #if defined(__MMI_GAME_MAJUNG_320x480__)
