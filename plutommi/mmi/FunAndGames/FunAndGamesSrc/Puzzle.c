...
#if defined(__MMI_GAME_PUZZLE_128x160__) || defined(__MMI_GAME_PUZZLE_176x220__) || \
    defined(__MMI_GAME_PUZZLE_240x320__) || defined(__MMI_GAME_PUZZLE_320x240__) || \
...
#elif defined(__MMI_GAME_PUZZLE_128x160__) || defined(__MMI_GAME_PUZZLE_176x220__) || \
      defined(__MMI_GAME_PUZZLE_240x320__) || defined(__MMI_GAME_PUZZLE_320x240__) || \
      defined(__MMI_GAME_PUZZLE_240x400__) || defined(__MMI_GAME_PUZZLE_320x480__) 
...
#if defined(__MMI_TOUCH_SCREEN__) && \
    (defined(__MMI_GAME_PUZZLE_240x320__) || defined(__MMI_GAME_PUZZLE_320x240__) || \
     defined(__MMI_GAME_PUZZLE_240x400__) || defined(__MMI_GAME_PUZZLE_320x480__))      /* || defined(__MMI_GAME_PUZZLE_176x220__)) */
    /* draw softkay image */
...
#if 0
#if !defined(__MMI_GAME_PUZZLE_240x400__) && !defined(__MMI_GAME_PUZZLE_320x480__) && !defined(__MMI_GAME_PUZZLE_320x240__)
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
#if defined(__MMI_GAME_PUZZLE_240x400__)
...
void mmi_gx_puzzle_render(void)
{
    ...
    {
    #if defined(__MMI_GAME_PUZZLE_320x240__)
        #if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
...
#elif defined(__MMI_GAME_PUZZLE_128x160__) || defined(__MMI_GAME_PUZZLE_176x220__) || \
    defined(__MMI_GAME_PUZZLE_240x400__) || \
    defined(__MMI_GAME_PUZZLE_320x480__)
    ...
    if (g_gx_puzzle_context.long_tick % 10 == 0)
    {
    ...
    #elif  defined(__MMI_GAME_PUZZLE_240x320__) || defined(__MMI_GAME_PUZZLE_240x400__)
        ...
        do
        {
            ...
            tmp_tick = tmp_tick / 10;
            gui_show_image(MMI_GX_PUZZLE_TIME_POSITION_X + position_shift,
        #if defined(__MMI_GAME_PUZZLE_240x320__) || defined(__MMI_GAME_PUZZLE_240x400__)
                           MMI_GX_PUZZLE_TIME_POSITION_Y + 5 + 128,
        #elif defined(__MMI_GAME_PUZZLE_176x220__) || defined(__MMI_GAME_PUZZLE_128x160__)
