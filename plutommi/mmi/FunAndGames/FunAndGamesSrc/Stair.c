...
/* currently __MMI_GAME_STAIR_128x160__, __MMI_GAME_STAIR_128x128 and __MMI_GAME_STAIR_176x220 is not used */
...
void mmi_gx_stair_enter_gfx(void)
{
    ...
    GFX.game_data.game_str_id = STR_ID_GX_STAIR_GAME_NAME;  /* game name string ID */
    ...
    /* help */
#if defined(__MMI_GAME_STAIR_128x160__) || defined(__MMI_GAME_STAIR_128x128__) || defined(__MMI_GAME_STAIR_176x220__)
    GFX.game_data.help_str_id = STR_ID_GX_STAIR_HELP_DESCRIPTION;       /* help desciption string id */
#elif defined(__MMI_GAME_CHICKEN_128x128__) || defined(__MMI_GAME_CHICKEN_128x160__)
