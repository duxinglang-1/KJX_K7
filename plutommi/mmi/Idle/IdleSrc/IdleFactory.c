...
/* under construction !*/
    ...
    U8 IDLE_OP011V32_STRUCT[sizeof(mmi_idle_op11v32_struct)];
    ...
    U8 IDLE_SHELL_STRUCT[sizeof(mmi_idle_shell_struct)];
...
/* under construction !*/
    ...
    MMI_FACTORY_CFG_ADD(
        ...
        sizeof(mmi_idle_op11v32_struct),
        mmi_idle_op11v32_on_want_to_run,
        (mmi_factory_on_init_cb)mmi_idle_op11v32_on_init,
    ...
    MMI_FACTORY_CFG_ADD(
        MMI_IDLE_TYPE_SHELL,
        sizeof(mmi_idle_shell_struct),
        mmi_idle_obj_on_want_to_run,
        (mmi_factory_on_init_cb)mmi_idle_shell_on_init,
        (mmi_factory_on_deinit_cb)mmi_idle_obj_on_deinit),
#endif /* defined(__MMI_VUI_SHELL_APP__) */
