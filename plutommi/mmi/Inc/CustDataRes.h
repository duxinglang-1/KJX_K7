 ...
 *  S32    0 is success
 *****************************************************************************/
extern S32 mmi_res_img_chk_set_status(MMI_BOOL is_on);
 ...
 *  S32    0 is success
 *****************************************************************************/
extern S32 mmi_res_ado_chk_set_status(MMI_BOOL is_on);
 ...
 *  S32     0 is success
 *****************************************************************************/
extern S32 mmi_res_img_chk_record(MMI_IMG_ID str_id, WCHAR *string);
 ...
 *  S32     0 is success
 *****************************************************************************/
extern S32 mmi_res_ado_chk_record(MMI_ID str_id, WCHAR *string);
...
#define MMI_RES_IMG_CHK_RECORD(x,y) mmi_res_img_chk_record(x,y)
#define MMI_RES_ADO_CHK_RECORD(x,y) mmi_res_ado_chk_record(x,y)
#define MMI_RES_STR_CHK_RESET() mmi_res_str_chk_reset()

#else /* __MMI_RES_STR_CHECK_TOOL__ */
#define MMI_RES_STR_CHK_SET_STATUS(x)
#define MMI_RES_STR_CHK_GET_STATUS()
#define MMI_RES_STR_CHK_RECORD(x,y)
#define MMI_RES_IMG_CHK_RECORD(x,y) 
#define MMI_RES_ADO_CHK_RECORD(x,y) 
