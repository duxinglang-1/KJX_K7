...
// baiwenlin 20130830  
#if (defined(__MMI_MAINLCD_96X64__)||defined(__MMI_MAINLCD_128X36__)||defined(__MMI_MAINLCD_128X64__))
...
/* under construction !*/
	...
	#ifndef __KJX_FUN__		//xb add 2017-08-29
...
/* under construction !*/
	...
	(!defined(__LOW_COST_SUPPORT_COMMON__) || defined(__MMI_MAINLCD_96X64__ ) || defined(__KJX_OLED_64_48_UI__))	//xb add 2016-09-02 开关机动画
...
#if defined(CUSTOMER_NAME_B601)||defined(CUSTOMER_NAME_B602)||defined(CUSTOMER_NAME_B606)||defined(CUSTOMER_NAME_B608)
     #define  __CITY_EASY_MODEL_W__ 
#endif
