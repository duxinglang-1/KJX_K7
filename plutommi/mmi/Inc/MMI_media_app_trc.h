...
/*barcodereader op11*/
	...
	TRC_MSG(MMI_AUDPLY_TRC_APPLY_PICKED_FILE,"[AUDPLY] apply picked file")
	...
	TRC_MSG(MMI_AV_BT_TRC_OPEN_DEV,"[AV_BT] av_bt_open_dev, done_callback=%d, reconnect=%d, wait_cnf=%d")
	...
	TRC_MSG(MMI_AV_BT_TRC_DISCOVER_STREAM,"[AV_BT] av_bt_discover_stream")
	TRC_MSG(MMI_AV_BT_TRC_GET_STREAM_CAP,"[AV_BT] av_bt_get_stream_cap")
