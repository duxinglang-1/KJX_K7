...
/* ADD-E 20120417 FOR CMMBCAS2GPP*/
#ifdef __NPR_TTS__
    TIMER_NPR_TTS_NET_INIT,
    TIMER_NPR_TTS_NET_INIT1,
#endif
#if defined(__GGT_TASK__)
    GGT_TIMER_ID_START,
    GGT_TIMER_ID_END=GGT_TIMER_ID_START+100,
#endif
#if defined(__OLED_BW_MMI__)
	MMI_MAKE_SOS_CALL_TIMER,
	MMI_MAKE_SOS_EMPTY_TIMER,
#endif /* __OLED_BW_MMI__ */
	MMI_GOBACK_IDLE_TIMER,
	...
	MMI_OLDMAN_LOCK_TIMER,
	MMI_OLDMAN_HEARTRATE_TIMER,
	MMI_OLDMAN_HEARTRATE_DATA_TIMER,
	MMI_OLDMAN_HEARTRATE_SCREEN_TIMER,
#endif
