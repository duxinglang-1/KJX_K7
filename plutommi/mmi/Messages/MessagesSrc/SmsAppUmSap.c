...
#ifdef __GGT_TASK__
  extern void GT_sms_register_filter_handle(void);
#endif
#ifdef	__KJX_FUN__
extern	void	kjx_sms_register_filter_handle(void);
#endif
/*****************************************************************************
 * FUNCTION
 *  mmi_sms_um_sap_init
...
#endif /* __SRV_UM_THREAD_MESSAGE_SUPPORT__ */
#ifdef __GGT_TASK__
   GT_sms_register_filter_handle();
#endif
#ifdef __KJX_SMS_COMMAND__
	kjx_sms_register_filter_handle();
#endif/*__KJX_SMS_COMMAND__*/
}
