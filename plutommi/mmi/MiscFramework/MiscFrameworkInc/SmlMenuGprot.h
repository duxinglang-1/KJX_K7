...
#ifdef __MMI_DUAL_SIM_MASTER__
extern void mmi_sml_switch_content_2(U8 simInterface);
extern void mmi_sml_entry_lock_category_sim_interface(void);
extern void mmi_sml_entry_unlock_category_sim_interface(void);
extern void mmi_sml_entry_add_category_sim_interface(void);
extern void mmi_sml_entry_remove_category_sim_interface(void);
extern void mmi_sml_entry_permanent_unlock_sim_interface(void);
extern U8 mmi_sml_entry_lock_req_sim_interface(void);
extern U8 mmi_sml_entry_unlock_req_sim_interface(void);
extern U8 mmi_sml_entry_query_req_sim_interface(void);
extern void mmi_sml_entry_only_sim1_auto_locked(void);
extern void mmi_sml_entry_only_sim2_auto_locked(void);
extern void mmi_sml_entry_sim1_sim2_auto_locked(void);
