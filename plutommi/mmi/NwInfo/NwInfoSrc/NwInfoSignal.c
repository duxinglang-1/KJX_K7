...
#ifdef __KJX_FUN__	//xb add 2017-07-29 无SIM卡的时候显示状态
	if(!mmi_bootup_is_sim_valid())
	{
		wgui_status_icon_bar_change_icon_level(mainlcd_icon_id, 0);
		if (sublcd_icon_id != STATUS_ICON_INVALID_ID)
		{
			wgui_status_icon_bar_change_icon_level(sublcd_icon_id, 0);
		}
	}
#endif
