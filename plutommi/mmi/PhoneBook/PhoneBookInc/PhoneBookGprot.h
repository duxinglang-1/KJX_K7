...
{
    U32 index;
    mmi_phb_speed_dial_struct g_srv_phb_dialer_direct_dial_list[MMI_PHB_SPEED_DIAL_COUNT];
    U16 edit_number[MMI_PHB_NUMBER_PLUS_LENGTH + 1];
    mmi_id phb_group_id;
}mmi_phb_dialer_direct_dial_cntx_struct;
#endif
 ...
 * DESCRIPTION
 *  make call to a phonebook contact interface for voice dial
 * PARAMETERS
 *  store_index     :     [IN]     store index of contact           
 * RETURNS
 *  void
 *****************************************************************************/
 ...
 * DESCRIPTION
 *  Phonebook list interface for voice dial
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 ...
 * DESCRIPTION
 *  ice call back funtion for entry idle 
 * PARAMETERS
 *  void
 * RETURNS
 *  U8
 ...
 *  0              :                    no need show ice
 *****************************************************************************/
extern U8 mmi_phb_ice_contact_check(void);
 ...
 * DESCRIPTION
 *  entry ice contacts list
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
extern void mmi_phb_entry_ice_contact(void);
...
#ifdef __OP01_FWPBW__
extern void mmi_phb_direct_dial_launch(U32 index);
#endif
