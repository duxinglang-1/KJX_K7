...
extern void mmi_phb_swflash_select_from_file_mamager(void);
extern void mmi_phb_swflash_play_callback(S32 result);
extern void mmi_phb_swflash_select_from_file_mamager_done(void);
#endif
...
extern void mmi_phb_build_preferred_number_list(void);
#endif
...
#if defined(__MMI_MULTITAP_FOR_STAR_AND_POUND__)
extern void mmi_phb_generic_multi_select_and_quick_search_go_back_editor(void);
extern void mmi_phb_generic_highlight_multi_select_and_quick_search_input_method(void);
extern void mmi_phb_generic_highlight_multi_select_and_quick_search_done(void);
extern void mmi_phb_generic_exit_multi_select_and_quick_search_option(void);
extern void mmi_phb_generic_entry_multi_select_and_quick_search_option(void);
...
extern void mmi_phb_entry_dialer_direct_dial(void);
extern mmi_ret mmi_phb_dialer_direct_dial_proc(mmi_event_struct *evt);
#endif
