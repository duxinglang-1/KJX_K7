...
static void mmi_phb_vrsidial_entry(void);
#endif
...
static mmi_ret mmi_phb_op_all_proc(mmi_event_struct *evt)
{
    ...
    switch (evt->evt_id)
    {
        ...
        case EVT_ID_GROUP_DEINIT:
        {
            ...
            {
                srv_phb_mem_free(g_mmi_phb_mess_operation_title);
...
#ifdef __MMI_DYNAMIC_SIM_DYNAMIC_UI__
    g_mmi_phb_mess_operation_title = (WCHAR *)srv_phb_mem_malloc(sizeof(WCHAR) * MMI_PHB_MAX_DYNAMIC_SIM_NAME_LENGTH, SRV_PHB_MEMORY_TYPE_CTR);
#endif
...
mmi_ret mmi_phb_main_list_menu_cui_proc(mmi_event_struct *evt)
{
    ...
    switch (evt->evt_id)
    {
        ...
        case EVT_ID_CUI_MENU_ITEM_SELECT:
        {
            ...
            #if defined(__OP12__)
                case MENU_ID_PHB_ADD_CONTACT_IN_EDIT:
                    mmi_phb_op_add_new_entry_ext(GRP_ID_PHB_MAIN);
                    break;

                case MENU_ID_PHB_EDIT_CONTACT_IN_EDIT:
                    mmi_phb_op_edit_pre_entry_ext(GRP_ID_PHB_MAIN);
                    break;
            #endif
            ...
            #if defined(__MMI_VRSD_DIAL__)
                case MENU_ID_VRSD_DIAL_PHB_OPTION:
                    mmi_phb_vrsidial_entry();
                    break;
            #endif
...
mmi_ret mmi_phb_main_list_menu_cui_proc(mmi_event_struct *evt)
{
    ...
    switch (evt->evt_id)
    {
        ...
        case EVT_ID_CUI_MENU_ITEM_SELECT:
        {
            ...
            #ifdef __OP01_FWPBW__
                case  MENU_ID_PHB_DIALER_DIRECT_DIAL:
            #ifdef __MMI_DYNAMIC_SIM_DYNAMIC_UI__
                    if (srv_sim_ctrl_any_sim_is_available())
                    {
                        mmi_phb_entry_dialer_direct_dial(); 
                    }
                    else
                    {
                        mmi_phb_popup_display_ext(STR_GLOBAL_UNAVAILABLE_SIM, MMI_EVENT_INFO);
...
void mmi_phb_entry_op_option(void)
{
    ...
    #endif
    #if defined(__MMI_VRSD_DIAL__)
        cui_menu_set_item_hidden(menu_gid, MENU_ID_VRSD_DIAL_PHB_OPTION, MMI_TRUE);
    #endif
    #ifdef __MMI_PHB_MULTI_OPERATION__
    ...
    #if defined(__MMI_VRSD_DIAL__)
        mmi_phb_sim_ctrl_not_inserted_disable_menu(menu_gid, MENU_ID_VRSD_DIAL_PHB_OPTION);
    #endif
...
static void mmi_phb_view_group_info_exit(void)
{
    ...
    {
        srv_phb_mem_free(g_mmi_phb_view_contact_p->group_array); 
    }
}
...
static void mmi_phb_contact_view_group_info(void)
{
    	...
    	MMI_FRM_UNKNOW_SCRN))
	{
        g_mmi_phb_view_contact_p->group_array = 
            (U8*)srv_phb_mem_malloc(sizeof(U8) * MMI_PHB_GROUP_COUNT, SRV_PHB_MEMORY_TYPE_CTR);
        storage = (phb_storage_enum)srv_phb_get_storage(g_mmi_phb_view_contact_p->store_index);
...
/* under construction !*/
    ...
    switch (g_mmi_phb_view_contact_p->highlight_type)
    {
        ...
        case MMI_PHB_FIELD_VOIP:
            g_mmi_phb_view_contact_p->select_data = g_mmi_phb_contact_p->voip;
            if (mmi_ucs2strlen((CHAR*) g_mmi_phb_view_contact_p->select_data))
            {
                cui_menu_set_item_hidden(menu_gid, MENU_ID_PHB_VIEW_CONTACT_DIAL, MMI_FALSE);
            }
            break;
        #endif
    #ifdef __MMI_PHB_OPTIONAL_FIELD__
...
void mmi_phb_single_op_done(S32 result, U16 store_index, mmi_phb_op_cntx_struct *op_cntx)
{
    ...
    switch (op_cntx->action)
    {
        ...
        case MMI_PHB_OP_EDIT:
        {
            ...
            {
            #ifdef __MMI_PHB_SPEED_DIAL__
                mmi_phb_contact_info_struct *contact = (mmi_phb_contact_info_struct *) srv_phb_mem_malloc(sizeof(mmi_phb_contact_info_struct), SRV_PHB_MEMORY_TYPE_ADM);
...
#if  defined(__MMI_FILE_MANAGER__) && defined(__MMI_VCARD__)
#ifdef __OP01_FWPBW__
    cui_menu_set_item_hidden(menu_gid, MENU_ID_PHB_COPY_TO_FMGR, MMI_TRUE); 
#endif
#endif
}
...
static void mmi_phb_dial_normal_call_ex(mmi_phb_op_action_cntx_struct *op_cntx, MMI_ID group_id)
{
    ...
    /*----------------------------------------------------------------*/
    mmi_phb_choose_number_struct *choose_data = 
        (mmi_phb_choose_number_struct *) srv_phb_mem_malloc(sizeof(mmi_phb_choose_number_struct), SRV_PHB_MEMORY_TYPE_CTR);
    mmi_id sg_id = group_id;
...
MMI_BOOL mmi_phb_og_start_browser(U16 store_index, MMI_ID group_id)
{
    ...
    {
        url = (U16 *) srv_phb_mem_malloc(sizeof(U16) * (MMI_PHB_URL_LENGTH + 1), SRV_PHB_MEMORY_TYPE_CTR);
...
void mmi_phb_option_op_play_video(MMI_ID group_id)
{
    ...
    if (selected_video_index == (g_mmi_phb_resource.total_video_id - 1)
        ...
        || (selected_video_index == (g_mmi_phb_resource.total_video_id - g_phb_swflash_video_minus))
...
static void mmi_phb_vrsidial_entry(void)
{
    ...
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    mmi_id sg_id = GRP_ID_PHB_MAIN;
    
    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_vrsddial_set_cur_store_index(g_mmi_phb_list_p->store_index);
...
static void mmi_phb_compose_contact_image(void* handle, mmi_phb_contact_info_struct *contact_info)
{
    ...
    S32  img_height = 0;
    U32  image_size = 0;
    WCHAR * pbuf = srv_phb_mem_malloc(SRV_FMGR_PATH_MAX_LEN + 1, SRV_PHB_MEMORY_TYPE_ADM);
...
/* under construction !*/
            ...
            case MMI_PHB_BPP_VOIP:
                mmi_ucs2_to_asc(value_buffer, (CHAR *) contact_info->voip);
                break;
...
static void mmi_phb_bpp_attr_buf_malloc(xhtml_attr_struct *attribute)
{
    ...
    for (i = 0; i < 5; i++)
    {
        attribute[i].name = (char *)srv_phb_mem_malloc(PHB_BPP_FIELD_TITLE_BUFFER_LENGTH, SRV_PHB_MEMORY_TYPE_ADM);
        attribute[i].value = (char *)srv_phb_mem_malloc(PHB_BPP_FIELD_VALUE_BUFFER_LENGTH, SRV_PHB_MEMORY_TYPE_ADM);
    }
}
...
U8 mmi_phb_get_sim_entry_by_location(U16 entryNum)
{
    ...
    else if (srv_sim_ctrl_is_available(MMI_SIM2) && srv_phb_check_storage_accessible(PHB_STORAGE_SIM2))
    {
        storage = PHB_STORAGE_SIM2;
    }
#if (MMI_MAX_SIM_NUM >= 3)
    else if (srv_sim_ctrl_is_available(MMI_SIM3) && srv_phb_check_storage_accessible(PHB_STORAGE_SIM3))
    {
        storage = PHB_STORAGE_SIM3;
    }
#endif
#if (MMI_MAX_SIM_NUM >= 4)
    else if (srv_sim_ctrl_is_available(MMI_SIM4) && srv_phb_check_storage_accessible(PHB_STORAGE_SIM4))
    {
        ...
        srv_uriagent_uri_request_hdlr_cb cb)
{
    ...
    uriagent_info = (mmi_phb_uriagent_info_struct *) srv_phb_mem_malloc(sizeof(mmi_phb_uriagent_info_struct), SRV_PHB_MEMORY_TYPE_ADM);
    uriagent_info->cb = cb;
...
mmi_phb_uriagent_err_enum mmi_phb_uriagent_parse_uri(U8* uri, CHAR* ucs2_name, CHAR* ucs2_num)
{
    ...
    else
    {
        ...
        temp_num_buff = srv_phb_mem_malloc(num_len + 1, SRV_PHB_MEMORY_TYPE_CTR);
...
void mmi_phb_unsaved_data_free_node(mmi_phb_unsaved_data_node_struct *data_node)
{
    ...
    {
        srv_phb_mem_free(data_node->object->phb_data->name);
    }
    if (data_node->object->phb_data->number != NULL)
    {
        srv_phb_mem_free(data_node->object->phb_data->number);
    }
#if defined(__MMI_PHB_INFO_FIELD__)
    if (data_node->object->phb_data->pobox != NULL)
    {
        srv_phb_mem_free(data_node->object->phb_data->pobox);
    }

    if (data_node->object->phb_data->extension != NULL)
    {
        srv_phb_mem_free(data_node->object->phb_data->extension);
    }

    if (data_node->object->phb_data->street != NULL)
    {
        srv_phb_mem_free(data_node->object->phb_data->street);
    }

    if (data_node->object->phb_data->city != NULL)
    {
        srv_phb_mem_free(data_node->object->phb_data->city);
    }

    if (data_node->object->phb_data->state != NULL)
    {
        srv_phb_mem_free(data_node->object->phb_data->state);
    }

    if (data_node->object->phb_data->postalcode != NULL)
    {
        srv_phb_mem_free(data_node->object->phb_data->postalcode);
    }

    if (data_node->object->phb_data->country != NULL)
    {
        srv_phb_mem_free(data_node->object->phb_data->country);
    }
#endif /* defined(__MMI_PHB_INFO_FIELD__) */
    /* free other fields */
    if (data_node->object->phb_data != NULL)
    {
        srv_phb_mem_free(data_node->object->phb_data);
    }
    if (data_node->object != NULL)
    {
        srv_phb_mem_free(data_node->object);
    }
    srv_phb_mem_free(data_node);
}
            ...
            srv_phb_contact_data_struct *phb_data)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    data_node = srv_phb_mem_malloc(sizeof(mmi_phb_unsaved_data_node_struct), SRV_PHB_MEMORY_TYPE_ADM); 
    memset(data_node, 0x00, sizeof(mmi_phb_unsaved_data_node_struct));
    
    data_node->object = srv_phb_mem_malloc(sizeof(mmi_phb_unsaved_data_struct), SRV_PHB_MEMORY_TYPE_ADM);
    ...
    data_node->object->phb_data = srv_phb_mem_malloc(sizeof(srv_phb_contact_data_struct), SRV_PHB_MEMORY_TYPE_ADM);
    memset(data_node->object->phb_data, 0x00, sizeof(srv_phb_contact_data_struct));

    if (phb_data->name != NULL && mmi_wcslen(phb_data->name))
    {
        data_node->object->phb_data->name = srv_phb_mem_malloc((MMI_PHB_NAME_FIELD_LENGTH + 1) * ENCODING_LENGTH, SRV_PHB_MEMORY_TYPE_ADM);
    ...
    {            
        ...
        data_node->object->phb_data->number = srv_phb_mem_malloc((MMI_PHB_NUMBER_LENGTH + 1 + 1) * ENCODING_LENGTH, SRV_PHB_MEMORY_TYPE_ADM);
    ...
    {
        data_node->object->phb_data->pobox = srv_phb_mem_malloc((MMI_PHB_ADDRESS_LENGTH + 1) * ENCODING_LENGTH, SRV_PHB_MEMORY_TYPE_ADM);
    ...
    {
        data_node->object->phb_data->extension = srv_phb_mem_malloc((MMI_PHB_ADDRESS_LENGTH + 1) * ENCODING_LENGTH, SRV_PHB_MEMORY_TYPE_ADM);
    ...
    {
        data_node->object->phb_data->street = srv_phb_mem_malloc((MMI_PHB_ADDRESS_LENGTH + 1) * ENCODING_LENGTH, SRV_PHB_MEMORY_TYPE_ADM);
    ...
    {
        data_node->object->phb_data->city = srv_phb_mem_malloc((MMI_PHB_ADDRESS_LENGTH + 1) * ENCODING_LENGTH, SRV_PHB_MEMORY_TYPE_ADM);
    ...
    {
        data_node->object->phb_data->state = srv_phb_mem_malloc((MMI_PHB_ADDRESS_LENGTH + 1) * ENCODING_LENGTH, SRV_PHB_MEMORY_TYPE_ADM);
    ...
    {
        data_node->object->phb_data->postalcode = srv_phb_mem_malloc((MMI_PHB_ADDRESS_LENGTH + 1) * ENCODING_LENGTH, SRV_PHB_MEMORY_TYPE_ADM);
    ...
    {
        data_node->object->phb_data->country = srv_phb_mem_malloc((MMI_PHB_ADDRESS_LENGTH + 1) * ENCODING_LENGTH, SRV_PHB_MEMORY_TYPE_ADM);
...
void mmi_phb_entry_unsaved_data_confirm(void)
{
    ...
    outBuf = srv_phb_mem_malloc(256, SRV_PHB_MEMORY_TYPE_CTR);
...
static U8 mmi_phb_startup_copy_sim_check_ext(U32 sim_index)
{
    ...
    else
    {
        ...
        if (!srv_sim_ctrl_is_available(MMI_SIM1<<sim_index) ||                           /* SIM is blocked or not inserted */
