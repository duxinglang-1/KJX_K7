...
static const cui_inline_item_caption_struct g_mmi_phb_inline_ice_caption[] =
{
    {STR_ID_PHB_ICE1},
    {STR_ID_PHB_ICE2},
    {STR_ID_PHB_ICE3}
...
static const cui_inline_item_text_edit_struct g_mmi_phb_inline_ice_number[] =
{
    {
        0,
        0,
...
#ifdef __OP11__ /*__MMI_PHB_ICE_CONTACT__ */
static const cui_inline_set_item_struct g_mmi_phb_inline_ice_contact[] =
{
    {INLINE_ID_PHB_ICE1_CAPTION, CUI_INLINE_ITEM_TYPE_CAPTION, IMG_GLOBAL_L1, &g_mmi_phb_inline_ice_caption[0]},
    {INLINE_ID_PHB_ICE1_NUMBER, CUI_INLINE_ITEM_TYPE_TEXT_EDIT, 0, &g_mmi_phb_inline_ice_number[0]},
    {INLINE_ID_PHB_ICE2_CAPTION, CUI_INLINE_ITEM_TYPE_CAPTION, IMG_GLOBAL_L2, &g_mmi_phb_inline_ice_caption[1]},
    {INLINE_ID_PHB_ICE2_NUMBER, CUI_INLINE_ITEM_TYPE_TEXT_EDIT, 0, &g_mmi_phb_inline_ice_number[1]},
    {INLINE_ID_PHB_ICE3_CAPTION, CUI_INLINE_ITEM_TYPE_CAPTION, IMG_GLOBAL_L3, &g_mmi_phb_inline_ice_caption[2]},
    {INLINE_ID_PHB_ICE3_NUMBER, CUI_INLINE_ITEM_TYPE_TEXT_EDIT, 0, &g_mmi_phb_inline_ice_number[2]}
};
...
#else
	{INLINE_ID_PHB_EMAIL_ADDR2 + 100, CUI_INLINE_ITEM_TYPE_CAPTION, IMG_EMAIL_ADDRESS2, &my_email_caption2},
#endif
...
#ifdef __OP11__ /*__MMI_PHB_ICE_CONTACT__ */
static const cui_inline_struct g_mmi_phb_inline_screen4 =
{
    sizeof(g_mmi_phb_inline_ice_contact) / sizeof(cui_inline_set_item_struct),
    STR_ID_PHB_ICE_CONTACT,
    IMG_SCR_PBOOK_CAPTION,
    0,
    NULL,
    &g_mmi_phb_inline_ice_contact[0]
};
#endif /* __MMI_PHB_ICE_CONTACT__ */
...
mmi_ret mmi_phb_entry_group_extra_number_proc(mmi_event_struct *evt)
{
    ...
    switch (evt->evt_id)
    {
        ...
        #ifdef __MMI_DYNAMIC_SIM_DYNAMIC_UI__ 
            srv_phb_mem_free(mmi_phb_extra_number_p->title);
        #endif
            srv_phb_mem_free(mmi_phb_extra_number_p);
            break;
...
void mmi_phb_entry_group_extra_number(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_phb_extra_number_p = srv_phb_mem_malloc(
                                sizeof(mmi_phb_extra_number_cntx_struct),
                                SRV_PHB_MEMORY_TYPE_ADM);
    
#ifdef __MMI_DYNAMIC_SIM_DYNAMIC_UI__
    mmi_phb_extra_number_p->title = (WCHAR *)srv_phb_mem_malloc(sizeof(WCHAR) * MMI_PHB_MAX_DYNAMIC_SIM_NAME_LENGTH, SRV_PHB_MEMORY_TYPE_CTR);
#endif
...
#ifdef __OP11__
    else if (highlighted_menu_id == MENU_ID_PHB_ICE_CONTACT)
    {
        ...
        case EVT_ID_CUI_INLINE_SUBMIT:
            {
                ...
                {
                    MMI_ASSERT(item_id >= INLINE_ID_PHB_ICE_BEGIN && item_id <= INLINE_ID_PHB_ICE_END);
                    mmi_phb_save_ice_contact();
                }
            #endif /* __MMI_PHB_ICE_CONTACT__ */
            #endif /* __MMI_PHB_SLIM_EXTRA_DEFEATURE__ */
            }
        ...
        case EVT_ID_CUI_INLINE_SET_KEY:
            {
                ...
                if (set_key_evt->item_id >= INLINE_ID_PHB_ICE_BEGIN && set_key_evt->item_id <= INLINE_ID_PHB_ICE_END)
                {
                    SetKeyHandler(mmi_phb_ice_contact_make_call, KEY_SEND, KEY_EVENT_UP);
                }
            }
            break;
    #endif /* __MMI_PHB_ICE_CONTACT__ */
        ...
        case EVT_ID_CUI_INLINE_NOTIFY:
            {
                ...
                {
                    if (item_id >= INLINE_ID_PHB_ICE_BEGIN && item_id <= INLINE_ID_PHB_ICE_END)
                    {
                        g_mmi_phb_active_index = (U16) (item_id - INLINE_ID_PHB_ICE1_CAPTION) / 2;
                    }
                }
            }
            break;
...
#endif /* __MMI_PHB_SLIM_EXTRA_NUMBER__ */
 ...
 * Local Variable
 */
static mmi_phb_ice_contact_struct g_mmi_phb_ice_list[MMI_PHB_ICE_CONTACT_COUNT];
static U8 g_mmi_phb_ice_status;


/*****************************************************************************
 * FUNCTION
 *  mmi_phb_read_ice_contact
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_phb_read_ice_contact(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    ReadRecord(NVRAM_EF_PHB_ICE_CONTACT_LID, 1, g_mmi_phb_ice_list, NVRAM_EF_PHB_ICE_CONTACT_SIZE, &error);
}


/*****************************************************************************
 * FUNCTION
 *  mmi_phb_write_ice_contact
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_phb_write_ice_contact(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    WriteRecord(NVRAM_EF_PHB_ICE_CONTACT_LID, 1, g_mmi_phb_ice_list, NVRAM_EF_PHB_ICE_CONTACT_SIZE, &error);
}
 ...
 *  void
 *****************************************************************************/
void mmi_phb_entry_ice_contact(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if (!mmi_frm_group_is_present(GRP_ID_PHB_EXTRA_NUMBER))
    {
        mmi_phb_extra_number_p = srv_phb_mem_malloc(sizeof(mmi_phb_extra_number_cntx_struct), SRV_PHB_MEMORY_TYPE_ADM);

        mmi_frm_group_create_ex(GRP_ID_ROOT, GRP_ID_PHB_EXTRA_NUMBER, mmi_phb_entry_group_extra_number_proc, mmi_phb_extra_number_p, MMI_FRM_NODE_SMART_CLOSE_FLAG);
    }

    mmi_phb_read_ice_contact();

    inline_id = cui_inline_create(GRP_ID_PHB_EXTRA_NUMBER, &g_mmi_phb_inline_screen4);
    cui_inline_set_value(inline_id, INLINE_ID_PHB_ICE1_NUMBER, g_mmi_phb_ice_list[0].number);
    cui_inline_set_value(inline_id, INLINE_ID_PHB_ICE2_NUMBER, g_mmi_phb_ice_list[1].number);
    cui_inline_set_value(inline_id, INLINE_ID_PHB_ICE3_NUMBER, g_mmi_phb_ice_list[2].number);
    mmi_phb_extra_number_p->sender_id = inline_id;
    cui_inline_run(inline_id);
}
 ...
 *  void
 *****************************************************************************/
void mmi_phb_ice_contact_make_call(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    cui_inline_get_value(mmi_phb_extra_number_p->sender_id, INLINE_ID_PHB_ICE1_NUMBER, g_mmi_phb_ice_list[0].number);
    cui_inline_get_value(mmi_phb_extra_number_p->sender_id, INLINE_ID_PHB_ICE2_NUMBER, g_mmi_phb_ice_list[1].number);
    cui_inline_get_value(mmi_phb_extra_number_p->sender_id, INLINE_ID_PHB_ICE3_NUMBER, g_mmi_phb_ice_list[2].number);
    ...
    mmi_phb_call_launch_ex(
        NULL, 
        g_mmi_phb_ice_list[g_mmi_phb_active_index].number, 
        call_type);
}
 ...
 *  void
 *****************************************************************************/
void mmi_phb_save_ice_contact(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    for (i = 0; i < MMI_PHB_ICE_CONTACT_COUNT; i++)
    {
        if (!srv_phb_check_valid_number(g_mmi_phb_ice_list[i].number))
        {
            mmi_phb_popup_display_ext(STR_GLOBAL_INVALID_NUMBER, MMI_EVENT_FAILURE);
            return;
        }
...
/*****************************************************************************
 * FUNCTION
 *  mmi_phb_go_back_from_ice_contact
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_phb_go_back_from_ice_contact(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  U8
 *****************************************************************************/
U8 mmi_phb_ice_contact_check(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (!g_mmi_phb_ice_status)
    {
        g_mmi_phb_ice_status = MMI_TRUE;
        ReadRecord(NVRAM_EF_SYS_CACHE_OCTET_LID, NVRAM_SYS_INFO, &buffer, NVRAM_EF_SYS_CACHE_OCTET_SIZE, &error);
        ...
        {
            buffer[0] = 1;
            WriteRecord(NVRAM_EF_SYS_CACHE_OCTET_LID, NVRAM_SYS_INFO, &buffer, NVRAM_EF_SYS_CACHE_OCTET_SIZE, &error);
            return MMI_TRUE;
        }
    }
...
mmi_ret mmi_phb_entry_group_my_number_proc(mmi_event_struct *evt)
{
    ...
    {
        case EVT_ID_GROUP_DEINIT:
            srv_phb_mem_free(mmi_phb_my_number_p);
            break;
...
void mmi_phb_entry_group_my_number(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_phb_my_number_p = srv_phb_mem_malloc(sizeof(mmi_phb_my_number_cntx_struct), SRV_PHB_MEMORY_TYPE_ADM);
#ifndef __MMI_MAINLCD_96X64__
    mmi_frm_group_create_ex(
        GRP_ID_PHB_SETTING,
...
void mmi_phb_save_my_number(void)
{
    ...
    {
        str_id = STR_ID_PHB_NAME_NUM_REQUIRE_ALL;
    }
    else if (mmi_phb_my_number_p->first_name[0] == 0
    #ifdef __MMI_PHB_LAST_NAME_FIELD__
        && mmi_phb_my_number_p->last_name[0] == 0
    #endif
        )
    ...
    else if (mmi_phb_my_number_p->mobile_number[0] == 0)
    {
...
mmi_ret mmi_phb_entry_group_speed_dial_proc(mmi_event_struct *evt)
{
    ...
    {
        case EVT_ID_GROUP_DEINIT:
            srv_phb_mem_free(mmi_phb_speed_dial_p);
            break;
...
void mmi_phb_entry_group_speed_dial(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_phb_speed_dial_p = srv_phb_mem_malloc(sizeof(mmi_phb_extra_number_cntx_struct), SRV_PHB_MEMORY_TYPE_ADM);
#ifndef __MMI_MAINLCD_96X64__
    mmi_frm_group_create_ex(
        GRP_ID_PHB_SETTING,
...
mmi_ret mmi_phb_speed_dial_pre_set_proc(mmi_event_struct *evt)
{
    ...
    {
        case EVT_ID_GROUP_DEINIT:
            srv_phb_mem_free(evt->user_data);
            break;
...
void mmi_phb_speed_dial_pre_set_number(mmi_id sg_id, U16 store_index, U32 num_type, mmi_phb_contact_info_struct* contact)
{
    ...
    /*----------------------------------------------------------------*/
    mmi_phb_speed_dial_pre_set_cntx_struct* cntx =
            (mmi_phb_speed_dial_pre_set_cntx_struct*)srv_phb_mem_malloc(
...
#define MMI_PHB_DIALER_DIRECT_DIAL
#ifdef __OP01_FWPBW__
static void mmi_phb_entry_direct_dial(void);

/*****************************************************************************
 * FUNCTION
 *  mmi_phb_direct_dial_enter_contact
 * DESCRIPTION
 ...
 *  void
 *****************************************************************************/
static void mmi_phb_direct_dial_enter_contact(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    mmi_phb_dialer_direct_dial_cntx_struct *group_data = 
        (mmi_phb_dialer_direct_dial_cntx_struct *)mmi_frm_group_get_user_data(GRP_ID_PHB_DIRECT_DIAL);
    
    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    group_data->phb_group_id = cui_phb_list_select_contact_create(GRP_ID_PHB_DIRECT_DIAL);

    if (group_data->phb_group_id != GRP_ID_INVALID)
    {
        cui_phb_list_select_contact_set_field_filter(group_data->phb_group_id, SRV_PHB_ENTRY_FIELD_GSM_NUM);
        cui_phb_list_select_contact_run(group_data->phb_group_id);
    }
}
 ...
 *  void
 *****************************************************************************/
static void mmi_phb_save_direct_dial(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    srv_phb_direct_dial_save(group_data->index, group_data->edit_number);

    mmi_frm_scrn_close(GRP_ID_PHB_DIRECT_DIAL, SCR_DIRECT_DIAL_EDIT);
}
 ...
 *  void
 *****************************************************************************/
void mmi_phb_entry_direct_dial_edit(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    ret = mmi_frm_scrn_enter(
            ...
            NULL,
            (FuncPtr)mmi_phb_entry_direct_dial_edit,
            MMI_FRM_FULL_SCRN);

    //gui_buffer = mmi_frm_scrn_get_gui_buf(GRP_ID_PHB_DIRECT_DIAL, SCR_DIRECT_DIAL_EDIT);
    gui_buffer = NULL;
    ...
    ShowCategory16Screen(
        ...
        STR_ID_IDLE_CONTACT,
        IMG_GLOBAL_BACK,
        (U8 *)group_data->edit_number,
        MMI_PHB_NUMBER_PLUS_LENGTH,
        gui_buffer);

    SetLeftSoftkeyFunction(mmi_phb_save_direct_dial, KEY_EVENT_UP);
    SetCenterSoftkeyFunction(mmi_phb_save_direct_dial, KEY_EVENT_UP);
    SetCategory16RightSoftkeyFunction(mmi_phb_direct_dial_enter_contact, KEY_EVENT_UP);
}


/*****************************************************************************
 * FUNCTION
 *  mmi_phb_entry_direct_dial_delete
 * DESCRIPTION
 *  This function handles the enter action.
 * PARAMETERS
 *  obj             : [IN]          Object
 ...
 *  void
 *****************************************************************************/
static void mmi_phb_entry_direct_dial_delete(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    memset(group_data->edit_number, 0x00, sizeof(group_data->edit_number));
    mmi_phb_save_direct_dial();
}
...
/*****************************************************************************
 * FUNCTION
 *  mmi_phb_dialer_direct_dial_proc
 * DESCRIPTION
 *  
 * PARAMETERS
 *  evt         [IN]        
 ...
 *  mmi_ret
 *****************************************************************************/
mmi_ret mmi_phb_dialer_direct_dial_proc(mmi_event_struct *evt)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    switch (evt->evt_id)
    {
        ...
        case EVT_ID_PHB_SELECT_CONTACT:
        {
            cui_phb_select_contact_result_struct *select_contact = (cui_phb_select_contact_result_struct*) evt;
            mmi_phb_dialer_direct_dial_cntx_struct *group_data = 
                (mmi_phb_dialer_direct_dial_cntx_struct *)mmi_frm_group_get_user_data(GRP_ID_PHB_DIRECT_DIAL);
            mmi_wcscpy(group_data->edit_number, select_contact->select_data);
            mmi_phb_entry_direct_dial_edit();
            cui_phb_list_select_contact_close(group_data->phb_group_id);
            break;
        }
 ...
 *  void
 *****************************************************************************/
static void mmi_phb_entry_direct_dial_option(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/*****************************************************************************
 * FUNCTION
 *  mmi_phb_direct_dial_highlight_hdlr
 * DESCRIPTION
 *  
 * PARAMETERS
 *  index       [IN]        
 ...
 *  void
 *****************************************************************************/
static void mmi_phb_direct_dial_highlight_hdlr(S32 index)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if (group_data->g_srv_phb_dialer_direct_dial_list[index].number[0])
    {
        SetLeftSoftkeyFunction(mmi_phb_entry_direct_dial_option, KEY_EVENT_UP);
        ChangeLeftSoftkey(STR_GLOBAL_OPTIONS, IMG_GLOBAL_OPTIONS);
    }
    else
    {
        SetLeftSoftkeyFunction(mmi_phb_entry_direct_dial_edit, KEY_EVENT_UP);
        ChangeLeftSoftkey(STR_GLOBAL_EDIT, IMG_GLOBAL_OPTIONS);
    }
}
...
static void mmi_phb_entry_direct_dial(void)
{
    ...
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    U8  *item_list[MMI_PHB_DIALER_DIRECT_DIAL_COUNT];
    U16  icon_list[MMI_PHB_DIALER_DIRECT_DIAL_COUNT];
    U16  i;
    U8  *gui_buffer;
    mmi_phb_dialer_direct_dial_cntx_struct *group_data = 
        (mmi_phb_dialer_direct_dial_cntx_struct *)mmi_frm_group_get_user_data(GRP_ID_PHB_DIRECT_DIAL);
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    srv_phb_direct_dial_init(group_data->g_srv_phb_dialer_direct_dial_list);
    
    for (i = 0; i < MMI_PHB_DIALER_DIRECT_DIAL_COUNT; ++i)
    {
        item_list[i] = (U8 *)group_data->g_srv_phb_dialer_direct_dial_list[i].number;
        icon_list[i] = IMG_PHB_DIRECT_DIAL_F1 + i;
    }
    ...
    RegisterHighlightHandler(mmi_phb_direct_dial_highlight_hdlr);
    wgui_override_list_menu_slim_style(WGUI_LIST_MENU_SLIM_STYLE_DRAW_ICON);
    ...
    ShowCategory53Screen(
        ...
        STR_GLOBAL_BACK,
        IMG_GLOBAL_BACK,
        MMI_PHB_DIALER_DIRECT_DIAL_COUNT,
        item_list,
        (U16*)icon_list,
        NULL,
        0,
    ...
    SetCenterSoftkeyFunction(mmi_phb_entry_direct_dial_edit, KEY_EVENT_UP);
}
 ...
 *  void
 *****************************************************************************/
void mmi_phb_entry_dialer_direct_dial(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
#ifndef __MMI_MAINLCD_96X64__
    mmi_frm_group_create_ex(GRP_ID_PHB_SETTING, GRP_ID_PHB_DIRECT_DIAL, mmi_phb_dialer_direct_dial_proc, user_data,MMI_FRM_NODE_SMART_CLOSE_FLAG);
#else
    mmi_frm_group_create_ex(GRP_ID_PHB_MAIN, GRP_ID_PHB_DIRECT_DIAL, mmi_phb_dialer_direct_dial_proc, user_data,MMI_FRM_NODE_SMART_CLOSE_FLAG);
#endif
...
void mmi_phb_direct_dial_launch(U32 index)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void mmi_phb_confirm_display(UI_string_type text, mmi_id parent_id, FuncPtr lsk_func, FuncPtr rsk_func, MMI_BOOL is_enable_csk)
{
    ...
    mmi_phb_confirm_data_struct *confirm_data =
        srv_phb_mem_malloc(sizeof(mmi_phb_confirm_data_struct), SRV_PHB_MEMORY_TYPE_CTR);
