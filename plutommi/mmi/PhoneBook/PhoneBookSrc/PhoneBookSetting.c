...
void mmi_phb_setting_init(void)
{
	...
	void * buf = srv_phb_mem_malloc(sizeof(mmi_phb_setting_screen_cntx_struct), SRV_PHB_MEMORY_TYPE_ADM);
#endif
...
void mmi_phb_sg_entry_setting_ext(void)
{
    mmi_phb_sg_entry_setting(GRP_ID_INVALID);
}
...
void mmi_phb_highlight_setting(void)
{
    ...
    SetLeftSoftkeyFunction(mmi_phb_sg_entry_setting_ext, KEY_EVENT_UP);
    SetCenterSoftkeyFunction(mmi_phb_sg_entry_setting_ext ,KEY_EVENT_UP);
...
#ifdef __VCARD_CLOUD_SUPPORT__
    g_phb_cloud_cntx = srv_phb_mem_malloc(sizeof(mmi_phb_cloud_cntx_struct), SRV_PHB_MEMORY_TYPE_ADM);
...
static mmi_ret mmi_phb_setting_group_proc(mmi_event_struct *evt)
{
    ...
    switch(evt->evt_id)
    {
        case EVT_ID_GROUP_DEINIT:
            ...
            {
                srv_phb_mem_free(sg_setting_cntx->contact_array);
                sg_setting_cntx->contact_array = NULL;
            }
        #endif
            srv_phb_mem_free(sg_setting_cntx);
        #ifdef LOW_COST_SUPPORT
            ...
            srv_phb_mem_free(g_phb_cloud_cntx);
...
void mmi_phb_entry_backup_contact(MMI_ID group_id)
{
    ...
    {
        sg_setting_cntx->contact_array = srv_phb_mem_malloc(MMI_PHB_ENTRIES * sizeof(U16), SRV_PHB_MEMORY_TYPE_ADM);
    }
