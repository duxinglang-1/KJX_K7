...
void mmi_sat_app_launch(mmi_id parent_gid, mmi_sim_enum sim_id)
{
    ...
    mmi_frm_scrn_first_enter(*gid_p, SCR_ID_SAT_CMD_SCREEN, (FuncPtr)mmi_sat_main_menu_scrn_entry, gid_p);
}
...
void mmi_sat_get_input_process(srv_sat_proactive_sim_struct *cmd_info)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    group_data = mmi_sat_init_group_data(cmd_info->sim_id,cmd_info->cmd_type, &cmd_info->cmd_data, MMI_FALSE , mmi_sat_get_input_scrn_entry);  //slim
...
void mmi_sat_send_sms_process(srv_sat_proactive_sim_struct *cmd_info)
{
    ...
    group_data = mmi_sat_init_group_data(cmd_info->sim_id, cmd_info->cmd_type, send_sms, MMI_FALSE , mmi_sat_send_sms_scrn_entry);	//slim
...
void mmi_sat_send_ss_process(srv_sat_proactive_sim_struct *cmd_info)
{
    ...
    group_data = mmi_sat_init_group_data(cmd_info->sim_id, cmd_info->cmd_type, send_ss, MMI_FALSE , mmi_sat_send_ss_scrn_entry);	//slim
...
void mmi_sat_send_ussd_process(srv_sat_proactive_sim_struct *cmd_info)
{
    ...
    group_data = mmi_sat_init_group_data(cmd_info->sim_id, cmd_info->cmd_type, send_ussd, MMI_FALSE , mmi_sat_send_ussd_scrn_entry);	//slim
