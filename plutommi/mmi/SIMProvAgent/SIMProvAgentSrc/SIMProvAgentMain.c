...
void mmi_spa_sim_info_handler(const mmi_spa_sim_status_info_ind_struct *sim_info)
{
    ...
    if (sim_info->sim_id == MMI_SPA_SIM_ID_SIM1 || sim_info->sim_id == MMI_SPA_SIM_ID_SIM2)
    {
        ...
        if (mmi_spa_get_sim_status_notified() == MMI_SPA_SIM_ID_DUAL_SIM &&
        ...
        #ifdef __MMI_DUAL_SIM__
            mmi_spa_set_sim_changed_status_ok(MMI_SPA_SIM_ID_SIM2);
        #endif 
        }
        /* else check all blocked */
    #ifdef __MMI_DUAL_SIM__
        else if (mmi_spa_get_sim_status_notified() == MMI_SPA_SIM_ID_DUAL_SIM &&
                 (g_spa_context.sim_status == MMI_SPA_SIM_ID_SIM1 &&
                  g_spa_context.sim1_type == MMI_SPA_SIM_TYPE_BLOCKED_SIM) ||
                 (g_spa_context.sim_status == MMI_SPA_SIM_ID_SIM2 &&
                  g_spa_context.sim2_type == MMI_SPA_SIM_TYPE_BLOCKED_SIM) ||
                 (g_spa_context.sim_status == MMI_SPA_SIM_ID_DUAL_SIM &&
                  g_spa_context.sim1_type == MMI_SPA_SIM_TYPE_BLOCKED_SIM &&
                  g_spa_context.sim2_type == MMI_SPA_SIM_TYPE_BLOCKED_SIM))
    #else /* __MMI_DUAL_SIM__ */ 
...
#ifdef __MMI_DUAL_SIM__
    if (MMI_SPA_SIM_ID_DUAL_SIM == mmi_spa_get_sim_status_notified())
    {
