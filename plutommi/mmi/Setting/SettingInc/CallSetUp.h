...
typedef struct
{
    ...
    U8 SSCFNum[(MAX_FWD_ADDR_LEN *ENCODING_LENGTH) + 2];
    U8 SSCFNumFromPHB;
    U8 SSCFNoAnsTimeIndex;
    mmi_id screen_group_id;
    mmi_id phb_cui_id;
...
extern void AppendBScodeString(U8, CHAR *);
...
extern void ShowCauseString(U16, CHAR *);
#endif 
...
#define MAX_BLACK_LIST_NUMBER 20
#define MAX_BLACK_LIST_NUMBER_LEN   20
#endif /* __MMI_CM_BLACK_LIST__ */

#ifdef __MMI_CM_WHITE_LIST__
#define MAX_WHITE_LIST_NUMBER 20
#define MAX_WHITE_LIST_NUMBER_LEN   20
