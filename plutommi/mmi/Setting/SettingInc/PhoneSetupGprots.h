...
* DESCRIPTION
*  This function is enter function of wallpaper main screen 
* PARAMETERS
*  void
* RETURNS
*  void
...
* DESCRIPTION
*  return current home screen setting status
* PARAMETERS
*  void
* RETURNS
*  whether home screen is on or off
* RETURN VALUES
*  MMI_TRUE  : if home screen setting is on
*  MMI_FALSE : if home screen setting is off
 *****************************************************************************/
extern MMI_BOOL PhnsetGetHomeScreenStatus(void);
...
*  void
* RETURNS
*  UART config status from rmmi_sim_uart_setting_enum
 *****************************************************************************/
extern rmmi_sim_uart_setting_enum PhnsetGetUARTConfig(void);
...
*  UART config status from rmmi_sim_uart_setting_enum
 *****************************************************************************/
extern void PhnsetSetUARTConfig(rmmi_sim_uart_setting_enum uart_config);
#endif  /* __GEMINI__ */
