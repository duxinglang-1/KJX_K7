...
/* Set date and format */
#ifndef __MMI_MAINLCD_96X64__
static const cui_inline_item_caption_struct g_phnset_set_date_format_caption1 = {STR_DATE_FORMAT_CAPTION};
#endif
static const cui_inline_item_select_struct g_phnset_set_date_format_select1 = 
{
    3,
    0,
    g_date_format_str_id
...
#ifndef __MMI_MAINLCD_96X64__
static const cui_inline_item_caption_struct g_phnset_set_date_format_caption2 = {STR_ENTER_DATE_FORMAT_DISP_CAPTION};
static const cui_inline_set_item_struct g_phnset_set_date_format_data[] =
{
    {SET_DATE_AND_FORMAT_DATE_FORMAT_CAPTION, CUI_INLINE_ITEM_TYPE_CAPTION, NULL, &g_phnset_set_date_format_caption1},
    {SET_DATE_AND_FORMAT_DATE_FORMAT_SELECT, CUI_INLINE_ITEM_TYPE_SELECT, 0, &g_phnset_set_date_format_select1},
    {SET_DATE_AND_FORMAT_SET_DATE_CAPTION, CUI_INLINE_ITEM_TYPE_CAPTION, NULL, &g_phnset_set_date_format_caption2},
...
/* Set time and format */
#ifndef __MMI_MAINLCD_96X64__
static const cui_inline_item_caption_struct g_phnset_set_time_format_caption1 = {STR_TIME_FORMAT_CAPTION};
#endif
static const cui_inline_item_select_struct g_phnset_set_time_format_select1 =
{
    2,
    0,
    g_time_format_str_id
...
#ifndef __MMI_MAINLCD_96X64__
static const cui_inline_item_caption_struct g_phnset_set_time_format_caption2 = {STR_ENTER_TIME_FORMAT_DISP_CAPTION};
static const cui_inline_item_caption_struct g_phnset_set_time_format_caption3 = {STR_ID_PHNSET_SET_DST};
#endif
static const cui_inline_item_select_struct g_phnset_set_time_format_select2 = 
{
    2,
    0,
    g_phnset_dt_on_off_str_id
...
#ifndef __MMI_MAINLCD_96X64__
static const cui_inline_set_item_struct g_phnset_set_time_format_data[] =
{
    {SET_TIME_AND_FORMAT_TIME_FORMAT_CAPTION, CUI_INLINE_ITEM_TYPE_CAPTION, NULL, &g_phnset_set_time_format_caption1},
    {SET_TIME_AND_FORMAT_TIME_FORMAT_SELECT, CUI_INLINE_ITEM_TYPE_SELECT, 0, &g_phnset_set_time_format_select1},
    {SET_TIME_AND_FORMAT_SET_TIME_CAPTION, CUI_INLINE_ITEM_TYPE_CAPTION, NULL, &g_phnset_set_time_format_caption2},
...
#ifndef __MMI_PHNSET_DAYLIGHT_SAVING_DISABLE__
    {SET_TIME_AND_FORMAT_DAYLIGHT_SAVING_CAPTION, CUI_INLINE_ITEM_TYPE_CAPTION, NULL, &g_phnset_set_time_format_caption3},
...
#ifdef __MMI_SEPARATE_DT_SETTING__
static void mmi_phnset_set_separate_dt_format(MMI_ID inline_cui_gid);
...
static void mmi_phnset_entry_separate_dt_format_setting(MMI_ID parent_gid)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if(mmi_phnset_entry_group_check_ex(parent_gid,GRP_ID_PHNSET_SEPARATE_SET_DT_AND_FORMAT))
        return;
...
static mmi_ret mmi_phnset_separate_dt_format_proc(mmi_event_struct *param)
{
    ...
    case EVT_ID_CUI_INLINE_SUBMIT:
    case EVT_ID_CUI_INLINE_CSK_PRESS:        
        mmi_phnset_set_separate_dt_format(notify_event->sender_id);
        break;
...
static void mmi_phnset_set_separate_dt_format(MMI_ID inline_cui_gid)
{
    ...
    if (g_phnset_cntx_p->curHightlightItem == PHNSET_DT_MNU_DATEANDFORMAT)
    {
        cui_inline_get_value(inline_cui_gid, SET_DATE_AND_FORMAT_DATE_FORMAT_SELECT, (void*)&g_phnset_cntx_p->CurDateFmt);
        cui_inline_get_value(inline_cui_gid, SET_DATE_AND_FORMAT_SET_DATE, (void*)&(inline_time.date_time));	
        set_time.nYear = (kal_uint16)inline_time.date_time.year;
        set_time.nMonth = (kal_uint8)inline_time.date_time.month;
        set_time.nDay = (kal_uint8)inline_time.date_time.day;        
    }
    else if(g_phnset_cntx_p->curHightlightItem == PHNSET_DT_MNU_TIMEANDFORMAT)
    {
        cui_inline_get_value(inline_cui_gid, SET_TIME_AND_FORMAT_TIME_FORMAT_SELECT, (void*)&g_phnset_cntx_p->CurTimeFmt);
        cui_inline_get_value(inline_cui_gid, SET_TIME_AND_FORMAT_SET_TIME, (void*)&inline_time);
#ifndef __MMI_PHNSET_DAYLIGHT_SAVING_DISABLE__        
        cui_inline_get_value(inline_cui_gid, SET_TIME_AND_FORMAT_DAYLIGHT_SAVING_SELECT, (void*)&g_phnset_cntx_p->currentDST);
#endif
        set_time.nHour = (kal_uint8)inline_time.date_time.hour;    
        set_time.nMin = (kal_uint8)inline_time.date_time.minute;        
    }
...
#endif
        PhnsetSendSetTimeReqMessage(&set_time);
    }
...
BOOL PhnsetTzoneByIndex(float time)
{
   U16 i;
   S16 error;
   S16 tmpCity;	
   ...
   {  
     if(GetTimeZone(i) == kjxsettime)
     {
         g_phnset_cntx_p->currentCity = i;
         WriteValue(CURRENT_CITY, &(g_phnset_cntx_p->currentCity), DS_BYTE, &error);
		 
	  tmpCity = (S16)(GetTimeZone(i) * 4);
	  WriteValue(NVRAM_TIMEZONE, &tmpCity, DS_SHORT, &error);
...
S16 PhnGetTzoneByCurrentCity(void)
{
   return (S16)GetTimeZone(g_phnset_cntx_p->currentCity);   
}
...
void PhnsetSetTimeResHdlr(MMI_BOOL result, void *user_data)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
#ifdef __KJX_FUN__	//xb add 2017-07-26	屏蔽时间设置结果提示
	return;
#endif
