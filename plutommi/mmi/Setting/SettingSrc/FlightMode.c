...
#if defined(__KJX_FUN__)&&defined(CUSTOMER_NAME_B610)
void city_switch_flight_mode(U16 SELECT_MODE)
{
	g_flight_mode_select_mode = SELECT_MODE;
	srv_mode_switch_switch_flight_mode(((g_flight_mode_select_mode == MENU_FLIGHT_MODE) ? MMI_TRUE : MMI_FALSE),MMI_TRUE, mmi_flight_mode_switch_rsp, NULL);
}

U16 city_get_flight_mode(void)
{
   return g_flight_mode_current_mode;
}
#endif
