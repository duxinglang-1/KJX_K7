...
static MMI_BOOL mmi_phnset_disp_is_hide_calendar_idle(void);
#endif	
#if defined(__MMI_OP11_HOMESCREEN_0301__) || defined(__MMI_OP11_HOMESCREEN_0302__) || defined(__MMI_OP11_HOMESCREEN__)
static MMI_BOOL mmi_phnset_disp_is_hide_homescreen(void);
#endif
...
static MMI_BOOL mmi_phnset_disp_is_hide_show_op_name(void);
#endif
...
const mmi_setting_hide_menu_struct mmi_phnset_disp_hide_menu[] =
{
...
#endif
#ifdef __MMI_CALENDAR_ON_IDLE_SCREEN__
	{MENU_ID_PHNSET_CALENDAR_IDLESCREEN, mmi_phnset_disp_is_hide_calendar_idle},
#endif
#if defined(__MMI_OP11_HOMESCREEN_0301__) || defined(__MMI_OP11_HOMESCREEN_0302__) || defined(__MMI_OP11_HOMESCREEN__)
	{MENU_ID_PHNSET_HOMESCREEN, mmi_phnset_disp_is_hide_homescreen},
#endif
#ifdef __MMI_DUAL_CLOCK__
	...
	/*{MENU_MTPNP_DM_SHOW_OWNER_NUMBER, mmi_phnset_disp_is_hide_mtpnp_owner_number}, */
#else
	/* {MENU_SETTING_SHOW_OWN_NUMBER, mmi_phnset_disp_is_hide_owner_number}, */
#endif
#ifdef __MMI_SCREEN_SWITCH_EFFECT__
	{MENU_ID_PHNSET_SCRSWITCH_EFFECT, mmi_phnset_disp_is_hide_scrswitch_effect},
#endif
#ifdef __MMI_OPERATOR_NAME_MENU__
	{MENU_SETTING_SHOW_OPN, mmi_phnset_disp_is_hide_show_op_name},	
#endif
#ifdef __MMI_UI_TECHNO_IDLESCREEN_BAR__
...
/*****************************************************************************
* FUNCTION
*  mmi_phnset_disp_is_hide_calendar_idle
* DESCRIPTION
*  This function is used to get calendar in idle menu status
* PARAMETERS
*  void          
* RETURNS
*  MMI_BOOL
...
/*****************************************************************************
* FUNCTION
*  mmi_phnset_disp_is_hide_homescreen
* DESCRIPTION
*  This function is used to get operator home screen menu status
* PARAMETERS
*  void          
* RETURNS
*  MMI_BOOL
...
/*****************************************************************************
* FUNCTION
*  mmi_phnset_disp_is_hide_show_op_name
* DESCRIPTION
*  This function is used to get operator name menu status
* PARAMETERS
*  void          
* RETURNS
*  MMI_BOOL
