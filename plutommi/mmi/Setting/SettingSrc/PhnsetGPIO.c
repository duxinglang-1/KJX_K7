...
#ifdef __MMI_GPIO_SUPPORT_BL_TIME_SETTING__
    ReadValue(NVRAM_BYTE_BL_SETTING_HFTIME, &data, DS_SHORT, &error);
    if (data != g_phnset_gpio_cntx_p->bl_setting_hftime)
    {
        WriteValue(NVRAM_BYTE_BL_SETTING_HFTIME, &(g_phnset_gpio_cntx_p->bl_setting_hftime), DS_SHORT, &error);
    }
 ...
 *  S32
 *****************************************************************************/
S32 GetPhnsetGPIOBlHftime(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    return srv_gpio_setting_get_hf_time();
}
...
/*****************************************************************************
 * FUNCTION
 *  mmi_phset_gpio_backlight_timeout_get_highlighted_menu_item
 * DESCRIPTION
 *  This is the proc function for backlight timeout menu cui
 * PARAMETERS
 *  void      
 * RETURNS
 *  U16
 *****************************************************************************/
U16 mmi_phset_gpio_backlight_timeout_get_highlighted_menu_item(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    switch (g_phnset_gpio_cntx_p->bl_setting_hftime)
    {
        case PHSET_GPIO_BACKLIGHT_TIMEOUT_15SEC :
        {
            return MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_15;
        }
        case PHSET_GPIO_BACKLIGHT_TIMEOUT_30SEC :
        {
            return MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_30;
        }
        case PHSET_GPIO_BACKLIGHT_TIMEOUT_45SEC :
        {
            return MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_45;
        }
    }
    return MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_5;
}


/*****************************************************************************
 * FUNCTION
 *  mmi_phset_gpio_entry_backlite_timeout_proc
 * DESCRIPTION
 *  This is the proc function for backlight timeout menu cui
 * PARAMETERS
 *  void      
 ...
 *  mmi_ret
 *****************************************************************************/
mmi_ret mmi_phset_gpio_entry_backlite_timeout_proc(mmi_event_struct *evt)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    switch (menu_evt->evt_id)
    {
        ...
        {
            if(menu_evt->highlighted_menu_id == MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_5)
            {
                srv_gpio_setting_set_hf_time(PHSET_GPIO_BACKLIGHT_TIMEOUT_5SEC, MMI_TRUE);
            }
            else if(menu_evt->highlighted_menu_id == MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_15)
            {
                srv_gpio_setting_set_hf_time(PHSET_GPIO_BACKLIGHT_TIMEOUT_15SEC, MMI_TRUE);
            }
            else if(menu_evt->highlighted_menu_id == MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_30)
            {
                srv_gpio_setting_set_hf_time(PHSET_GPIO_BACKLIGHT_TIMEOUT_30SEC, MMI_TRUE);
            }
            else if(menu_evt->highlighted_menu_id == MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT_45)
            {
                srv_gpio_setting_set_hf_time(PHSET_GPIO_BACKLIGHT_TIMEOUT_45SEC, MMI_TRUE);
            }
	        mmi_popup_display_simple_ext(STR_GLOBAL_DONE, MMI_EVENT_SUCCESS, g_gpio_gid, NULL);
...
void mmi_phset_gpio_entry_backlite_timeout(void)
{
    ...
    menu_id = cui_menu_create(
        ...
        MENU_ID_PHNSET_GPIO_BACKLIGHT_TIMEOUT,
        MMI_TRUE,
        NULL);
