...
#ifdef __MMI_VERSION_INFO__	
#define MAX_VERSION_STRING_BUF         80
...
static void EntrySettingVersion(void)
{
    ...
    mmi_frm_group_create(GRP_ID_ROOT, GRP_ID_SETTING_VERSION, NULL, NULL);
    mmi_frm_group_enter(GRP_ID_SETTING_VERSION, MMI_FRM_NODE_SMART_CLOSE_FLAG);
...
static void mmi_setting_entry_version_info_screen(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (!mmi_frm_scrn_enter(GRP_ID_SETTING_VERSION, SCR_ID_VERSION_INFO,
        mmi_setting_exit_version_info_screen, mmi_setting_entry_version_info_screen, MMI_FRM_FULL_SCRN))
    {
        return;
    }
