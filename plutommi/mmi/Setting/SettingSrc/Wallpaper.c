...
U8 PhnsetGetCurWallPaperIdx(void)
{
    ...
    {
        if (mmi_phnset_wallpaper_get_static_id() == SysWpIDList[idx])
        {
            break;
        }
    }
...
static void mmi_phnset_entry_wallpaper_select_menu(mmi_id parent_gid)
{
    ...
    mmi_frm_group_create(parent_gid, 
                         ...
                         NULL,
                         MMI_FRM_NODE_SMART_CLOSE_FLAG);
    cui_menu_create_and_run(GRP_ID_WALLPAPER_MAIN, CUI_MENU_SRC_TYPE_RESOURCE, CUI_MENU_TYPE_FROM_RESOURCE, MENU_SETTING_WALLPAPER_HOMESCREEN, MMI_FALSE, NULL);
}
...
/* Screen lock wallpaper setting init*/	
    ...
    mmi_dispchar_get_img_id(NVRAM_FUNANDGAMES_SETWALLPAPER, &g_mmi_wallpaper_id);
#else
    /* BW do not support wallpaper, set the wallpaper to theme wallpaper */
    g_mmi_wallpaper_id = IMG_ID_DISPCHAR_THEME_WALLPAPER;
#endif
