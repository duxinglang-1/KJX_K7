...
#if (MMI_MAX_SIM_NUM >= 2)
    SetKeyHandler(mmi_ucm_sendkeys_send1_hdlr, KEY_SEND, keyevent);
#ifdef __SENDKEY2_SUPPORT__
    SetKeyHandler(mmi_ucm_sendkeys_send2_hdlr, KEY_SEND2, keyevent);
#endif /* __SENDKEY2_SUPPORT__ */
#else /*(MMI_MAX_SIM_NUM >= 2)*/
    SetKeyHandler(mmi_ucm_sendkeys_send_hdlr, KEY_SEND, keyevent);
#endif /* (MMI_MAX_SIM_NUM >= 2) */
}
