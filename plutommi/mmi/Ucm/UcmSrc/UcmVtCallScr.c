...
static void mmi_vtcs_register_key_event(void)
{
    ...
    if (mmi_ucm_vt_get_incall_screen_mode() == MMI_UCM_VT_INCALL_SCREEN_MODE_INCALL)
    {
        ...
        mmi_frm_set_key_handler(mmi_vtcs_vol_up_key_press, MMI_VTCS_VOL_UP_KEY, KEY_EVENT_DOWN);
        mmi_frm_set_key_handler(mmi_vtcs_vol_up_key_release, MMI_VTCS_VOL_UP_KEY, KEY_EVENT_UP);
        mmi_frm_set_key_handler(mmi_vtcs_vol_down_key_press, MMI_VTCS_VOL_DOWN_KEY, KEY_EVENT_DOWN);
        mmi_frm_set_key_handler(mmi_vtcs_vol_down_key_release, MMI_VTCS_VOL_DOWN_KEY, KEY_EVENT_UP);
        mmi_frm_set_key_handler(NULL, MMI_VTCS_VOL_DOWN_KEY, KEY_EVENT_LONG_PRESS);
        mmi_frm_set_key_handler(NULL, MMI_VTCS_VOL_UP_KEY, KEY_EVENT_LONG_PRESS);
        mmi_frm_set_key_handler(NULL, MMI_VTCS_VOL_DOWN_KEY, KEY_EVENT_REPEAT);
        mmi_frm_set_key_handler(NULL, MMI_VTCS_VOL_UP_KEY, KEY_EVENT_REPEAT);
    }
