...
/*****************************************************************************
 * FUNCTION
 *  mmi_umms_app_ui_plug_in_delete_all_confirm_func
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  
 *****************************************************************************/
MMI_UMMS_ERROR mmi_umms_app_ui_plug_in_delete_all_confirm_func(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    switch ((mma_folder_enum) info->folder_id)
    {
        case MMA_FOLDER_INBOX:
            message = STR_ID_UMMS_INBOX;
            break;
        case MMA_FOLDER_OUTBOX:
            message = STR_ID_UMMS_OUTBOX;
            break;
        case MMA_FOLDER_DRAFT:
            message = STR_ID_UMMS_DRAFT;
            break;
        case MMA_FOLDER_SENT:
            message = STR_ID_UMMS_SENT;
            break;
    #ifdef __UNIFIED_MESSAGE_ARCHIVE_SUPPORT__
        case MMA_FOLDER_ARCHIVE:
            message = STR_ID_UMMS_ARCHIVE;
            break;
    #endif /* __UNIFIED_MESSAGE_ARCHIVE_SUPPORT__ */ 
    #ifdef __MMI_MMS_TEMPLATE_SUPPORT__
        case MMA_FOLDER_USRDEF_TEMPLATE:
            message = STR_ID_UMMS_USER_DEF_TEMPL;
            break;
    ...
    mmi_umms_app_dtmgr_set_confirm_screen_para(
        ...
        MMI_FALSE,
        MMI_FALSE,
        mmi_umms_app_sh_mms_option_delete_all_lsk_handler,  /* mmi_umms_entry_cancel_dwnld, */
        mmi_frm_scrn_close_active_id,
        NULL,
        NULL);
    return MMI_UMMS_TRUE;
