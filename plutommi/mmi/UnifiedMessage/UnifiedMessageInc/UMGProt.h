...
/*****************************************************************************
 * FUNCTION
 *  mmi_um_set_message_list_filter_type
 * DESCRIPTION
 *  Set the message list filter type.
 * PARAMETERS
 *  index           [IN]: Selected index
 * RETURNS
 *  void
 ...
 *  void
 *****************************************************************************/
extern void mmi_um_set_message_list_filter_type(U16 index);
/*****************************************************************************
 * FUNCTION
 *  mmi_um_prepare_filter_selection_list
 * DESCRIPTION
 *  Prepare the string id of the filter screen
 * PARAMETERS
 *  menu_item_str_id            [IN]: Selected index
 *  max_menu_item               [IN]: The maximum items of above buffer.
 * RETURNS
 ...
 *  The number of menu items.
 *****************************************************************************/
extern U16 mmi_um_prepare_filter_selection_list(U16 *menu_item_str_id, U16 max_menu_item);
/*****************************************************************************
 * FUNCTION
 *  mmi_um_get_message_list_filter_type
 * DESCRIPTION
 *  Get the message list filter type.
 * PARAMETERS
 *  user_data           [IN]: The screen context pointer of UM data
 * RETURNS
 *  Current filter type of screen context
 * RETURN VALUES
 *  SRV_UM_SIM_GSM_SIM1
 *  SRV_UM_SIM_GSM_SIM2
 *  SRV_UM_SIM_ALL
 *****************************************************************************/
extern srv_um_sim_enum mmi_um_get_message_list_filter_type(void *user_data);
