...
#if 0
    <MENU id="MENU_ID_UM_DELETE_FOLDER" type="APP_SUB" str="STR_UM_DELETE_FOLDER_ID" img="IMG_UM_DELETE_FOLDER_ID" highlight="mmi_um_highlight_delete_folder">
                                    <MENUITEM_ID>MENU_ID_UM_DELETE_FOLDER_INBOX</MENUITEM_ID>
                                    <MENUITEM_ID>MENU_ID_UM_DELETE_FOLDER_DRAFT</MENUITEM_ID>
                                    <MENUITEM_ID>MENU_ID_UM_DELETE_FOLDER_UNSENT</MENUITEM_ID>
                                    <MENUITEM_ID>MENU_ID_UM_DELETE_FOLDER_SENT</MENUITEM_ID>
                                    <MENUITEM_ID>MENU_ID_UM_DELETE_FOLDER_ARCHIVE</MENUITEM_ID>
                                    <MENUITEM_ID>MENU_ID_UM_DELETE_FOLDER_SIM</MENUITEM_ID>
                                    <MENUITEM_ID>MENU_ID_UM_DELETE_FOLDER_REPORT</MENUITEM_ID>
                                    <MENUITEM_ID>MENU_ID_UM_DELETE_FOLDER_ALL</MENUITEM_ID></MENU>
#endif /* 0 */
...
#if !defined(__MMI_PUSH_IN_UM__) && defined(BROWSER_SUPPORT) && defined(__WAP_PUSH_SUPPORT__)
...
#endif
#if 0
    <MENUITEM id="MENU_ID_UM_DELETE_FOLDER_INBOX" str="STR_GLOBAL_INBOX" img="IMG_UM_INBOX_ID"/>
    <MENUITEM id="MENU_ID_UM_DELETE_FOLDER_UNSENT" str="STR_GLOBAL_OUTBOX" img="IMG_UM_UNSENT_ID"/>
    <MENUITEM id="MENU_ID_UM_DELETE_FOLDER_SENT" str="STR_UM_SENT_ID" img="IMG_UM_SENT_ID"/>
    <MENUITEM id="MENU_ID_UM_DELETE_FOLDER_DRAFT" str="STR_GLOBAL_DRAFTS" img="IMG_UM_DRAFT_ID"/>
#ifdef __UNIFIED_MESSAGE_ARCHIVE_SUPPORT__
    <MENUITEM id="MENU_ID_UM_DELETE_FOLDER_ARCHIVE" str="STR_UM_ARCHIVE_ID" img="IMG_UM_ARCHIVE_ID"/>
#endif /* __UNIFIED_MESSAGE_ARCHIVE_SUPPORT__ */
#ifdef __UNIFIED_MESSAGE_SIMBOX_SUPPORT__
    <MENUITEM id="MENU_ID_UM_DELETE_FOLDER_SIM" str="STR_UM_SIM_ID" img="IMG_UM_SIM_ID"/>
#endif /* __UNIFIED_MESSAGE_SIMBOX_SUPPORT__ */
#ifdef __MMI_UM_REPORT_BOX__
    <MENUITEM id="MENU_ID_UM_DELETE_FOLDER_REPORT" str="STR_UM_REPORT_ID" img="IMG_UM_REPORT_ID"/>
#endif /* __MMI_UM_REPORT_BOX__ */
    <MENUITEM id="MENU_ID_UM_DELETE_FOLDER_ALL" str="STR_GLOBAL_DELETE_ALL" img="IMG_UM_DELETE_FOLDER_ALL_ID"/>
#endif /* 0 */
