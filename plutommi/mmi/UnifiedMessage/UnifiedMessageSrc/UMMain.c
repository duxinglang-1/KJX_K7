 ...
 * DESCRIPTION
 *  Set the filter type to UM
 * PARAMETERS
 *  index:              [IN]    The selected index of filter type
 *
 * RETURNS
 *  void
 *****************************************************************************/
 ...
 * DESCRIPTION
 *  Provide the sim type menu item list for message application.
 * PARAMETERS
 *  menu_item_str_id            [IN]: buffer for string id
 *  max_menu_item               [IN]: maximum size of buffer
 *
 * RETURNS
 *  The number of item inside
 *****************************************************************************/
 ...
 * DESCRIPTION
 *  Get the sim type menu item list for specified user data.
 * PARAMETERS
 *  user_data                   [IN]: Pointer of screen context
 *
 * RETURNS
 *  The sim type
 *****************************************************************************/
srv_um_sim_enum mmi_um_get_message_list_filter_type(void *user_data)
{
    ...
    srv_um_sim_enum sim_id = SRV_UM_SIM_ALL;
    ...
    sim_id = mmi_um_ui_fsm_ef_get_sim_type(&(scrn_cntx->fsm));
