...
typedef struct _sat_dspl_text_ind_peer_struct
{
...
typedef struct _sat_get_inkey_ind_peer_struct
{
	kal_uint16 no_text_string;
	kal_uint8 *text_string;
	kal_uint8 dcs_of_text_string;
...
typedef struct _sat_get_inkey_res_peer_struct
{
...
typedef struct _sat_get_input_ind_peer_struct
{
	kal_uint16 no_text_string;
	kal_uint8 *text_string;
	kal_uint8 dcs_of_text_string;
...
typedef struct _sat_get_input_res_peer_struct
{
	kal_uint8 no_text_string;
	kal_uint8 *text_string;
	kal_uint8 dcs_of_text_string;
...
typedef struct _sat_setup_menu_ind_peer_struct
{
...
typedef struct _sat_select_item_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 dcs_of_alpha_id;
...
typedef struct _sat_play_tone_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 dcs_of_alpha_id;
...
typedef struct _sat_setup_call_ind_peer_struct
{
...
typedef struct _sat_send_sms_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_send_ss_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_send_ussd_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_mmi_info_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_addr_struct
{
	kal_uint8 no_addr;
	kal_uint8 *addr;
} sat_addr_struct;
...
typedef struct _sat_setup_idle_dspl_ind_peer_struct
{
	kal_uint16 no_text_string;
	kal_uint8 *text_string;
	kal_uint8 dcs_of_text_string;
...
typedef struct _sat_run_at_command_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_send_dtmf_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_launch_browser_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_open_gprs_channel_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _l4csmu_sat_open_channel_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_open_csd_channel_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_open_server_mode_channel_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_close_channel_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _l4csmu_sat_close_channel_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_send_data_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_recv_data_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_recv_data_res_peer_struct
{
	kal_uint8 no_data;
	kal_uint8 *data;
...
typedef struct _l4csat_open_channel_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _l4csat_close_channel_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _l4csat_send_data_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _l4csmu_sat_send_data_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _l4csat_recv_data_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _l4csmu_sat_recv_data_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
...
typedef struct _sat_open_channel_ind_peer_struct
{
	kal_uint8 no_alpha_id;
	kal_uint8 *alpha_id;
	kal_uint8 is_alpha_id_present;
	kal_uint8 dcs_of_alpha_id;
} sat_open_channel_ind_peer_struct;
