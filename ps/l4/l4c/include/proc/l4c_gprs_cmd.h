...
extern kal_bool l4c_ps_exe_enter_data_state_req(kal_uint8 src_id, kal_uint8 l2p, kal_uint8 cid);
...
extern kal_bool l4c_ps_get_pdp_addr_req(kal_uint8 src_id, kal_uint8 cid, kal_uint8 *addr);
