    ...
    else
    {
        switch (type)
        {
            ...
            case PHB_SNE:
                ...
                ext_data_desc_entry = NULL;
                if (!phb_desc_is_type2_file((data_desc_enum) (DATA_DESC_SNE + occurrence - 1)))
                {
            ...
            case PHB_ANR:
                ...
                ext_data_desc_entry = &phb_ptr->data_desc[DATA_DESC_EXT1];
                if (!phb_desc_is_type2_file((data_desc_enum) (DATA_DESC_ANR + occurrence - 1)))
                {
                    data_desc_entry->free_count = phb_ptr->data_desc[DATA_DESC_ADN].free_count;
                }
                break;
            ...
            case PHB_EMAIL:
                ...
                if (!phb_desc_is_type2_file((data_desc_enum) (DATA_DESC_EMAIL + occurrence - 1)))
                {
                    data_desc_entry->free_count = phb_ptr->data_desc[DATA_DESC_ADN].free_count;
                }
                ext_data_desc_entry = NULL;
