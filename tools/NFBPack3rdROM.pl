...
my %EnfbInputFiles = (
"ENFBMMIResB\0" => "plutommi\\Customer\\CustResource\\CustMMI3rdROM",
"CustENFBThm\0" => "plutommi\\Customer\\ResGenerator\\ThemeXML\\Temp\\CustEnfbVenusThemeData",
"CustENFBIcn\0" => "plutommi\\Customer\\ResGenerator\\ThemeXML\\Temp\\CustEnfbVenusAppIconData",
"IME_HW_DATA\0" => "plutommi\\Customer\\ResGenerator\\hw_data.gbd",
"CustENFBFnt\0" => "plutommi\\Customer\\CustResource\\CustENFBFontData",
);
my $EnfbReservedHearderSize = 1024;
