...
copy /Y          .\plutommi\mmi\inc\mmi_features_check_wvga_lang.h						 %1
...
copy /Y          .\tst\database_classb_umts\pstrace_db\gdi_trc_gen.h						 %1
...
copy /Y          .\venusmmi\framework\ui_core\mvc\vfx_visual_factory.h						 %1
copy /Y          .\venusmmi\framework\ui_core\mvc\vfx_control.h						 %1
copy /Y          .\interface\middleware\nvram_editor_data_item.h						 %1
copy /Y          .\venusmmi\vrt\interface\vrt_3d_enum.h						 %1
