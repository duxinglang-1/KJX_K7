...
sub Lookup_SFI_setting_by_IDX_CLK_BB_REG
{
    ...
    if (($bb eq 'MT6252') || ($bb eq 'MT6255') || ($bb eq 'MT6250') || ($bb eq 'MT6260'))
    {
...
sub combo_sfi_defs_h_file_body
{
    ...
    if ((($MAKEFILE_OPTIONS_LOCAL->{'platform'} eq 'MT6252') || ($MAKEFILE_OPTIONS_LOCAL->{'platform'} eq 'MT6250') || ($MAKEFILE_OPTIONS_LOCAL->{'platform'} eq 'MT6260')) and ($MAKEFILE_OPTIONS_LOCAL->{'sip_serial_flash_size'} ne 'NONE'))
    {
