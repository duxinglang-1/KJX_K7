...
sub custom_EMI_release_h_file_body
{
    ...
    elsif (($MAKEFILE_OPTIONS_LOCAL->{'platform'} eq 'MT6252') || ($MAKEFILE_OPTIONS_LOCAL->{'platform'} eq 'MT6250') || ($MAKEFILE_OPTIONS_LOCAL->{'platform'} eq 'MT6260'))
    {
