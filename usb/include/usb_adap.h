...
__inline USB_DEVICE_STATE USB_Get_Device_State(void)
{
	return gUsbDevice.nDevState;
}

__inline void USB_Set_Device_State(USB_DEVICE_STATE usb_device_state)
{
	gUsbDevice.nDevState = usb_device_state;
}

__inline USB_DEVICE_TYPE USB_Get_Device_Type(void)
{
	return gUsbDevice.device_type;
}

__inline void USB_Set_Device_Type(USB_DEVICE_TYPE usb_device_type)
{
	gUsbDevice.device_type = usb_device_type;
}

__inline USB_EP0_STATE USB_Get_Endpoint0_State(void)
{
	return gUsbDevice.ep0_state;
}

__inline void USB_Set_Endpoint0_State(USB_EP0_STATE ep0_state)
{
	gUsbDevice.ep0_state = ep0_state;
}

__inline USB_Comport_Boot_Status USB_Get_Comport_Boot_Status(void)
{
	return g_UsbMode.usb_comport_boot;
}

__inline void USB_Release(void)
{

}

__inline void USB_Register_EP0_RxHdlr(usb_ep0_rx_ptr handler)
{
...
extern void USB_IRQ_Unmask(void);
...
extern void USB_Remote_Wake_UP_Start(void);
extern void USB_Remote_Wake_UP_End(void);

extern void USB_Lock_SleepMode(void);
extern void USB_UnLock_SleepMode(void);
#endif
...
__inline kal_bool USB_INT_USBBoot(void)
{
...
__inline void USB_Get_Current_Table(void)
{
...
__inline void USB_Register_USB_HISR(usb_hisr func_ptr)
{
	DCL_HANDLE pmu_handle; // add for usb charging 
...
__inline void USB_BMT_NO_CHARGING_OUT(void)
{
...
__inline void USB_BMT_NO_CHARGING_IN(void)
{
	DCL_HANDLE bmt_handler;
	BMT_CTRL_SENDMES2UEM_T bmt_cmd_data1;
