...
/* FOR Add webcam to DCM */
#if defined(__MM_DCM_SUPPORT__)
#define __USB_MM_DCM_SUPPORT__
#endif
...
extern USBVideo_Control_Struct g_USBVideo_control;
...
extern void USB_Video_Sendto_USB_Msg(USBVIDEO_MSG_TYPE usb_msg_type, kal_uint32 param1);
