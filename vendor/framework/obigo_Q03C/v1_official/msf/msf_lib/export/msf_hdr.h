...
#define MSF_HDR_AUTHENTICATION_INFO		  0x4b
#define MSF_HDR_WPS_CONTENT_DIGEST_MD5		  0x4c
...
#else
extern const msf_strtable_info_t gmms_msf_hdr_names;
extern const msf_strtable_info_t gmms_msf_languages;
#endif /*Q03C_IND_MOD_ARCH_SUPPORT*/


#define MSF_HDR_WPS_CONTENT_DIGEST_MD5_STR	"wps-content-digest-md5"
 ...
 */ 
msf_hdr_t*
gmms_msf_hdr_create (MSF_UINT8 module);

/* 
 * Deallocate a header table and all its content 
 */
void
gmms_msf_hdr_delete (msf_hdr_t* hdr);

/*
 * Copy a header table 
 */ 
msf_hdr_t* 
gmms_msf_hdr_copy (msf_hdr_t* hdr);

/*
 * Delete all fields of the specified kind.
 */
void
gmms_msf_hdr_delete_field (msf_hdr_t *hdr, int field_name);
 ...
 */
int
gmms_msf_hdr_add_string (msf_hdr_t *hdr, int field_name, const char* value);
 ...
 */
int
gmms_msf_hdr_add_parameter (msf_hdr_t *hdr, int field_name,
 ...
 */
int
gmms_msf_hdr_add_header_from_text_line (msf_hdr_t *hdr, const char *str, int len);
 ...
 */
int
gmms_msf_hdr_add_headers_from_text (msf_hdr_t *hdr, const char *text);
 ...
 */
int
gmms_msf_hdr_make_string (msf_hdr_t *hdr, char **str);
 ...
 */
int
gmms_msf_hdr_get_uint32 (msf_hdr_t *hdr, int field_name, MSF_UINT32 *value);
 ...
 */
const char *
gmms_msf_hdr_get_string (msf_hdr_t *hdr, int field_name);
 ...
 */
char *
gmms_msf_hdr_get_parameter (msf_hdr_t *hdr, int field_name, const char *parameter);


#define msf_hdr_names gmms_msf_hdr_names

#define msf_languages gmms_msf_languages

#define msf_hdr_create gmms_msf_hdr_create

#define msf_hdr_delete gmms_msf_hdr_delete

#define msf_hdr_copy gmms_msf_hdr_copy

#define msf_hdr_delete_field gmms_msf_hdr_delete_field

#define msf_hdr_add_string gmms_msf_hdr_add_string

#define msf_hdr_add_parameter gmms_msf_hdr_add_parameter

#define msf_hdr_add_header_from_text_line gmms_msf_hdr_add_header_from_text_line

#define msf_hdr_add_headers_from_text gmms_msf_hdr_add_headers_from_text

#define msf_hdr_make_string gmms_msf_hdr_make_string

#define msf_hdr_get_uint32 gmms_msf_hdr_get_uint32

#define msf_hdr_get_string gmms_msf_hdr_get_string

#define msf_hdr_get_parameter gmms_msf_hdr_get_parameter

#ifdef Q03C_IND_MOD_ARCH_SUPPORT
int
msf_hdr_get_n_parameters_list (MSF_UINT8 modId, const char *param_list, 
