 ...
 * amp (&), apos ('), gt (>), lt (<), quot (").
 */ 
extern const msf_strtable_info_t gmmms_msf_prsr_XmlEntities;
 ...
 */
msf_prsr_parser_t*
gmms_msf_prsr_create (MSF_UINT8             modId,
                 void*                 userData,
 ...
 */
int
gmms_msf_prsr_parse (msf_prsr_parser_t* parser);
 ...
 */
int
gmms_msf_prsr_delete (msf_prsr_parser_t* parser, int *type, int *handle, void* *userData);
 ...
 */
void
gmms_msf_prsr_free_attributes (MSF_UINT8             modId,
 ...
 */
int
gmms_msf_prsr_read_num (const char*  s,
                   const char*  end,
                   int         *error);
 ...
 */
int
gmms_msf_prsr_extract_attributes (msf_prsr_parser_t*          parser,
                             const char*                 s,
                             const char*                 end,
 ...
 */
int 
gmms_msf_dec_opaqueSpecific (msf_prsr_parser_t*  parser,
                        const char*        *s,
                        const char*         end,
                        int                 size,
                        int                 type);
 ...
 */
void
gmms_msf_prsr_html_config (msf_prsr_parser_t*        parser,
                      const unsigned char*      htmlTable,
                      msf_prsr_changeCharset_t* changeCharset);


#define msf_prsr_XmlEntities gmmms_msf_prsr_XmlEntities

#define msf_prsr_create gmms_msf_prsr_create

#define msf_prsr_parse gmms_msf_prsr_parse

#define msf_prsr_delete gmms_msf_prsr_delete

#define msf_prsr_free_attributes gmms_msf_prsr_free_attributes

#define msf_prsr_read_num gmms_msf_prsr_read_num

#define msf_prsr_extract_attributes gmms_msf_prsr_extract_attributes

#define msf_dec_opaqueSpecific gmms_msf_dec_opaqueSpecific

#define msf_prsr_html_config gmms_msf_prsr_html_config
