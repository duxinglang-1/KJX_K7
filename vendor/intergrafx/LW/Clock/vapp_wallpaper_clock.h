 ...
 * Description:
 * ------------
 *  Home screen clock wallpaper class header file
 *
 * Author:
 * -------
 * -------
...
#ifndef __VAPP_WALLPAPER_CLOCK_H__
#define __VAPP_WALLPAPER_CLOCK_H__
...
/*****************************************************************************
 * Home screen UI componet: clock wallpaper class
 *****************************************************************************/
class VappWallpaperClock: public VappWallpaper
{
    VFX_DECLARE_CLASS(VappWallpaperClock);

    VAPP_WALLPAPER_CREATE(VappWallpaperClock);
...
private:
	VappClockFilter *m_draw;
	VfxBool     m_isSerialized;
	VfxBool     m_isRestored;

    VfxFloatTimeline *m_timeline;

	static mmi_ret mmi_ig_lw_clock_proc(mmi_frm_asm_evt_struct *evt);
...
class VappClockFilter : public VfxFrameFilter
{
// Constructor
public:
	VfxSize	m_imgSize;
...
#endif /* __VAPP_WALLPAPER_CLOCK_H__ */
