 ...
 * Description:
 * ------------
 *  Home screen daydream wallpaper class header file
 *
 * Author:
 * -------
 * -------
...
#ifndef __VAPP_WALLPAPER_DAYDREAM_H__
#define __VAPP_WALLPAPER_DAYDREAM_H__
...
/*****************************************************************************
 * Home screen UI componet: daydream wallpaper class
 *****************************************************************************/
class VappWallpaperDaydream: public VappWallpaper
{
    VFX_DECLARE_CLASS(VappWallpaperDaydream);

    VAPP_WALLPAPER_CREATE(VappWallpaperDaydream);
...
private:
	VappDaydreamFilter *m_draw;
	VfxBool     m_isSerialized;
	VfxBool     m_isRestored;

    VfxFloatTimeline *m_timeline;

	static mmi_ret mmi_ig_lw_daydream_proc(mmi_frm_asm_evt_struct *evt);
	void restoreWallpaperSetting(void);
};
...
class VappDaydreamFilter : public VfxFrameFilter
{
// Constructor
public:
	VfxSize	m_imgSize;
...
#endif /* __VAPP_WALLPAPER_DAYDREAM_H__ */
