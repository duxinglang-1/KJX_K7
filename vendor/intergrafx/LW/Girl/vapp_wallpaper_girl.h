 ...
 * Description:
 * ------------
 *  Home screen girl wallpaper class header file
 *
 * Author:
 * -------
 * -------
...
#ifndef __VAPP_WALLPAPER_GIRL_H__
#define __VAPP_WALLPAPER_GIRL_H__
...
/*****************************************************************************
 * Home screen UI componet: girl wallpaper class
 *****************************************************************************/
class VappWallpaperGirl: public VappWallpaper
{
    VFX_DECLARE_CLASS(VappWallpaperGirl);

    VAPP_WALLPAPER_CREATE(VappWallpaperGirl);
...
private:
	VappGirlFilter *m_draw;
	VfxBool     m_isSerialized;
	VfxBool     m_isRestored;

    VfxFloatTimeline *m_timeline;

	static mmi_ret mmi_ig_lw_girl_proc(mmi_frm_asm_evt_struct *evt);
	void restoreWallpaperSetting();
};

class VappGirlFilter : public VfxFrameFilter
{
// Constructor
public:
	VfxSize	m_imgSize;
...
#endif /* __VAPP_WALLPAPER_GIRL_H__ */
