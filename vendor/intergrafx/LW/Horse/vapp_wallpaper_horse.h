 ...
 * Description:
 * ------------
 *  Home screen horse wallpaper class header file
 *
 * Author:
 * -------
 * -------
...
#ifndef __VAPP_WALLPAPER_HORSE_H__
#define __VAPP_WALLPAPER_HORSE_H__
...
/*****************************************************************************
 * Home screen UI componet: horse wallpaper class
 *****************************************************************************/
class VappWallpaperHorse: public VappWallpaper
{
    VFX_DECLARE_CLASS(VappWallpaperHorse);

    VAPP_WALLPAPER_CREATE(VappWallpaperHorse);
...
private:
	VappHorseFilter *m_draw;
	VfxBool     m_isSerialized;
	VfxBool     m_isRestored;

    VfxFloatTimeline *m_timeline;

	static mmi_ret mmi_ig_lw_horse_proc(mmi_frm_asm_evt_struct *evt);
	void restoreWallpaperSetting();
};

class VappHorseFilter : public VfxFrameFilter
{
// Constructor
public:
	VfxSize	m_imgSize;
...
#endif /* __VAPP_WALLPAPER_HORSE_H__ */
