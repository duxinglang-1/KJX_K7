...
#ifndef __VAPP_WALLPAPER_MIMOSA_H__
#define __VAPP_WALLPAPER_MIMOSA_H__
...
class VappMimosaFilter : public VfxFrameFilter
{
// Constructor
public:
	VfxSize	m_imgSize;
...
#endif /* __VAPP_WALLPAPER_MIMOSA_H__ */
