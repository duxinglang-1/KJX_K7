 ...
 * Description:
 * ------------
 *  Home screen puppy wallpaper class header file
 *
 * Author:
 * -------
 * -------
...
#ifndef __VAPP_WALLPAPER_PUPPY_H__
#define __VAPP_WALLPAPER_PUPPY_H__
...
/*****************************************************************************
 * Home screen UI componet: puppy wallpaper class
 *****************************************************************************/
class VappWallpaperPuppy: public VappWallpaper
{
    VFX_DECLARE_CLASS(VappWallpaperPuppy);

    VAPP_WALLPAPER_CREATE(VappWallpaperPuppy);
...
private:
	VappPuppyFilter *m_draw;
	VfxBool     m_isSerialized;
	VfxBool     m_isRestored;

    VfxFloatTimeline *m_timeline;
	
	static mmi_ret mmi_ig_lw_puppy_proc(mmi_frm_asm_evt_struct *evt);
...
class VappPuppyFilter : public VfxFrameFilter
{
// Constructor
public:
	VfxSize	m_imgSize;
...
#endif /* __VAPP_WALLPAPER_PUPPY_H__ */
