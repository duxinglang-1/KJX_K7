 ...
 * Description:
 * ------------
 *  Home screen solar wallpaper class header file
 *
 * Author:
 * -------
 * -------
...
#ifndef __VAPP_WALLPAPER_SOLAR_H__
#define __VAPP_WALLPAPER_SOLAR_H__
...
/*****************************************************************************
 * Home screen UI componet: solar wallpaper class
 *****************************************************************************/
class VappWallpaperSolar: public VappWallpaper
{
    VFX_DECLARE_CLASS(VappWallpaperSolar);

    VAPP_WALLPAPER_CREATE(VappWallpaperSolar);
...
private:
	VappSolarFilter *m_draw;
	VfxBool     m_isSerialized;
	VfxBool     m_isRestored;

    VfxFloatTimeline *m_timeline;

	static mmi_ret mmi_ig_lw_solar_proc(mmi_frm_asm_evt_struct *evt);
...
class VappSolarFilter : public VfxFrameFilter
{
// Constructor
public:
	VfxSize	m_imgSize;
...
#endif /* __VAPP_WALLPAPER_SOLAR_H__ */
