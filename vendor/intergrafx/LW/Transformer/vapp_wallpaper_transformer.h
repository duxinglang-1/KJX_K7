 ...
 * Description:
 * ------------
 *  Home screen transformer wallpaper class header file
 *
 * Author:
 * -------
 * -------
...
#ifndef __VAPP_WALLPAPER_TRANSFORMER_H__
#define __VAPP_WALLPAPER_TRANSFORMER_H__
...
/*****************************************************************************
 * Home screen UI componet: transformer wallpaper class
 *****************************************************************************/
class VappWallpaperTransformer: public VappWallpaper
{
    VFX_DECLARE_CLASS(VappWallpaperTransformer);

    VAPP_WALLPAPER_CREATE(VappWallpaperTransformer);
...
private:
	VappTransformerFilter *m_draw;
	VfxBool     m_isSerialized;
	VfxBool     m_isRestored;

    VfxFloatTimeline *m_timeline;

	static mmi_ret mmi_ig_lw_transformer_proc(mmi_frm_asm_evt_struct *evt);
...
class VappTransformerFilter : public VfxFrameFilter
{
// Constructor
public:
	VfxSize	m_imgSize;
...
#endif /* __VAPP_WALLPAPER_TRANSFORMER_H__ */
