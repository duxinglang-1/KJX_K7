 ...
 * Description:
 * ------------
 *  Home screen mimosa wallpaper class header file
 *
 * Author:
 * -------
 * -------
...
#ifndef __VAPP_WALLPAPER_MIMOSA_GL_H__
#define __VAPP_WALLPAPER_MIMOSA_GL_H__
...
/*****************************************************************************
 * Home screen UI componet: mimosa wallpaper class
 *****************************************************************************/
class VappWallpaperMimosa: public VappWallpaper
{
    VFX_DECLARE_CLASS(VappWallpaperMimosa);

    VAPP_WALLPAPER_CREATE(VappWallpaperMimosa);
...
private:
	VappMimosaDraw *m_draw;
	VfxBool     m_isSerialized;
	VfxBool     m_isRestored;

    VfxFloatTimeline *m_timeline;

	static mmi_ret mmi_ig_lw_mimosa_proc(mmi_frm_asm_evt_struct *evt);
};
...
class VappMimosaDraw : public VfxOwnerDraw
{
// Constructor
public:
	VfxSize	m_imgSize;
...
#endif /* __VAPP_WALLPAPER_MIMOSA_GL_H__ */
