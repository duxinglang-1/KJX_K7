...
/* If defined trusted interface is disabled.
   WPSif is used for UI requirement */
#define SEC_CFG_V2_BROWSER
...
extern unsigned int WPSif_get_security_warning_dialog(void);

#define SEC_CFG_CONN_WITHOUT_CERT_WARNING_DLG (WPSif_get_security_warning_dialog())

/*define whether we want to display more information in certificate*/
#define SEC_CFG_DISPLAY_EXTRA_CERT_INFO
