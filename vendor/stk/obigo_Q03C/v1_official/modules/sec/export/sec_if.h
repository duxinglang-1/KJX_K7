...
#define SEC_SIG_TI_CONFIRM_DLG_RESPONSE         ((MSF_MODID_SEC << 8) + 0x59)
/***********************************************************************
 *
...
/*
 Response to ses_dlg_create_dialog and ses_dlg_create_prop_list.
*/
typedef struct {
  /** The screen where the dlg was presented on. */
  MSF_UINT32 screen_id;
  /** Is either SEC_ERR_OK or SEC_ERR_CANCEL. */
  MSF_UINT8 result;
} sec_ti_confirm_dlg_response_t;
...
#define WAP_SEC_HASH_MD5                   1
#define SEC_HASH_SHA                   2
#define WAP_SEC_HASH_MD2                   3
