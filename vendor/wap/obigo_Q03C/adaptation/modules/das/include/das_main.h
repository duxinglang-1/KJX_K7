...
typedef enum
{
    ...
    DAS_STATUS_PREFETCHING_COMPLETED
} das_status_enum;
...
#define DAS_DEFAULT_FILENAME     "filename"
...
extern void das_write_data_to_file (das_job_t *job);
