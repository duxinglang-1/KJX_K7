...
/* under construction !*/
    ...
    void(*wap_paintbox_on_top_callback)(void);

    kal_bool resume_rendering;
    kal_bool is_paintbox_created;
#ifdef  __MMI_WAP_MOUSE_POINTER_SUPPORT__
    ...
    kal_bool register_ucm_callback_in_mmi_task;
...
typedef struct
{
    ...
    /* HDIa_widgetExtRegisterSystemMsgEx (for MMS) */
    kal_uint32 system_msg_type;
    void (*system_msg_callback)(void);
