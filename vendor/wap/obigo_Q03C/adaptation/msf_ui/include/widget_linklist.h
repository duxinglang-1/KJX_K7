...
#define WIDGET_USE_FUNCTIONS_TO_MACRO

#ifdef WIDGET_USE_FUNCTIONS_TO_MACRO
extern void widget_insert_array_func(int MODID, void ***ARRAY, kal_uint16 *SIZE, kal_uint16 *MAXSIZE, void *ITEM, int INDEX);
extern void widget_index_childs_func(int *CNT, MSF_UINT32 PARENT, void *CHILD);
extern void widget_set_active_childs_by_index_func(MSF_UINT32 PARENT, int INDEX);
extern void widget_get_active_childs_func(widget_header_struct **NODE, MSF_UINT32 PARENT);
extern void widget_set_attrib_func(void *PARENT, MSF_UINT32 *ATTRIB, MSF_UINT32 NODE);
extern void widget_set_attrib_ptr_func(void *PARENT, MSF_UINT32 **ATTRIB, MSF_UINT32 *NODE);
extern void widget_remove_childs_by_index_func(MSF_UINT32 PARENT, int INDEX);

#define widget_get_active_childs(NODE,PARENT) widget_get_active_childs_func(&NODE,(MSF_UINT32)PARENT)
#define widget_set_attrib(PARENT,ATTRIB,NODE) widget_set_attrib_func((void*)PARENT,(MSF_UINT32*)&(PARENT->ATTRIB),(MSF_UINT32)NODE)
#define widget_set_attrib_ptr(PARENT,ATTRIB,NODE) widget_set_attrib_ptr_func((void*)PARENT,(MSF_UINT32**)&(PARENT->ATTRIB),(MSF_UINT32*)NODE)
#define widget_remove_childs_by_index(PARENT,INDEX) widget_remove_childs_by_index_func((MSF_UINT32)PARENT,(int)INDEX)
#define widget_index_childs(CNT,PARENT,CHILD) widget_index_childs_func(&CNT,(MSF_UINT32)PARENT,(void*)CHILD)
#define widget_insert_array(MODID,ARRAY,SIZE,MAXSIZE,ITEM,INDEX) widget_insert_array_func(MODID,(void***)(&ARRAY),(kal_uint16*)&SIZE,(kal_uint16*)&MAXSIZE,(void*)ITEM,INDEX)
#define widget_set_active_childs_by_index(PARENT,INDEX) widget_set_active_childs_by_index_func((MSF_UINT32)PARENT,INDEX)
#endif /* WIDGET_USE_FUNCTIONS_TO_MACRO */


#ifndef WIDGET_USE_FUNCTIONS_TO_MACRO

#define widget_set_attrib_ptr(PARENT,ATTRIB,NODE) widget_set_attrib(PARENT,ATTRIB,NODE)
...
//will have no effect of converting
