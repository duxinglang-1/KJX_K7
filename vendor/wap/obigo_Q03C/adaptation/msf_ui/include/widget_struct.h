...
#ifndef widget_struct_h
#define widget_struct_h
#include "widget.h"
...
#else /* MSF_CFG_BRW_ACCESSKEY_SUPPORT */
...
#else /* MSF_CFG_BRW_MARQUEE_SUPPORT */
...
#define S_CTK                                                  \
   ...
   int                              menu_items_sum;            \
   /* for total menu items some in CTK MSF MENU window, added for CTK_MSF_MENU */   \
   MsfChoiceType                    choice_type;               \
   /* specify the choice of CTK Msf Menu */                    \
   MsfMenuExtHighlightHandle        highlight_handler;         \
   /* Used to register the highlight handler for CTK Msf Menu */    \
   kal_uint32                       menu_flags;                \
   /* This flag is used for WIDGET_MENU_FLAG_PROFILE_STYLE, specific to CTK Msf Menu */  \
   int                              highlight_index;           \
   /* Used to store the highlight index of CTK Msf Menu, specific to CTK MSF MENU */
...
/* the struct should be 4 bytes alignment */
typedef struct
{
S_BASIC_HEADER kal_uint16 padding; } widget_pre_string_struct;
...
/* the struct need to be 4 bytes alignment */
typedef struct
{
S_BASIC_HEADER kal_uint16 padding; } widget_pre_image_struct;
