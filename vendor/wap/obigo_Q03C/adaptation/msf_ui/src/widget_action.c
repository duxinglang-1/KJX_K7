...
#ifdef WAP_USE_ASM
    widget_internal_mem_free(MSF_MODID_WIDGET, mydef);
#else
...
#ifdef WAP_USE_ASM
                widget_internal_mem_free(MSF_MODID_WIDGET, accesskey);
#else
                    ...
                    int visualise)
{
     ...
     */
#ifdef WAP_USE_ASM
    accesskey = widget_internal_mem_alloc(MSF_MODID_WIDGET, sizeof(widget_accesskey_struct));
#else
