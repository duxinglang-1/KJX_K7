                    ...
                    MsfStyleHandle defaultStyle)
{
    ...
    {
        widget_gadget_input_struct *w = (widget_gadget_input_struct*) MSF_WIDGET_TEXT_INPUT_CREATE_CSS(
                                                                        modId,
                                                                        0,
                                                                        text,
                                                                        MsfText,
                    ...
                    MsfStyleHandle defaultStyle)
{
    ...
    if (!inputString)
    {
        str = MSF_WIDGET_STRING_CREATE(modId, "", MsfUtf8, 1, 0);
    }
    else
    {
...
void HDIa_widgetSetInputGadgetText(MsfGadgetHandle gadgethandle,MsfStringHandle inputString)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    widget_gadget_input_struct *w = (widget_gadget_input_struct*) gadgethandle;
    if (!inputString)
    {
	str = MSF_WIDGET_STRING_CREATE(3, "", MsfUtf8, 1, 0);
    }
    else
    {
	str = widget_copy_string(3, inputString);
    }
    widget_set_attrib(w, text, str);
}
