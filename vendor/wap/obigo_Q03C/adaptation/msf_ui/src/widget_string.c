                        ...
                        int max_size)
{
    ...
    w->module_id = modId;
    widget_set_attrib_ptr(w, raw, string);
...
void widget_resize_string(widget_string_struct *str, int max_len)
{
    ...
    widget_set_attrib_ptr(str, raw, string);
...
/*****************************************************************************
 * FUNCTION
 *  widget_get_string_id
 * DESCRIPTION
 *  Get the string ID from predefined string handle
 * PARAMETERS
 *  winHandle       [IN]        String handle
 * RETURNS
 *  int
 *****************************************************************************/
int widget_get_string_id(MsfStringHandle winHandle)
{

    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    widget_pre_string_struct *pstr = NULL;
    int resid;
