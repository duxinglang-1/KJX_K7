...
#define BRS_SIG_HTTP_STATUS                       BRS_MODULE_MAIN + 13
...
#ifdef MTK_TMP_PATCH /* CR36388 */
int
brs_instance_is_wap_conn (int instance_id);
#endif

void
brs_remove_channel (void);
...
brs_status (int instanceId, int transaction_id,
			...
			, long upload_bytes_sent, long upload_bytes_total 
			);
...
void brs_timer_stop_all (void);     /* MAUI_03014956 */
...
void
brs_http_delete_status (stk_http_status_t *p);
void
...
void brs_handle_app_ready_to_start(void);
void brs_handle_app_pref_changed(void);
#endif /* MSF_REGISTRY_SUPPORT */

void brs_get_default_dynamic_ua_string(char *uaString);
