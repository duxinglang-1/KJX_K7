...
void VappAlarmSnoozePage::onInit(void)
{
	...
	titleBar->setTitle(VFX_WSTR_RES(STR_ID_VAPP_ALARM_SNOOZE));
	setTopBar(titleBar);
...
void VappAlarmSettingPage::onInit(void)
{
	...
	launchSnooze->setMainText(VFX_WSTR_RES(STR_ID_VAPP_ALARM_SNOOZE));
	...
	launchVolume->setMainText(VFX_WSTR_RES(STR_GLOBAL_VOLUME));
