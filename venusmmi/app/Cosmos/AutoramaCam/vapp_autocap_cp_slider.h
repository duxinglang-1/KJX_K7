...
class VappAutoCapCpSlider : public VfxControl
{
#define VAPP_AUTOCAP_CP_SUPPORT_QUICK_MOVE  (0)
#define VAPP_AUTOCAP_CP_SLIDER_SPACE        (11)
#define VAPP_AUTOCAP_CP_SLIDER_V_SPACE        (3)

public:
    VappAutoCapCpSlider(){}    
    virtual ~VappAutoCapCpSlider(){}
