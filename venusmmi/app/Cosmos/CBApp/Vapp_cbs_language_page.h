...
**********************************************************************************/
#ifndef __VAPP_CBS_LANGUAGE_PAGE_H__
#define __VAPP_CBS_LANGUAGE_PAGE_H__
...
class VappCbsLanguagePage : public VfxPage, public IVcpListMenuContentProvider
{
    //VFX_DECLARE_CLASS(VappCbsLanguagePage);

public:
    VappCbsLanguagePage(VfxS32 sim);
    // cntx
    VfxS32 getSim();
...
/* under construction !*/
#endif
    static void languageChangeCallBack(cbsCallbackStruct *callbackData);  // for option call back
...
private:
    ...
    VcpListMenu *m_languageList;
    VcpToolBar *m_toolBar;
	VfxS32 m_SIM;
    VcpIndicatorPopup *m_processingPopup;
    // data cache
	srv_cbs_language_struct m_languageData;
	VfxU32 m_selectedNumber;
};

#endif /* __VAPP_CBS_LANGUAGE_PAGE_H__ */
