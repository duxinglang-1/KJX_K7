...
#ifndef __VAPP_CAMCO_SETTING_ITEM__
#define __VAPP_CAMCO_SETTING_ITEM__
...
#define VAPP_CAMCO_SETTING_NA (65536)
#define IS_ENABLE(x) (x == VAPP_CAMCO_SETTING_STATUS_ENABLED)
#define IS_NOT_SUPPORT(x) (x == (1ll <<VAPP_CAMCO_SETTING_STATUS_DRV_NOT_SUPPORT))
#define IS_DISABLE(x, y) (x == (1ll <<y))
#define ENABLE() (VAPP_CAMCO_SETTING_STATUS_ENABLED)
#define NOT_SUPPORT() (1ll <<VAPP_CAMCO_SETTING_STATUS_DRV_NOT_SUPPORT)
...
protected:    
    ...
    vapp_camco_setting_enum         m_settingType;
    MMI_ID_TYPE                     m_mainImgId;
    MMI_ID_TYPE                     m_mainStrId;  
    VfxBool                         m_isHiliteMode;
    VfxU64                          m_cap;
    VfxU64                          m_statusBitMap;
    CamcoSettingUnit               *m_content[VAPP_CAMCO_MAX_SETTING_ITEM_COUNT]; 
    CamcoSettingMgr*                m_settingMgr;

    VfxU32                          m_wallpaperSizeMDIEnum;
    VfxU32                          m_wallpaperSize[2];    
};


class CapModeSetting : public CamcoSettingItem
{
...
public:
    ...
    VfxU16 m_CamSceneTable[VAPP_CAMCO_CAMSCENEMODE_END];    
private:
...
class HighlightSetting : public CamcoSettingItem
{
...
class AFRangeSetting : public CamcoSettingItem
{
...
public:
    ...
    VfxU16 m_CamSceneTable[VAPP_CAMCO_CAMSCENEMODE_END];
    VfxU16 m_VdoSceneTable[VAPP_CAMCO_CAMSCENEMODE_END];        
...
class AFZoneSetting : public CamcoSettingItem
{
...
class AEmeterSetting : public CamcoSettingItem
{
public:
...
class SharpnessSetting : public CamcoSettingItem
{
...
class ContrastSetting : public CamcoSettingItem
{
...
class SaturationSetting : public CamcoSettingItem
{
...
class ShuttersoundSetting : public CamcoSettingItem
{
...
class BandingSetting : public CamcoSettingItem
{
...
private:
    ...
    VfxU32                          m_wallpaperQtyMDIEnum;    
    
    void config_recqty_capability(vapp_camco_setting_enum changed_setting);

};

class AFmodeSetting : public CamcoSettingItem
{
public:
    virtual void initialize(void);    
    virtual void setDefault(void);    
...
class RecAudSetting : public CamcoSettingItem
{
public:
    virtual void initialize(void);    
    virtual void setDefault(void);    
...
private:
    ...
    VfxU32                          m_wallpaperCodecMDIEnum;    
...
class RestoredefaultSetting : public CamcoSettingItem
{
...
class AddFrameFrameSetting : public CamcoSettingItem
{
...
class AuxiliarySetting : public CamcoSettingItem
{
