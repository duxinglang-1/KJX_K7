...
#ifndef __VAPP_CAMCO_SETTING_MGR__
#define __VAPP_CAMCO_SETTING_MGR__
...
typedef struct 
{
    MMI_ID_TYPE                     settingImgId[VAPP_CAMCO_SETTING_END];  
    MMI_ID_TYPE                     settingStrId[VAPP_CAMCO_SETTING_END];      
    vapp_camco_setting_enum         settingValue[VAPP_CAMCO_SETTING_END];          
    VfxU16                          settingCount;
    VfxU16                          CurrentSettingIdx;    
    
    MMI_ID_TYPE                     settingItemImgId[VAPP_CAMCO_MAX_SETTING_ITEM_COUNT];  
    MMI_ID_TYPE                     settingItemStrId[VAPP_CAMCO_MAX_SETTING_ITEM_COUNT];          
    VfxU16                          settingItemValue[VAPP_CAMCO_MAX_SETTING_ITEM_COUNT];         
...
{
#define PERSISTENT_SETTING_SAVING  (1)
public:
...
private:
    ...
    /* each setting */   
    CapModeSetting                         *m_CapMode;
    CamSceneModeSetting                    *m_CamSCN;     
    CapSizeSetting                         *m_CapSize;
    FlashSetting                           *m_Flash;
    HighlightSetting                       *m_Hilite;
    AFRangeSetting                         *m_AFrange;
    SelfTimerSetting                       *m_SelfTimer;
    ISOSetting                             *m_ISO;
    WBSetting                              *m_WB;
    EffectSetting                          *m_Effect;
    StorageSetting                         *m_CamStorage;
    StorageSetting                         *m_RecStorage;    
    CapqtySetting                          *m_CapQty;
    AFZoneSetting                          *m_AFzone;
    AEmeterSetting                         *m_AEmeter;
    SharpnessSetting                       *m_Sharpness;
    ContrastSetting                        *m_Contrast;
    SaturationSetting                      *m_Saturation;
    ShuttersoundSetting                    *m_CapSound;
    BandingSetting                         *m_Banding;
    VdoSceneModeSetting                    *m_RecSCN;
    RecSizeSetting                         *m_RecSize;
    TimeLapseSetting                       *m_TimeLapse;
    TimeLapsePeriodSetting                 *m_TimeLapsePeriod;
    LimitSetting                           *m_RecLimit;
    VisQtySetting                          *m_RecQty;
    AFmodeSetting                          *m_AFmode;
    RecAudSetting                          *m_RecSound;
    VisCodecSetting                        *m_RecCodec;
    CamEVSetting                           *m_CapEV;
    VdoEVSetting                           *m_RecEV;
    CamZoomSetting                         *m_CapZoom;
    VdoZoomSetting                         *m_RecZoom;
    RestoredefaultSetting                  *m_Restore;
    ApplicationSetting                     *m_Application;
    CameraSensorSetting                    *m_CamearaSensor;
    AddFrameFrameSetting                   *m_imageFrame;
    AuxiliarySetting                       *m_auxiliary;
