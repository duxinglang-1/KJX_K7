...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_RESET_HW_OBJ, 1);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_PREVIEW_START, param->flag->isPreviewStart);
    ...
    if (((FlashSetting*)(param->Setting->getSetting(VAPP_CAMCO_SETTING_FLASH)))->getFlashType() == VAPP_CAMCO_FLASH_TYPE_LED &&
        (param->Setting->getValue(VAPP_CAMCO_SETTING_SD) == VAPP_CAMCO_SMILE_DETECT_ON)
       )
    {
        camera_setting_data.flash = param->Setting->getMappingID(VAPP_CAMCO_SETTING_FLASH, VAPP_CAMCO_FLASH_OFF);
    }
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_PREVIEW_START_F, result);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_PREVIEW_STOP, param->flag->isPreviewStart);
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_PREVIEW_STOP_F);
#endif
    return MDI_RES_CAMERA_SUCCEED;
}
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_PREVIEW_START, param->flag->isPreviewStart);
    ...
    {
        video_preview_data.record_aud = 0;
    }
    else
    {
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_PREVIEW_START_F, result);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_PREVIEW_STOP, param->flag->isPreviewStart);
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_PREVIEW_STOP_F);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_POWER_ON, param->flag->isPowerOn);
    ...
    if(!param->flag->isPowerOn)
    {
        ...
        MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_POWER_ON_F, ret);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_POWER_OFF, param->flag->isPowerOn);
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_POWER_OFF_F);
#endif
    return MDI_RES_CAMERA_SUCCEED;
}
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_POWER_ON, param->flag->isPowerOn);
    ...
    if(!param->flag->isPowerOn)
    {
        ...
        MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_POWER_ON_F, ret);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_POWER_OFF, param->flag->isPowerOn);
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_POWER_OFF_F);
#endif
    return MDI_RES_VDOREC_SUCCEED;
}
...
MDI_RESULT vapp_camco_cam_normal_shot(vapp_camco_cam_capture_param_struct *param)
{
...
#if defined(__MTK_TARGET__)
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_NORMAL_SHOT);
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_NORMAL_SHOT_F, ret);
...
MDI_RESULT vapp_camco_cam_save_capture_image(vapp_camco_cam_capture_save_param_struct *param)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_SAVE_CAPTURE_IMAGE, ret);
...
MDI_RESULT vapp_camco_cam_scenedetect_get_result(vapp_camco_cam_scene_param_struct *param)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_GET_ASD_RESULT, param->currentScene);
    return MDI_RES_CAMERA_SUCCEED;
}
#endif
...
MDI_RESULT vapp_camco_cam_smiledetect_get_result(vapp_camco_cam_sd_param_struct *param)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_SMILEDETECT_GET_RESULT, param->fd_result);
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_SMILEDETECT_GET_RESULT_1, param->fd_searched_num);
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_SMILEDETECT_GET_RESULT_2, param->sd_end_flag);
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_SMILEDETECT_GET_RESULT_3, param->sd_searched_num);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_SD_START, param->flag->isSmiledetectStart);
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_SD_START, ret);
    return ret;
#else
    return MDI_RES_CAMERA_SUCCEED;
#endif
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_SD_STOP, param->flag->isSmiledetectStart);
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_SD_STOP, ret);
    return ret;
#else
    return MDI_RES_CAMERA_SUCCEED;
#endif
...
void vapp_camco_rec_record_result_hdlr(MDI_RESULT result, void* user_data)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_RECORD_CALLBACK, result);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_RECORD_START, param->flag->isPreviewStart);
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_RECORD_START, ret);
    return ret;
#else
    param->flag->isOnRecord = VFX_TRUE;
    return MDI_RES_VDOREC_SUCCEED;
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_RECORD_STOP, param->flag->isOnRecord);
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_RECORD_STOP, ret);
    return ret;
#else
    return MDI_RES_VDOREC_SUCCEED;
#endif
...
MDI_RESULT vapp_camco_rec_record_pause(vapp_camco_rec_record_param_struct *param)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_RECORD_PAUSE, ret);
...
MDI_RESULT vapp_camco_rec_record_resume(vapp_camco_rec_record_param_struct *param)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_RECORD_RESUME, ret);
...
MDI_RESULT vapp_camco_rec_record_get_time(VfxU64 *time)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_RECORD_GET_TIME, (*time));
...
MDI_RESULT vapp_camco_rec_record_get_size(VfxU64 *size)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_RECORD_GET_SIZE, (*size));
...
MDI_RESULT vapp_camco_rec_record_get_count(VfxU64 *count)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_RECORD_GET_COUNT, (*count));
...
static void vapp_camco_rec_save_result_hdlr(MDI_RESULT result, void* user_data)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_SAVE_VIDEO_RESULT, result);
...
MDI_RESULT vapp_camco_rec_stop_save_video(void)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_STOP_SAVE_VIDEO);
#endif
    return MDI_RES_VDOREC_SUCCEED;
}
...
MDI_RESULT vapp_camco_rec_save_video(vapp_camco_rec_record_save_param_struct *param)
{
    ...
    VAPP_CAMCO_STOP_LOGGING("ARS");
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_SAVE_VIDEO, result);
...
MDI_RESULT vapp_camco_rec_fetch_frame(vapp_camco_rec_fetch_param_struct *param)
{
    ...
    {
        MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_FETCH_FRAME, ret);
        return ret;
    }
    gdi_handle handleT = param->previewFrame->getLayerHandle();
    gdi_layer_push_and_set_active(handleT);
...
static void vapp_camco_cam_autofocus_result_hdlr(mdi_camera_af_result_struct result_ind, void* user_data)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_GET_AUTOFOCUS_RESULT, param.afRet.af_success_zone);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_AUTOFOCUS_START, param->flag->isAFon);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_AUTOFOCUS_STOP, param->flag->isAFon);
...
MDI_RESULT vapp_camco_cam_get_autofocus_result(vapp_camco_autofocus_param_struct *param)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_GET_AUTOFOCUS_RESULT, param->af_zone.af_active_zone);
#else
...
static void vapp_camco_rec_autofocus_result_hdlr(mdi_video_rec_af_result_struct result_ind, void* user_data)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_GET_AUTOFOCUS_RESULT, param.recAfRet.af_success_zone);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_AUTOFOCUS_START, param->flag->isAFon);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_AUTOFOCUS_STOP, param->flag->isAFon);
...
MDI_RESULT vapp_camco_rec_get_autofocus_result(vapp_camco_autofocus_param_struct *param)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_GET_AUTOFOCUS_RESULT, param->rec_af_zone.af_active_zone);
#else
...
MDI_RESULT vapp_camco_cam_get_estimated_picture_size(vapp_camco_estimate_size_param_struct *param)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_GET_EST_SIZE);
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_CAM_GET_EST_SIZE_F,
        image_qty,
        image_width,
        image_height,
        param->size);
...
MDI_RESULT vapp_camco_rec_get_estimated_video_size(vapp_camco_estimate_size_param_struct *param)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_GET_EST_SIZE);
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_REC_GET_EST_SIZE_F,
        spec.quality,
        spec.video_format,
        spec.video_size,
        spec.storage,
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_BG_CAL_START, param->flag->isCalBgProcessOn);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_CAMCO_EXPRESS_BG_CAL_STOP, param->flag->isCalBgProcessOn);
