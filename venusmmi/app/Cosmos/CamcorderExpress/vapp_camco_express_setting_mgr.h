...
#ifndef __VAPP_CAMCO_EXPRESS_SETTING_MGR__
#define __VAPP_CAMCO_EXPRESS_SETTING_MGR__
...
private:
    ...
    SmileDetectSetting                     *m_SmileDetect;
    SceneDetectSetting                     *m_SceneDetect;
    ZeroDelaySetting                       *m_ZeroDelay;
    ApplicationSetting                     *m_Application;
    CameraSensorSetting                    *m_CamearaSensor;
};

#endif /*__VAPP_CAMCO_EXPRESS__*/
#endif /*__VAPP_CAMCO_EXPRESS_SETTING_MGR__*/
