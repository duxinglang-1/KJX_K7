...
#ifndef __VAPP_CAMCO_SLIM_OSD_STATE__
#define __VAPP_CAMCO_SLIM_OSD_STATE__
...
private:
    ...
    VappCamcoCpRotatableImageButton *m_phone;
	VappCamcoCpRotatableImageButton *m_card;
...
private:
    ...
    void layout(void);
    void onZooming(VcpSlider *obj, VfxFloat value);
    ...
    void onSwitchDriveClicked(VfxObject *obj, VfxId id);
    void onSwitchAppClicked(VfxObject* obj, VfxId id);
    void onSwitchAppTick(VfxTimer *source);
    void onCaptureTick(VfxTimer *source);
    ...
    VappCamcoCpRotatableImageFrame  *m_switcherRec;
    VappCamcoCpRotatableImageFrame  *m_switcherCam;
	VappCamcoCpRotatableImageFrame  *m_zoom;
    VappCamcoCpRotatableImageFrame  *m_zoom_;
    VappCamcoCpRotatableFrame       *m_galleryContainer;
    VappCamcoCpRotatableImageButton *m_gallery;
    VappCamcoCpRotatableFrame       *m_galleryContent;
    VappCamcoCpRotatableImageButton *m_capture;
...
class OSDRecRecordingState : public CamcoOSDState
{
    ...
    #define CAMCO_REC_RESET_TIME 10000
...
#endif /*__VAPP_CAMCO_SLIM_OSD_STATE__*/