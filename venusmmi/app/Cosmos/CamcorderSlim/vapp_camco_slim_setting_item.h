...
#ifndef __VAPP_CAMCO_SLIM_SETTING_ITEM__
#define __VAPP_CAMCO_SLIM_SETTING_ITEM__
...
#include "vapp_camco_slim_setting.h"
...
#if defined(__COSMOS_NO_USER_DRIVE__) || defined(__MMI_CAMCO_NOPHONEDRIVE__)
...
#endif /*__VAPP_CAMCO_SLIM_SETTING_ITEM__*/
