...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_LAUNCH_VAPP_GALLERY_FILE_OPEN_HANDLER_S_D_D, filepath, filetype, fromFileMgr);
    ...
    pOption->disableSSE = disable_SSE ? VFX_TRUE : VFX_FALSE;
...
static BOOL vapp_gallery_pdl_da_video_filepath_hdlr(
                ...
                PU16 filepath)
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_PDL_VAPP_GALLERY_PDL_DA_VIDEO_FILEPATH_HDLR_CALLED_SESSION_ID_D, session_id);
...
static void vapp_gallery_pdl_da_report_hdlr(
                ...
                U32 total_size)
{ 
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_PDL_VAPP_GALLERY_PDL_DA_REPORT_HDLR_WITH_SESSION_ID_D, session_id);
    ...
    {
        MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_PDL_VAPP_GALLERY_PDL_DA_REPORT_HDLR_PROGRESS_REPORT);
        // already running
        switch (status)
        {
    ...
    {
        MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_PDL_VAPP_GALLERY_PDL_DA_REPORT_HDLR_FIRST_RUN);
        // not running
        switch (status)
        {
            case SRV_DA_STATE_DOWNLOADING:
            ...
            srv_da_setting_struct *settings_p)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_PDL_VAPP_GALLERY_PDL_DA_NOTIFY_VIDEO_FILE_WITH_SESSION_ID_D, session_id);
}
