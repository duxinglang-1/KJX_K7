...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_CACHE_PUSH_FREE_ELEMENT_D, freeId);
    ...
    for(VfxObjListEntry *e = m_freeList.getHead(); e != NULL; e = e->getNext())
    {
        ...
        {
            MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_CACHE_PUSH_FREE_ELEMENT_ALREADY_HAVE_D_DO_NOTHING, freeId);
            return;
        }
    }
...
VfxId VappGalleryCacheIndex::popFreeElement()
{
    ...
    {
        MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_CACHE_POP_FREE_ELEMENT_WHILE_LIST_IS_EMPTY);
        VFX_ASSERT(0);
    }
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_CACHE_INDEX_CLEAR);
