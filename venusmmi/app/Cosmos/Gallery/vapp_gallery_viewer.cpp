...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_INIT);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_DEINIT);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_ENTER);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_ENTERED);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_EXIT);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_EXITED2);
    ...
    case 'INFO':
        {
            ...
            {
                // some other error
                MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_TOOLBAR_COMMAND_NO_VALID_FILE_PATH);
                return;
            }
        }
        break;
...
void VappGalleryViewerPage::onDeleteFile(const VfxWString &path)
{
    ...
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_DELET_FILE);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_DELET_FILE_FINISHED, result);
    ...
    if(VGFOR_DONE == result)
    {
        ...
        VappGalleryShootingPage *page= reinterpret_cast<VappGalleryShootingPage*>(getMainScr()->getPage(PN_MY_SHOOTING));
        if(page)
        {
...
void VappGalleryViewerPage::onShareFile(const VfxWString &path)
{
    if(m_fileOp)
    {
        MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_SHARE_FILE_ALREADY_HAVE_FILE_OP);
        return;
    }
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_SHARE_FILE_DONE);
    ...
    {
        MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_SHARE_AND_SET_AS_FINISHED, 1);
...
{
    MMI_TRACE(TRACE_GROUP_2, TRC_VAPP_GALLERY_VIEWER_ON_REQUIRE_RES_RELEASE);
    onPageInactiveImpl();
    onPageInactived2Impl();
}
