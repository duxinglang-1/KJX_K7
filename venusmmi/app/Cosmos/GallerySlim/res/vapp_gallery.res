...
<APP id = "VCUI_GALLERY_WALLPAPER_PICKER" name="STR_ID_VAPP_GALLERY_WALLPAPER_PICKER" type="venus">
    ...
    #endif
#endif
    fg="fg(APP_VENUS_WALLPAPER) + VAPP_GALLERY_IMG_PICKER_FG_SIZE"
...
<APP id="VAPP_GALLERY" name="STR_ID_VAPP_GALLERY_AP_NAME"
    ...
    #define GAL_VIDEO_PLAYER_PATH   RES_IMG_ROOT"\\\\Gallery\\\\VideoPlayerPortrait\\\\"
#else
    ...
    <IMAGE id="IMG_ID_VAPP_GALLERY_IDX_SHOOTING_ICON">GAL_INDEX_PATH"icon_myphoto_slim.png"</IMAGE>
    <IMAGE id="IMG_ID_VAPP_GALLERY_IDX_PICTURE_ICON">GAL_INDEX_PATH"icon_mypic_slim.png"</IMAGE>
    <IMAGE id="IMG_ID_VAPP_GALLERY_IDX_VIDEO_ICON">GAL_INDEX_PATH"icon_myvideo_slim.png"</IMAGE>
    <IMAGE id="IMG_ID_VAPP_GALLERY_PICTURE_FOLDER_ICON">GAL_MY_PICTURE_PATH"icon_folder_slim.png"</IMAGE>
#else
...
#ifdef __MMI_REDUCED_UI_BUFFER__    
    <IMAGE id="IMG_ID_VAPP_GALLERY_VID_PORTRAIT_SLIDER">GAL_VIDEO_PLAYER_PATH"Vertical_H.9slice.png"</IMAGE>
    <IMAGE id="IMG_ID_VAPP_GALLERY_VID_PORTRAIT_SLIDER_TRACK">GAL_VIDEO_PLAYER_PATH"Vertical_BG.9slice.png"</IMAGE>
    <IMAGE id="IMG_ID_VAPP_GALLERY_VID_TITLE_BAR">RES_IMG_ROOT"\\\\Components\\\\MultimediaCP\\\\TitleBar\\\\TitleBar.9slice.png"</IMAGE>
#endif
