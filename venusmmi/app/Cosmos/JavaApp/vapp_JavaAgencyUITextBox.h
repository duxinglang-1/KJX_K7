...
#ifndef __VAPP_JAVAAGENCYUITEXTBOX_H__
#define __VAPP_JAVAAGENCYUITEXTBOX_H__
 ...
 * Class 
 *****************************************************************************/
class VappJavaUITextboxScr : public VfxAppCatScr
{
    // Declaration
    public:
