 ...
 * Filename:
 * ---------
 *  vapp_launcher_cosmos_desktop.h
 *
 * Project:
 * --------
 *  MAUI
...
#ifndef VAPP_LAUNCHER_COSMOS_DESKTOP_H
#define VAPP_LAUNCHER_COSMOS_DESKTOP_H
 ...
 * Define
 *****************************************************************************/
#define VAPP_LAUNCHER_COSMOS_DESKTOP_PAGE_BG_OPACITY 0.3
...
class VappLauncherCosmosDesktopPage : public VfxFrame
{
public:
    VappLauncherCosmosDesktopPage();
...
class VappLauncherCosmosDesktop : public VfxControl
{
    VFX_DECLARE_CLASS(VappLauncherCosmosDesktop);

// Constructor / Destructor
public:
    // Default constructor
    VappLauncherCosmosDesktop();
...
public:
    ...
    VfxSignal1 <
        VappLauncherCosmosDesktop *       // [IN] Desktop object
    > m_signalPageChanged;
...
public:
    ...
    //
    // SEE ALSO: VAPP_LAUNCHER_COSMOS_DESKTOP_OUTER_BORDER_TOP_WIDTH,
    // SEE ALSO: VAPP_LAUNCHER_COSMOS_DESKTOP_OUTER_BORDER_BOTTOM_WIDTH,
    // SEE ALSO: VAPP_LAUNCHER_COSMOS_DESKTOP_OUTER_BORDER_LEFT_WIDTH,
    // SEE ALSO: VAPP_LAUNCHER_COSMOS_DESKTOP_OUTER_BORDER_RIGHT_WIDTH
...
public:
    ...
    //
    // SEE ALSO: VAPP_LAUNCHER_COSMOS_DESKTOP_AUTO_SLIDE_BORDER_LEFT_WIDTH
    // SEE ALSO: VAPP_LAUNCHER_COSMOS_DESKTOP_AUTO_SLIDE_BORDER_LEFT_WIDTH
...
private:
    ...
    VappLauncherCosmosDesktopPage *m_page[VAPP_LAUNCHER_COSMOS_MAX_PAGE_NUM];

    VfxS32Timeline *m_tlTranslateDummyNodeX;

    VfxFrame *m_animDummyFrame;

    VappLauncherCosmosPageTransition *m_transition;

    VfxS32 m_curDommyPosX;
...
private:
    ...
    // This function sets the widget's position to be on this room.
    void initPageAnim(VappLauncherCosmosDesktopPage* page);
    ...
    // show desktop transparent bg when page switching
    void showDesktopPageBg(VfxBool isShow);
...
#endif /* VAPP_LAUNCHER_COSMOS_DESKTOP_H */
