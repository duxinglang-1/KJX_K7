...
VFX_IMPLEMENT_CLASS("VappLauncherCosmosColorMaterial", VappLauncherCosmosColorMaterial, VfxObject);


VappLauncherCosmosColorMaterial::VappLauncherCosmosColorMaterial() :
    m_material(NULL)
{
    // Do nothing.
}
...
void VappLauncherCosmosColorMaterial::onInit()
{
    VfxObject::onInit();
...
//    kal_wsprintf(vs, "%c:\\test\\vapp_launcher_cosmos_color_filter.vs", SRV_FMGR_PHONE_DRV);
//    kal_wsprintf(fs, "%c:\\test\\vapp_launcher_cosmos_color_filter.fs", SRV_FMGR_PHONE_DRV);
...
//        (VFX_WSTR_DYNAMIC(vs), VFX_WSTR_DYNAMIC(fs)));
    ...
    VFX_OBJ_CREATE_EX(
        ...
        VfxShaderProgram,
        pass,
        (VFX_RES_ID_NULL, VAPP_LAUNCHER_COSMOS_COLOR_FILTER_FS));

    pass->setShaderProgram(program);
}


void VappLauncherCosmosColorMaterial::onDeinit()
{
    VfxObject::onInit();
}


VfxMaterial *VappLauncherCosmosColorMaterial::get() const
{
    return m_material;
}
...
VFX_IMPLEMENT_CLASS("VappLauncherCosmosColorFilter", VappLauncherCosmosColorFilter, VfxFrameFilter);


VappLauncherCosmosColorFilter::VappLauncherCosmosColorFilter() :
    m_minR(0),
    m_minG(0),
    m_minB(0),
    m_rangeR(255),
...
void VappLauncherCosmosColorFilter::setColorFilter(
...
VfxFrameFilter::BufferModeEnum VappLauncherCosmosColorFilter::onGetBufferMode() const
{
    return BUFFER_MODE_OUT_OF_PLACE;
}


VfxBool VappLauncherCosmosColorFilter::onProcess(
    VfxU8 *outBuf,
...
void VappLauncherCosmosColorFilter::onProcessArgb(
    VfxU8 *outBuf,
    VfxImageBuffer &inBuf,
    VfxFloat timing)
{
...
void VappLauncherCosmosColorFilter::onProcessPargb(
    VfxU8 *outBuf,
    VfxImageBuffer &inBuf,
    VfxFloat timing)
{
...
#if defined(GDI_LAYER_PARGB6666_FLATTEN_SUPPORT)
void VappLauncherCosmosColorFilter::onProcessPargb6666(
    VfxU8 *outBuf,
    VfxImageBuffer &inBuf,
    VfxFloat timing)
{
...
VFX_IMPLEMENT_CLASS("VappLauncherCosmosSort", VappLauncherCosmosSort, VfxObject);


VappLauncherCosmosSort::VappLauncherCosmosSort()
{
    // Do nothing.
}


void VappLauncherCosmosSort::sortByName(VappWidgetId **array, VfxS32 size)
{
...
VfxWChar **VappLauncherCosmosSort::createNameArray(
    VappWidgetId **array,
    VfxS32 size)
{
    VfxWChar **nameArray;
...
void VappLauncherCosmosSort::releaseNameArray(
    VfxWChar **nameArray,
    VfxS32 size)
{
    if (nameArray)
...
void VappLauncherCosmosSort::quickSort(
    VappWidgetId **array,
    VfxWChar **nameArray,
    VfxS32 left,
    VfxS32 right)
...
VfxS32 VappLauncherCosmosSort::partition(
    VappWidgetId **array,
    VfxWChar **nameArray,
    VfxS32 left,
    VfxS32 right,
...
void VappLauncherCosmosSort::swap(
    VappWidgetId **array,
    VfxWChar **nameArray,
    VfxS32 index1,
    VfxS32 index2)
