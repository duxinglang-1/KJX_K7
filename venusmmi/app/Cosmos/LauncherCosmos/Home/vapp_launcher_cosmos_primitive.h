...
#ifndef VAPP_LAUNCHER_COSMOS_PRIMITIVE_H
#define VAPP_LAUNCHER_COSMOS_PRIMITIVE_H
...
class VappLauncherCosmosColorMaterial : public VfxObject
{
    VFX_DECLARE_CLASS(VappLauncherCosmosColorMaterial);

// Constructor / Destructor
public:
    // Default constructor
    VappLauncherCosmosColorMaterial();

// Method
public:
    // This function gets the material.
    // RETURNS: material.
    VfxMaterial *get() const;
...
class VappLauncherCosmosColorFilter : public VfxFrameFilter
{
    VFX_DECLARE_CLASS(VappLauncherCosmosColorFilter);

// Constructor / Destructor
public:
    // Default constructor
    VappLauncherCosmosColorFilter();
...
private:
    ...
    // This function processes the PARGB6666 color format.
    void onProcessPargb6666(
        VfxU8 *outBuf,          // [OUT] Output buffer
        VfxImageBuffer &inBuf,  // [IN]  Input buffer
        VfxFloat timing         // [IN]  Timing
    );
...
class VappLauncherCosmosSort : public VfxObject
{
    VFX_DECLARE_CLASS(VappLauncherCosmosSort);

// Constructor / Destructor
public:
    // Default constructor
    VappLauncherCosmosSort();
...
#endif /* VAPP_LAUNCHER_COSMOS_PRIMITIVE_H */
