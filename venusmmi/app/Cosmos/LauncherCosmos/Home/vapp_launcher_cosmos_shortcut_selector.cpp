 ...
 * Filename:
 * ---------
 *  vapp_launcher_cosmos_shortcut_selector.cpp
 *
 * Project:
 * --------
 *  MAUI
...
VFX_IMPLEMENT_CLASS(
    "VappLauncherCosmosShortcutContentFrame",
    VappLauncherCosmosShortcutContentFrame,
    VcpListMenuCellClientBaseFrame);

const VfxFloat VappLauncherCosmosShortcutContentFrame::s_textAniStartOpacity = 0.6f;


VappLauncherCosmosShortcutContentFrame::VappLauncherCosmosShortcutContentFrame() :
    m_index(0),
...
VappLauncherCosmosShortcutContentFrame::VappLauncherCosmosShortcutContentFrame(
    VfxS32 index,
    VappLauncherCosmosShortcutContentProvider *contentProvider) :
    m_index(index),
...
void VappLauncherCosmosShortcutContentFrame::setIndex(VfxS32 index)
{
    VFX_ASSERT(index >= 0);
...
void VappLauncherCosmosShortcutContentFrame::bind(
    VappLauncherCosmosShortcutContentProvider *contentProvider)
{
    m_contentProvider = contentProvider;
}
...
void VappLauncherCosmosShortcutContentFrame::setAnimation(VfxBool isOn)
{
    m_isAnimationOn = isOn;
}


void VappLauncherCosmosShortcutContentFrame::onCreateElements()
{
...
void VappLauncherCosmosShortcutContentFrame::onCloseElements()
{
...
void VappLauncherCosmosShortcutContentFrame::onLayoutElements()
{
...
void VappLauncherCosmosShortcutContentFrame::onUpdateElements()
{
...
const VappWidgetId *VappLauncherCosmosShortcutContentFrame::getPackage() const
{
...
VFX_IMPLEMENT_CLASS(
    "VappLauncherCosmosShortcutContentProvider",
    VappLauncherCosmosShortcutContentProvider,
    VfxObject);


VappLauncherCosmosShortcutContentProvider::VappLauncherCosmosShortcutContentProvider() :
    m_list(NULL),
    m_num(0),
    m_blockedList(NULL),
    m_blockedNum(0),
...
VfxU32 VappLauncherCosmosShortcutContentProvider::getCount() const
{
    return m_num;
}


VfxBool VappLauncherCosmosShortcutContentProvider::getMenuEmptyText(
    VfxWString &text,
    VcpListMenuTextColorEnum &color)
{
    text.loadFromRes(STR_ID_VAPP_LAUNCHER_COSMOS_NO_SHORTCUT);
...
VcpListMenuCellClientBaseFrame *
VappLauncherCosmosShortcutContentProvider::getItemCustomContentFrame(
    VfxU32 index,
    VfxFrame *parentFrame)
{
    VappLauncherCosmosShortcutContentFrame *cell;
...
void VappLauncherCosmosShortcutContentProvider::closeItemCustomContentFrame(
    VfxU32 index,
...
void VappLauncherCosmosShortcutContentProvider::updateContent()
{
    VappWidgetId::deleteArray(m_list, m_num);
    m_list = NULL;
    m_num = 0;
...
void VappLauncherCosmosShortcutContentProvider::setBlockedList(
    VappWidgetId **list,
    VfxS32 num)
{
    VappWidgetId::deleteArray(m_blockedList, m_blockedNum);
...
VfxBool VappLauncherCosmosShortcutContentProvider::isBlocked(const VappWidgetId &id) const
{
    if (!m_blockedList)
    {
        return VFX_FALSE;
...
void VappLauncherCosmosShortcutContentProvider::setAnimation(VfxBool isOn)
{
    m_isAnimationOn = isOn;
}


const VappWidgetId *VappLauncherCosmosShortcutContentProvider::getId(VfxS32 index) const
{
...
void VappLauncherCosmosShortcutContentProvider::sortList(VappWidgetId **list, VfxS32 size)
{
    VFX_ASSERT(list && size > 0);

    VappLauncherCosmosSort *sort;

    VFX_OBJ_CREATE(sort, VappLauncherCosmosSort, this);
...
VappWidgetId **VappLauncherCosmosShortcutContentProvider::createWhiteList(VfxS32 &listNum)
{
    //
    ...
    fullList[totalNum]->assignWith(
                            ...
                            srv_appmgr_get_id_by_app_package_name("native.mtk.launcher_cosmos_mm_barrel_setting"));
    totalNum++;
#else
...
VFX_IMPLEMENT_CLASS(
    "VappLauncherCosmosShortcutSelector",
    VappLauncherCosmosShortcutSelector,
    VfxPage);


VappLauncherCosmosShortcutSelector::VappLauncherCosmosShortcutSelector() :
    m_menu(NULL),
    m_contentProvider(NULL)
{
    // Do nothing.
...
void VappLauncherCosmosShortcutSelector::onInit()
{
    VfxPage::onInit();
    ...
    VFX_OBJ_CREATE(m_contentProvider, VappLauncherCosmosShortcutContentProvider, this);
}


void VappLauncherCosmosShortcutSelector::onDeinit()
{
    VfxPage::onDeinit();
}


VfxBool VappLauncherCosmosShortcutSelector::onKeyInput(VfxKeyEvent &event)
{
...
VfxBool VappLauncherCosmosShortcutSelector::onPreviewPenInput(VfxPenEvent &event)
{
    if (m_contentProvider)
    {
        m_contentProvider->setAnimation(VFX_FALSE);
...
void VappLauncherCosmosShortcutSelector::show()
{
    updateMenu();
...
void VappLauncherCosmosShortcutSelector::setBlockedList(VappWidgetId **list, VfxS32 num)
{
...
void VappLauncherCosmosShortcutSelector::createTitleBar()
{
    VcpTitleBar *bar;

    VFX_OBJ_CREATE(bar, VcpTitleBar, this);
    bar->setTitle((STR_ID_VAPP_LAUNCHER_COSMOS_SELECT_SHORTCUT));

    setTopBar(bar);
}


void VappLauncherCosmosShortcutSelector::updateMenu()
{
    //
    ...
    m_menu->m_signalItemTapped.connect(this, &VappLauncherCosmosShortcutSelector::onItemTapped);
...
void VappLauncherCosmosShortcutSelector::create2ndPassLoader()
{
    //
    ...
    m_timer2ndPassLoader->m_signalTick.connect(this, &VappLauncherCosmosShortcutSelector::on2ndPassLoader);
...
void VappLauncherCosmosShortcutSelector::on2ndPassLoader(VfxTimer *timer)
{
...
void VappLauncherCosmosShortcutSelector::onItemTapped(VcpListMenu *menu, VfxU32 index)
{
    VFX_ASSERT(m_contentProvider);
