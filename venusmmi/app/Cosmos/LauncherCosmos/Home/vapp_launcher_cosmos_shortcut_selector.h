 ...
 * Filename:
 * ---------
 *  vapp_launcher_cosmos_shortcut_selector.h
 *
 * Project:
 * --------
 *  MAUI
...
#ifndef VAPP_LAUNCHER_COSMOS_SHORTCUT_SELECTOR_H
#define VAPP_LAUNCHER_COSMOS_SHORTCUT_SELECTOR_H
...
class VappLauncherCosmosShortcutContentProvider;


class VappLauncherCosmosShortcutContentFrame : public VcpListMenuCellClientBaseFrame
{
    VFX_DECLARE_CLASS(VappLauncherCosmosShortcutContentFrame);
...
private:
    VfxS32 m_index;
    VfxWeakPtr <VappLauncherCosmosShortcutContentProvider> m_contentProvider;
    VfxTextFrame *m_text;
    VfxFrame *m_icon;
...
{
    VFX_DECLARE_CLASS(VappLauncherCosmosShortcutContentProvider);
...
public:
    ...
    // Default destructor
    virtual ~VappLauncherCosmosShortcutContentProvider();
...
class VappLauncherCosmosShortcutSelector : public VfxPage
{
    VFX_DECLARE_CLASS(VappLauncherCosmosShortcutSelector);
...
public:
    ...
    // Default destructor
    virtual ~VappLauncherCosmosShortcutSelector();
...
private:
    ...
    // Content provider.
    VappLauncherCosmosShortcutContentProvider *m_contentProvider;
...
#endif /* VAPP_LAUNCHER_COSMOS_SHORTCUT_SELECTOR_H */
