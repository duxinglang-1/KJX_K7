...
VFX_IMPLEMENT_CLASS("VappLauncherCosmosWidgetGridCell", VappLauncherCosmosWidgetGridCell, VcpPageGridCell);

const VfxFloat VappLauncherCosmosWidgetGridCell::s_textAniStartOpacity = 0.6f;


VappLauncherCosmosWidgetGridCell::VappLauncherCosmosWidgetGridCell() :
...
void VappLauncherCosmosWidgetGridCell::onShowCell()
{
...
void VappLauncherCosmosWidgetGridCell::setWidgetId(const VappWidgetId &id)
{
    m_id = id;
}


void VappLauncherCosmosWidgetGridCell::setAnimation(VfxBool isOn)
{
...
VFX_IMPLEMENT_CLASS("VappLauncherCosmosWidgetSelector", VappLauncherCosmosWidgetSelector, VfxPage);


VappLauncherCosmosWidgetSelector::VappLauncherCosmosWidgetSelector():
    m_pageGrid(NULL),
    m_widgetIdList(NULL),
    m_widgetNum(0),
    m_blockedList(NULL),
...
void VappLauncherCosmosWidgetSelector::onInit()
{
    VfxPage::onInit();
...
void VappLauncherCosmosWidgetSelector::onDeinit()
{
    // Do nothing.
...
void VappLauncherCosmosWidgetSelector::show()
{
    createSeparateLine();
...
void VappLauncherCosmosWidgetSelector::setBlockedList(
    VappWidgetId **list,
    VfxS32 num)
{
    VappWidgetId::deleteArray(m_blockedList, m_blockedNum);
...
void VappLauncherCosmosWidgetSelector::createTitleBar()
{
    VcpTitleBar *bar;

    VFX_OBJ_CREATE(bar, VcpTitleBar, this);
    bar->setTitle((STR_ID_VAPP_LAUNCHER_COSMOS_SELECT_WIDGET));

    setTopBar(bar);
}


void VappLauncherCosmosWidgetSelector::createSeparateLine()
{
...
void VappLauncherCosmosWidgetSelector::createPageGrid()
{
    ...
    m_pageGrid->m_itemClicked.connect(this, &VappLauncherCosmosWidgetSelector::onItemClicked);
...
void VappLauncherCosmosWidgetSelector::updatePageGrid()
{
    //
    ...
    {
        VappLauncherCosmosWidgetGridCell *cell;

        VFX_OBJ_CREATE(cell, VappLauncherCosmosWidgetGridCell, this);
...
void VappLauncherCosmosWidgetSelector::onPostUpdate()
{
    updatePageGrid();
}


void VappLauncherCosmosWidgetSelector::onItemClicked(VfxS32 itemIndex)
{
...
VfxBool VappLauncherCosmosWidgetSelector::isBlocked(const VappWidgetId &id) const
{
    if (!m_blockedList)
    {
        return VFX_FALSE;
...
VappWidgetId **VappLauncherCosmosWidgetSelector::createWhiteList(VfxS32 &whiteWidgetNum)
{
    //
...
void VappLauncherCosmosWidgetSelector::sortList(VappWidgetId **list, VfxS32 size)
{
...
#if defined(__GADGET_SUPPORT__)
VfxBool VappLauncherCosmosWidgetSelector::sanityCheckForGadget()
{
    VfxS32 type;
    ...
    if(srv_usb_is_in_mass_storage_mode() && drive != SRV_WGTMGR_DRIVE_SYSTEM)
    {
        ...
        vapp_nmgr_global_popup_show_confirm_one_button_id(
            ...
            STR_ID_VAPP_LAUNCHER_COSMOS_NOT_AVAILABLE_IN_USB_MODE,
            STR_GLOBAL_OK,
    ...
    if (srv_wgtmgr_check_downloaded_wgt(type) != SRV_WGTMGR_RET_OK)
    {
        ...
        else
        {
            ...
            vapp_nmgr_global_popup_show_confirm_two_button_id(
                ...
                STR_ID_VAPP_LAUNCHER_COSMOS_FILE_NOT_EXISTS,
                STR_GLOBAL_DELETE,
                STR_ID_VAPP_LAUNCHER_COSMOS_KEEP_IT,
                VCP_POPUP_BUTTON_TYPE_NORMAL,
                VCP_POPUP_BUTTON_TYPE_NORMAL,
...
void VappLauncherCosmosWidgetSelector::onPopupCorruptedClicked(VfxId id, void *userData)
{
    VappLauncherCosmosWidgetSelector *selector;

    selector = (VappLauncherCosmosWidgetSelector *)handleToObject((VfxObjHandle)userData);
    ...
    if (selector)
    {
        ...
        vfxPostInvoke0(selector, &VappLauncherCosmosWidgetSelector::onPostUpdate);
    }
}


void VappLauncherCosmosWidgetSelector::onPopupMemoryCardPlugOutClicked(
    VfxId id,
    void *userData)
{
    VappLauncherCosmosWidgetSelector *selector;
