...
#ifndef VAPP_LAUNCHER_COSMOS_WIDGET_SELECTOR_H
#define VAPP_LAUNCHER_COSMOS_WIDGET_SELECTOR_H
...
class VappLauncherCosmosWidgetGridCell : public VcpPageGridCell
{
   VFX_DECLARE_CLASS(VappLauncherCosmosWidgetGridCell);

// Constructor / Desctructor
public:
    // Default constructor.
    VappLauncherCosmosWidgetGridCell();
...
class VappLauncherCosmosWidgetSelector : public VfxPage
{
   VFX_DECLARE_CLASS(VappLauncherCosmosWidgetSelector);

// Constructor / Destructor
public:
    // Default constructor
    VappLauncherCosmosWidgetSelector();

    // Default destructor
    virtual ~VappLauncherCosmosWidgetSelector();
...
#endif /* VAPP_LAUNCHER_COSMOS_WIDGET_SELECTOR_H */
