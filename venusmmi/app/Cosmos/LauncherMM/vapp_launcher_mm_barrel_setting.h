 ...
 * Filename:
 * ---------
 *  vapp_launcher_mm_barrel_setting.h
 *
 * Project:
 * --------
 *  Launcher
...
#ifndef __VAPP_LAUNCHER_MM_BARREL_SETTING_H__
#define __VAPP_LAUNCHER_MM_BARREL_SETTING_H__
...
class VappLauncherMmBarrelSetting : public VfxObject
{
    VFX_DECLARE_CLASS(VappLauncherMmBarrelSetting);
    
// Constructor / Destructor
public:
    // Default constructor
    VappLauncherMmBarrelSetting();
...
#endif /* __VAPP_LAUNCHER_MM_BARREL_SETTING_H__*/
