 ...
 * Filename:
 * ---------
 *  vapp_launcher_robot_page_selector.h
 *
 * Project:
 * --------
 *  MAUI
...
#ifndef VAPP_LAUNCHER_ROBOT_PAGE_SELECTOR_H
#define VAPP_LAUNCHER_ROBOT_PAGE_SELECTOR_H
...
class VappLauncherRobotPageSelectorDebugPanel : public VfxControl
{
public:
    VappLauncherRobotPageSelectorDebugPanel();
...
class VappLauncherRobotPageSnapshot : public VfxControl
{
public:
    VappLauncherRobotPageSnapshot();

public:
    VfxSignal1 <VappLauncherRobotPageSnapshot *> m_signalTapped;
...
class VappLauncherRobotPageSelector : public VfxControl
{
public:
    enum AbortCauseEnum
    {
...
public:
    // Default constructor
    VappLauncherRobotPageSelector();

    // Default destructor
    virtual ~VappLauncherRobotPageSelector();
...
public:
    ...
    VfxSignal1 <VappLauncherRobotPageSelector *> m_signalAssembled;
    ...
    VfxSignal2 <VappLauncherRobotPageSelector *, VfxS32> m_signalSelected;
    ...
    VfxSignal2 <VappLauncherRobotPageSelector *, AbortCauseEnum> m_signalAborted;
    ...
    VfxSignal1 <VappLauncherRobotPageSelector *> m_signalDismissed;
...
private:
    ...
    VappLauncherRobotPageSnapshot *m_snapshot[VAPP_LAUNCHER_ROBOT_MAX_PAGE_NUM];
...
private:
    ...
    void onSnapshotTapped(
        VappLauncherRobotPageSnapshot *snapshot
    );
...
#if defined(VAPP_LAUNCHER_ROBOT_UT_PAGE_SELECTOR_DEBUG_PANEL)
private:
    VappLauncherRobotPageSelectorDebugPanel *m_debugPanel;
...
#endif /* VAPP_LAUNCHER_ROBOT_PAGE_SELECTOR_H */
