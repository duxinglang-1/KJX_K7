 ...
 * Filename:
 * ---------
 *  vapp_launcher_robot_preinstaller.h
 *
 * Project:
 * --------
 *  MAUI
...
#ifndef VAPP_LAUNCHER_ROBOT_PREINSTALLER_H
#define VAPP_LAUNCHER_ROBOT_PREINSTALLER_H
...
class VappLauncherRobotPreinstaller : public VfxObject
{
    VFX_DECLARE_CLASS(VappLauncherRobotPreinstaller);

// Constructor / Destructor
public:
    // Default constructor
    VappLauncherRobotPreinstaller();
...
#endif /* VAPP_LAUNCHER_ROBOT_PREINSTALLER_H */
