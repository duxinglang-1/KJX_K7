 ...
 * Filename:
 * ---------
 *  vapp_launcher_robot_primitive.h
 *
 * Project:
 * --------
 *  MAUI
...
#ifndef VAPP_LAUNCHER_ROBOT_PRIMITIVE_H
#define VAPP_LAUNCHER_ROBOT_PRIMITIVE_H
...
class VappLauncherRobotColorMaterial : public VfxObject
{
    VFX_DECLARE_CLASS(VappLauncherRobotColorMaterial);

// Constructor / Destructor
public:
    // Default constructor
    VappLauncherRobotColorMaterial();
...
class VappLauncherRobotColorFilter : public VfxFrameFilter
{
    VFX_DECLARE_CLASS(VappLauncherRobotColorFilter);

// Constructor / Destructor
public:
    // Default constructor
    VappLauncherRobotColorFilter();
...
class VappLauncherRobotSort : public VfxObject
{
    VFX_DECLARE_CLASS(VappLauncherRobotSort);

// Constructor / Destructor
public:
    // Default constructor
    VappLauncherRobotSort();
...
#endif /* VAPP_LAUNCHER_ROBOT_PRIMITIVE_H */
