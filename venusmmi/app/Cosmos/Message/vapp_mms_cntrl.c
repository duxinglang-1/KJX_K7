...
#include "mmsadp.h"
#include "vapp_mms_res_def.h"
#include "mmi_rp_app_venus_mms_def.h"
#include "MmsSrvGprot.h"
#include "vapp_mms_cntrl.h"
#include "vapp_mms_dtmgr.h"
#include "vapp_mms_res_cntr.h"
#include "MMSMemoryManagerSrv.h"

//#include "VappMessagesResourceData.h"
...
MMI_UMMS_ERROR mmi_umms_app_cntrlr_screen_render_start(U16 scr_id)
{
    ...
    {
        //U16 scr_id = (mmi_umms_dtmgr_get_group_id() == GRP_ID_UMMS_LIST_TEMPLATES) ? SCR_ID_UMMS_PROGRESS_TMPLT : SCR_ID_UMMS_PROGRESS;
...
MMI_UMMS_ERROR mmi_umms_app_cntrlr_setting_common_create_func(U16 scr_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
MMI_UMMS_ERROR mmi_umms_app_cntrlr_setting_common_pre_func(U16 scr_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
MMI_UMMS_ERROR mmi_umms_app_cntrlr_setting_common_post_func(U16 scr_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
MMI_UMMS_ERROR mmi_umms_app_cntrlr_setting_common_show_func(U16 scr_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/

	//vapp_rajbir_menu_launch();
		vapp_mms_setting_launch();
    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    return MMI_UMMS_TRUE;
