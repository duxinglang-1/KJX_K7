...
#endif
/* Screen group */
MMI_ID g_mmi_umms_dtmgr_screen_group_id =  GRP_ID_INVALID;
MMI_BOOL g_mmi_umms_dtmgr_screen_group_flag =  MMI_FALSE;
MMI_ID g_umms_app_dtmgr_inline_gid = GRP_ID_INVALID;
MMI_ID g_umms_app_dtmgr_inline_gid_ext = GRP_ID_INVALID;
MMI_ID g_umms_app_dtmgr_compose_image_gid = GRP_ID_INVALID;
U8 g_umms_app_dtmgr_proc_flag = FALSE;
U8 g_mmi_umms_dtmgr_tmplte_screen_group_flag;
...
mmi_umms_app_dtmgr_context *mmi_umms_app_dtmgr_get_free_cntx(U16 scr_id);
void mmi_umms_app_dtmgr_save_header_info(srv_mms_xml_msg_header_struct *srv_header_info);
void mmi_umms_app_dtmgr_get_use_details_for_viewer_cb(srv_mms_result_enum result, void *msgrsp, S32 user_data);
...
mmi_umms_app_dtmgr_context g_dtmgr_cntx[MMI_UMMS_MAX_DTMGR_HANDLES];

mmi_umms_app_dtmgr_confrim_screen_struct g_umms_app_app_dtmgr_confirm_scr_data;

/**************************for popup data ***********************************/
mmi_umms_app_dtmgr_popup_screen_struct g_mms_app_dtmgr_popup_scr_data;
mmi_umms_app_dtmgr_callback_popup_screen_struct g_mms_app_dtmgr_callback_popup_scr_data;
mmi_umms_app_dtmgr_infinite_popup_screen_struct g_mms_app_dtmgr_infinite_popup_scr_data;
...
U16 g_umms_phb_cui_id = 0;
U16 g_umms_fmgr_cui_id = 0;
