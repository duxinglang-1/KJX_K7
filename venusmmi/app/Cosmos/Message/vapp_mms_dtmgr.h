...
extern MMI_UMMS_ERROR mmi_umms_app_dtmgr_get_option_scr_sync_data(mmi_umms_app_dtmgr_option_scr_data_struct *data, MMI_BOOL is_viewer_flow, void* success_cb);
...
extern void mmi_umms_app_dtmgr_get_viewer_data_ready_cb(srv_mms_result_enum result, void *msgrsp, S32 user_data);
...
#endif 
#if (defined(JPG_ENCODE) && defined(__MMI_MMS_2__))
#ifndef __MMI_MMS_MEGA_PIXEL_SUPPORT__
#define __MMI_MMS_MEGA_PIXEL_SUPPORT__
#endif 
#endif /* (defined(JPG_ENCODE) && defined(__MMI_MMS_2__)) */ 
...
typedef struct
{
    ...
    S8 *delivery_time_list[SRV_DELIEVERY_TOTAL];
...
extern MMI_UMMS_ERROR mmi_umms_app_dtmgr_check_template_count(void);
...
extern void mmi_umms_app_dtmgr_set_confirm_screen_para(U16 lsk_str_id,  /* String id of LSK */
                                                       ...
                                                       MMI_BOOL need_csk,
                                                       void (*lsk_handler) (void),
                                                       void (*rsk_handler) (void),void (*exit_screen) (void), mmi_ret del_scr_handler);
...
//extern void mmi_umms_app_dtmgr_handle_action_on_curr_msg(mmi_um_iter_viewer_result_struct other_msg_data, U8 folder_id, void *user_data);
...
#endif
extern MMI_BOOL mmi_umms_app_dtmgr_add_node_to_addr_list(srv_mms_addr_struct **list, srv_mms_msg_addr_info_struct *node);
extern void mmi_umms_app_dtmgr_forward_option_scrn_data(S32 result, U32 user_data);
extern void mmi_umms_app_dtmgr_forward_viewer_option_scrn_data(S32 result, U32 user_data);
