...
const mmi_umms_app_cntrlr_struct g_umms_app_cntrlrDB[] = 
{
    ...
    /* -----------------------------Niraj-----------------------------------------------// */
    {
     ...
     mmi_umms_app_cntrlr_setting_common_create_func,
     mmi_umms_app_cntrlr_setting_common_pre_func,
     mmi_umms_app_cntrlr_setting_common_post_func,
     mmi_umms_app_cntrlr_setting_common_show_func,
     NULL,
