...
#ifndef __VAPP_MMSSETTINGCM_H__
#define __VAPP_MMSSETTINGCM_H__
...
class VappMMSSetCreationPage : public VfxPage, public IVcpListMenuContentProvider
{
    VFX_DECLARE_CLASS(VappMMSSetCreationPage);
...
class VappMMSSetPicResizePage : public VfxPage, public IVcpListMenuContentProvider
{
    VFX_DECLARE_CLASS(VappMMSSetPicResizePage);
