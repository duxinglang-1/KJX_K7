...
#ifndef __VAPP_MMSSETTING_SEND_H__
#define __VAPP_MMSSETTING_SEND_H__
...
class VappMMSSetSendPrioPage : public VfxPage, public IVcpListMenuContentProvider
{
    VFX_DECLARE_CLASS(VappMMSSetSendPrioPage);
...
class VappMMSSetSendValidPage : public VfxPage, public IVcpListMenuContentProvider
{
    VFX_DECLARE_CLASS(VappMMSSetSendValidPage);
...
class VappMMSSetSendDeliveryPage : public VfxPage, public IVcpListMenuContentProvider
{
    VFX_DECLARE_CLASS(VappMMSSetSendDeliveryPage);
...
#endif
#endif /* __MMI_MMS_2__ */
#endif /* __VAPP_MMSSETTING_SEND_H__ */
