...
#ifndef __VAPP_SNS_ALBUMS_H__
#define __VAPP_SNS_ALBUMS_H__
...
class VappSnsMyAlbumsPage : public VappSnsBasePage
{
    VFX_DECLARE_CLASS(VappSnsMyAlbumsPage);
...
class VappSnsBaseAlbumAccLauncherCell : public VcpFormItemLauncherCell
{
    VFX_DECLARE_CLASS(VappSnsBaseAlbumAccLauncherCell);
protected:
    virtual void onInit(void);
    virtual void onDeinit(void);
    
public:
    void setAccount(srv_sns_account_struct *account);
    srv_sns_account_struct* getAccount(void);
