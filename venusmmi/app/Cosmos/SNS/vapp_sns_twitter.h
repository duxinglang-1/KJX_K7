 ...
 * Include
 *****************************************************************************/
#ifndef __VAPP_SNS_TWITTER_H__
#define __VAPP_SNS_TWITTER_H__
 ...
 */
class VappSnsTwtToolBarController : public VappSnsToolBarController
{
    VFX_DECLARE_CLASS(VappSnsTwtToolBarController);

// Constructor / Destructor
public:
    // Default constructor.
    VappSnsTwtToolBarController();

    // Default destructor.
    virtual ~VappSnsTwtToolBarController();
...
private:
    ...
    // Is allow retweet flag
    VfxBool m_allowRetweet;
    
    // Is retweet flag
    VfxBool m_isRetweeted;

};


class VappTwitterFactory : public VappSnsFactory
{
    VAPP_SNS_DECLARE_CLASS(VappTwitterFactory);
