...
#ifndef __VAPP_SCREEN_LOCK_COSMOS_CALL_CARD_H__
#define __VAPP_SCREEN_LOCK_COSMOS_CALL_CARD_H__
 ...
 * Class 
 *****************************************************************************/
class VappScreenLockCallCard : public VappScreenLockCard
{
    VAPP_SCREEN_LOCK_UNLOCK_ITEM_DECLARE_CLASS(VappScreenLockCallCard);
...
#endif /* __VAPP_SCREEN_LOCK_COSMOS_CALL_CARD_H__ */
