 ...
 * Filename:
 * ---------
 *  vapp_screen_lock_camcoder_card.cpp
 *
 * Project:
 * --------
 *  Venus
...
#include "vapp_screen_lock_cosmos_camcoder_card.h"
 ...
 * Function
 *****************************************************************************/
VAPP_SCREEN_LOCK_UNLOCK_ITEM_IMPLEMENT_CLASS(VappScreenLockCamcoderCard, VappScreenLockCard);

VappScreenLockCamcoderCard::VappScreenLockCamcoderCard()
{
}

void VappScreenLockCamcoderCard::onClicked()
{
}

void VappScreenLockCamcoderCard::onReleased()
{
}

void VappScreenLockCamcoderCard::onUnlocked()
{
...
void VappScreenLockCamcoderCard::onInit()
{
    ...
    m_imgIcon->setResId(IMG_ID_VAPP_SCREEN_LOCK_CARD_ICON_CAMCODER);
...
void VappScreenLockCamcoderCard::onDeinit()
{
