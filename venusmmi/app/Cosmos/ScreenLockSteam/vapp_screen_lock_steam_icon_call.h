 ...
 * Filename:
 * ---------
 *  vapp_steam_screen_lock_icon_call.h
 *
 * Project:
 * --------
 *  Venus
...
#ifndef __VAPP_SCREEN_LOCK_STEAM_ICON_CALL_H__
#define __VAPP_SCREEN_LOCK_STEAM_ICON_CALL_H__
 ...
 * Class 
 *****************************************************************************/
class VappSteamScreenLockIconCall : public VappSteamScreenLockIcon
{
    VAPP_SCREEN_LOCK_UNLOCK_ITEM_DECLARE_CLASS(VappSteamScreenLockIconCall);
...
private:
    ...
    VfxMaterial             *m_colMaterial;
    VfxKeyframeTimeline     *m_tlRotateIcon;
    VfxKeyframeTimeline     *m_tlShakeIcon;
    VfxFloatTimeline        *m_tlRef;
};

#endif /* __COSMOS_3D_SCREEN_LOCK__*/
#endif /* __VAPP_SCREEN_LOCK_STEAM_ICON_CALL_H__ */
