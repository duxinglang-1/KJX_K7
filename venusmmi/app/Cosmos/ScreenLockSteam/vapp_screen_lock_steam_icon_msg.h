 ...
 * Filename:
 * ---------
 *  vapp_steam_screen_lock_icon_msg.h
 *
 * Project:
 * --------
 *  Venus
...
#ifndef __VAPP_SCREEN_LOCK_STEAM_ICON_MSG_H__
#define __VAPP_SCREEN_LOCK_STEAM_ICON_MSG_H__
 ...
 * Class 
 *****************************************************************************/
class VappSteamScreenLockIconMsg : public VappSteamScreenLockIcon
{
    VAPP_SCREEN_LOCK_UNLOCK_ITEM_DECLARE_CLASS(VappSteamScreenLockIconMsg);
...
#endif /* __VAPP_SCREEN_LOCK_STEAM_ICON_MSG_H__ */
