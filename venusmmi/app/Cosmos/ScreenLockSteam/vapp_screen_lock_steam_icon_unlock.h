 ...
 * Filename:
 * ---------
 *  vapp_steam_screen_lock_icon_unlock.h
 *
 * Project:
 * --------
 *  Venus
...
#ifndef __VAPP_SCREEN_LOCK_STEAM_ICON_UNLOCK_H__
#define __VAPP_SCREEN_LOCK_STEAM_ICON_UNLOCK_H__
 ...
 * Class 
 *****************************************************************************/
class VappSteamScreenLockIconUnlock : public VappSteamScreenLockIcon
{
    VAPP_SCREEN_LOCK_UNLOCK_ITEM_DECLARE_CLASS(VappSteamScreenLockIconUnlock);
...
#endif /* __VAPP_SCREEN_LOCK_STEAM_ICON_UNLOCK_H__ */
