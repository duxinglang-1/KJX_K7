...
#ifndef VAPP_SCREEN_LOCK_STEAM_UNLOCK_ITEM_FACTORY_H
#define VAPP_SCREEN_LOCK_STEAM_UNLOCK_ITEM_FACTORY_H
...
typedef enum
{
    ...
    VAPP_SCREEN_LOCK_STEAM_UNLOCK_ITEM_TYPE_TOTAL,

    VAPP_SCREEN_LOCK_STEAM_UNLOCK_ITEM_TYPE_INVALID
    
} VappScreenLockSteamUnlockItemTypeEnum;
...
typedef enum
{
    VAPP_SCREEN_LOCK_STEAM_UNLOCK_ITEM_LEFT = 0,
        
    VAPP_SCREEN_LOCK_STEAM_UNLOCK_ITEM_MIDDLE,
    
    VAPP_SCREEN_LOCK_STEAM_UNLOCK_ITEM_RIGHT
} VappScreenLockSteamUnlockItemPos;

/*****************************************************************************
 * Unlock Item Factory
 *****************************************************************************/

class VappScreenLockSteamUnlockItemFactory : public VfxObject
{
    VFX_DECLARE_CLASS(VappScreenLockSteamUnlockItemFactory);
...
public:
    ...
    public:
        // Default constructor
        createTableEntry() :
            m_type(VAPP_SCREEN_LOCK_STEAM_UNLOCK_ITEM_TYPE_INVALID),
            m_create(NULL)
        {
            // Do nothing.
        }
        ...
        createTableEntry(VappScreenLockSteamUnlockItemTypeEnum type, createFunc create) :
            m_type(type),
            m_create(create)
        {
            // Do nothing.
    ...
    public:
        ...
        VappScreenLockSteamUnlockItemTypeEnum m_type;
    ...
    public:
        ...
        // Construct a entry with the type and create function.
        configTableEntry(VappScreenLockSteamUnlockItemTypeEnum type) :
            m_type(type)
        {
            // Do nothing.
        }
...
// Constructor / Destructor
public:
    VappScreenLockSteamUnlockItemFactory();
...
public:
    ...
    VappScreenLockSteamUnlockItemTypeEnum getUnlockItemId(
...
#endif /* VAPP_SCREEN_LOCK_STEAM_UNLOCK_ITEM_FACTORY_H */
