...
/***************************************************************************** 
 * Class VappSyncPhoneAccntEditPage
 *****************************************************************************/
class VfxObject;
...
class VappSyncPhoneAccntEditPage : public VfxPage
{
	VFX_DECLARE_CLASS(VappSyncPhoneAccntEditPage);

public:
	VappSyncPhoneAccntEditPage(const VfxS32 &accntIndex = 0);
	virtual ~VappSyncPhoneAccntEditPage(){}

	enum 
	{	
		ID_FORM_CELL_EDIT_LAUNCH_NAME,
		ID_FORM_CELL_EDIT_LAUNCH_SEL_DATABASE,
...
private:
	...
	void onSelectDatabaseDone(VfxObject *obj, VfxU32 index);
