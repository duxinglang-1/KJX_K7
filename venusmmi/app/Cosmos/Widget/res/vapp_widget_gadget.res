 ...
 * Description:
 * ------------
 *  This file defines the gadget's resources.
 *
 * Author:
 * -------
...
<APP id="VAPP_WIDGET_GADGET">
    ...
    <!-- Event Area (Receiver) ------------------------------------------------>
    <RECEIVER id="EVT_ID_VAPP_WIDGET_SYS_INIT" proc="VappWidgetGadgetFactoryPublisher"/>
