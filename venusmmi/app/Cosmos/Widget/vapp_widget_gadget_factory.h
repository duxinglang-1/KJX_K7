 ...
 * Description:
 * ------------
 *  This file defines the gadget widget factory.
 *
 * Author:
 * -------
 * -------
...
#ifndef VAPP_WIDGET_GADGET_FACTORY_H
#define VAPP_WIDGET_GADGET_FACTORY_H
...
class VappWidgetGadgetFactory : public VappWidgetFactory
{
    VAPP_WIDGET_FACTORY_DECLARE_CLASS(VappWidgetGadgetFactory);
...
#endif /* VAPP_WIDGET_GADGET_FACTORY_H */
