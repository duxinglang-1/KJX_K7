 ...
 *****************************************************************************/
class VappWidgetGallerySettingIntervalCell : public VcpFormItemLauncherCell
{
    VFX_DECLARE_CLASS(VappWidgetGallerySettingIntervalCell);
 ...
 *****************************************************************************/
class VappWidgetGallerySettingIntervalListPage : public VfxPage, public IVcpListMenuContentProvider
{
    VFX_DECLARE_CLASS(VappWidgetGallerySettingIntervalListPage);
...
extern VfxMsec vapp_widget_gallery_set_get_slide_show_timeout_value_in_msec(void);
