...
//
    ...
    #define VAPP_WIDGET_IDLE_FG_SIZE   			((240 - (8 * 2))*(192 - (8 * 2))*(2)*(4)*(1))
    #define VAPP_WIDGET_DETAILS_FG_SIZE			(((240) * (320) * (2) * (COLOR_FORMAT_BITS_NUM + 1)))
#elif defined(__MMI_MAINLCD_240X400__)
    #define VAPP_WIDGET_IDLE_FG_SIZE				((240 - (8 * 2))*(275 - (8 * 2))*(2)*(4)*(1))
    #define VAPP_WIDGET_DETAILS_FG_SIZE			(((240) * (400) * (2) * (COLOR_FORMAT_BITS_NUM + 1)))  
#elif defined(__MMI_MAINLCD_320X480__)
    #define VAPP_WIDGET_IDLE_FG_SIZE				((320 - (10 * 2))*(320 - (10 * 2))*(2)*(4)*(1))
    #define VAPP_WIDGET_DETAILS_FG_SIZE			(((320) * (480) * (2) * (COLOR_FORMAT_BITS_NUM + 1)))
#elif defined(__MMI_MAINLCD_480X800__)
    #define VAPP_WIDGET_IDLE_FG_SIZE				((480 - (18 * 2))*(550 - (18 * 2))*(2)*(4)*(1))
    #define VAPP_WIDGET_DETAILS_FG_SIZE			(((480) * (800) * (2) * (COLOR_FORMAT_BITS_NUM + 1)))
#else
    #define VAPP_WIDGET_IDLE_FG_SIZE   			(LCD_WIDTH * LCD_HEIGHT *(2)*(4)*(1))
    #define VAPP_WIDGET_DETAILS_FG_SIZE			(LCD_WIDTH * LCD_HEIGHT * 2 * (COLOR_FORMAT_BITS_NUM + 1)))
