 ...
 * Description:
 * ------------
 *  COSMOS Call Log global prot header file
 *
 * Author:
 * -------
 * -------
...
#ifndef __VAPP_CALL_LOG_GPROT_H__
#define __VAPP_CALL_LOG_GPROT_H__
...
extern VfxBool vapp_clog_usage_checking_hdlr(void);
/* clog enter event struct */
typedef struct
{
    MMI_EVT_PARAM_HEADER
        
    void *userdata;
} vapp_clog_evt_struct;



#endif /* __VAPP_CALL_LOG_GPROT_H__ */
