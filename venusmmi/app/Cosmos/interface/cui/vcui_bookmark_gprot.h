...
#ifndef _VCUI_BOOKMARK_GPROT_H_
#define _VCUI_BOOKMARK_GPROT_H_
...
#define VCUI_BKM_MAX_URL_LEN                         (1024)
#elif (defined (OBIGO_Q05A) || defined (OBIGO_Q03C_BROWSER))
#define VCUI_BKM_MAX_URL_LEN                         (255)
#else
#define VCUI_BKM_MAX_URL_LEN                         (0)        /* Dummy for BROWSER_SUPPORT = NONE */
#define VCUI_BKM 65500
#endif
...
typedef enum
{
    /* vcui_bkm_sel_bkm_result_evt_struct */
    EVT_ID_VCUI_BKM_SEL_BKM_RESULT = (VCUI_BKM + 1),

    /* vcui_bkm_add_bkm_result_evt_struct */
    EVT_ID_VCUI_BKM_ADD_BKM_CLOSE
} cui_bkm_evt_enum;
...
typedef struct
{
    ...
    /* Bookmark CUI need to allocate memory for *selected_utf8_title. 
       ...
       vcui_bookmark_select_bookmark_close(). If user do not select bookmark or 
