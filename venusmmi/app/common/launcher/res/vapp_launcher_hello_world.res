 ...
 * Description:
 * ------------
 *  This file defines the resoruces of the hello world launcher.
 *
 * Author:
 * -------
...
<APP id="VAPP_LAUNCHER_HELLOWORLD">
    ...
    <RECEIVER id="EVT_ID_VAPP_LAUNCHER_SYS_INIT" proc="VappLauncherHelloWorldPublisher"/>
