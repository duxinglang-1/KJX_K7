...
<APP id="VAPP_LAUNCHER_SYSTEM">
    ...
    <EVENT id="EVT_ID_VAPP_LAUNCHER_SYS_INIT" type="SENDER"/>


    <!-- Event Area (Receiver) ------------------------------------------------>

    <RECEIVER id="EVT_ID_VAPP_LAUNCHER_SYS_INIT" proc="VappLauncherNativeFactoryPublisher"/>
