 ...
 * Description:
 * ------------
 *  This file implements the MRE launcher factory.
 *
 * Author:
 * -------
 * -------
...
#ifndef VAPP_LAUNCHER_MRE_FACTORY_H
#define VAPP_LAUNCHER_MRE_FACTORY_H
...
class VappLauncherMreFactory : public VappLauncherFactory
{
    VAPP_LAUNCHER_FACTORY_DECLARE_CLASS(VappLauncherMreFactory);
...
#endif /* VAPP_LAUNCHER_MRE_FACTORY_H */
