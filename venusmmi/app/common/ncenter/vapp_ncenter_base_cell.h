...
protected:
    ...
    void onButtonClickInt(VfxObject* sender, VfxId id);
...
// method
public:
    void setContentFrame(VfxFrame *);
    VfxFrame* getContentFrame() { return m_content.get(); };
    VappNCenterListCellType getType() { return m_type; };
...
private:
    VfxBool checkIsFocusable(VfxS32 index);
#endif    
};
