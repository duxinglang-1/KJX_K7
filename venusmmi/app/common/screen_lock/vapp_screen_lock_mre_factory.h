 ...
 * Filename:
 * ---------
 *  vapp_screen_lock_mre_factory.h
 *
 * Project:
 * --------
 *  MAUI
...
#ifndef VAPP_SCREEN_LOCK_MRE_FACTORY_H
#define VAPP_SCREEN_LOCK_MRE_FACTORY_H
...
class VappScreenLockMreFactory : public VappScreenLockFactory
{
    VAPP_SCREEN_LOCK_FACTORY_DECLARE_CLASS(VappScreenLockMreFactory);
...
public:
    ...
    {
        return VAPP_SCREEN_LOCK_SRC_MRE;
    }
...
#endif /* VAPP_SCREEN_LOCK_MRE_FACTORY_H */
