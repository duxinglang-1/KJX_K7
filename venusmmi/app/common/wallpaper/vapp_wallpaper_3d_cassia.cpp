...
#include "mmi_rp_app_venus_wallpaper_3d_cassia_def.h"
 ...
 *****************************************************************************/
VFX_IMPLEMENT_CLASS("3D cassia Wallpaper", VappWallpaper3DCassia, VappWallpaper);

VappWallpaper3DCassia::VappWallpaper3DCassia()
...
void VappWallpaper3DCassia::onSerializeView()
{
    onReleaseView();
}

void VappWallpaper3DCassia::onRestoreView()
{
    onCreateView();
}

void VappWallpaper3DCassia::onCreateView()
{
    setPos(0, 0);
    ...
    // load the scene
    VfxAssetLoader::loadSceneBegin(m_world, VAPP_WALLPAPER_3D_CASSIA_SCN_CAMERA);
        VfxCamera * m_camera;
    ...
    m_worldCameraTimeline->setFromValue(0.5f);
    m_worldCameraTimeline->setToValue(0.5f);

    // load the animation
    VFX_OBJ_CREATE(m_worldCameraAnim, VfxAnimation, m_world);
    VfxAssetLoader::loadAnimation(m_worldCameraAnim,
                                  m_world,
                                  VAPP_WALLPAPER_3D_CASSIA_SCN_CAMERA_ANIM);
    ...
    // load the scene
    VfxAssetLoader::loadSceneBegin(m_world, VAPP_WALLPAPER_3D_CASSIA_SCN);
    VfxAssetLoader::loadSceneEnd();
    ...
    VfxAssetLoader::loadAnimation(m_worldAnim,
                                  m_world,
                                  VAPP_WALLPAPER_3D_CASSIA_SCN_ANIM);
    ...
    // load the scene
    VfxAssetLoader::loadSceneBegin(m_petals, VAPP_WALLPAPER_3D_CASSIA_PETALS_SCN);
    VfxAssetLoader::loadSceneEnd();
    ...
    VfxAssetLoader::loadAnimation(m_petalsAnim,
                                  m_petals,
                                  VAPP_WALLPAPER_3D_CASSIA_PETALS_ANIM);
    ...
    // load the scene
    VfxAssetLoader::loadSceneBegin(m_butterfly, VAPP_WALLPAPER_3D_CASSIA_BUTTERFLY_SCN);
    VfxAssetLoader::loadSceneEnd();
    ...
    VfxAssetLoader::loadAnimation(m_butterflyAnim,
                                  m_butterfly,
                                  VAPP_WALLPAPER_3D_CASSIA_BUTTERFLY_ANIM);

    m_butterflyAnim->setTimelineTime(m_butterflytimeline);
    m_butterflytimeline->m_signalStopped.connect(this, &VappWallpaper3DCassia::onEndOfButterflyTimeline);
    if(!this->isSuspended())
    ...
    // load the scene
    VfxAssetLoader::loadSceneBegin(m_tree, VAPP_WALLPAPER_3D_CASSIA_BG_TREE_SCN);
    VfxAssetLoader::loadSceneEnd();
    ...
    VfxAssetLoader::loadAnimation(m_treeAnim,
                                  m_tree,
                                  VAPP_WALLPAPER_3D_CASSIA_BG_TREE_ANIM);
    ...
    VfxAssetLoader::loadSceneBegin(m_petals2, VAPP_WALLPAPER_3D_CASSIA_PETALS_FALL_SCN);
    VfxAssetLoader::loadSceneEnd();
    ...
    VfxAssetLoader::loadAnimation(m_petals2Anim,
                                  m_petals2,
                                  VAPP_WALLPAPER_3D_CASSIA_PETALS_FALL_ANIM);
...
/* under construction !*/
    ...
    m_motionSensorHandle = srv_sensor_start_listen(
                            ...
                            (void*)&threshold,
                            &VappWallpaper3DCassia::onMotionSensorEvent,
                            (void*)this);
#endif
}


void VappWallpaper3DCassia::onReleaseView()
{
...
MMI_IMG_ID VappWallpaper3DCassia::getThumbnail()
{
    return IMG_ID_VAPP_WALLPAPER_3D_CASSIA_THUMBNAIL;
}

void VappWallpaper3DCassia::onSuspend()
{
...
void VappWallpaper3DCassia::onResume()
{
    m_worldTimeline->start();
    m_worldCameraTimeline->start();
    m_treetimeline->start();
...
VfxBool VappWallpaper3DCassia::onAllowSuspendOnSwipe()
{
    return VFX_FALSE;
}

VfxBool VappWallpaper3DCassia::onAllowSuspendOnPenDown()
{
    return VFX_FALSE;
}

VfxBool VappWallpaper3DCassia::onPenInput(VfxPenEvent &event)
{
    switch (event.type)
    {
...
void VappWallpaper3DCassia::onDesktopBoundsChanged(
...
void VappWallpaper3DCassia::onEndOfButterflyTimeline(VfxBaseTimeline *timeline, VfxBool isCompleted)
{
    if(isCompleted)
    {
        m_butterflytimeline->setDuration(6000);
...
void VappWallpaper3DCassia::onMotionSensorEvent(srv_sensor_type_enum type, void *sensor_data, void *user_data)
{
#if defined(MOTION_SENSOR_SUPPORT)
#if 0
/* under construction !*/
...
/* under construction !*/
    ...
    {
        VappWallpaper3DCassia *obj = (VappWallpaper3DCassia*)user_data;
