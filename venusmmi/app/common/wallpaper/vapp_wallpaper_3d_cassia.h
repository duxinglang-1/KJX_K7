...
#ifndef __VAPP_WALLPAPER_3D_CASSIA_H__
#define __VAPP_WALLPAPER_3D_CASSIA_H__
 ...
 *****************************************************************************/
class VappWallpaper3DCassia : public VappWallpaper
{
    VFX_DECLARE_CLASS(VappWallpaper3DCassia);

    VAPP_WALLPAPER_CREATE(VappWallpaper3DCassia);
...
#endif /* __VAPP_WALLPAPER_3D_CASSIA_H__ */
#endif /* __MMI_VUI_HOMESCREEN_LIVE_WALLPAPER_3D_CASSIA__ */
