...
#ifndef __VAPP_WALLPAPER_3D_MAPLE_H__
#define __VAPP_WALLPAPER_3D_MAPLE_H__
 ...
 *****************************************************************************/
class VappWallpaper3DMaple : public VappWallpaper
{
    VFX_DECLARE_CLASS(VappWallpaper3DMaple);

    VAPP_WALLPAPER_CREATE(VappWallpaper3DMaple);
...
#endif /* __VAPP_WALLPAPER_3D_MAPLE_H__ */
#endif /* __MMI_VUI_HOMESCREEN_LIVE_WALLPAPER_3D_MAPLE__ */
