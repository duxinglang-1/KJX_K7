...
#include "mmi_rp_app_venus_wallpaper_3d_sakura_def.h"
 ...
 *****************************************************************************/
VFX_IMPLEMENT_CLASS("3D sakura Wallpaper", VappWallpaper3DSakura, VappWallpaper);

VappWallpaper3DSakura::VappWallpaper3DSakura()
...
void VappWallpaper3DSakura::onSerializeView()
{
    onReleaseView();
}

void VappWallpaper3DSakura::onRestoreView()
{
    onCreateView();
}

void VappWallpaper3DSakura::onCreateView()
{
    setPos(0, 0);
    ...
    // load the scene
    VfxAssetLoader::loadSceneBegin(m_world, VAPP_WALLPAPER_3D_SAKURA_SCN_CAMERA);
        VfxCamera * m_camera;
    ...
    VfxAssetLoader::loadAnimation(m_worldCameraAnim,
                                  m_world,
                                  VAPP_WALLPAPER_3D_SAKURA_SCN_CAMERA_ANIM);
    ...
    // load the scene
    VfxAssetLoader::loadSceneBegin(m_world, VAPP_WALLPAPER_3D_SAKURA_SCN);
    VfxAssetLoader::loadSceneEnd();
    ...
    VfxAssetLoader::loadAnimation(m_worldAnim,
                                  m_world,
                                  VAPP_WALLPAPER_3D_SAKURA_SCN_ANIM);
    ...
    // load the scene
    VfxAssetLoader::loadSceneBegin(m_petals, VAPP_WALLPAPER_3D_SAKURA_PETALS_SCN);
    VfxAssetLoader::loadSceneEnd();
    ...
    VfxAssetLoader::loadAnimation(m_petalsAnim,
                                  m_petals,
                                  VAPP_WALLPAPER_3D_SAKURA_PETALS_ANIM);
    ...
    // load the scene
    VfxAssetLoader::loadSceneBegin(m_butterfly, VAPP_WALLPAPER_3D_SAKURA_BUTTERFLY_SCN);
    VfxAssetLoader::loadSceneEnd();
    ...
    VfxAssetLoader::loadAnimation(m_butterflyAnim,
                                  m_butterfly,
                                  VAPP_WALLPAPER_3D_SAKURA_BUTTERFLY_ANIM);

    m_butterflyAnim->setTimelineTime(m_butterflytimeline);
    m_butterflytimeline->m_signalStopped.connect(this, &VappWallpaper3DSakura::onEndOfButterflyTimeline);
    if(!this->isSuspended())
    ...
    // load the scene
    VfxAssetLoader::loadSceneBegin(m_tree, VAPP_WALLPAPER_3D_SAKURA_BG_TREE_SCN);
    VfxAssetLoader::loadSceneEnd();
    ...
    VfxAssetLoader::loadAnimation(m_treeAnim,
                                  m_tree,
                                  VAPP_WALLPAPER_3D_SAKURA_BG_TREE_ANIM);
    ...
    VfxAssetLoader::loadSceneBegin(m_petals2, VAPP_WALLPAPER_3D_SAKURA_PETALS_FALL_SCN);
    VfxAssetLoader::loadSceneEnd();
    ...
    VfxAssetLoader::loadAnimation(m_petals2Anim,
                                  m_petals2,
                                  VAPP_WALLPAPER_3D_SAKURA_PETALS_FALL_ANIM);
...
/* under construction !*/
    ...
    m_motionSensorHandle = srv_sensor_start_listen(
                            ...
                            (void*)&threshold,
                            &VappWallpaper3DSakura::onMotionSensorEvent,
                            (void*)this);
#endif
}


void VappWallpaper3DSakura::onReleaseView()
{
...
MMI_IMG_ID VappWallpaper3DSakura::getThumbnail()
{
    return IMG_ID_VAPP_WALLPAPER_3D_SAKURA_THUMBNAIL;
}

void VappWallpaper3DSakura::onSuspend()
{
...
void VappWallpaper3DSakura::onResume()
{
    m_worldTimeline->start();
    m_worldCameraTimeline->start();
    m_treetimeline->start();
...
VfxBool VappWallpaper3DSakura::onAllowSuspendOnSwipe()
{
    return VFX_FALSE;
}

VfxBool VappWallpaper3DSakura::onAllowSuspendOnPenDown()
{
    return VFX_FALSE;
}

VfxBool VappWallpaper3DSakura::onPenInput(VfxPenEvent &event)
{
    switch (event.type)
    {
...
void VappWallpaper3DSakura::onDesktopBoundsChanged(
...
void VappWallpaper3DSakura::onEndOfButterflyTimeline(VfxBaseTimeline *timeline, VfxBool isCompleted)
{
    if(isCompleted)
    {
        m_butterflytimeline->setDuration(6000);
...
void VappWallpaper3DSakura::onMotionSensorEvent(srv_sensor_type_enum type, void *sensor_data, void *user_data)
{
#if defined(MOTION_SENSOR_SUPPORT)
#if 0
/* under construction !*/
...
/* under construction !*/
    ...
    {
        VappWallpaper3DSakura *obj = (VappWallpaper3DSakura*)user_data;
