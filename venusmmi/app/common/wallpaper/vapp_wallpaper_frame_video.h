...
#ifndef __VAPP_WALLPAPER_FRAME_VIDEO_H__
#define __VAPP_WALLPAPER_FRAME_VIDEO_H__
 ...
 *****************************************************************************/
class VappWallpaperFrameVideo : public VappWallpaper
{
    VFX_DECLARE_CLASS(VappWallpaperFrameVideo);

    VAPP_WALLPAPER_CREATE(VappWallpaperFrameVideo);
...
class VappFrameVideoDraw : public VfxOwnerDraw
{
// Constructor
public:
    // Default constructor
...
// Override
public:
    static vrt_render_dirty_type_enum VappFrameVideoDraw::onUpdate(
    ...
    static VfxU32 getMaxSrcBufSize();
    static VfxU32 getMaxDstBufSize();
...
#endif /* __VAPP_WALLPAPER_FRAME_VIDEO_H__ */
