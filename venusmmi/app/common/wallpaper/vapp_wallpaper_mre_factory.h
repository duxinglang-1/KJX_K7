 ...
 * Description:
 * ------------
 *  This file implements the MRE wallpaper factory.
 *
 * Author:
 * -------
 * -------
 ...
 *============================================================================
 ****************************************************************************/
#ifndef VAPP_WALLPAPER_MRE_FACTORY_H
#define VAPP_WALLPAPER_MRE_FACTORY_H
...
class VappWallpaperMreFactory : public VappWallpaperFactory
{
    VAPP_WALLPAPER_FACTORY_DECLARE_CLASS(VappWallpaperMreFactory);
...
#endif /* VAPP_WALLPAPER_MRE_FACTORY_H */
