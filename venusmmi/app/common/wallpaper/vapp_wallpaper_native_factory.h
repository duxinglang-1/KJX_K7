 ...
 * Filename:
 * ---------
 *  vapp_wallpaper_native_factory.h
 *
 * Project:
 * --------
 *  MAUI
...
#ifndef VAPP_WALLPAPER_NATIVE_FACTORY_H
#define VAPP_WALLPAPER_NATIVE_FACTORY_H
...
class VappWallpaperNativeFactory : public VappWallpaperFactory
{
    VAPP_WALLPAPER_FACTORY_DECLARE_CLASS(VappWallpaperNativeFactory);

// Constructor / Destructor
public:
    // Default constructor
    VappWallpaperNativeFactory();
...
// Variable
private:
    VfxS32 getLiveWallpaperindex(VfxS32 number) const;

};

#endif /* VAPP_WALLPAPER_NATIVE_FACTORY_H */
