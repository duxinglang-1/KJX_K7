...
#ifndef VAPP_WALLPAPER_USER_FILE_FACTORY_H
#define VAPP_WALLPAPER_USER_FILE_FACTORY_H
 ...
 *****************************************************************************/
class VappWallpaperUserFileFactory : public VappWallpaperFactory
{
    VAPP_WALLPAPER_FACTORY_DECLARE_CLASS(VappWallpaperUserFileFactory);

// Constructor / Destructor
public:
    // Default constructor
    VappWallpaperUserFileFactory();
...
private:
    VappWallpaper* createWallpaperByUserFile(const VfxWString &userFile);
};

#endif /* VAPP_WALLPAPER_USER_FILE_FACTORY_H */
