...
#ifndef VAPP_WIDGET_FACTORY_H
#define VAPP_WIDGET_FACTORY_H
 ...
 */
#define VAPP_WIDGET_FACTORY_DECLARE_CLASS(_className)                       \
 ...
 */
#define VAPP_WIDGET_FACTORY_IMPLEMENT_CLASS(_className)                     \
    VFX_IMPLEMENT_CLASS(#_className, _className, VappWidgetFactory);        \
    VFX_OBJ_IMPLEMENT_SINGLETON_CLASS(_className)

/*
 * Widget Factory Base Class
 */
class VappWidgetFactory : public VfxObject
{
    VFX_DECLARE_CLASS(VappWidgetFactory);
...
public:
    ...
    virtual VappWidgetSrcEnum getSource() const = 0;
    ...
    virtual VfxS32 getAllId(
        VappWidgetId **id,              // [OUT] Id of all the widget
    ...
    virtual VappWidget *createWidget(
        const VappWidgetId &id,         // [IN] Id of the widget
