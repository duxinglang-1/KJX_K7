 ...
 * Description:
 * ------------
 *  This file defines the MRE widget factory.
 *
 * Author:
 * -------
 * -------
...
#ifndef VAPP_WIDGET_MRE_FACTORY_H
#define VAPP_WIDGET_MRE_FACTORY_H
...
class VappWidgetMreFactory : public VappWidgetFactory
{
    VAPP_WIDGET_FACTORY_DECLARE_CLASS(VappWidgetMreFactory);
...
#endif /* VAPP_WIDGET_MRE_FACTORY_H */
