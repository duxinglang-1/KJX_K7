 ...
 * Filename:
 * ---------
 *  vapp_widget_shortcut_factory.h
 *
 * Project:
 * --------
 *  MAUI
...
#ifndef VAPP_WIDGET_SHORTCUT_FACTORY_H
#define VAPP_WIDGET_SHORTCUT_FACTORY_H
...
class VappWidgetShortcutFactory : public VappWidgetFactory
{
    VAPP_WIDGET_FACTORY_DECLARE_CLASS(VappWidgetShortcutFactory);
...
public:
    ...
    {
        return VAPP_WIDGET_SRC_SHORTCUT;
    }
...
#endif /* VAPP_WIDGET_SHORTCUT_FACTORY_H */
