 ...
 * Description:
 * ------------
 *  This file implements the parts related to the widget system, e.g., the
...
/* Please refer to vapp_widget_system.h. */
void vapp_widget_sys_init(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    static VfxBool s_isInitialized = VFX_FALSE;
    vapp_widget_sys_init_evt_struct evt;
    ...
    if (!s_isInitialized)
    {
        MMI_FRM_INIT_EVENT(&evt, EVT_ID_VAPP_WIDGET_SYS_INIT);
