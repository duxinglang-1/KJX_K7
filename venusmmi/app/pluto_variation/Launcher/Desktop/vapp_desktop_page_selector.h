...
#ifndef VAPP_DESKTOP_PAGE_SELECTOR_H
#define VAPP_DESKTOP_PAGE_SELECTOR_H
...
class VappDesktopPageSelectorDebugPanel : public VfxControl
{
public:
    VappDesktopPageSelectorDebugPanel();
...
class VappDesktopPageSnapshot : public VfxControl
{
public:
    VappDesktopPageSnapshot();

public:
    VfxSignal1 <VappDesktopPageSnapshot *> m_signalTapped;
...
private:
    ...
    VfxRect m_insideRect;
    VfxRect m_outsideRect;
...
class VappDesktopPageSelector : public VfxControl
{
public:
    enum AbortCauseEnum
    {
...
public:
    ...
    VfxSignal1 <VappDesktopPageSelector *> m_signalAssembled;
    ...
    VfxSignal2 <VappDesktopPageSelector *, VfxS32> m_signalSelected;
    ...
    VfxSignal2 <VappDesktopPageSelector *, AbortCauseEnum> m_signalAborted;
    ...
    VfxSignal1 <VappDesktopPageSelector *> m_signalDismissed;
...
private:
    ...
    VappDesktopPageSnapshot *m_snapshot[VAPP_DESKTOP_MAX_PAGE_NUM];
...
private:
    ...
    void onSnapshotTapped(
        VappDesktopPageSnapshot *snapshot
    );
...
#if defined(VAPP_DESKTOP_UT_PAGE_SELECTOR_DEBUG_PANEL)
private:
    VappDesktopPageSelectorDebugPanel *m_debugPanel;
...
#endif /* VAPP_DESKTOP_PAGE_SELECTOR_H */
