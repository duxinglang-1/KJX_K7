 ...
 * Include
 *****************************************************************************/
#include "vapp_hs_widget_dclock.h"
...
VappHsWidgetDclock::VappHsWidgetDclock() :
    m_clock(NULL)
{
}


void VappHsWidgetDclock::onCreateView()
{
    // background image 
    setImgContent(VfxImageSrc(VAPP_HS_IMG_WG_DCLOCK_BG));
...
void VappHsWidgetDclock::onReleaseView()
{
