...
VappMultiTouchTest *g_vapp_multi_touch_test_scr;

void vadp_p2v_multi_touch_test_exit()
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    VFX_OBJ_CLOSE(g_vapp_multi_touch_test_scr);
    VfxAppCatScr::deinitalize();
}


void vadp_p2v_multi_touch_test_entry()
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    VFX_OBJ_CREATE(g_vapp_multi_touch_test_scr,
        VappMultiTouchTest, 
