...
/*****************************************************************************
 * FUNCTION
 *  vadp_p2v_photo_file_select_callback
 * DESCRIPTION
 *  The callback function of file manager browser
 * PARAMETERS
 *  path        [IN]        image path
 *  isShort    [IN]        file name is short or nots
 * RETURNS
 *  void
 *****************************************************************************/
void vadp_p2v_photo_file_select_callback(void *path, int isShort)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
